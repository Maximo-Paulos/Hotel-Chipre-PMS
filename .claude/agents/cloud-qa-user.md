...
Scope: Use the authorized production Render test hotel with synthetic data. Do not send email, complete payments, trigger webhooks, or contact OTAs. Block completion on any missing evidence.
