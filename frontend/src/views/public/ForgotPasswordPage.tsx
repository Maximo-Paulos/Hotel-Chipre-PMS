  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg ring-1 ring-slate-100">
        ...
        <p className="mb-4 text-sm text-slate-600">Enviaremos un codigo seguro a tu correo.</p>
        ...
        {sent && (
          <p className="mt-3 rounded-md bg-emerald-50 p-3 text-sm text-emerald-700">
            Si el email existe, enviamos un codigo de reset.
          </p>
        )}
        {debugCode && <p className="mt-2 rounded-md bg-amber-50 p-2 text-xs text-amber-800">Codigo demo: {debugCode}</p>}
