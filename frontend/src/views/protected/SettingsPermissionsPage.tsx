...
const permissionLabels: Record<string, string> = {
  ...
  "guest:view": "Ver huéspedes",
  "guest:create": "Crear huéspedes",
  "guest:edit": "Editar huespedes",
  "guest:tags": "Etiquetas de huesped",
  "guest:export": "Exportar datos de huéspedes",
  "reservation:create": "Crear reservas",
  "reservation:room_move": "Mover reservas",
  "reservation:charge": "Agregar consumos",
  "reservation:manual_rate": "Definir tarifa manual",
  "checkin:perform": "Check-in",
  "room:cleaning_status": "Alternar limpieza y libre",
  "room_block:create": "Crear bloqueos de habitación",
  "room_block:release": "Resolver bloqueos de habitación",
  ...
  "reports:operational:view": "Ver reportes operativos",
  "reports:financial:view": "Ver reportes financieros",
  "laundry:manage_vendors": "Administrar lavaderos y precios",
  "laundry:operate_remitos": "Operar remitos de lavandería",
