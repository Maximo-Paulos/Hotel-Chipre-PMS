...
// lives in the slide-over panel behind the menu button (B7). Choosing by
// viewport instead of by what has rendered so far keeps this deterministic
// while the shell is still loading on a slow machine.
