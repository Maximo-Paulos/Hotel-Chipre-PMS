...
## Corpus Check
- Large corpus: 1313 files · ~1,806,478 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 12608 nodes · 70862 edges · 581 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 23722 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 23722 · ON_BRANCH: 22780 · contains: 6851 · calls: 5065 · MODIFIES: 4661 · rationale_for: 3282 · imports: 1240 · imports_from: 997 · PARENT_OF: 859 · inherits: 721 · method: 680 · re_exports: 4
...
- Excluded: 0 untracked · 25430 ignored · 12 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `917de27`
...
Cohesion: 0.02
Nodes (580): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, daily_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c (+572 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (493): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+485 more)

### Community 2 - "Community 2"
Cohesion: 0.15
Nodes (475): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+467 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (266): add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Base (+258 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (213): occupancy_report(), Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+205 more)

### Community 5 - "Community 5"
Cohesion: 0.15
Nodes (221): CheckInRequest, FastAPI routes for Check-in / Check-out., cancel_reservation(), change_dates(), create_new_reservation(), create_or_update_manual_ota(), create_reservation_charge(), _ensure_action_permission() (+213 more)
...
Cohesion: 0.07
Nodes (102): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+94 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (44): _authorize_override(), checkin(), _collect_realtime_events_after_flush(), _discard_realtime_events_after_rollback(), _discard_realtime_events_after_root_soft_rollback(), _publish_realtime_events_after_commit(), Database engine and session management. Supports both PostgreSQL (production) an, Collect model changes while the transaction can still be rolled back. (+36 more)
...
Cohesion: 0.04
Nodes (58): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, 0f8da23 fix(tests): update invitation rate-limit test for persisted-invitation 400 (not 401), 165d047 fix(security): reduce rate limiter race window under concurrent requests, 429e62c fix(review): require the CSRF cookie explicitly, no silent fallback, 8a26166 fix(security): close secrets/logging/rate-limit gaps (TECH-0111), 9703fdc fix(security): close secrets/logging/rate-limit gaps (TECH-0111), a1caf63 fix(security): close secrets/logging/rate-limit gaps (TECH-0111), b0217a2 fix(security): close secrets/logging/rate-limit gaps (TECH-0111) (#68) (+50 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (20): 1165233 feat(backups): soft-delete + local restore drill for TECH-0110, 8d88259 Merge pull request #29 from Maximo-Paulos/codex/fix/full-functional-qa, f1644f3 feat(security): fail-closed external effects, RBAC narrowing, QA catalog v2, PermissionGateProps, owner, manager, credentials, owner (+12 more)
...
Cohesion: 0.05
Nodes (29): 307e650 Add replayable operational warehouse projections, 4d12b77 perf(backend): fix N+1 queries and missing indexes (TECH-0063), 7667a6b feat(jobs): add portable dispatch and worker heartbeats, 7e2edb6 Merge Analytics R1.0, af2ce63 perf(backend): fix N+1 queries and missing indexes (TECH-0063), b5bc141 Harden core tenant composite relationships, d852a9d perf(backend): fix N+1 queries and missing indexes (TECH-0063), df173d1 Implement Analytics R1.0 dashboard, chat IA, and support (+21 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (59): PermissionGate(), OnboardingWizard(), SettingsAssistantPage(), SettingsUsersPage(), PmsHoteleroPage(), PricingPage(), RegisterOwnerPage(), SoftwareParaHotelesPage() (+51 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (61): chore/weekly-orchestrator-2026-07-03, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 0a4396e Add multi-hotel isolation tests and bcrypt shim, 0c9034f Fix clsx reference in app shell, 0de2c27 Align deploy config and docs for Vercel, Render, and Cloudflare, 1861352 feat(R5b): production payments — MP preference §12.2, link delivery, company deferred §3.5 (+53 more)
...
Cohesion: 0.05
Nodes (52): validateGuestForCheckin(), add_reservation_guests(), addReservationCharge(), addReservationGuests(), buildQueryString(), cancelReservation(), CheckInPayload, checkInReservation() (+44 more)

### Community 26 - "Community 26"
Cohesion: 0.10
Nodes (59): codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, 15f1429 Refresh Graphify and generated system inventories, 15fca54 Merge pull request #22 from Maximo-Paulos/chore/claude-code-pro-setup, 1ca1c06 Fix PostgreSQL enum schema drift, 1da134a feat(R2a): expand audit coverage to business mutations (§26), 1efb927 Update orchestrator status: multi-agent audit blocked by plan session limits, 1f51d3d Record Redis + Playwright install and PR #20 in orchestrator log (+51 more)
...
Cohesion: 0.09
Nodes (56): codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista, 0f3e9a4 fix(auth): graceful token-expiry handling + 12h TTL, 107f875 Support legacy master admin underscore routes, 116a3bc chore: snapshot analysis artifacts, 127cb22 fix(frontend): make reservation/guest modals scrollable so footer buttons stay reachable, 1d1874d Add owner-only visibility panel for hotel config (+48 more)
...
Cohesion: 0.05
Nodes (24): Shared, secret-safe binding for the Render QA bootstrap configuration., Application Configuration. Uses pydantic-settings for environment variable manag, 19b8b7b Harden isolated preview QA and trusted release evidence, 365b263 Harden isolated QA bootstrap and provider evidence, 4cbb226 feat(infra): centralize ephemeral redis ports, 4d007b9 fix(migrations): chain Apple sign-in migration onto TECH-0110 soft-delete head, 50f02d8 feat(auth): secure google identity linking, 53f480f feat(auth): add Sign in with Apple, symmetric to Google OIDC (TECH-0024) (+16 more)
...
Cohesion: 0.07
Nodes (50): claude/feature/pms-roles-housekeeping-qa, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker, 05d296d Fix cash freshness after reservation payments, 07ea889 Record preview functional QA evidence, 0b2de37 Refresh Graphify for current tenant hardening, 1030f87 Refresh Graphify after serialized WebKit coverage, 14c3453 Fail closed when managed databases are not migrated (+42 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (34): Recover invalidation domains after a cursor without exposing payloads., recover_domain_events(), 0fc3f49 feat(realtime): add tenant-scoped recovery contract, 4c7ec61 docs(tech-0140): record realtime recovery baseline, 5616166 Merge pull request #90 from Maximo-Paulos/feature/realtime-collaboration, 8feca40 feat(tech-0140): close local release gate, 917de27 Fix realtime SSE fallback and Google initialization, 9aee997 Implement real-time synchronization and collaboration (+26 more)
...
Cohesion: 0.04
Nodes (16): _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Emit bounded HTTP timing fields and make correlation IDs observable., request_telemetry(), 1af6bfc Add demo seed script and README instructions for stage 1, 9385c0f Hardening multi-hotel scope and subscription enforcement, bad20c6 Gate startup email behind SMTP_STARTUP_NOTIFY and send once, ec54376 Add env example and GHCR build/push workflow (+8 more)
...
Cohesion: 0.06
Nodes (40): Base, FxPolicy, ProductRoomCompatibility, RatePlan, RatePlanPrice, Commercial domain models for the next reservation/OTA foundation.  These tables, SellableProduct, TaxPolicy (+32 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (36): Category, listCategories(), ApiError, apiFetch(), AuthResponsePayload, buildAuthHeaders(), buildUrl(), formatErrorDetail() (+28 more)
...
Cohesion: 0.07
Nodes (31): checkRoomAvailability(), createRoom(), createRoomCategory(), deleteRoom(), get_category(), get_room(), _housekeeping_room(), list_categories() (+23 more)
...
Cohesion: 0.07
Nodes (26): acceptInvitation(), auth_providers(), AuthProvidersResponse, AuthResponse, getInvitationInfo(), _google_allowed_domains(), _google_self_signup_enabled(), link_google() (+18 more)
...
Cohesion: 0.09
Nodes (26): cancelPaymentLinkTest(), createMercadoPagoPaymentLinkTest(), listPaymentLinkTests(), PaymentLinkTest, PaymentLinkTestCreatePayload, refreshPaymentLinkTest(), getSecurityEvents(), getSecurityOverview() (+18 more)
...
Cohesion: 0.07
Nodes (26): markReservationNoShow(), ReservationChargePayload, ReservationNoShowPayload, ReservationPayload, ReservationPendingAction, ReservationRoomMovePayload, ReservationRoomMoveResponse, ReservationSource (+18 more)
...
Cohesion: 0.10
Nodes (8): 1a71e7d feat: add ota allocation data foundation, 3f48c33 chore: snapshot current implementation state for analysis, a61a51c chore: checkpoint de prueba antes de gemma 4, c580b56 ojala si, fc9081b Revise AGENTS.md with updated guidelines and protocols, add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c, extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard, add trial and comped fields to subscriptions  Revision ID: 20260419_subscription

### Community 143 - "Community 143"
Cohesion: 0.10
Nodes (14): 77170cf feat(phase2): port movement-groups API (§5.4) wired to main service, 7fa8df6 feat(phase2): port reoptimization trigger (§5.2) from fervent, 83674a3 feat(phase2): port payment surcharges (§12.3) from fervent, 9d8f59f fix(phase5): correct MercadoPago webhook signature to manifest HMAC (security), a808f2c feat(phase3): harvest cranky net-new — @audited_change decorator + design docs, bdb51c9 test(phase2): port V72 test safety-net adapted to main (74 pass, 35 xfail), dd53b2c fix(phase2): rename surcharge constraint to avoid PG name collision, e7d7971 feat(phase6): NoSQL polyglot foundation — Redis/Mongo/Cassandra/Neo4j clients (+6 more)
...
Cohesion: 0.15
Nodes (12): ReservationGlobalSearch(), useReservationDrawer(), reservationsKey(), useReservations(), DashboardPage(), todayIso(), formatMoney(), formatterCache (+4 more)
...
Cohesion: 0.16
Nodes (13): IntegrationCatalog, IntegrationConnection, IntegrationEvent, Backward-compatible local name for the shared secret-encryption helper., Keep provider diagnostics useful without returning credential material., Backward-compatible local name for the shared secret-encryption helper., _Response, test_validate_gmail_credentials_requires_send_scope() (+5 more)
...
Cohesion: 0.13
Nodes (16): format_sse(), get_domain_event_outbox_metrics(), get_domain_event_recovery(), iter_postgres_event_stream(), _outbox_sse_payload(), Build a safe invalidation frame from a committed outbox row.      The PostgreSQL, Build a safe invalidation frame from a committed outbox row.      The PostgreSQL, Stream committed outbox invalidations when Redis is unavailable.      Each poll (+8 more)
...
Cohesion: 0.17
Nodes (8): ABC, EmailProvider, EmailProviderError, get_email_provider(), _normalize_display_from(), NullEmailProvider, ResendEmailProvider, Fail-closed boundary tests: disabled lanes do no parsing, DB work or network.
...
Cohesion: 0.17
Nodes (12): insert_historical_hotel_config(), Helpers for seeding schemas before a migration under test., Insert the hotel-config shape that existed before the 2026-08 changes.      Migr, _alembic(), Migration coverage for the deduplication sweep., test_category_pricing_rows_are_folded_into_hotel_scoped_price_periods(), _assert_migrated_state(), Regression/data-migration guard for 20260727_linen_split.  The owner explicitly (+4 more)
...
Cohesion: 0.20
Nodes (9): 55aa9af feat(reservations): tiered room-move permissions and guest room avoidance, a046d4a refactor(auth): migrate 21 unambiguous routes from require_roles to require_permission, _client(), _move(), test_receptionist_can_record_complaint_but_cannot_resolve_it(), test_second_complaint_reactivates_the_same_guest_room_row(), _function(), Regression contracts for routes migrated from the legacy role dependency.  These (+1 more)
...
Cohesion: 0.14
Nodes (2): Public WhatsApp bot hooks authenticated only by hotel API key., 805b47a Unify reservation pricing with signed quote contract
...
Cohesion: 0.14
Nodes (9): 2e14d9a Record owner cloud recheck evidence, 3cb353b Add reservation lifecycle E2E coverage, 9021c5c Explain reservation quote failures, a8f9e64 Refresh Graphify after reservation lifecycle coverage, aa8b60d Document report error regression evidence, b052ed0 Refresh Graphify after reservation quote fix, c28847a Refresh Graphify after report error fix, eb6f03a Make report failures actionable (+1 more)
...
Cohesion: 0.24
Nodes (6): admin_comped_override(), change_plan(), _remaining_trial_days(), _serialize_status_payload(), start_subscription_trial(), subscription_status()

### Community 261 - "Community 261"
Cohesion: 0.17
Nodes (9): 02c5612 Add tenant realtime sync and warehouse boundary, 2935fa8 Harden validate-all Python selection, 381fbb1 Expand release catalog and validation skill, 73c12e8 Refresh Graphify for validation gate, b8b52fa Harden permission seeding and mobile regression coverage, b933ce7 Silence disabled warehouse fallback, c95d147 Add staged preview load runner, effd195 Harden analytics freshness and distributed concurrency (+1 more)
...
Cohesion: 0.18
Nodes (9): 00bf891 Explain analytics errors and add retry action, 3783d27 Document functional QA findings and refresh graph, 4048d3b Fix mobile overflow for long hotel names, 5c4faf9 Document cloud reservation quote blocker, 79980ed Refresh Graphify after auth onboarding coverage, 91d5845 Record cloud functional sweep evidence, b1f2bb5 Enforce mobile touch targets on critical flows, be475f3 Document auth onboarding E2E evidence (+1 more)
...
Cohesion: 0.27
Nodes (9): getSubscriptionStatus(), listSubscriptionPlans(), SubscriptionLimit, SubscriptionStatus, buildMockStatus(), enrichPlans(), FALLBACK_PLANS, normalizeLimits() (+1 more)
...
Cohesion: 0.36
Nodes (8): _alembic(), Regression coverage for the additive permission-catalog migration., role_permission_defaults must agree with DEFAULT_MATRIX after migrating.      Ru, test_housekeeping_occupancy_default_migration_tightens_without_touching_grant(), test_migrated_defaults_match_the_code_default_matrix(), test_permission_catalog_migration_is_additive_and_reversible(), test_permission_enforcement_migration_backfills_defaults_and_removes_sessions(), test_room_move_tier_migration_is_additive_idempotent_and_preserves_overrides()
...
Cohesion: 0.33
Nodes (2): e6abcab fix(rbac): make section view permissions gate the API, not just the menu, API regression coverage for section visibility permissions.
...
- **Thin community `Community 181`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 185`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 196`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 197`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 211`** (2 nodes): `Public WhatsApp bot hooks authenticated only by hotel API key.`, `805b47a Unify reservation pricing with signed quote contract`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 270`** (2 nodes): `collaboration_client()`, `FakeTicketRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (2 nodes): `LocalObjectStorage`, `Stores objects as files under a local directory root.      Generalizes the patte`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 376`** (2 nodes): `Stub for a real S3-compatible bucket. Not wired to a live bucket --     there ar`, `S3ObjectStorage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 390`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 404`** (2 nodes): `ObjectStorage`, `Content-addressed-ish blob store: put/get/delete bytes by string key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 431`** (2 nodes): `e6abcab fix(rbac): make section view permissions gate the API, not just the menu`, `API regression coverage for section visibility permissions.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 433`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 440`** (2 nodes): `detect_no_shows()`, `_parse_datetime()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 442`** (2 nodes): `_context()`, `test_generic_room_status_patch_projects_event_and_reallocates()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 444`** (2 nodes): `_integration_client()`, `test_gmail_oauth_callback_uses_signed_state()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 472`** (2 nodes): `d3dcbfd fix(migrations): chain staff invitation lifecycle migration onto guest search index head`, `persist staff invitation lifecycle  Revision ID: 8b5d07cc381b Revises: 20260820_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 473`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 478`** (2 nodes): `HotelConfigUpdate`, `_normalize_currency()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 486`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 502`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 503`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 504`** (2 nodes): `ownerCredentials`, `receptionistCredentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 509`** (2 nodes): `POST /api/checkin/checkout only enforced authentication (get_auth_context),`, `test_housekeeping_cannot_checkout_reservation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 511`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 516`** (1 nodes): `Regression: provider-supplied OAuth error text must not break out of the inline`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 521`** (1 nodes): `TestBookingWebhook`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 530`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 531`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 532`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 533`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 534`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 535`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 536`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 537`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 538`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 539`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 540`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 541`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 542`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 543`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 544`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 545`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 546`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 547`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 548`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 549`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 550`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 551`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 552`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 553`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 554`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 555`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 556`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 557`** (1 nodes): `stock_items.kind (supply vs linen) + soft-delete-aware name uniqueness  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 558`** (1 nodes): `repair: ensure (hotel_id, id) unique constraints exist on rooms/room_categories/`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 559`** (1 nodes): `add idempotency_key to stock_movements  Revision ID: 20260818_stock_movement_ide`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 560`** (1 nodes): `Add normal-user server-side sessions for TECH-0021.  Revision ID: 20260820_user_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 561`** (1 nodes): `Add soft-delete metadata to guests and payments for TECH-0110.  The columns are`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 562`** (1 nodes): `Grant receptionist the same-category room move default.  Phase A narrowed reserv`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 563`** (1 nodes): `Fix ota_reservation_lifecycle_enum labels to match the ORM's values_callable.  ``
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 564`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 565`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 566`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 567`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 568`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 569`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 570`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 571`** (2 nodes): `main()`, `validate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 573`** (2 nodes): `BridgeActivity`, `MainActivity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 574`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 575`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 577`** (2 nodes): `DomainEventRecoveryResponse`, `Safe cursor response used to repair missed realtime invalidations.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 580`** (1 nodes): `One-shot notification cycle: generate due daily reports, then deliver pending ou`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 581`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 582`** (1 nodes): `Small durable heartbeat API for workers and schedulers.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 586`** (1 nodes): `TestCurrentSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 587`** (1 nodes): `TestExportSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 588`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 591`** (1 nodes): `Minimal API for recording room preferences on a guest profile.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 594`** (1 nodes): `Pydantic schemas for the small guest-room preference signal.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 598`** (1 nodes): `Tighten housekeeping's default access to occupancy planning.  Revision ID: 20260`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 599`** (1 nodes): `Set one global default without creating duplicate rows on reruns.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 600`** (1 nodes): `add tenant-scoped guest room preferences  Revision ID: 3c2dea57666d Revises: 202`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 601`** (1 nodes): `Install the PostgreSQL tenant policy; no-op on other dialects.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 602`** (1 nodes): `Remove the PostgreSQL tenant policy before dropping its table.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 3` to `Community 11`, `Community 426`, `Community 367`, `Community 39`, `Community 87`, `Community 212`, `Community 275`, `Community 213`, `Community 214`, `Community 98`, `Community 44`, `Community 51`, `Community 84`, `Community 1`, `Community 77`, `Community 86`, `Community 85`, `Community 5`, `Community 278`, `Community 15`, `Community 48`, `Community 145`, `Community 140`, `Community 47`, `Community 254`, `Community 0`, `Community 505`, `Community 30`, `Community 34`, `Community 106`, `Community 27`, `Community 7`, `Community 14`, `Community 168`, `Community 40`, `Community 316`, `Community 17`, `Community 185`, `Community 10`, `Community 169`, `Community 59`, `Community 45`, `Community 143`, `Community 101`, `Community 164`, `Community 20`, `Community 4`, `Community 474`, `Community 91`, `Community 38`, `Community 123`, `Community 79`, `Community 8`, `Community 436`, `Community 109`, `Community 12`, `Community 122`, `Community 172`, `Community 353`, `Community 354`, `Community 522`, `Community 523`, `Community 524`, `Community 194`, `Community 206`, `Community 298`, `Community 128`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 27`, `Community 48`, `Community 3`, `Community 572`, `Community 40`, `Community 5`, `Community 4`, `Community 10`, `Community 106`, `Community 86`, `Community 77`, `Community 375`, `Community 13`, `Community 65`, `Community 344`, `Community 6`, `Community 78`, `Community 17`, `Community 113`, `Community 1`, `Community 59`, `Community 133`, `Community 91`, `Community 35`, `Community 146`, `Community 85`, `Community 313`, `Community 12`, `Community 126`, `Community 122`, `Community 168`, `Community 39`, `Community 172`, `Community 202`, `Community 44`, `Community 446`, `Community 45`, `Community 521`, `Community 7`, `Community 118`, `Community 522`, `Community 523`, `Community 524`, `Community 205`, `Community 8`, `Community 194`, `Community 206`, `Community 72`, `Community 15`, `Community 56`, `Community 586`, `Community 587`, `Community 120`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 20`, `Community 3`, `Community 48`, `Community 76`, `Community 1`, `Community 10`, `Community 4`, `Community 5`, `Community 84`, `Community 86`, `Community 77`, `Community 145`, `Community 30`, `Community 59`, `Community 65`, `Community 141`, `Community 377`, `Community 126`, `Community 521`, `Community 118`, `Community 179`, `Community 15`, `Community 56`, `Community 586`, `Community 587`, `Community 120`?**
