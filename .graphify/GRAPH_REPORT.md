...
## Corpus Check
- Large corpus: 679 files · ~427,395 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 5519 nodes · 17071 edges · 264 communities detected
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 5883 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 5883 · contains: 3600 · calls: 2373 · MODIFIES: 1468 · imports: 696 · rationale_for: 659 · ON_BRANCH: 615 · imports_from: 547 · method: 506 · inherits: 500 · PARENT_OF: 224


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 679 · Candidates: recursive
...
Cohesion: 0.02
Nodes (56): add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c, extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard, add trial and comped fields to subscriptions  Revision ID: 20260419_subscription, v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_, v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus, ota hardening: hotel-scoped mappings and webhook credentials  Revision ID: a7f3d, baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7, _utcnow() (+48 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (31): add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2, add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio, add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D, _remaining_trial_days(), _serialize_status_payload(), subscription_status(), change_plan(), start_subscription_trial() (+23 more)
...
Cohesion: 0.02
Nodes (59): add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em, reservation financial lifecycle  Revision ID: 20260410_reservation_financial_lif, ai assistant sessions  Revision ID: 20260411_ai_assistant_sessions Revises: 2026, ai assistant insights  Revision ID: 20260412_ai_assistant_insights Revises: 2026, _is_demo_mode_enabled(), _require_demo_mode(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Check whether demo-only utilities should be exposed. (+51 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (9): master admin panel  Revision ID: 20260421_master_admin_panel Revises: 9c0d2f3e1a, master admin system owner mail and stripe settings  Revision ID: 20260421_master, sync_model_drift_missing_columns  Revision ID: 3eaf48a79290 Revises: 20260419_on, guest legal profile  Revision ID: 9c0d2f3e1a44 Revises: 3eaf48a79290 Create Date, _parse_datetime(), detect_no_shows(), Celery application configuration and async tasks for OTA synchronization., 7e2edb6 Merge Analytics R1.0 (+1 more)
...
Cohesion: 0.03
Nodes (166): v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc, Defensive datastore clients for optional infrastructure., Application decorators., HotelConfiguration — per-hotel business rules. No global/singleton: one row per, Security / access audit log — free-form operational security events.  Distinct f, Pydantic schemas for HotelConfiguration., mockCategories, mockCalendar (+158 more)
...
Cohesion: 0.03
Nodes (57): repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi, email_status(), FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., _serialize_reallocation_result(), _attach_current_rate(), list_categories(), get_category() (+49 more)
...
Cohesion: 0.04
Nodes (82): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _generate_code(), _mask_email(), _pick_default_hotel_id(), _build_auth_response(), _issue_email_token(), register(), request_verify() (+74 more)
...
Cohesion: 0.04
Nodes (66): validate_reset(), Validate reset code without changing password (paso previo en UI)., AcceptPayload, LoginRequest, _assert_assignable_role(), _assert_manageable_membership(), _membership_user_info(), list_users() (+58 more)
...
Cohesion: 0.04
Nodes (69): BaseModel, MasterAdminLoginRequest, MasterAdminUserPayload, MasterAdminLoginResponse, MasterAdminSessionResponse, BillingPolicyUpdateRequest, BillingPolicyPayload, EmailTestRequest (+61 more)
...
Cohesion: 0.04
Nodes (84): FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Ensure computed fields land in the response., Lightweight availability placeholder. When all parameters are provided,     it r, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., ReservationStatusEnum, ReservationSourceEnum, BookingCreate (+76 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (50): CheckInRequest, FastAPI routes for Check-in / Check-out., DocumentTypeEnum, CheckInError, validate_guest_for_checkin(), perform_checkin(), perform_checkout(), GuestProfile (+42 more)
...
Cohesion: 0.07
Nodes (64): DailyRateOut, Config, DailyRateFallbackOut, DailyRateIn, BulkRateIn, BulkFieldRateIn, BulkRateOut, PricePeriodIn (+56 more)

### Community 204 - "Community 204"
Cohesion: 0.33
Nodes (6): _require_demo_mode(), seed_demo(), reset_demo(), Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for
...
Cohesion: 0.17
Nodes (33): FastAPI routes for Guest management., Add new companions to an existing guest., GuestRatingEnum, Guest, GuestTagTypeEnum, GuestTag, Primary guest record. Contains all fields required for check-in     and legal co, Behavioral / alert tags on a guest (v72 §2.6).     Multiple tags per guest; each (+25 more)

### Community 241 - "Community 241"
Cohesion: 0.83
Nodes (3): _postgres_healthcheck(), _redis_healthcheck(), datastores_healthcheck()

### Community 77 - "Community 77"
Cohesion: 0.15
Nodes (14): Staff management endpoints for hotel public API keys., HotelAPIKey, Per-hotel API credential. `key_hash` stores a hashed version of the secret;, HotelAPIKeyError, _hash_secret(), _generate_secret(), issue_key(), verify_key() (+6 more)
...
Cohesion: 0.10
Nodes (19): LaundryItemCreate, LaundryItemRead, LaundryBatchCreate, LaundryBatchRead, LaundryStatusUpdate, FastAPI routes for laundry operations., LaundryStatus, LaundryItem (+11 more)
...
Cohesion: 0.08
Nodes (12): FastAPI routes for the onboarding flow used by smoke tests., OnboardingProviderSetup, OnboardingStatus, HotelIdentityPayload, DepositPolicyPayload, CategoryPayload, StaffPayload, PaymentMethodsPayload (+4 more)
...
Cohesion: 0.47
Nodes (3): _get_surcharge_or_404(), update_payment_surcharge(), deactivate_payment_surcharge()

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (108): PaymentSurchargeRead, PaymentSurchargeCreate, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range. (+100 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (82): FastAPI routes for Payments., _is_manager_context(), _trigger_reoptimization_bg(), list_reservations(), get_reservation(), add_reservation_guests(), change_dates(), AllocationRunPayload (+74 more)
...
Cohesion: 0.07
Nodes (93): Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by id (v72 §16).      Scoped to the API key, RoomStatusUpdate, RoomCategoryAssignmentUpdate, FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it (+85 more)
...
Cohesion: 0.08
Nodes (68): _to_read(), _project_reservation_graph(), create_new_reservation(), create_or_update_manual_ota(), register_settlement(), cancel_reservation(), release_no_guarantee_reservation(), mark_no_show() (+60 more)
...
Cohesion: 0.10
Nodes (27): Public WhatsApp bot hooks authenticated only by hotel API key., PaymentLinkError, _create_mercadopago_preference(), _default_email_delivery(), _money(), _signing_secret(), _signature(), sign_external_reference() (+19 more)

### Community 50 - "Community 50"
Cohesion: 0.13
Nodes (21): Settings, BaseSettings, get_settings(), _normalized_env_value(), _has_value(), _is_public_https_url(), _mercadopago_is_active(), _paypal_is_active() (+13 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (100): Base, DeclarativeBase, Base class for all ORM models., _DecimalAwareEncoder, lifespan(), SafeStaticFiles, StaticFiles, Initialize database on application startup. (+92 more)
...
Cohesion: 0.33
Nodes (6): _frontend_placeholder(), serve_frontend(), serve_spa(), Fallback page shown when the Vite build is missing., Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, SPA fallback for React Router.     Skips API/asset paths to avoid shadowing.

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (34): Master admin panel backend package., Middleware to block mutating requests when subscription enforcement is enabled., Email provider abstraction for platform transactional mail., ApiError, RequestOptions, readCookie(), setMasterAdminCsrfToken(), clearMasterAdminCsrfToken() (+26 more)
...
Cohesion: 0.17
Nodes (35): ReservationAllocationLock, Company, RoomMoveTypeEnum, RoomMovementGroup, RoomMoveEvent, Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, AllocationError, ReservationSlot (+27 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (67): AuditLog, GuestCompanion, HotelConfiguration, Configuration table scoped by hotel (id == hotel_id)., HotelOutboundEmailError, A review is 'for today' when the stay is active on `today`.      §13.3: reviews, §13.3 review routing.      If the reservation under manual review is active *tod, Subscription helpers: plan lookup, room limits, status checks and entitlements. (+59 more)
...
Cohesion: 0.34
Nodes (28): OTASyncStatusEnum, OTAReservationMapping, OTAWebhookCredential, Maps an external OTA reservation to an internal reservation.     Stores the raw, Per-hotel OTA webhook credential. The secret is stored as a hash so the     raw, OTAReservationLifecycleEnum, OTAProvider, OTAConnection (+20 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (18): OTASyncJob, OTASyncEvent, OTACurrencyRate, OTACommissionRule, OTA domain models for channel mappings, sync orchestration and external links., Foundational OTA adapter interfaces and orchestration services., OTAAdapterContext, OTAOperationResult (+10 more)
...
Cohesion: 0.11
Nodes (23): RateLimitEvent, _stub_transactional_auth_email(), db_engine(), db(), sample_categories(), sample_categories_hotel2(), sample_rooms(), sample_rooms_hotel2() (+15 more)

### Community 63 - "Community 63"
Cohesion: 0.21
Nodes (23): ReservationNoShowPolicyAppliedEnum, PricingPolicyError, StayPricingQuote, quote_rate_plan_stay(), _select_rate_plan_price(), _select_tax_policy(), _apply_tax_policy(), _calculate_rule_amount() (+15 more)
...
Cohesion: 0.33
Nodes (5): seed(), main(), Seed minimal demo data for local testing.  Usage:     python -m app.scripts.seed, 1af6bfc Add demo seed script and README instructions for stage 1, 26970dd Add token store cleanup helper

### Community 174 - "Community 174"
Cohesion: 0.36
Nodes (8): ValueError, CommercialConfigError, create_rate_plan(), update_rate_plan(), _replace_rate_plan_prices(), _validate_sellable_product_id(), _get_rate_plan(), Raised when hotel-scoped commercial configuration is invalid.
...
Cohesion: 0.70
Nodes (5): create_sellable_product(), update_sellable_product(), _replace_product_compatibilities(), _validate_room_category_id(), _get_sellable_product()
...
Cohesion: 0.13
Nodes (31): ReservationPricingResult, generate_confirmation_code(), _invalidate_availability_cache(), _resolve_hotel_id(), _validate_reservation_occupancy(), compute_reservation_pricing(), calculate_reservation_pricing(), _daily_rate_pricing_result() (+23 more)
...
Cohesion: 0.07
Nodes (22): MasterAdminAuditPage(), MasterAdminDashboardPage(), MasterAdminLoginPage(), APP_HOST, publicRoutes, router, AppShell(), SettingsAssistantPage() (+14 more)
...
Cohesion: 0.05
Nodes (18): OwnerPayload, RoomPayload, SubscriptionChoicePayload, setOwner(), setHotelIdentity(), setCategories(), setRooms(), setDepositPolicy() (+10 more)
...
Cohesion: 0.15
Nodes (18): RoomBlockReasonCode, RoomBlock, RoomBlockCreatePayload, listActiveRoomBlocks(), createRoomBlock(), resolveRoomBlock(), roomBlocksKey(), roomBlockReasonLabel (+10 more)
...
Cohesion: 0.29
Nodes (1): 486bfb2 feat(R1): expose Room (§4) and Company (§3) fields in API schemas
...
Cohesion: 0.47
Nodes (4): _seed_gmail_connection(), _seed_mercadopago_connection(), test_send_hotel_email_uses_connected_gmail(), test_payment_link_test_requires_hotel_gmail_connection()
...
Cohesion: 0.11
Nodes (6): _make_period(), TestGetPriceForDate, TestApplyPricePeriod, TestPricePeriodOverlap, TestPricePeriodModel, TestResolveRateCalendar
...
- **Thin community `Community 248`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 249`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 250`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 251`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 252`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 253`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 254`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 255`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 256`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 257`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 258`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 259`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 261`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 263`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 264`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 185`** (2 nodes): `_mercadopago_webhook_impl()`, `mercadopago_payment_link_webhook()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 274`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 269`** (1 nodes): `SubscriptionEnforcementMiddleware`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 270`** (2 nodes): `RoomMoveEventRead`, `RoomMovementGroupRead`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 209`** (2 nodes): `AnalyticsAIProvider`, `Protocol`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (2 nodes): `OTAProviderAdapter`, `ExpediaAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (1 nodes): `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (2 nodes): `_hotel_default_currency()`, `OTAIntegrationService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 222`** (2 nodes): `credentials`, `PAGES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 265`** (2 nodes): `valid_https()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 266`** (2 nodes): `fail()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 267`** (2 nodes): `git()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 268`** (2 nodes): `graphify_state()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (1 nodes): `Regression contracts for the repository's agent-operations setup.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 187`** (1 nodes): `486bfb2 feat(R1): expose Room (§4) and Company (§3) fields in API schemas`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 164`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 4` to `Community 203`, `Community 3`, `Community 204`, `Community 1`, `Community 206`, `Community 113`, `Community 95`, `Community 21`, `Community 28`, `Community 17`, `Community 5`, `Community 9`, `Community 2`, `Community 79`, `Community 74`, `Community 12`, `Community 119`, `Community 15`, `Community 30`, `Community 19`, `Community 77`, `Community 0`, `Community 11`, `Community 72`, `Community 96`, `Community 25`, `Community 37`, `Community 97`, `Community 52`, `Community 63`, `Community 7`, `Community 26`, `Community 40`, `Community 208`, `Community 147`, `Community 62`, `Community 162`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 9` to `Community 10`, `Community 11`, `Community 14`, `Community 5`, `Community 141`, `Community 0`, `Community 4`, `Community 2`, `Community 17`, `Community 15`, `Community 30`, `Community 213`, `Community 65`, `Community 37`, `Community 41`, `Community 69`, `Community 7`, `Community 63`, `Community 35`, `Community 40`, `Community 147`, `Community 52`, `Community 62`, `Community 72`, `Community 25`, `Community 129`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 5` to `Community 7`, `Community 30`, `Community 2`, `Community 14`, `Community 3`, `Community 4`, `Community 28`, `Community 21`, `Community 17`, `Community 15`, `Community 79`, `Community 9`, `Community 37`, `Community 41`, `Community 33`, `Community 63`, `Community 35`, `Community 26`, `Community 89`, `Community 52`, `Community 108`, `Community 129`?**
