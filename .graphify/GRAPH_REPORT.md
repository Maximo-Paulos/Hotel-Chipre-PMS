...
## Corpus Check
- Large corpus: 872 files · ~518,890 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6856 nodes · 22945 edges · 304 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 8431 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 8431 · contains: 4358 · calls: 3338 · MODIFIES: 1801 · ON_BRANCH: 1271 · rationale_for: 1054 · imports: 728 · imports_from: 576 · method: 574 · inherits: 533 · PARENT_OF: 281


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 872 · Candidates: 965
- Excluded: 0 untracked · 22490 ignored · 8 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `4bbb730`
...
Cohesion: 0.07
Nodes (183): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+175 more)
...
Cohesion: 0.03
Nodes (124): CheckInRequest, UpdateRolePayload, BaseModel, 805b47a Unify reservation pricing with signed quote contract, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest (+116 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (80): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., 02c5612 Add tenant realtime sync and warehouse boundary (+72 more)
...
Cohesion: 0.03
Nodes (97): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), approvePaymentProof() (+89 more)
...
Cohesion: 0.08
Nodes (102): cancel_reservation(), create_new_reservation(), create_or_update_manual_ota(), extend_stay(), mark_no_show(), modify_reservation(), _project_reservation_graph(), FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend (+94 more)
...
Cohesion: 0.18
Nodes (8): 14c3453 Fail closed when managed databases are not migrated, 15f1429 Refresh Graphify and generated system inventories, 34ae6e9 Install dependencies before release evidence checks, 9303473 Add scalable data architecture specialist workflow, bf14bf5 Sync QA branch with updated main baseline, c0d33fd Refresh Graphify after schema bootstrap, d25c542 Record current cloud gate status, f0ff717 Integrate local memory into agents and project vault
...
Cohesion: 0.32
Nodes (6): 0b2de37 Refresh Graphify for current tenant hardening, 7d0c500 Complete tenant composite foreign keys, _has_fk(), _has_unique(), Complete tenant-leading foreign keys outside the core booking domain.  The core, upgrade()
...
- **Thin community `Community 203`** (2 nodes): `TestReoptimizationIntegration`, `TestReoptimizationTrigger`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 225`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 261`** (1 nodes): `TestCheckIn`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 306`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 313`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 10` to `Community 15`, `Community 239`, `Community 206`, `Community 4`, `Community 30`, `Community 26`, `Community 111`, `Community 32`, `Community 8`, `Community 11`, `Community 14`, `Community 17`, `Community 87`, `Community 58`, `Community 135`, `Community 134`, `Community 6`, `Community 2`, `Community 29`, `Community 3`, `Community 16`, `Community 12`, `Community 25`, `Community 112`, `Community 7`, `Community 46`, `Community 27`, `Community 68`, `Community 307`, `Community 105`, `Community 5`, `Community 56`, `Community 35`, `Community 216`, `Community 78`, `Community 193`, `Community 194`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 16` to `Community 12`, `Community 26`, `Community 10`, `Community 30`, `Community 11`, `Community 1`, `Community 28`, `Community 3`, `Community 101`, `Community 163`, `Community 6`, `Community 308`, `Community 8`, `Community 2`, `Community 245`, `Community 35`, `Community 246`, `Community 80`, `Community 46`, `Community 25`, `Community 7`, `Community 105`, `Community 135`, `Community 5`, `Community 56`, `Community 78`, `Community 29`, `Community 27`, `Community 151`, `Community 14`, `Community 44`, `Community 203`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 5` to `Community 4`, `Community 10`, `Community 26`, `Community 2`, `Community 101`, `Community 16`, `Community 11`, `Community 6`, `Community 8`, `Community 32`, `Community 17`, `Community 210`, `Community 46`, `Community 35`, `Community 62`, `Community 7`, `Community 68`, `Community 29`, `Community 261`, `Community 151`, `Community 14`, `Community 44`, `Community 203`?**
