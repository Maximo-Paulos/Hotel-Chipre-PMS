...
## Corpus Check
- Large corpus: 1345 files · ~1,830,978 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 13053 nodes · 72605 edges · 593 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 23722 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 23722 · ON_BRANCH: 23584 · contains: 7063 · calls: 5220 · MODIFIES: 4864 · rationale_for: 3437 · imports: 1320 · imports_from: 1031 · PARENT_OF: 872 · inherits: 765 · method: 723 · re_exports: 4


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1345 · Candidates: 1493
- Excluded: 0 untracked · 17481 ignored · 12 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `409e9ed`
...
Cohesion: 0.02
Nodes (656): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re (+648 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (448): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+440 more)

### Community 2 - "Community 2"
Cohesion: 0.17
Nodes (479): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+471 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (260): _attach_current_rate(), delete_room(), _housekeeping_room(), housekeeping_summary(), FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it (+252 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (240): add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Base (+232 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (217): FxSnapshotRead, create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate (+209 more)

### Community 6 - "Community 6"
Cohesion: 0.12
Nodes (239): CheckInRequest, FastAPI routes for Check-in / Check-out., cancel_reservation(), change_dates(), create_new_reservation(), create_or_update_manual_ota(), create_reservation_charge(), _ensure_action_permission() (+231 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (204): 955325e feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, HotelMembership, HotelRoleVisibilityWindow, Reservation visibility limits configured independently per hotel role.      A mi, HotelPermissionOverride, Permission, Configurable permission matrix models., An employee-specific permission decision within one hotel membership. (+196 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (167): apple_callback(), _apple_full_name(), apple_login(), _apple_login_config(), apple_start(), _attach_user_session_cookies(), _audit_security_event(), _build_auth_response() (+159 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (89): 300d128 feat(security): audit-log MFA, login, and Google account-linking events, 9f4f9ac feat(security): audit-log MFA, login, and Google account-linking events, _auth_headers(), _complete_onboarding(), _configure_resend(), _enroll_and_confirm_mfa(), _fake_apple_claims(), _fake_google_claims() (+81 more)
...
Cohesion: 0.07
Nodes (103): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail). (+95 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (20): 8d88259 Merge pull request #29 from Maximo-Paulos/codex/fix/full-functional-qa, f1644f3 feat(security): fail-closed external effects, RBAC narrowing, QA catalog v2, owner, manager, credentials, ApiSession, backendURL, Persona (+12 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (52): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, 0f8da23 fix(tests): update invitation rate-limit test for persisted-invitation 400 (not 401), 165d047 fix(security): reduce rate limiter race window under concurrent requests, 429e62c fix(review): require the CSRF cookie explicitly, no silent fallback, 8a26166 fix(security): close secrets/logging/rate-limit gaps (TECH-0111), 9703fdc fix(security): close secrets/logging/rate-limit gaps (TECH-0111), a1caf63 fix(security): close secrets/logging/rate-limit gaps (TECH-0111), b0217a2 fix(security): close secrets/logging/rate-limit gaps (TECH-0111) (#68) (+44 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (37): _authorize_override(), checkin(), 50ad65d feat: harden gmail onboarding and multi-tenant email flow, 7a43bdd feat: add billing, integrations, and Mercado Pago test flows, dc4b68a ojooooo, IntegrationCatalog, IntegrationConnection, IntegrationEvent (+29 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (51): 654d69e Add reservation arrival metadata and internal comments, 8c239da Merge pull request #100 from Maximo-Paulos/feature/reservation-arrival-comment, APIKeyPurposeEnum, PaymentLinkRead, PublicReservationRead, ReservationRead, Pydantic schemas for Booking (lightweight wrapper around Reservation)., HotelAPIKeyIssue (+43 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (27): e34785c prueba, chat_completions(), ChatCompletionRequest, ChatMessage, _extract_latest_user_message(), build_controlled_proposal(), _dedupe_preserve_order(), _detect_channel() (+19 more)

### Community 17 - "Community 17"
Cohesion: 0.10
Nodes (70): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca (+62 more)
...
Cohesion: 0.06
Nodes (56): AuthUser, accept_invitation(), _available_invitation(), get_invitation(), _source_key(), _assert_assignable_role(), _assert_manageable_membership(), invite_user() (+48 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (61): OnboardingWizard(), SettingsAssistantPage(), SettingsUsersPage(), PmsHoteleroPage(), PricingPage(), RegisterOwnerPage(), SoftwareParaHotelesPage(), TermsPage() (+53 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (30): main(), valid_https(), Shared, secret-safe binding for the Render QA bootstrap configuration., Application Configuration. Uses pydantic-settings for environment variable manag, 19b8b7b Harden isolated preview QA and trusted release evidence, 362fdd4 feat(security): add core TOTP/MFA enrollment, verification, and recovery codes, 3635693 Bootstrap trusted isolated cloud QA gate, 365b263 Harden isolated QA bootstrap and provider evidence (+22 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (28): CategoryPayload, DepositPolicyPayload, finishOnboarding(), HotelIdentityPayload, OnboardingProviderSetup, OTAChannelsPayload, OwnerPayload, PaymentMethodsPayload (+20 more)
...
Cohesion: 0.05
Nodes (51): validateGuestForCheckin(), add_reservation_guests(), addReservationCharge(), addReservationGuests(), buildQueryString(), cancelReservation(), CheckInPayload, checkInReservation() (+43 more)
...
Cohesion: 0.10
Nodes (39): requestVerification(), verifyEmail(), 409e9ed Implement PMS audit remediation workflows, 6e6d179 Prepare release candidate for landing and onboarding, 87b0eb6 Improve marketing SEO content, linking, and metadata, b48fd42 Add public marketing inquiry flow and SEO, fbc419c Fix invalid verification email requests, Seo() (+31 more)
...
Cohesion: 0.04
Nodes (50): Base, FxPolicy, ProductRoomCompatibility, RatePlan, RatePlanPrice, Commercial domain models for the next reservation/OTA foundation.  These tables, SellableProduct, TaxPolicy (+42 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (55): chore/weekly-orchestrator-2026-07-03, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0a4396e Add multi-hotel isolation tests and bcrypt shim, 0f3e9a4 fix(auth): graceful token-expiry handling + 12h TTL, 127cb22 fix(frontend): make reservation/guest modals scrollable so footer buttons stay reachable, 1ac0c3c Add StatCard component and fix reservations dashboard error, 1d1874d Add owner-only visibility panel for hotel config (+47 more)
...
Cohesion: 0.10
Nodes (55): codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 0de2c27 Align deploy config and docs for Vercel, Render, and Cloudflare, 116a3bc chore: snapshot analysis artifacts, 15f1429 Refresh Graphify and generated system inventories, 15fca54 Merge pull request #22 from Maximo-Paulos/chore/claude-code-pro-setup, 1ca1c06 Fix PostgreSQL enum schema drift (+47 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (36): list_countries(), list_timezones(), Reference data endpoints used by the frontend., Return the cached IANA timezone catalog., Return the cached IANA timezone catalog., Return the curated country -> primary IANA timezone catalog., ReferenceCountry, listCountries() (+28 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (24): ensure_all_ota_webhook_secrets(), _ensure_membership_and_subscription(), ensure_plans_seeded(), get_or_create_hotel_for_owner(), Hotel helper utilities (ownership + bootstrap)., Ensure every hotel has webhook secrets for the OTA providers used by the app., Ensure every hotel has webhook secrets for the OTA providers used by the app., Seed default plans if missing. (+16 more)
...
Cohesion: 0.11
Nodes (52): codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista, 0c9034f Fix clsx reference in app shell, 107f875 Support legacy master admin underscore routes, 1861352 feat(R5b): production payments — MP preference §12.2, link delivery, company deferred §3.5, 1da134a feat(R2a): expand audit coverage to business mutations (§26), 28e3e55 feat(onboarding): dropdown de categorías y staff opcional con invitación (+44 more)
...
Cohesion: 0.06
Nodes (50): 12f7011 fix(subscription): route all subscription writes through the v2 sync service, _collect_plan_entitlements(), delete_entitlement_override(), ensure_entitlements_seeded(), ensure_room_within_limit(), ensure_staff_within_limit(), ensure_subscription(), entitlements_payload() (+42 more)
...
Cohesion: 0.07
Nodes (42): addCashMovement(), approveCashCloseDifference(), CashCloseReport, CashCustodyHandoff, CashDailyCollector, CashDailyEntry, CashDailyPaymentMethod, CashDailySession (+34 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (29): _collect_realtime_events_after_flush(), _discard_realtime_events_after_rollback(), _discard_realtime_events_after_root_soft_rollback(), _publish_realtime_events_after_commit(), Database engine and session management. Supports both PostgreSQL (production) an, Collect model changes while the transaction can still be rolled back., Ensure rolled-back writes never leak to another browser/device., Prune a failed SAVEPOINT or clear a completed root rollback. (+21 more)
...
Cohesion: 0.04
Nodes (13): _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Emit bounded HTTP timing fields and make correlation IDs observable., Emit bounded HTTP timing fields and make correlation IDs observable., request_telemetry(), 1af6bfc Add demo seed script and README instructions for stage 1, bad20c6 Gate startup email behind SMTP_STARTUP_NOTIFY and send once, ec54376 Add env example and GHCR build/push workflow (+5 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (24): 4d12b77 perf(backend): fix N+1 queries and missing indexes (TECH-0063), 9385c0f Hardening multi-hotel scope and subscription enforcement, af2ce63 perf(backend): fix N+1 queries and missing indexes (TECH-0063), b5bc141 Harden core tenant composite relationships, ca694f7 feat(rbac,config,perf): permission-driven visibility, dedup sweep and infra readiness, d852a9d perf(backend): fix N+1 queries and missing indexes (TECH-0063), e202fdd feat(db): v72 gaps phase 1+2 — Numeric precision, new tables, search indexes, OTA dedup, Enum (+16 more)
...
Cohesion: 0.08
Nodes (37): Category, listCategories(), ApiError, apiFetch(), AuthResponsePayload, buildAuthHeaders(), buildUrl(), formatErrorDetail() (+29 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (44): claude/feature/pms-roles-housekeeping-qa, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker, 07ea889 Record preview functional QA evidence, 0b2de37 Refresh Graphify for current tenant hardening, 14c3453 Fail closed when managed databases are not migrated, 1588fd0 Record mobile master admin fix, 1b3433c Document cloud contract and bundle drift (+36 more)

### Community 51 - "Community 51"
Cohesion: 0.09
Nodes (45): audited_change(), Record an AuditLog row for a successful entity mutation., Record an AuditLog row for a successful entity mutation., AuditLog, Append-only record of every significant mutation within a hotel tenant.     Do N, PaymentProof, PaymentProofBlob, PaymentProofStatusEnum (+37 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (19): 7e2edb6 Merge Analytics R1.0, df173d1 Implement Analytics R1.0 dashboard, chat IA, and support, AnalyticsComparisonStateRead, AnalyticsComparisonWindowRead, AnalyticsMetricCardRead, AnalyticsResponseEnvelopeRead, AnalyticsStarterSummaryDataRead, AnalyticsStarterSummaryRead (+11 more)
...
Cohesion: 0.19
Nodes (42): FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia., Receive reservation notifications from Despegar., OTAConnection, OTAProvider, OTARatePlanMapping, OTARoomMapping (+34 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (37): refreshAfterMutation(), refreshCashState(), refreshDomains(), refreshGuestState(), refreshPaymentState(), refreshReservationState(), refreshRoomState(), refreshSettingsState() (+29 more)
...
Cohesion: 0.07
Nodes (30): checkRoomAvailability(), createRoom(), createRoomCategory(), deleteRoom(), get_category(), get_room(), list_categories(), list_rooms() (+22 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (32): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), markReservationNoShow() (+24 more)

### Community 66 - "Community 66"
Cohesion: 0.12
Nodes (36): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses the ca, Calculate pricing for a potential booking without persisting it.     Uses the ca (+28 more)
...
Cohesion: 0.24
Nodes (29): AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, FactRoomOccupancyDaily, RoomStateEvent, RoomStateEventReasonCodeEnum, RoomStateEventTypeEnum, AnalyticsAIConfigRead (+21 more)

### Community 70 - "Community 70"
Cohesion: 0.12
Nodes (5): BookingAdapter, BookingAdapterError, Booking.com Connectivity adapter.  The adapter keeps provider traffic behind a s, Acknowledge processed reservation messages in Booking's queue., A provider operation failed before it could return normalized data.
...
Cohesion: 0.08
Nodes (19): Recover invalidation domains after a cursor without exposing payloads., recover_domain_events(), getPaymentSummary(), makePayment(), newPaymentIdempotencyKey(), PaymentMethod, PaymentRequest, PaymentSummary (+11 more)
...
Cohesion: 0.08
Nodes (31): apply_resource_changes(), _CashSessionDraft, editable_resource_values(), get_resource(), get_resource_spec(), _json_safe(), _LaundryVendorDraft, _LinenDraft (+23 more)
...
Cohesion: 0.06
Nodes (33): _is_demo_mode_enabled(), lifespan(), Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Initialize database on application startup. (+25 more)
...
Cohesion: 0.09
Nodes (24): getGuestProhibitedDetail(), RestrictionOverride, ReservationStatus, ConfirmDialogProps, GuestRestrictionBadge(), Props, CheckinCaptureForm, emptyCaptureForm (+16 more)
...
Cohesion: 0.09
Nodes (16): acceptInvitation(), AuthProvidersResponse, AuthResponse, getInvitationInfo(), loginWithApple(), loginWithGoogle(), RegistrationResponse, 299323c feat(security): migrate frontend from localStorage JWT to cookie-based sessions (TECH-0021 phase 2) (+8 more)
...
Cohesion: 0.08
Nodes (13): 1a71e7d feat: add ota allocation data foundation, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 3f48c33 chore: snapshot current implementation state for analysis, a61a51c chore: checkpoint de prueba antes de gemma 4, c580b56 ojala si, e1bc3d1 feat(db): v72 gaps phase 3 — room_movement_groups, BillingAdjustment Numeric, Room.description, f0ca779 feat(security): prohibido_alojar enforcement, optimistic locking, payment tables, fc9081b Revise AGENTS.md with updated guidelines and protocols (+5 more)
...
Cohesion: 0.12
Nodes (22): createGuestRestriction(), GuestProhibitedErrorBody, GuestRestriction, GuestRestrictionCreatePayload, GuestRestrictionResolvePayload, GuestRestrictionStatus, listGuestRestrictions(), resolveGuestRestriction() (+14 more)
...
Cohesion: 0.11
Nodes (22): Guest, GuestPayload, Reservation, emptyQuickGuestForm(), guestFullName(), GuestQuickCreatePanelProps, GuestSummaryCard(), hasQuickGuestFormData() (+14 more)
...
Cohesion: 0.19
Nodes (24): _apply_terminal_dates(), cancel_mercadopago_payment_link_test(), create_mercadopago_payment_link_test(), _ensure_utc(), _friendly_mercadopago_error(), _is_public_webhook_base(), list_payment_link_tests(), _mercadopago_access_token() (+16 more)
...
Cohesion: 0.11
Nodes (18): _load_composite_fk_migration(), _load_extended_composite_fk_migration(), _load_master_admin_bypass_migration(), _load_rls_migration(), Return model relationships not covered by the core composite contract., Return model relationships not covered by the core composite contract., Return model relationships not covered by the core composite contract., Return model relationships not covered by the core composite contract. (+10 more)

### Community 127 - "Community 127"
Cohesion: 0.13
Nodes (19): acknowledgeShiftHandoff(), createOperationalTask(), createShiftHandoff(), listOperationalTaskHistory(), listOperationalTasks(), listShiftHandoffs(), OperationalTask, OperationalTaskCreate (+11 more)
...
Cohesion: 0.09
Nodes (6): 02908b1 feat(storage): add verified tenant object metadata, Durable tenant-scoped metadata for private object-storage blobs., StoredObjectStatusEnum, Upload/verify/register object-storage bytes without exposing them in events., Persist pending metadata, upload, stat and mark ready after verification., register_uploaded_object()
...
Cohesion: 0.13
Nodes (14): ReservationGlobalSearch(), useReservationDrawer(), pendingReservationActionsKey(), reservationsKey(), usePendingReservationActions(), useReservations(), DashboardPage(), todayIso() (+6 more)
...
Cohesion: 0.15
Nodes (10): getOperationalAudit(), OperationalAuditFilters, OperationalAuditItem, OperationalAuditResponse, Read-only integral operations audit endpoint., 9a75a8e Merge pull request #99 from Maximo-Paulos/feature/operational-audit-cash-daily, ce4dbca Add operational audit and daily cash dashboard, useOperationalAudit() (+2 more)

### Community 149 - "Community 149"
Cohesion: 0.13
Nodes (13): 67e4e68 fix(data-integrity): make audit_logs append-only at the database level, TDD tests for the AuditLog model.  Invariants:   - AuditLog is hotel-scoped (hot, When a hotel is deleted all its audit logs cascade., Deleting a hotel cannot destroy its audit-log evidence., test_audit_log_hotel_cascade_delete(), test_audit_log_hotel_delete_is_restricted(), downgrade(), _hotel_fk() (+5 more)
...
Cohesion: 0.13
Nodes (17): SessionState, useCrossTabSync(), useRealtimeStatus(), ACTIVE_SUBSCRIPTION_STATUSES, AppShell(), baseNav, dailyNav, groupedNav (+9 more)
...
Cohesion: 0.11
Nodes (5): Public WhatsApp bot hooks authenticated only by hotel API key., 1896a68 Complete mixed payments and guided stock controls, 3abbd31 Complete core reservation business journey, 805b47a Unify reservation pricing with signed quote contract, Build the canonical quote shared by reservation-facing surfaces.

### Community 162 - "Community 162"
Cohesion: 0.11
Nodes (6): 02c5612 Add tenant realtime sync and warehouse boundary, 307e650 Add replayable operational warehouse projections, b8b52fa Harden permission seeding and mobile regression coverage, effd195 Harden analytics freshness and distributed concurrency, detect_no_shows(), _parse_datetime()

### Community 163 - "Community 163"
Cohesion: 0.18
Nodes (15): 142d695 feat(subscription): add idempotent adjustment ledger (TECH-0051), 83cc7df fix(migrations): chain subscription adjustment ledger onto staff invitation lifecycle head, 9f8ba34 fix(security): audit and validate comped subscription override, a7d08c3 fix(migrations): chain subscription adjustment ledger onto guest search index head, _auth_headers(), _ensure_hotel(), test_comped_override_is_idempotent_and_keeps_one_append_only_adjustment(), test_comped_override_records_audit_event() (+7 more)
...
Cohesion: 0.35
Nodes (19): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyStatusAtNightEnum, HotelAuditEvent, ReservationGuestSegmentEnum, ReservationGuestSegmentSourceEnum, ComparisonState (+11 more)
...
Cohesion: 0.15
Nodes (15): SessionLike, cancelPaymentLink(), createPaymentLink(), listPaymentLinks(), PaymentLink, PaymentLinkCreatePayload, listReservationCommunications(), ReservationEmailDelivery (+7 more)
...
Cohesion: 0.14
Nodes (11): getSecurityEvents(), getSecurityOverview(), listUserSessions(), revokeAllSessions(), RevokeAllSessionsResponse, revokeUserSession(), SecurityEvent, SecurityEventsResponse (+3 more)
...
Cohesion: 0.21
Nodes (12): cancelPaymentLinkTest(), createMercadoPagoPaymentLinkTest(), listPaymentLinkTests(), PaymentLinkTest, PaymentLinkTestCreatePayload, refreshPaymentLinkTest(), useGuardedMutation(), paymentLinkTestsKey() (+4 more)
...
Cohesion: 0.11
Nodes (6): queryClient, router, SessionProvider(), The rate calendar's "Hoy" must follow the hotel's timezone, not the server's.  R, Run the process in UTC like Render does, so a regression back to     `date.today, utc_server_clock()
...
Cohesion: 0.16
Nodes (16): get_realtime_client(), _get_redis_client(), publish_domain_event(), Return a configured client after a bounded connectivity check., Return a configured client after a bounded connectivity check., Return a configured client after a bounded connectivity check., Return a configured client after a bounded connectivity check., Return a configured client after a bounded connectivity check. (+8 more)
...
Cohesion: 0.18
Nodes (10): getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., updateHotelConfig(), hotelConfigKey(), useHotelConfig(), InterfaceLanguage (+2 more)
...
Cohesion: 0.13
Nodes (6): 4378bea chore: preview launch.json + graphify refresh (full-stack verification), 6f4beb1 feat(v72): Wave 3 — public API/keys + allocation V72 rules, 731394e perf(measured): guest-search hot path EXPLAIN ANALYZE on real PG — trgm indexes used, <6ms p, meets SLO, 9db1623 feat(frontend): V72 Wave D — room blocks, allocation revert, guest tags/override UI, a146746 test(e2e): seed completed onboarding (valid provider JSON) + robust login selector, eee73bf test(perf+e2e): PG guest-search trgm indexes, benchmark harness, Playwright e2e harness
...
Cohesion: 0.13
Nodes (14): StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on (+6 more)

### Community 207 - "Community 207"
Cohesion: 0.13
Nodes (15): StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin (+7 more)

### Community 208 - "Community 208"
Cohesion: 0.13
Nodes (15): Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., SPA fallback for React Router.     Skips API/asset paths to avoid shadowing., SPA fallback for React Router.     Skips API/asset paths to avoid shadowing., SPA fallback for React Router.     Skips API/asset paths to avoid shadowing., SPA fallback for React Router.     Skips API/asset paths to avoid shadowing., SPA fallback for React Router.     Skips API/asset paths to avoid shadowing. (+7 more)

### Community 209 - "Community 209"
Cohesion: 0.20
Nodes (13): 0b14a55 Subscription status: seed starter and add safe fallback, 32cbdcf Config UI: show numeric markers on receptionist sliders, 6f08611 Subscriptions: auto-seed starter and skip blocking owners, 7d837f5 chore(auth): permitir onboarding aun sin token válido usando X-Hotel-Id, ae0b102 Auth: auto-create membership for owner on role-guard, b0313ba Subscription status: auto-create starter sub and plans, cdef069 Relax role guard: owners pass even without membership, f955664 fix(onboarding): respetar X-Hotel-Id y no fallar con token faltante; agregar get_settings import (+5 more)

### Community 210 - "Community 210"
Cohesion: 0.14
Nodes (11): 1e02ce9 docs(phase1): consolidation baseline green + plan/audit artifacts, 1f19859 test(e2e): GREEN 12/12 authenticated V72 pages with screenshots, 32c7435 feat(phase2): port daily rates (§13) from fervent, 77170cf feat(phase2): port movement-groups API (§5.4) wired to main service, 7fa8df6 feat(phase2): port reoptimization trigger (§5.2) from fervent, 83674a3 feat(phase2): port payment surcharges (§12.3) from fervent, bdb51c9 test(phase2): port V72 test safety-net adapted to main (74 pass, 35 xfail), dd53b2c fix(phase2): rename surcharge constraint to avoid PG name collision (+3 more)

### Community 211 - "Community 211"
Cohesion: 0.13
Nodes (13): 27d2207 Add frontend/vercel.json for Root Directory = frontend deploy, 373fd62 feat(auth): pilot-ready email-optional verification + CORS safety net, 39d221d Add request-verify route observability, 4cd2294 Fix SMTP verification confirmation, 5292f6a Add production branding assets, 59830a1 test: add docs baseline validation, 6874c7a ci: add PR validation workflow and pin cryptography, 70b1481 Relax startup validation for optional integrations (+5 more)

### Community 212 - "Community 212"
Cohesion: 0.13
Nodes (10): 3783d27 Document functional QA findings and refresh graph, 5c4faf9 Document cloud reservation quote blocker, 9021c5c Explain reservation quote failures, 91d5845 Record cloud functional sweep evidence, b052ed0 Refresh Graphify after reservation quote fix, b1f2bb5 Enforce mobile touch targets on critical flows, c28847a Refresh Graphify after report error fix, eac0792 Align QA report with current frontend build (+2 more)
...
Cohesion: 0.20
Nodes (12): blocked_room_ids_for_range(), create_block(), get_block(), _invalidate_availability_cache(), list_active_blocks(), Raised when releasing a block would make an unsafe room state appear sellable., SQLAlchemy predicate for unresolved blocks overlapping [start_date, end_date)., resolve_block() (+4 more)
...
Cohesion: 0.14
Nodes (14): queue_domain_change(), QueuedDomainChange, A safe invalidation signal waiting for the surrounding DB commit., A safe invalidation signal waiting for the surrounding DB commit., A safe invalidation signal waiting for the surrounding DB commit., Queue one tenant-scoped change for publication after commit.      Services can c, Queue one tenant-scoped change for publication after commit.      Services can c, Queue one tenant-scoped change for publication after commit.      Services can c (+6 more)
...
Cohesion: 0.15
Nodes (2): export_cash_ledger_csv(), Export the existing transaction/cash ledger without creating a second balance.
...
Cohesion: 0.24
Nodes (11): approvePaymentProof(), fetchPaymentProofImage(), listPaymentProofs(), PaymentProof, PaymentProofCreatePayload, PaymentProofStatus, rejectPaymentProof(), submitPaymentProof() (+3 more)
...
Cohesion: 0.23
Nodes (12): distributed_lock(), _get_redis_client(), Small Redis/Valkey lease used to serialize cross-worker critical paths., Acquire a short lease and release it only if this worker owns it.      When the, Acquire a transaction-scoped PostgreSQL advisory lock when available.      ``Tru, Acquire a transaction-scoped PostgreSQL advisory lock when available.      ``Tru, Acquire a short lease and release it only if this worker owns it.      Redis/Val, Acquire a short lease and release it only if this worker owns it.      Redis/Val (+4 more)

### Community 254 - "Community 254"
Cohesion: 0.15
Nodes (10): channel_for_hotel(), DomainEvent, iter_event_stream(), Yield a tenant-scoped stream and close when membership is revoked., Yield a tenant-scoped stream and close when membership is revoked., Yield a tenant-scoped stream and close when membership is revoked., Yield a tenant-scoped SSE stream; sync iteration runs in Starlette's worker., Yield a tenant-scoped SSE stream; sync iteration runs in Starlette's worker. (+2 more)
...
Cohesion: 0.31
Nodes (12): _completed_at(), _ensure_completed_transaction(), _find_existing_event(), ingest_webhook(), _insert_event(), _is_allowed_status_transition(), _normalize_status(), _parse_mercadopago_signature_header() (+4 more)
...
Cohesion: 0.26
Nodes (10): createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge, PaymentSurchargeCreatePayload, PaymentSurchargeType, surchargesKey() (+2 more)

### Community 272 - "Community 272"
Cohesion: 0.17
Nodes (12): _frontend_placeholder(), Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing. (+4 more)

### Community 273 - "Community 273"
Cohesion: 0.17
Nodes (7): 0510fa0 Add guest companion UI journey, 2523c66 Refresh QA evidence after cash journey, b5d1a6d Add cash control UI journey, c0c27e4 Refresh QA evidence after guest journey, credentials, credentials, receptionistCredentials

### Community 274 - "Community 274"
Cohesion: 0.20
Nodes (10): 0c6029d Improve responsive dashboard and stock movement UX, 54eed63 Expose payment method configuration for owners, a733848 Refresh Graphify after finance hardening, e85df76 Harden reservation finance loading states, eed124a Harden cash reconciliation and transfer proof approvals, f01c735 Refresh Graphify after tenant isolation hardening, clientNavigate(), credentials (+2 more)
...
Cohesion: 0.17
Nodes (12): C2: app/master_admin/router.py queries Subscription directly, and     transitive, C2: app/master_admin/router.py queries Subscription directly, and     transitive, C2: app/master_admin/router.py queries Subscription directly, and     transitive, C2: app/master_admin/router.py queries Subscription directly, and     transitive, C2: app/master_admin/router.py queries Subscription directly, and     transitive, C2: app/master_admin/router.py queries Subscription directly, and     transitive, C2: app/master_admin/router.py queries Subscription directly, and     transitive, C2: app/master_admin/router.py queries Subscription directly, and     transitive (+4 more)
...
Cohesion: 0.24
Nodes (10): _active_reservation_conflicts_for_room(), create_grouped_room_move(), get_group(), list_groups(), Most recent movement groups for a hotel (newest first)., Keep Room.status in sync after a reservation's room changed.      Room.status is, Keep Room.status in sync after a reservation's room changed.      Room.status is, Most recent movement groups for a hotel (newest first). (+2 more)
...
Cohesion: 0.18
Nodes (11): _load_user_override_migration(), Compile the additive RLS helpers through Alembic's PostgreSQL recorder.      Thi, Compile the additive RLS helpers through Alembic's PostgreSQL recorder.      Thi, Compile the additive RLS helpers through Alembic's PostgreSQL recorder.      Thi, Compile the additive RLS helpers through Alembic's PostgreSQL recorder.      Thi, Compile the additive RLS helpers through Alembic's PostgreSQL recorder.      Thi, Compile the additive RLS helpers through Alembic's PostgreSQL recorder.      Thi, Compile the additive RLS helpers through Alembic's PostgreSQL recorder.      Thi (+3 more)
...
Cohesion: 0.20
Nodes (10): format_sse(), iter_postgres_event_stream(), _outbox_sse_payload(), Build a safe invalidation frame from a committed outbox row.      The PostgreSQL, Build a safe invalidation frame from a committed outbox row.      The PostgreSQL, Build a safe invalidation frame from a committed outbox row.      The PostgreSQL, Stream committed outbox invalidations when Redis is unavailable.      Each poll, Stream committed outbox invalidations when Redis is unavailable.      Each poll (+2 more)

### Community 325 - "Community 325"
Cohesion: 0.20
Nodes (10): get_domain_event_outbox_metrics(), get_domain_event_recovery(), Report pending-outbox depth/age for one tenant; warn when stale.      "Stale" me, Report pending-outbox depth/age for one tenant; warn when stale.      "Stale" me, Report pending-outbox depth/age for one tenant; warn when stale.      "Stale" me, Return changed domains after a tenant-scoped outbox cursor.      V2 rows use ``s, Return changed domains after a tenant-scoped outbox cursor.      V2 rows use ``s, Return changed domains after a tenant-scoped outbox cursor.      V2 rows use ``s (+2 more)
...
Cohesion: 0.28
Nodes (4): delete_company_document(), get_company_document(), _get_document_or_404(), e6abcab fix(rbac): make section view permissions gate the API, not just the menu

### Community 347 - "Community 347"
Cohesion: 0.33
Nodes (8): 1165233 feat(backups): soft-delete + local restore drill for TECH-0110, fbb6c00 fix(security): bind Google logins to a stable subject id to close an email-squatting account-takeover vector, _alembic(), _engine(), _load_migration(), _seed_legacy_tags(), test_guest_restriction_migration_owns_reversible_postgresql_rls(), test_guest_restriction_upgrade_downgrade_upgrade_backfills_without_touching_tags()

### Community 348 - "Community 348"
Cohesion: 0.22
Nodes (6): 24135ad Document functional-first cloud QA blocker, 36d5d8f Optimize room availability query shape, 4236cf3 Harden ledger pricing and payment idempotency, 4992735 Refresh Graphify after guest profile serialization, 5012c54 Refresh Graphify after availability optimization, 69b2c87 Fix guest quick profile response serialization

### Community 349 - "Community 349"
Cohesion: 0.25
Nodes (6): 7667a6b feat(jobs): add portable dispatch and worker heartbeats, Small durable heartbeat API for workers and schedulers., publish_outbox(), Celery task that drains the durable domain-event outbox.  Mirrors app/tasks/noti, Replay pending domain_event_outbox rows onto Redis/Valkey, per hotel.      Bound, _session()
...
Cohesion: 0.22
Nodes (9): publish_queued_domain_changes(), Publish committed signals without allowing Redis to break the request., Publish committed signals without allowing Redis to break the request.      This, Publish committed signals without allowing Redis to break the request.      This, Publish committed signals without allowing Redis to break the request.      This, Record one publish attempt on a durable outbox row, if it still exists., Record one publish attempt on a durable outbox row, if it still exists., Record one publish attempt on a durable outbox row, if it still exists. (+1 more)
...
Cohesion: 0.25
Nodes (8): auth_providers(), _google_allowed_domains(), _google_self_signup_enabled(), link_google(), Verify the Google token and return (claims, normalized email, sub).      The lib, Expose public auth capabilities without returning secrets., Link Google only after both local-password and Google proof., _verify_google_claims()
...
Cohesion: 0.25
Nodes (6): 9d8f59f fix(phase5): correct MercadoPago webhook signature to manifest HMAC (security), a808f2c feat(phase3): harvest cranky net-new — @audited_change decorator + design docs, e7d7971 feat(phase6): NoSQL polyglot foundation — Redis/Mongo/Cassandra/Neo4j clients, f09d3e4 feat(phase4): harvest Redis read-model cache from WIP + wire analytics, Defensive datastore clients for optional infrastructure., Application decorators.
...
Cohesion: 0.29
Nodes (8): _model_event_payload(), _model_hotel_id(), queue_model_changes(), Collect safe domain signals from ORM writes before a transaction ends., Collect safe domain signals from ORM writes before a transaction ends., Collect safe domain signals from ORM writes before a transaction ends., Collect safe domain signals from ORM writes before a transaction ends., _scalar_event_value()
...
Cohesion: 0.50
Nodes (4): getOnboardingStatus(), OnboardingStatus, onboardingStatusKey(), useOnboardingStatus()
...
Cohesion: 0.40
Nodes (5): discard_queued_domain_changes(), Drop signals from a rolled-back root or nested transaction., Drop signals from a rolled-back root or nested transaction., Drop signals from a rolled-back root or nested transaction., Drop signals from a rolled-back root or nested transaction.
...
Cohesion: 0.67
Nodes (3): list_keys(), List hotel keys. Callers must not serialize key_hash., List hotel keys. Callers must not serialize key_hash.
...
Cohesion: 0.67
Nodes (1): Regression guard: verify the notification backend migration against a REAL `alem
...
## Knowledge Gaps
- **1561 isolated node(s):** `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`, `add temporary action grants  Revision ID: 0f85dca5b98b Revises: 20260820_user_se`, `Install the PostgreSQL tenant policy; no-op on other dialects.`, `Remove the PostgreSQL tenant policy before dropping the table.`, `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho` (+1556 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 104`** (1 nodes): `test_database_foundation_complete()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 185`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 190`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 201`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 241`** (2 nodes): `export_cash_ledger_csv()`, `Export the existing transaction/cash ledger without creating a second balance.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (2 nodes): `collaboration_client()`, `FakeTicketRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 355`** (2 nodes): `LocalObjectStorage`, `Stores objects as files under a local directory root.      Generalizes the patte`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 369`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 387`** (2 nodes): `Stub for a real S3-compatible bucket. Not wired to a live bucket --     there ar`, `S3ObjectStorage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 402`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 414`** (2 nodes): `ObjectStorage`, `Content-addressed-ish blob store: put/get/delete bytes by string key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 440`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 447`** (2 nodes): `_context()`, `test_generic_room_status_patch_projects_event_and_reallocates()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 478`** (2 nodes): `d3dcbfd fix(migrations): chain staff invitation lifecycle migration onto guest search index head`, `persist staff invitation lifecycle  Revision ID: 8b5d07cc381b Revises: 20260820_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 479`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 483`** (2 nodes): `HotelConfigUpdate`, `_normalize_currency()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 484`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 494`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 509`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 510`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 511`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 513`** (2 nodes): `ownerCredentials`, `receptionistCredentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 518`** (2 nodes): `POST /api/checkin/checkout only enforced authentication (get_auth_context),`, `test_housekeeping_cannot_checkout_reservation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 520`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 525`** (1 nodes): `Regression: provider-supplied OAuth error text must not break out of the inline`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 529`** (1 nodes): `TestBookingWebhook`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 538`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 539`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 540`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 541`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 551`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 552`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 553`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 554`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 555`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 556`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 557`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 558`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 559`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 560`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 561`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 562`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 563`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 564`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 565`** (1 nodes): `stock_items.kind (supply vs linen) + soft-delete-aware name uniqueness  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 566`** (1 nodes): `repair: ensure (hotel_id, id) unique constraints exist on rooms/room_categories/`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 567`** (1 nodes): `add idempotency_key to stock_movements  Revision ID: 20260818_stock_movement_ide`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 568`** (1 nodes): `Add normal-user server-side sessions for TECH-0021.  Revision ID: 20260820_user_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 569`** (1 nodes): `Add soft-delete metadata to guests and payments for TECH-0110.  The columns are`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 570`** (1 nodes): `Grant receptionist the same-category room move default.  Phase A narrowed reserv`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 571`** (1 nodes): `Fix ota_reservation_lifecycle_enum labels to match the ORM's values_callable.  ``
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 572`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 573`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 574`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 575`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 576`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 577`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 578`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 579`** (1 nodes): `Add tenant-scoped object metadata without deleting legacy file references.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 580`** (2 nodes): `main()`, `validate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 583`** (2 nodes): `BridgeActivity`, `MainActivity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 584`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 585`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 587`** (1 nodes): `ExampleInstrumentedTest`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 588`** (1 nodes): `ExampleUnitTest`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 589`** (2 nodes): `DomainEventRecoveryResponse`, `Safe cursor response used to repair missed realtime invalidations.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 592`** (1 nodes): `One-shot notification cycle: generate due daily reports, then deliver pending ou`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 596`** (1 nodes): `Regression guard: verify the notification backend migration against a REAL `alem`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 597`** (1 nodes): `Regression guard for a real bug: `dee1bd0660f6_ota_allocation_foundation` create`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 600`** (1 nodes): `TestCurrentSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 601`** (1 nodes): `TestExportSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 602`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 608`** (1 nodes): `Minimal API for recording room preferences on a guest profile.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 611`** (1 nodes): `Pydantic schemas for the small guest-room preference signal.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 615`** (1 nodes): `Tighten housekeeping's default access to occupancy planning.  Revision ID: 20260`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 616`** (1 nodes): `Set one global default without creating duplicate rows on reruns.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 617`** (1 nodes): `add tenant-scoped guest room preferences  Revision ID: 3c2dea57666d Revises: 202`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 618`** (1 nodes): `Install the PostgreSQL tenant policy; no-op on other dialects.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 619`** (1 nodes): `Remove the PostgreSQL tenant policy before dropping its table.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 4` to `Community 43`, `Community 434`, `Community 377`, `Community 45`, `Community 86`, `Community 206`, `Community 272`, `Community 207`, `Community 208`, `Community 51`, `Community 105`, `Community 47`, `Community 53`, `Community 87`, `Community 3`, `Community 69`, `Community 165`, `Community 88`, `Community 6`, `Community 148`, `Community 17`, `Community 29`, `Community 1`, `Community 151`, `Community 147`, `Community 210`, `Community 268`, `Community 0`, `Community 514`, `Community 46`, `Community 28`, `Community 15`, `Community 34`, `Community 7`, `Community 12`, `Community 14`, `Community 36`, `Community 322`, `Community 18`, `Community 190`, `Community 95`, `Community 11`, `Community 191`, `Community 55`, `Community 40`, `Community 109`, `Community 166`, `Community 480`, `Community 96`, `Community 38`, `Community 130`, `Community 22`, `Community 81`, `Community 8`, `Community 115`, `Community 149`, `Community 9`, `Community 129`, `Community 332`, `Community 175`, `Community 363`, `Community 364`, `Community 530`, `Community 531`, `Community 532`, `Community 199`, `Community 218`, `Community 284`, `Community 126`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 34`, `Community 29`, `Community 4`, `Community 202`, `Community 581`, `Community 36`, `Community 6`, `Community 3`, `Community 11`, `Community 43`, `Community 165`, `Community 69`, `Community 386`, `Community 13`, `Community 35`, `Community 5`, `Community 79`, `Community 18`, `Community 98`, `Community 55`, `Community 124`, `Community 1`, `Community 96`, `Community 39`, `Community 152`, `Community 88`, `Community 320`, `Community 149`, `Community 51`, `Community 9`, `Community 133`, `Community 129`, `Community 14`, `Community 332`, `Community 45`, `Community 175`, `Community 67`, `Community 47`, `Community 450`, `Community 40`, `Community 529`, `Community 7`, `Community 530`, `Community 531`, `Community 532`, `Community 217`, `Community 8`, `Community 199`, `Community 218`, `Community 74`, `Community 17`, `Community 60`, `Community 600`, `Community 601`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 46`, `Community 4`, `Community 29`, `Community 66`, `Community 11`, `Community 6`, `Community 3`, `Community 87`, `Community 165`, `Community 69`, `Community 151`, `Community 28`, `Community 55`, `Community 35`, `Community 51`, `Community 1`, `Community 388`, `Community 133`, `Community 529`, `Community 183`, `Community 17`, `Community 60`, `Community 600`, `Community 601`?**
