...
## Corpus Check
- Large corpus: 764 files · ~508,742 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7119 nodes · 24237 edges · 296 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9256 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9256 · contains: 4432 · calls: 3367 · MODIFIES: 1886 · ON_BRANCH: 1347 · rationale_for: 1148 · imports: 746 · imports_from: 585 · method: 579 · inherits: 534 · PARENT_OF: 357
...
Cohesion: 0.07
Nodes (164): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+156 more)
...
Cohesion: 0.05
Nodes (126): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+118 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (120): codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker, 0510fa0 Add guest companion UI journey, 05d296d Fix cash freshness after reservation payments, 0b2de37 Refresh Graphify for current tenant hardening (+112 more)
...
Cohesion: 0.03
Nodes (88): Base, Base class for all ORM models., _frontend_placeholder(), _is_demo_mode_enabled(), lifespan(), StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on (+80 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (68): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), _mask_email() (+60 more)
...
Cohesion: 0.04
Nodes (34): AcceptPayload, cancelPaymentLinkTest(), createMercadoPagoPaymentLinkTest(), listPaymentLinkTests(), PaymentLinkTest, PaymentLinkTestCreatePayload, refreshPaymentLinkTest(), 50ad65d feat: harden gmail onboarding and multi-tenant email flow (+26 more)
...
Cohesion: 0.04
Nodes (20): 3f48c33 chore: snapshot current implementation state for analysis, 70b1481 Relax startup validation for optional integrations, c580b56 ojala si, Transaction and PaymentMethod models. Supports: Efectivo (Cash), MercadoPago, Pa, _resolve_jurisdiction_code(), MERCADOPAGO_WEBHOOK_SECRET is required only when MP_ACCESS_TOKEN is set., Partial integration env vars should not block production startup., Partial integration env vars should not block production startup. (+12 more)
...
Cohesion: 0.10
Nodes (30): Shared, secret-safe binding for the Render QA bootstrap configuration., b5d6e0f Merge pull request #26 from Maximo-Paulos/codex/feature/trusted-qa-bootstrap, b94ce7b Bind final QA evidence to probed provider state, e59f101 Harden isolated QA bootstrap and provider evidence, configure_dedicated_baseline(), env_page(), fixtures(), set_render_preview_env() (+22 more)
...
Cohesion: 0.09
Nodes (26): graphify_state(), main(), main(), run(), validate_json(), 15fca54 Merge pull request #22 from Maximo-Paulos/chore/claude-code-pro-setup, 1ca1c06 Fix PostgreSQL enum schema drift, 1ebf84a Audit and harden agent operations context (+18 more)
...
Cohesion: 0.09
Nodes (10): 5de6817 Add field-based bulk rate editing, 64f2b60 feat(settings): manage payment-method surcharges from the UI (BR §12.3), 6cdbbc5 Polish rate calendar UX and fix Vercel install step, bed8c5c feat: BR audit — pricing source of truth, caja, checkout, occupancy, surcharges, c3ec022 feat(payments): generate & share a deposit payment link from a reservation (BR §M/Q126), df770c3 Polish rate calendar and reservation pricing, mockCalendar, mockCategories (+2 more)
...
Cohesion: 0.14
Nodes (13): SimpleRateLimiter, 4959706 Enforce tenant isolation with PostgreSQL RLS context, get_public_api_context(), _public_api_rate_limit_for_hotel(), Public API-key authentication, separate from staff JWT auth., Bind a SQLAlchemy transaction to the authenticated tenant.  PostgreSQL RLS polic, Set the authenticated user id used by membership RLS policies., Set or clear the current hotel id for tenant-scoped RLS policies. (+5 more)
...
Cohesion: 0.13
Nodes (11): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, 1efb927 Update orchestrator status: multi-agent audit blocked by plan session limits, 1f51d3d Record Redis + Playwright install and PR #20 in orchestrator log, 3461e2d Reinstall graphify and regenerate knowledge graph for macOS layout, 3d7e0fc Fix Windows-era paths and outdated checkout test after macOS migration, 55b4b0c Add stack MCP servers and specialized dev agents, 5c302fd feat(reservations): cancel active seña payment links when a reservation is cancelled (BR §M), 879bd34 Merge pull request #20 from Maximo-Paulos/chore/weekly-orchestrator-2026-07-03 (+3 more)
...
Cohesion: 0.18
Nodes (13): main(), valid_https(), 19b8b7b Harden isolated preview QA and trusted release evidence, command(), fenced(), frontend_routes(), heading(), main() (+5 more)
...
Cohesion: 0.18
Nodes (2): fd617c0 Harden private transfer proof workflow, Store private transfer-proof bytes separately from searchable metadata.
...
Cohesion: 0.40
Nodes (4): list_timezones(), Reference data endpoints used by the frontend., Return the cached IANA timezone catalog., 2ba0905 Cache timezone catalog and remove repeated lookups
...
- **Thin community `Community 135`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 160`** (2 nodes): `fd617c0 Harden private transfer proof workflow`, `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 259`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (2 nodes): `Persona`, `personas`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 284`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 294`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 12` to `Community 238`, `Community 204`, `Community 10`, `Community 89`, `Community 117`, `Community 34`, `Community 42`, `Community 21`, `Community 64`, `Community 5`, `Community 14`, `Community 63`, `Community 17`, `Community 92`, `Community 8`, `Community 145`, `Community 1`, `Community 6`, `Community 3`, `Community 59`, `Community 2`, `Community 33`, `Community 13`, `Community 61`, `Community 118`, `Community 0`, `Community 56`, `Community 31`, `Community 71`, `Community 297`, `Community 98`, `Community 4`, `Community 30`, `Community 41`, `Community 58`, `Community 29`, `Community 24`, `Community 38`, `Community 80`, `Community 193`, `Community 194`, `Community 125`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 3` to `Community 9`, `Community 22`, `Community 5`, `Community 99`, `Community 2`, `Community 1`, `Community 94`, `Community 33`, `Community 12`, `Community 63`, `Community 93`, `Community 21`, `Community 6`, `Community 245`, `Community 38`, `Community 246`, `Community 13`, `Community 82`, `Community 56`, `Community 86`, `Community 0`, `Community 8`, `Community 30`, `Community 42`, `Community 58`, `Community 64`, `Community 89`, `Community 98`, `Community 80`, `Community 61`, `Community 122`, `Community 59`, `Community 31`, `Community 157`, `Community 14`, `Community 24`, `Community 109`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 6`, `Community 59`, `Community 0`, `Community 5`, `Community 4`, `Community 12`, `Community 63`, `Community 42`, `Community 34`, `Community 21`, `Community 17`, `Community 208`, `Community 3`, `Community 56`, `Community 38`, `Community 71`, `Community 30`, `Community 41`, `Community 210`, `Community 98`, `Community 130`, `Community 122`, `Community 157`, `Community 24`, `Community 14`, `Community 109`?**
