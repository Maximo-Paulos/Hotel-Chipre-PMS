...
## Corpus Check
- Large corpus: 713 files · ~469,439 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6300 nodes · 20087 edges · 290 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 6540 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 6540 · contains: 4115 · calls: 3152 · MODIFIES: 1638 · ON_BRANCH: 1245 · rationale_for: 814 · imports: 698 · imports_from: 557 · method: 554 · inherits: 519 · PARENT_OF: 255


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 713 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 7 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `4959706`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 446 edges
2. `Reservation` - 441 edges
3. `HotelConfiguration` - 391 edges
4. `Room` - 338 edges
5. `Guest` - 323 edges
6. `Base` - 317 edges
7. `RoomCategory` - 315 edges
8. `RoomStatusEnum` - 252 edges
9. `ReservationError` - 202 edges
...
Cohesion: 0.04
Nodes (242): FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it, Simple availability helper. Returns a placeholder message if required     parame, Generic room update (number, floor, notes, status, etc.). (+234 more)
...
Cohesion: 0.04
Nodes (121): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+113 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (105): FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response., Lightweight availability placeholder. When all parameters are provided,     it r, CheckInRequest, FastAPI routes for Check-in / Check-out., FastAPI routes for Guest management. (+97 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (100): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), AuditLog (+92 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (98): Base, Base class for all ORM models., DeclarativeBase, Record an AuditLog row for a successful entity mutation., AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, AnalyticsCurrencyDisplayEnum (+90 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (88): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), _mask_email() (+80 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (92): BaseModel, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse, MasterAdminSessionResponse, MasterAdminUserPayload (+84 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (71): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), email_status() (+63 more)
...
Cohesion: 0.04
Nodes (31): _DecimalAwareEncoder, _frontend_placeholder(), _is_demo_mode_enabled(), lifespan(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Fallback page shown when the Vite build is missing., Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, SPA fallback for React Router.     Skips API/asset paths to avoid shadowing. (+23 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (52): add_reservation_guests(), buildQueryString(), cancel_reservation(), cancelReservation(), change_dates(), checkInReservation(), checkOutReservation(), clearReservationManualReview() (+44 more)
...
Cohesion: 0.05
Nodes (43): createRoomBlock(), listActiveRoomBlocks(), resolveRoomBlock(), RoomBlock, RoomBlockCreatePayload, RoomBlockReasonCode, _attach_current_rate(), checkRoomAvailability() (+35 more)

### Community 19 - "Community 19"
Cohesion: 0.08
Nodes (41): main(), valid_https(), Shared, secret-safe binding for the Render QA bootstrap configuration., 19b8b7b Harden isolated preview QA and trusted release evidence, 3635693 Bootstrap trusted isolated cloud QA gate, 365b263 Harden isolated QA bootstrap and provider evidence, 3f9c8a0 Refresh Graphify after QA hardening, b5d6e0f Merge pull request #26 from Maximo-Paulos/codex/feature/trusted-qa-bootstrap (+33 more)
...
Cohesion: 0.06
Nodes (35): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), inviteUser(), list_users(), listUsers() (+27 more)
...
Cohesion: 0.07
Nodes (33): get_settings(), _gmail_is_active(), _has_value(), is_demo_mode(), is_preview_qa_mode(), is_production_mode(), _is_public_https_url(), is_testing_mode() (+25 more)
...
Cohesion: 0.11
Nodes (31): CashCloseReport, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca, Individual money movement within an open cash session.     Linked optionally to, Arqueo de caja: expected vs actual cash at session close.     Differences are fl (+23 more)

### Community 31 - "Community 31"
Cohesion: 0.07
Nodes (37): Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection (+29 more)
...
Cohesion: 0.06
Nodes (28): createStockItem(), createStockLocation(), createStockMovement(), CurrentStock, DecimalValue, getCurrentStock(), listLowStockItems(), listStockItems() (+20 more)
...
Cohesion: 0.06
Nodes (28): MasterAdminProtectedShell(), MasterAdminRoot(), navItems, MasterAdminSessionProvider(), OnboardingWizard(), MasterAdminAuditPage(), MasterAdminDashboardPage(), MasterAdminLoginPage() (+20 more)

### Community 40 - "Community 40"
Cohesion: 0.10
Nodes (35): Validate reset code without changing password (paso previo en UI)., Prefer a hotel whose onboarding is already complete.      When a user belongs to, validate_reset(), AcceptPayload, InvitePayload, InviteResponse, User management per hotel (owners/co-owners)., UpdateRolePayload (+27 more)
...
Cohesion: 0.31
Nodes (36): FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create, Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled., Cancel a reservation. Post check-in cancellations are not allowed., Cancel a reservation. Post check-in cancellations are not allowed., §10.2 — Internally release a no-guarantee OTA reservation (no provider cancel ca, §10.2 — Internally release a no-guarantee OTA reservation (no provider cancel ca (+28 more)
...
Cohesion: 0.06
Nodes (20): 1a71e7d feat: add ota allocation data foundation, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 7506225 feat(R2b): soft delete for domain records (§26), a61a51c chore: checkpoint de prueba antes de gemma 4, c580b56 ojala si, f0ca779 feat(security): prohibido_alojar enforcement, optimistic locking, payment tables, Reservation model with strict state machine. States: pending â†’ deposit_paid â† (+12 more)
...
Cohesion: 0.14
Nodes (11): _add_cash_movement(), _auth_context(), _make_hotel(), _make_reservation(), _make_transaction(), _make_user(), _open_cash_session(), TestCashMovements (+3 more)
...
Cohesion: 0.17
Nodes (12): 4959706 Enforce tenant isolation with PostgreSQL RLS context, get_public_api_context(), _public_api_rate_limit_for_hotel(), Public API-key authentication, separate from staff JWT auth., _load_rls_migration(), test_rls_migration_covers_every_hotel_scoped_model_table(), test_rls_migration_keeps_api_key_bootstrap_exception_explicit(), downgrade() (+4 more)

### Community 100 - "Community 100"
Cohesion: 0.19
Nodes (14): HotelAPIKey, Hotel API key model — v72 §16.  Each hotel can have multiple named API credentia, Per-hotel API credential. `key_hash` stores a hashed version of the secret;, _generate_secret(), _hash_secret(), HotelAPIKeyError, issue_key(), list_keys() (+6 more)
...
Cohesion: 0.24
Nodes (5): _make_reservation(), _pay_deposit(), _pay_full(), TestCheckoutGate, TestPaymentGateDepositPaid
...
- **Thin community `Community 127`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (2 nodes): `_make_reservation()`, `TestWaitlistResolveLogic`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 214`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 229`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 244`** (2 nodes): `credentials`, `PAGES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 246`** (2 nodes): `Middleware to block mutating requests when subscription enforcement is enabled.`, `SubscriptionEnforcementMiddleware`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 248`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 276`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 277`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 278`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 298`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (2 nodes): `RoomMoveEventRead`, `RoomMovementGroupRead`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 5` to `Community 230`, `Community 199`, `Community 10`, `Community 13`, `Community 270`, `Community 31`, `Community 9`, `Community 28`, `Community 2`, `Community 4`, `Community 30`, `Community 87`, `Community 83`, `Community 137`, `Community 0`, `Community 3`, `Community 22`, `Community 100`, `Community 24`, `Community 40`, `Community 23`, `Community 107`, `Community 27`, `Community 25`, `Community 128`, `Community 45`, `Community 36`, `Community 201`, `Community 51`, `Community 232`, `Community 207`, `Community 73`, `Community 188`, `Community 189`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 8`, `Community 40`, `Community 42`, `Community 3`, `Community 99`, `Community 24`, `Community 5`, `Community 31`, `Community 1`, `Community 236`, `Community 75`, `Community 27`, `Community 52`, `Community 23`, `Community 4`, `Community 80`, `Community 2`, `Community 51`, `Community 6`, `Community 67`, `Community 181`, `Community 73`, `Community 25`, `Community 30`, `Community 47`, `Community 102`, `Community 133`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 3`, `Community 42`, `Community 45`, `Community 5`, `Community 31`, `Community 2`, `Community 28`, `Community 87`, `Community 249`, `Community 27`, `Community 52`, `Community 4`, `Community 80`, `Community 36`, `Community 105`, `Community 122`, `Community 30`, `Community 47`, `Community 102`, `Community 133`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Are the 444 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 444 INFERRED edges - model-reasoned connections that need verification._
- **Are the 434 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 434 INFERRED edges - model-reasoned connections that need verification._
- **Are the 384 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 384 INFERRED edges - model-reasoned connections that need verification._
