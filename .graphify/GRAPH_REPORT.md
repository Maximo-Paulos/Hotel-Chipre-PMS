...
## Corpus Check
- Large corpus: 733 files · ~477,142 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6449 nodes · 20967 edges · 302 communities detected
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 7153 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 7153 · contains: 4183 · calls: 3195 · MODIFIES: 1686 · ON_BRANCH: 1253 · rationale_for: 875 · imports: 715 · imports_from: 565 · method: 554 · inherits: 525 · PARENT_OF: 263


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 733 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 8 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `805b47a`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 475 edges
2. `Reservation` - 473 edges
3. `HotelConfiguration` - 424 edges
4. `Room` - 358 edges
5. `RoomCategory` - 350 edges
6. `Guest` - 345 edges
7. `Base` - 327 edges
...
Cohesion: 0.04
Nodes (145): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+137 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (133): FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Exception, AuditLog, Append-only record of every significant mutation within a hotel tenant.     Do N, CashCloseReport (+125 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (177): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+169 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (110): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+102 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (116): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), _derive_payment_status() (+108 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (40): _DecimalAwareEncoder, _is_demo_mode_enabled(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., _require_demo_mode(), 0c6029d Improve responsive dashboard and stock movement UX, 1f352e4 feat(reports): SLICE-11 operational reports + alerts (+32 more)
...
Cohesion: 0.06
Nodes (85): Base, Base class for all ORM models., DeclarativeBase, Record an AuditLog row for a successful entity mutation., AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, AnalyticsCurrencyDisplayEnum (+77 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (89): UpdateRolePayload, BaseModel, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse, MasterAdminSessionResponse (+81 more)
...
Cohesion: 0.05
Nodes (67): HotelConfiguration, Serialize policies dict to JSON string., Check if a specific payment method is enabled., Configuration table scoped by hotel (id == hotel_id)., Parse and return extra_policies as a dictionary., BillingAdjustment, BillingAdjustmentTypeEnum, Operational reservation models for adjustments, room moves and audit history. (+59 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (34): datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Staff management endpoints for hotel public API keys., _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine() (+26 more)
...
Cohesion: 0.05
Nodes (54): add_reservation_guests(), buildQueryString(), cancel_reservation(), cancelReservation(), change_dates(), checkInReservation(), checkOutReservation(), clearReservationManualReview() (+46 more)
...
Cohesion: 0.05
Nodes (40): get_settings(), _gmail_is_active(), _has_value(), is_demo_mode(), is_preview_qa_mode(), is_production_mode(), _is_public_https_url(), is_testing_mode() (+32 more)

### Community 19 - "Community 19"
Cohesion: 0.09
Nodes (44): 805b47a Unify reservation pricing with signed quote contract, APIKeyPurposeEnum, Hotel API key model — v72 §16.  Each hotel can have multiple named API credentia, PaymentLinkRead, ReservationRead, HotelAPIKeyIssue, HotelAPIKeyIssued, HotelAPIKeyRead (+36 more)
...
Cohesion: 0.06
Nodes (28): 107f875 Support legacy master admin underscore routes, 3d34a97 Connect system mail through master admin, 7e196fa Fix master admin cross-origin session cookies, 89b1823 Align master admin env names and bootstrap login, 92ae064 Reduce noisy master session hydration 401, 96ff88b Migrate system mail to Resend, c580b56 ojala si, cfaae45 Fix master billing policy for legacy schema (+20 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (33): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), getPaymentSummary() (+25 more)
...
Cohesion: 0.40
Nodes (37): modify_reservation(), FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create, Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled., Cancel a reservation. Post check-in cancellations are not allowed., Cancel a reservation. Post check-in cancellations are not allowed. (+29 more)
...
Cohesion: 0.09
Nodes (25): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+17 more)

### Community 48 - "Community 48"
Cohesion: 0.09
Nodes (25): BootstrapConfigurationError, _decode_lease_entropy(), JsonGetter, main(), ProviderClients, Small GET-only API client with bounded retries and redacted failures., Safe failure whose message never contains provider response bodies., Small GET-only API client with bounded retries and redacted failures. (+17 more)
...
Cohesion: 0.24
Nodes (28): build_manifest(), _canonical_hostname(), _connection_fingerprint(), _database_identity(), _database_password(), _deployment_git_identity(), _deployment_hosts(), _dict() (+20 more)
...
Cohesion: 0.10
Nodes (23): AcceptPayload, AuthContext, Strict authentication/context helpers.  Every operational request must resolve t, Dependency factory that enforces a permission via the configurable hotel     per, Dependency factory that enforces a permission via the configurable hotel     per, Dependency to enforce that the current user has one of the allowed roles in the, Dependency to enforce that the current user has one of the allowed roles in the, Minimal request context used by routers that expect a hotel scope. (+15 more)
...
Cohesion: 0.19
Nodes (16): _load_manifest(), main(), ManifestContinuityError, _provider_subject(), Safe error that never prints provider values., Allow only a newer observation timestamp between provider snapshots., _timestamp(), verify_manifest_continuity() (+8 more)
...
Cohesion: 0.40
Nodes (14): _hotel(), _reservation(), test_cash_movement_requires_open_session(), test_cash_payment_posts_income_movement_to_open_session(), test_cash_payment_with_surcharge_posts_gross_amount_to_caja(), test_cash_payment_without_open_session_opens_zero_balance_session(), test_cash_payment_without_open_session_still_succeeds(), test_close_report_expected_balance_from_confirmed_cash() (+6 more)
...
Cohesion: 0.27
Nodes (10): approvePaymentProof(), listPaymentProofs(), PaymentProof, PaymentProofCreatePayload, PaymentProofStatus, rejectPaymentProof(), submitPaymentProof(), proofsKey() (+2 more)
...
Cohesion: 0.39
Nodes (10): approve_transfer_proof(), _decode_image(), get_transfer_proof(), PaymentProofError, proof_file_path(), _proof_path(), reject_transfer_proof(), _reservation() (+2 more)

### Community 146 - "Community 146"
Cohesion: 0.29
Nodes (11): calculate_base_amount_before_surcharge(), calculate_payment_surcharge(), get_hotel_config(), _payment_method_value(), process_payment(), _recommended_financial_action(), _resolve_payment_currency(), _signed_transaction_amount() (+3 more)
...
Cohesion: 0.24
Nodes (7): 1ac0c3c Add StatCard component and fix reservations dashboard error, 1af6bfc Add demo seed script and README instructions for stage 1, 26970dd Add token store cleanup helper, bad20c6 Gate startup email behind SMTP_STARTUP_NOTIFY and send once, de996f5 Loosen auth email validation to allow test domains, e470215 Frontend: hotel selector and settings per hotel, remove legacy seed dependency, ec54376 Add env example and GHCR build/push workflow
...
Cohesion: 0.40
Nodes (3): 1fd0691 Add display permission fields to hotel config with tests, HotelConfiguration — per-hotel business rules. No global/singleton: one row per, Pydantic schemas for HotelConfiguration.
...
- **Thin community `Community 106`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 252`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 279`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 280`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 282`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 298`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `ota hardening: hotel-scoped mappings and webhook credentials  Revision ID: a7f3d`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (2 nodes): `RoomMoveEventRead`, `RoomMovementGroupRead`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 8` to `Community 232`, `Community 199`, `Community 12`, `Community 6`, `Community 250`, `Community 177`, `Community 304`, `Community 24`, `Community 10`, `Community 46`, `Community 1`, `Community 0`, `Community 2`, `Community 87`, `Community 84`, `Community 132`, `Community 19`, `Community 11`, `Community 251`, `Community 64`, `Community 23`, `Community 106`, `Community 26`, `Community 25`, `Community 5`, `Community 122`, `Community 33`, `Community 50`, `Community 253`, `Community 207`, `Community 73`, `Community 189`, `Community 190`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 11` to `Community 7`, `Community 64`, `Community 36`, `Community 4`, `Community 80`, `Community 9`, `Community 5`, `Community 159`, `Community 251`, `Community 8`, `Community 24`, `Community 2`, `Community 305`, `Community 0`, `Community 238`, `Community 75`, `Community 26`, `Community 51`, `Community 23`, `Community 1`, `Community 81`, `Community 50`, `Community 66`, `Community 182`, `Community 73`, `Community 25`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 5` to `Community 0`, `Community 2`, `Community 36`, `Community 6`, `Community 8`, `Community 24`, `Community 1`, `Community 46`, `Community 87`, `Community 202`, `Community 26`, `Community 51`, `Community 145`, `Community 11`, `Community 81`, `Community 33`, `Community 104`, `Community 125`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 473 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 473 INFERRED edges - model-reasoned connections that need verification._
- **Are the 466 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 466 INFERRED edges - model-reasoned connections that need verification._
- **Are the 417 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 417 INFERRED edges - model-reasoned connections that need verification._
