...
## Corpus Check
- Large corpus: 805 files · ~544,377 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7793 nodes · 27921 edges · 317 communities detected
- Extraction: 59% EXTRACTED · 41% INFERRED · 0% AMBIGUOUS · INFERRED: 11410 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 11410 · contains: 4682 · calls: 3502 · MODIFIES: 2144 · ON_BRANCH: 1741 · rationale_for: 1360 · imports: 802 · imports_from: 626 · method: 593 · inherits: 539 · PARENT_OF: 522
...
Cohesion: 0.03
Nodes (280): Public booking-engine API authenticated only with hotel API keys., Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Simple availability helper. Returns a placeholder message if required     parame, Generic room update (number, floor, notes, status, etc.)., Update room status for housekeeping. When a room is set to cleaning/maintenance/, Update the category of a specific room., Manually trigger the allocation engine to optimally redistribute all reservation (+272 more)
...
Cohesion: 0.05
Nodes (209): PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, User management per hotel (owners/co-owners)., HotelConfiguration, BillingAdjustment, BillingAdjustmentTypeEnum (+201 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (194): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+186 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (105): requestVerification(), FastAPI routes for Check-in / Check-out., _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, _DecimalAwareEncoder (+97 more)
...
Cohesion: 0.06
Nodes (71): FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia., Receive reservation notifications from Despegar., ReservationAdjustment, ReservationAdjustmentKindEnum, ReservationAdjustmentStatusEnum, OTACommissionRule (+63 more)
...
Cohesion: 0.06
Nodes (31): email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., updateHotelConfig(), createPaymentSurcharge() (+23 more)
...
Cohesion: 0.07
Nodes (23): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., main(), run() (+15 more)
...
- **Thin community `Community 252`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 270`** (1 nodes): `Staff management endpoints for hotel public API keys.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 271`** (2 nodes): `housekeeping`, `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 272`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 273`** (2 nodes): `credentials`, `PAGES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 321`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 326`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 5` to `Community 250`, `Community 13`, `Community 4`, `Community 229`, `Community 213`, `Community 112`, `Community 251`, `Community 7`, `Community 37`, `Community 115`, `Community 61`, `Community 38`, `Community 18`, `Community 71`, `Community 17`, `Community 32`, `Community 15`, `Community 96`, `Community 10`, `Community 141`, `Community 0`, `Community 25`, `Community 2`, `Community 3`, `Community 97`, `Community 86`, `Community 116`, `Community 11`, `Community 14`, `Community 172`, `Community 63`, `Community 6`, `Community 49`, `Community 64`, `Community 254`, `Community 67`, `Community 221`, `Community 85`, `Community 199`, `Community 200`, `Community 125`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 2` to `Community 31`, `Community 97`, `Community 7`, `Community 9`, `Community 8`, `Community 98`, `Community 3`, `Community 5`, `Community 37`, `Community 0`, `Community 103`, `Community 63`, `Community 18`, `Community 6`, `Community 258`, `Community 11`, `Community 88`, `Community 91`, `Community 10`, `Community 32`, `Community 64`, `Community 4`, `Community 80`, `Community 195`, `Community 71`, `Community 85`, `Community 86`, `Community 14`, `Community 15`, `Community 240`, `Community 43`, `Community 17`, `Community 128`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 6`, `Community 5`, `Community 98`, `Community 7`, `Community 65`, `Community 56`, `Community 4`, `Community 37`, `Community 38`, `Community 61`, `Community 63`, `Community 18`, `Community 15`, `Community 274`, `Community 11`, `Community 104`, `Community 2`, `Community 71`, `Community 32`, `Community 49`, `Community 216`, `Community 43`, `Community 17`, `Community 128`?**
