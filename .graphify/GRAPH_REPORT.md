...
## Corpus Check
- Large corpus: 822 files · ~559,965 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8129 nodes · 29771 edges · 324 communities detected
- Extraction: 57% EXTRACTED · 43% INFERRED · 0% AMBIGUOUS · INFERRED: 12670 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 12670 · contains: 4868 · calls: 3585 · MODIFIES: 2231 · ON_BRANCH: 1763 · rationale_for: 1475 · imports: 831 · imports_from: 652 · method: 594 · inherits: 558 · PARENT_OF: 544


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 822 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 9 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `69280c5`
...
Cohesion: 0.01
Nodes (315): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening (+307 more)
...
Cohesion: 0.02
Nodes (174): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+166 more)
...
Cohesion: 0.02
Nodes (138): CheckInRequest, FastAPI routes for outsourced laundry vendors, pricing and remitos.  Separate ro, RemitoCreate, RemitoCreateResponse, RemitoLineIn, RemitoLineRead, RemitoRead, VendorBalanceLine (+130 more)
...
Cohesion: 0.15
Nodes (14): listCategories(), 8f9e29f feat(reservations): add manual OTA reservation form (B4) + shared guest quick-create, emptyQuickGuestForm(), GuestQuickCreatePanelProps, hasQuickGuestFormData(), QuickGuestFormValues, CHANNEL_OPTIONS, emptyFormState() (+6 more)
...
- **Thin community `Community 220`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 235`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 239`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 259`** (2 nodes): `housekeeping`, `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 263`** (2 nodes): `chat_completions()`, `_extract_latest_user_message()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 314`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 318`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 322`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (2 nodes): `build_gemma_hotel_context()`, `_enum_value()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `_DecimalAwareEncoder`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 334`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 335`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (2 nodes): `Derive the BRM §16.2 reportable origin for a reservation.      Precedence:`, `reportable_origin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 5` to `Community 236`, `Community 1`, `Community 10`, `Community 331`, `Community 2`, `Community 187`, `Community 77`, `Community 221`, `Community 8`, `Community 22`, `Community 119`, `Community 33`, `Community 50`, `Community 18`, `Community 76`, `Community 20`, `Community 24`, `Community 16`, `Community 97`, `Community 9`, `Community 139`, `Community 6`, `Community 27`, `Community 98`, `Community 4`, `Community 3`, `Community 55`, `Community 29`, `Community 120`, `Community 72`, `Community 32`, `Community 56`, `Community 172`, `Community 337`, `Community 64`, `Community 52`, `Community 65`, `Community 57`, `Community 242`, `Community 71`, `Community 112`, `Community 88`, `Community 197`, `Community 198`, `Community 126`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 4` to `Community 13`, `Community 55`, `Community 8`, `Community 3`, `Community 35`, `Community 7`, `Community 1`, `Community 10`, `Community 5`, `Community 22`, `Community 323`, `Community 64`, `Community 18`, `Community 6`, `Community 56`, `Community 246`, `Community 110`, `Community 90`, `Community 72`, `Community 66`, `Community 29`, `Community 9`, `Community 24`, `Community 65`, `Community 195`, `Community 57`, `Community 112`, `Community 94`, `Community 76`, `Community 88`, `Community 32`, `Community 16`, `Community 169`, `Community 20`, `Community 43`, `Community 96`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 5`, `Community 56`, `Community 8`, `Community 2`, `Community 22`, `Community 4`, `Community 50`, `Community 33`, `Community 64`, `Community 18`, `Community 6`, `Community 16`, `Community 209`, `Community 72`, `Community 66`, `Community 76`, `Community 24`, `Community 52`, `Community 108`, `Community 118`, `Community 94`, `Community 57`, `Community 20`, `Community 43`, `Community 96`?**
