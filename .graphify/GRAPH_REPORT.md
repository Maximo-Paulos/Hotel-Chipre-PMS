...
## Corpus Check
- Large corpus: 728 files · ~478,672 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6551 nodes · 21867 edges · 294 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 7912 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 7912 · contains: 4210 · calls: 3210 · MODIFIES: 1701 · ON_BRANCH: 1255 · rationale_for: 947 · imports: 719 · imports_from: 566 · method: 554 · inherits: 528 · PARENT_OF: 265
...
9. `TransactionTypeEnum` - 233 edges
10. `PaymentMethodEnum` - 230 edges
...
Cohesion: 0.04
Nodes (191): FastAPI routes for Check-in / Check-out., FastAPI routes for Guest management., Add new companions to an existing guest., Guest, GuestRatingEnum, GuestTag, GuestTagTypeEnum, HotelConfiguration (+183 more)
...
Cohesion: 0.03
Nodes (124): CheckInRequest, BaseModel, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse, MasterAdminSessionResponse (+116 more)
...
Cohesion: 0.04
Nodes (91): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), _mask_email() (+83 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (93): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re (+85 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (95): Base, Base class for all ORM models., lifespan(), Initialize database on application startup., Initialize database on application startup., DeclarativeBase, AnalyticsAIUsageMonthly, AnalyticsAlertSetting (+87 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (31): dc4b68a ojooooo, e34785c prueba, build_default_ota_orchestrator(), get_default_adapter(), Default OTA adapter registry.  This keeps provider construction in one place so, DashboardPage(), todayIso(), bubbleStyles (+23 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (92): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+84 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (96): cancel_reservation(), extend_stay(), mark_no_show(), modify_reservation(), FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create, Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled. (+88 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (75): DocumentTypeEnum, GuestCompanion, Companion/additional occupant traveling with a primary guest.     Hotels often n, RateLimitEvent, Room category/type â€” e.g. Standard, Superior, Suite, Penthouse., RoomCategory, Hotel-scoped waitlist lifecycle service., Business error for waitlist operations. (+67 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (75): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+67 more)
...
Cohesion: 0.04
Nodes (67): createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge, PaymentSurchargeCreatePayload, PaymentSurchargeType, createRoomBlock() (+59 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (74): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca (+66 more)
...
Cohesion: 0.04
Nodes (48): get_settings(), _gmail_is_active(), _has_value(), is_demo_mode(), is_preview_qa_mode(), is_production_mode(), _is_public_https_url(), is_testing_mode() (+40 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (21): _DecimalAwareEncoder, _is_demo_mode_enabled(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., _require_demo_mode(), 1f352e4 feat(reports): SLICE-11 operational reports + alerts, 3f48c33 chore: snapshot current implementation state for analysis (+13 more)
...
Cohesion: 0.06
Nodes (36): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), inviteUser(), list_users(), listUsers() (+28 more)
...
Cohesion: 0.08
Nodes (26): 15f1429 Refresh Graphify and generated system inventories, 2c8cad0 Record audited QA setup commit in vault, 365b263 Harden isolated QA bootstrap and provider evidence, 3d34a97 Connect system mail through master admin, 3f9c8a0 Refresh Graphify after QA hardening, 42dd238 Improve vault entrypoint and memory validation, 71cb80e Update Graphify community labels, 85252f7 Refresh Graphify after evidence continuity guard (+18 more)
...
Cohesion: 0.08
Nodes (25): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), ReservationPendingAction (+17 more)
...
- **Thin community `Community 290`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 295`** (1 nodes): `FakeResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (1 nodes): `V72 §8.5 — Per-day pricing models.  DailyRate: explicit price for a (hotel, cate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 6` to `Community 234`, `Community 199`, `Community 15`, `Community 17`, `Community 246`, `Community 179`, `Community 128`, `Community 28`, `Community 12`, `Community 30`, `Community 8`, `Community 14`, `Community 3`, `Community 89`, `Community 88`, `Community 302`, `Community 136`, `Community 10`, `Community 0`, `Community 2`, `Community 85`, `Community 27`, `Community 39`, `Community 26`, `Community 111`, `Community 5`, `Community 53`, `Community 29`, `Community 42`, `Community 218`, `Community 293`, `Community 90`, `Community 129`, `Community 1`, `Community 303`, `Community 11`, `Community 34`, `Community 4`, `Community 56`, `Community 16`, `Community 247`, `Community 295`, `Community 210`, `Community 76`, `Community 189`, `Community 190`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 4`, `Community 39`, `Community 9`, `Community 8`, `Community 159`, `Community 27`, `Community 6`, `Community 28`, `Community 294`, `Community 201`, `Community 78`, `Community 14`, `Community 53`, `Community 57`, `Community 26`, `Community 5`, `Community 3`, `Community 56`, `Community 185`, `Community 10`, `Community 295`, `Community 90`, `Community 76`, `Community 29`, `Community 147`, `Community 42`, `Community 37`, `Community 101`, `Community 84`, `Community 92`, `Community 11`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 8` to `Community 11`, `Community 0`, `Community 5`, `Community 9`, `Community 1`, `Community 6`, `Community 28`, `Community 30`, `Community 89`, `Community 203`, `Community 14`, `Community 53`, `Community 57`, `Community 42`, `Community 146`, `Community 3`, `Community 34`, `Community 205`, `Community 10`, `Community 90`, `Community 121`, `Community 147`, `Community 37`, `Community 101`, `Community 84`, `Community 92`?**
...
- **Are the 520 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 520 INFERRED edges - model-reasoned connections that need verification._
