...
## Corpus Check
- Large corpus: 709 files · ~468,043 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6255 nodes · 19843 edges · 296 communities detected
- Extraction: 68% EXTRACTED · 32% INFERRED · 0% AMBIGUOUS · INFERRED: 6369 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 6369 · contains: 4100 · calls: 3142 · MODIFIES: 1623 · ON_BRANCH: 1241 · rationale_for: 792 · imports: 697 · imports_from: 555 · method: 554 · inherits: 519 · PARENT_OF: 251
...
Cohesion: 0.04
Nodes (20): add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c, extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard, add trial and comped fields to subscriptions  Revision ID: 20260419_subscription, v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_, v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus, Reservation model with strict state machine. States: pending â†’ deposit_paid â†, Room and RoomCategory models., _resolve_jurisdiction_code() (+12 more)
...
Cohesion: 0.07
Nodes (184): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista, 0a4396e Add multi-hotel isolation tests and bcrypt shim, 0b14a55 Subscription status: seed starter and add safe fallback, 0c9034f Fix clsx reference in app shell, 0de2c27 Align deploy config and docs for Vercel, Render, and Cloudflare (+176 more)
...
Cohesion: 0.05
Nodes (72): _generate_code(), _mask_email(), _pick_default_hotel_id(), _build_auth_response(), _issue_email_token(), register(), request_verify(), login() (+64 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (32): validate_reset(), Auth endpoints: register, login, email verification and password reset. Verifica, Prefer a hotel whose onboarding is already complete.      When a user belongs to, Validate reset code without changing password (paso previo en UI)., MasterEmailConnectionError, _dev_outbox_path(), _record_dev_email(), SystemEmailStatus (+24 more)
...
Cohesion: 0.04
Nodes (84): BaseModel, MasterAdminLoginRequest, MasterAdminUserPayload, MasterAdminLoginResponse, MasterAdminSessionResponse, BillingPolicyUpdateRequest, BillingPolicyPayload, EmailTestRequest (+76 more)
...
Cohesion: 0.05
Nodes (175): FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Ensure computed fields land in the response., Lightweight availability placeholder. When all parameters are provided,     it r, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., CheckInRequest, FastAPI routes for Check-in / Check-out., RoomStatusUpdate (+167 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (30): _postgres_healthcheck(), _redis_healthcheck(), datastores_healthcheck(), get_engine(), _render_server_default(), _column_fill_value(), _backfill_not_null_nulls(), _sync_missing_columns() (+22 more)
...
Cohesion: 0.06
Nodes (49): AcceptPayload, LoginRequest, _assert_assignable_role(), _assert_manageable_membership(), _membership_user_info(), list_users(), InvitePayload, InviteResponse (+41 more)
...
Cohesion: 0.05
Nodes (125): Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., CashSessionStatusEnum, CashMovementTypeEnum, CashSession (+117 more)
...
Cohesion: 0.04
Nodes (55): _serialize_reallocation_result(), _attach_current_rate(), list_categories(), get_category(), room_availability(), update_room(), update_room_status(), update_room_category() (+47 more)
...
Cohesion: 0.09
Nodes (27): _remaining_trial_days(), _serialize_status_payload(), subscription_status(), change_plan(), start_subscription_trial(), admin_comped_override(), Subscription status and entitlements endpoints., SubscriptionPlan (+19 more)
...
Cohesion: 0.07
Nodes (14): _is_demo_mode_enabled(), _require_demo_mode(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Check whether demo-only utilities should be exposed., get_db_override_target(), get_auth_context_target(), client_with_db(), owner_ctx() (+6 more)
...
Cohesion: 0.08
Nodes (26): BootstrapConfigurationError, JsonGetter, ReadOnlyJsonApi, VerificationConfig, ProviderClients, _decode_lease_entropy(), _verify_dedicated_baseline_lease(), _verify_qa_external_effects_disabled() (+18 more)
...
Cohesion: 0.17
Nodes (12): FakeResponse, _register_owner(), _auth_headers(), _complete_onboarding(), _configure_resend(), test_register_verify_and_reset_use_resend_provider(), test_auth_flows_fail_without_connected_mail_provider(), test_unverified_users_cannot_use_operational_endpoints() (+4 more)
...
- **Thin community `Community 280`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 282`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 128`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 217`** (2 nodes): `_mercadopago_webhook_impl()`, `mercadopago_payment_link_webhook()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 309`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 249`** (2 nodes): `SubscriptionEnforcementMiddleware`, `Middleware to block mutating requests when subscription enforcement is enabled.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (1 nodes): `Schemas for manual OTA reservation entry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 124`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (2 nodes): `OTAProviderAdapter`, `ExpediaAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 193`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `TestAvailability`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 196`** (1 nodes): `TestReservationCreation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 261`** (1 nodes): `TestStateTransitions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 199`** (2 nodes): `TestReoptimizationTrigger`, `TestReoptimizationIntegration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 5` to `Community 232`, `Community 13`, `Community 46`, `Community 32`, `Community 6`, `Community 29`, `Community 33`, `Community 20`, `Community 4`, `Community 2`, `Community 89`, `Community 84`, `Community 139`, `Community 0`, `Community 3`, `Community 163`, `Community 24`, `Community 80`, `Community 28`, `Community 16`, `Community 25`, `Community 109`, `Community 10`, `Community 47`, `Community 26`, `Community 110`, `Community 17`, `Community 36`, `Community 52`, `Community 168`, `Community 87`, `Community 210`, `Community 73`, `Community 190`, `Community 191`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 3` to `Community 9`, `Community 16`, `Community 55`, `Community 10`, `Community 161`, `Community 28`, `Community 5`, `Community 32`, `Community 2`, `Community 0`, `Community 304`, `Community 20`, `Community 237`, `Community 42`, `Community 75`, `Community 47`, `Community 25`, `Community 4`, `Community 52`, `Community 168`, `Community 87`, `Community 73`, `Community 170`, `Community 26`, `Community 149`, `Community 79`, `Community 199`, `Community 123`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 163`, `Community 10`, `Community 2`, `Community 55`, `Community 17`, `Community 5`, `Community 32`, `Community 33`, `Community 29`, `Community 20`, `Community 89`, `Community 251`, `Community 130`, `Community 47`, `Community 42`, `Community 4`, `Community 36`, `Community 101`, `Community 3`, `Community 107`, `Community 132`, `Community 170`, `Community 149`, `Community 260`, `Community 196`, `Community 261`, `Community 79`, `Community 199`, `Community 123`?**
