...
## Corpus Check
- Large corpus: 875 files · ~524,452 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6969 nodes · 23127 edges · 308 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 8431 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 8431 · contains: 4379 · calls: 3350 · MODIFIES: 1827 · ON_BRANCH: 1289 · rationale_for: 1126 · imports: 736 · imports_from: 580 · method: 577 · inherits: 533 · PARENT_OF: 299
...
- Excluded: 2 untracked · 22543 ignored · 8 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `5012c54`
...
Cohesion: 0.07
Nodes (178): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+170 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (134): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+126 more)
...
Cohesion: 0.02
Nodes (71): 1a71e7d feat: add ota allocation data foundation, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 307e650 Add replayable operational warehouse projections, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 6e8e1f3 Add hotel_id scope migration and model indexes for rooms/categories/reservations, 7e2edb6 Merge Analytics R1.0, b5bc141 Harden core tenant composite relationships, df173d1 Implement Analytics R1.0 dashboard, chat IA, and support (+63 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (66): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., 02c5612 Add tenant realtime sync and warehouse boundary (+58 more)
...
Cohesion: 0.07
Nodes (115): ReservationAllocationLock, AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, AnalyticsExportJob, AnalyticsExportStatusEnum (+107 more)
...
Cohesion: 0.04
Nodes (57): createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge, PaymentSurchargeCreatePayload, PaymentSurchargeType, createRoomBlock() (+49 more)
...
Cohesion: 0.05
Nodes (38): add_companions(), addGuestCompanions(), addGuestTag(), _build_guest_ledger_csv(), checkInGuestReservation(), createGuest(), _enum_value(), export_guest_ledger() (+30 more)
...
Cohesion: 0.06
Nodes (31): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), markReservationNoShow() (+23 more)
...
Cohesion: 0.10
Nodes (17): listGuests(), Reservation, listRooms(), cancelWaitlistEntry(), createWaitlistEntry(), listWaitlistEntries(), promoteWaitlistEntry(), API routes for reservation waitlist operations. (+9 more)
...
Cohesion: 0.13
Nodes (11): _make_period(), V72 §13 — Daily Rate Management tests.  Tests cover:   - get_price_for_date: Dai, Applying a second period to overlapping dates updates those dates., No duplicate rows after two overlapping period applies (upsert semantics)., PricePeriod can be created and queried., A 30-day period (Dec 1–30 inclusive) generates exactly 30 DailyRates., Creating an inactive PricePeriod does not create DailyRate rows         (rows on, Tier-2: active PricePeriod used when no DailyRate exists. (+3 more)
...
Cohesion: 0.40
Nodes (5): Resolve the effective rate for every date in ``[from_date, to_date]`` using, Resolve the effective rate for every date in ``[from_date, to_date]`` using, Resolve the effective rate for every date in ``[from_date, to_date]`` using, Resolve the effective rate for every date in ``[from_date, to_date]`` using, resolve_rate_calendar()
...
- **Thin community `Community 194`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 200`** (2 nodes): `TestReoptimizationIntegration`, `TestReoptimizationTrigger`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 261`** (1 nodes): `TestCheckIn`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 263`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 307`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 9` to `Community 14`, `Community 204`, `Community 6`, `Community 29`, `Community 26`, `Community 116`, `Community 31`, `Community 8`, `Community 11`, `Community 10`, `Community 22`, `Community 16`, `Community 93`, `Community 64`, `Community 78`, `Community 141`, `Community 7`, `Community 1`, `Community 4`, `Community 17`, `Community 5`, `Community 25`, `Community 117`, `Community 12`, `Community 48`, `Community 27`, `Community 309`, `Community 88`, `Community 3`, `Community 50`, `Community 60`, `Community 34`, `Community 213`, `Community 83`, `Community 190`, `Community 191`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 17` to `Community 5`, `Community 26`, `Community 9`, `Community 2`, `Community 29`, `Community 11`, `Community 28`, `Community 4`, `Community 108`, `Community 162`, `Community 7`, `Community 310`, `Community 8`, `Community 1`, `Community 241`, `Community 34`, `Community 242`, `Community 85`, `Community 48`, `Community 25`, `Community 12`, `Community 10`, `Community 78`, `Community 258`, `Community 3`, `Community 60`, `Community 83`, `Community 27`, `Community 152`, `Community 40`, `Community 200`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 3` to `Community 5`, `Community 9`, `Community 26`, `Community 1`, `Community 108`, `Community 17`, `Community 11`, `Community 7`, `Community 8`, `Community 31`, `Community 16`, `Community 208`, `Community 48`, `Community 34`, `Community 68`, `Community 10`, `Community 12`, `Community 50`, `Community 261`, `Community 152`, `Community 40`, `Community 200`?**
