...
## Corpus Check
- Large corpus: 841 files · ~587,361 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8521 nodes · 34915 edges · 340 communities detected
- Extraction: 61% EXTRACTED · 39% INFERRED · 0% AMBIGUOUS · INFERRED: 13565 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 13565 · ON_BRANCH: 5214 · contains: 5050 · calls: 3726 · MODIFIES: 2430 · rationale_for: 1618 · imports: 883 · imports_from: 677 · method: 595 · PARENT_OF: 593 · inherits: 561 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 841 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 9 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `bfb74db`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 826 edges
2. `Reservation` - 825 edges
3. `HotelConfiguration` - 791 edges
4. `Room` - 666 edges
5. `Guest` - 648 edges
6. `RoomCategory` - 603 edges
7. `Base` - 459 edges
8. `RoomStatusEnum` - 406 edges
9. `ReservationError` - 365 edges
10. `ReservationSourceEnum` - 345 edges
...
Cohesion: 0.03
Nodes (321): FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Ensure computed fields land in the response., Ensure computed fields land in the response., CheckInRequest, FastAPI routes for Check-in / Check-out., B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests. (+313 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (157): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck() (+149 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (249): Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, User management per hotel (owners/co-owners)., AuditLog, Append-only record of every significant mutation within a hotel tenant.     Do N (+241 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (198): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+190 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (126): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+118 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (192): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista, 0a4396e Add multi-hotel isolation tests and bcrypt shim (+184 more)

### Community 6 - "Community 6"
Cohesion: 0.16
Nodes (199): agent-mobilenav, agent-settlement, agent-stocksplit, agent-ux, agent-warehouse, worktree-agent-a256bbe12be1abe44, worktree-agent-a3a198c21200e26be, worktree-agent-a3c8668a591bf7739 (+191 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (152): FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Simple availability helper. Returns a placeholder message if required     parame, Generic room update (number, floor, notes, status, etc.)., Update room status for housekeeping. When a room is set to cleaning/maintenance/, Update room status for housekeeping. When a room is set to cleaning/maintenance/, Update the category of a specific room. (+144 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (133): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), Category (+125 more)

### Community 9 - "Community 9"
Cohesion: 0.12
Nodes (160): cancel_reservation(), create_reservation_charge(), extend_stay(), mark_no_show(), modify_reservation(), occupancy_grid(), FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create (+152 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (138): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 0391f8f Fix flaky detached-node false positive in mobile touch-target check, 03f4d70 Document cloud date and quote regressions (+130 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (125): FastAPI routes for outsourced laundry vendors, pricing and remitos.  Separate ro, RemitoCreate, RemitoCreateResponse, RemitoLineIn, RemitoLineRead, RemitoRead, SettlementMarkPaid, SettlementQuarterRead (+117 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (55): 099e4c8 fix(e2e): stop the WebKit business Apple matrix from colliding with itself, 194af4d fix(reservations): search guests by name/DNI instead of raw ID field, 1cd0fce Merge claude/feature/pms-roles-housekeeping-qa: integrate parallel QA fixes, 25d09dc fix(mobile): replace two competing mobile nav mechanisms with one menu button, 45b6181 feat(stock): collapse movement Ubicacion/Reserva behind advanced options, add item delete, 531bfbf docs(design): audit action-permission granularity + design step-up token (not wired), 8850d76 Merge branch 'agent-stocksplit' into codex/feature/pms-e2e-scale-hardening, b64223d Merge branch 'agent-mobilenav' into codex/feature/pms-e2e-scale-hardening (+47 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (64): _authorize_override(), checkin(), checkin_partial(), email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel). (+56 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (43): CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload, OnboardingProviderSetup, OnboardingStatus, OTAChannelsPayload (+35 more)
...
Cohesion: 0.05
Nodes (49): main(), valid_https(), fail(), load_json_object(), main(), mapping(), nested_value(), positive_integer() (+41 more)
...
Cohesion: 0.05
Nodes (43): createLaundryRemito(), createLaundryVendor(), getLaundryVendorBalance(), getLaundryVendorSettlements(), getLaundryVendorSpend(), LaundryRemito, LaundryRemitoCreate, LaundryRemitoCreateResponse (+35 more)
...
Cohesion: 0.05
Nodes (29): create_movement(), createStockItem(), createStockLocation(), createStockMovement(), CurrentStock, DecimalValue, deleteStockItem(), _ensure_adjustment_permission() (+21 more)

### Community 31 - "Community 31"
Cohesion: 0.07
Nodes (43): MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection, MasterAdminContext (+35 more)

### Community 32 - "Community 32"
Cohesion: 0.07
Nodes (37): IntegrationCatalog, IntegrationConnection, _apply_terminal_dates(), cancel_mercadopago_payment_link_test(), create_mercadopago_payment_link_test(), _ensure_utc(), _friendly_mercadopago_error(), _is_public_webhook_base() (+29 more)
...
Cohesion: 0.19
Nodes (34): OTAConnection, OTAProvider, OTARatePlanMapping, OTAReservationLifecycleEnum, OTAReservationLink, OTARoomMapping, OTASyncStatusEnum, OTAWebhookCredential (+26 more)
...
Cohesion: 0.10
Nodes (38): GuestRatingEnum, Date-ranged block on a room. NULL ends_at means indefinite.     resolved_at popu, RoomBlock, RoomBlockReasonEnum, HotelVoucher, Hotel voucher (credit) models — refund path 2 per product §8.7.  A HotelVoucher, Records each partial or full redemption of a HotelVoucher on a reservation., Hotel credit issued to a guest (typically as a refund alternative).     The code (+30 more)
...
Cohesion: 0.15
Nodes (34): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+26 more)

### Community 53 - "Community 53"
Cohesion: 0.15
Nodes (33): FactReservationRowKindEnum, FactRoomOccupancyStatusAtNightEnum, ReservationGuestSegmentSourceEnum, _allocate_monetary_totals(), backfill_channel_code(), build_analytics_window(), build_comparison_state(), build_comparison_window() (+25 more)
...
Cohesion: 0.09
Nodes (32): AcceptPayload, AuthContext, get_auth_context(), _parse_header_hotel_id(), _parse_token_hotel_id(), Return an authenticated context scoped to an active hotel membership., Return an authenticated context scoped to an active hotel membership., Return an authenticated context scoped to an active hotel membership. (+24 more)

### Community 56 - "Community 56"
Cohesion: 0.09
Nodes (23): PaymentMethod, ReservationStatus, CheckinCaptureForm, emptyCaptureForm, guestFullName(), paymentMethodOptions, Props, ReservationDetailDrawer() (+15 more)
...
Cohesion: 0.15
Nodes (27): _apply_corporate_pricing(), _apply_custom_deposit_amount(), _apply_manual_total_override(), _apply_pricing_result_to_reservation(), assert_reservation_version(), calculate_reservation_pricing(), _calendar_pricing_source(), _compute_deposit_amount() (+19 more)
...
Cohesion: 0.18
Nodes (27): Exception, AllocationAssignment, AllocationAssignmentStatusEnum, AllocationExplanation, AllocationPolicyProfile, AllocationPolicyVersion, AllocationRun, AllocationRunStatusEnum (+19 more)
...
Cohesion: 0.08
Nodes (23): create_remito(), create_vendor(), _default_currency(), get_vendor(), mark_vendor_settlement_paid(), _quarter_bounds(), Outsourced laundry vendors: vendor/price catalog + remito transfers.  A remito i, Record a remito as a pair of StockMovements per line.      outbound: house_locat (+15 more)
...
Cohesion: 0.08
Nodes (21): OTAConnectionStatusEnum, OTASyncJobStatusEnum, PendingActionPriorityEnum, PendingActionStatusEnum, PendingActionTypeEnum, PendingOperationalAction, PendingOperationalAction — the "pending_actions" table referenced throughout the, A follow-up item that requires a human decision before the operation can proceed (+13 more)
...
Cohesion: 0.14
Nodes (26): _collect_plan_entitlements(), delete_entitlement_override(), ensure_entitlements_seeded(), ensure_room_within_limit(), ensure_subscription(), entitlements_payload(), get_effective_room_limit(), get_entitlements() (+18 more)
...
Cohesion: 0.17
Nodes (15): _auth_headers(), _complete_onboarding(), _configure_resend(), FakeResponse, .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by, _register_owner(), test_auth_flows_fail_without_connected_mail_provider(), test_login_prefers_a_completed_hotel_when_multiple_memberships_exist() (+7 more)
...
Cohesion: 0.11
Nodes (9): 0254334 Merge branch 'agent-ux' into codex/feature/pms-e2e-scale-hardening, 10e9d42 fix(security): gate manual reservation total_amount behind reservation:manual_rate, 1ae9c1e fix(security): wire room-blocks endpoint to granular create/release permissions, 23f30ca feat(ux): Apple-HIG-style polish pass -- motion, focus rings, tap targets, consistent status colors, 6b53804 Merge price-quote error fix into pms-e2e-scale-hardening, 75cd40a feat(analytics): incremental write-time fact table refresh (data warehouse pattern), a2019c7 Merge analytics self-heal fix into pms-e2e-scale-hardening, a4ecc40 Merge branch 'agent-warehouse' into codex/feature/pms-e2e-scale-hardening (+1 more)
...
Cohesion: 0.17
Nodes (20): availability(), price_quote(), Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Lightweight availability placeholder. When all parameters are provided,     it r, Lightweight availability placeholder. When all parameters are provided,     it r (+12 more)
...
Cohesion: 0.24
Nodes (21): AnalyticsExportJob, AnalyticsExportStatusEnum, FactReservationDaily, project_all_derived_facts_incremental(), _project_all_hotels_window(), project_operational_facts_to_clickhouse(), _project_operational_window(), project_reservation_facts_to_clickhouse() (+13 more)

### Community 101 - "Community 101"
Cohesion: 0.19
Nodes (18): _canonical_identity(), _enabled(), _identity_contains(), _load_local_evidence(), _load_provider_evidence(), Fail-closed safety guard for PostgreSQL tests that mutate schema or data.  Remot, Return ``dsn`` only when provider evidence proves a disposable QA target.      E, Return ``dsn`` only when provider evidence proves a disposable QA target.      E (+10 more)
...
Cohesion: 0.14
Nodes (19): _canonical_identity(), _enabled(), PostgresTargetSafetyError, Rebuild the shared test DB into a pristine, fully-migrated schema.      The sess, Alembic upgrade head succeeds on fresh PostgreSQL database., Alembic downgrade to base then upgrade to head — idempotency check., Verify that the SELECT FOR UPDATE pattern prevents double-booking.     Two concu, Verify that the SELECT FOR UPDATE pattern prevents double-booking.     Two concu (+11 more)
...
Cohesion: 0.27
Nodes (17): _seed_hotels(), _seed_house_stock(), test_create_remito_inbound_reverses_the_transfer(), test_create_remito_outbound_transfers_between_locations_without_changing_hotel_total(), test_create_remito_rejects_insufficient_stock_at_source_and_creates_nothing(), test_create_remito_rolls_back_entirely_when_a_later_line_fails(), test_create_vendor_creates_its_own_stock_location(), test_mark_vendor_settlement_paid_rejects_a_non_quarter_start_date() (+9 more)

### Community 115 - "Community 115"
Cohesion: 0.18
Nodes (17): D1: current_stock(location_id=...) narrows the balance to one location;     omit, D1: current_stock(location_id=...) narrows the balance to one location;     omit, Owner-reported bug: deleting an item ("producto que ya no se usa") is     a soft, A real (non-deleted) duplicate must still be rejected -- with a clean     StockE, D (stock/lavanderia separation): StockPage only ever wants     kind='supply' (bo, _seed_hotels(), test_current_stock_location_filter_is_additive_and_hotel_wide_total_unchanged(), test_low_stock_items_are_hotel_scoped() (+9 more)
...
Cohesion: 0.18
Nodes (4): _make_reservation(), TestWaitlistListing, TestWaitlistResolveLogic, tiny_hotel()
...
Cohesion: 0.16
Nodes (16): delete_room(), housekeeping_summary(), Simple availability helper. Returns a placeholder message if required     parame, Generic room update (number, floor, notes, status, etc.)., Update the category of a specific room., Get housekeeping overview: how many rooms in each status., Soft-delete a room when no active reservations are attached., room_availability() (+8 more)
...
Cohesion: 0.33
Nodes (9): _booking_to_read(), cancel_booking(), checkin_booking(), checkout_booking(), create_booking(), get_booking(), list_bookings(), _project_booking_graph() (+1 more)
...
Cohesion: 0.18
Nodes (9): AuthResponse, Config, LoginRequest, RegisterRequest, RequestCode, ResetCodeValidationResponse, ResetPasswordRequest, UserInfo (+1 more)
...
Cohesion: 0.51
Nodes (10): _client_with_db(), _override_auth(), API-level coverage for outsourced laundry vendors/remitos (D1): permission gatin, _teardown(), test_housekeeping_can_operate_remitos_but_not_manage_vendors(), test_owner_can_manage_vendors_and_receptionist_cannot(), test_remito_rejects_insufficient_house_stock_via_api(), test_settlements_are_hotel_scoped_across_the_api() (+2 more)
...
Cohesion: 0.27
Nodes (6): FakeConnection, FakeEngine, test_repair_adds_missing_cash_handoff_schema_objects(), test_repair_adds_only_missing_cash_handoff_schema_objects(), test_repair_refuses_non_postgres_targets(), test_schema_report_lists_only_missing_model_tables()
...
Cohesion: 0.22
Nodes (8): 1ac0c3c Add StatCard component and fix reservations dashboard error, 1af6bfc Add demo seed script and README instructions for stage 1, 26970dd Add token store cleanup helper, de996f5 Loosen auth email validation to allow test domains, e470215 Frontend: hotel selector and settings per hotel, remove legacy seed dependency, main(), Seed minimal demo data for local testing.  Usage:     python -m app.scripts.seed, seed()

### Community 194 - "Community 194"
Cohesion: 0.42
Nodes (8): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactRoomOccupancyDaily, HotelAuditEvent, RoomStateEvent, ReservationGuestSegmentEnum, FactRefreshResult, Write-time hook: re-derive both fact tables for a narrow window right     when t
...
Cohesion: 0.28
Nodes (6): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, update_payment_surcharge()

### Community 215 - "Community 215"
Cohesion: 0.22
Nodes (9): lifespan(), Initialize database on application startup., Initialize database on application startup., Initialize database on application startup., Initialize database on application startup., Initialize database on application startup., Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Seed the permission matrix once at boot (per worker process).      A1 fix: seed_ (+1 more)
...
Cohesion: 0.50
Nodes (7): _client_with_db(), _override_auth(), API-level coverage for stock items: delete-then-recreate (owner-reported bug), t, _teardown(), test_duplicate_active_name_returns_clean_409_not_a_500(), test_owner_can_delete_item_and_recreate_it_with_the_same_name(), test_stock_items_endpoint_filters_by_kind_for_stock_and_laundry_pages()
...
Cohesion: 0.29
Nodes (7): _is_demo_mode_enabled(), Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., _require_demo_mode()
...
Cohesion: 0.33
Nodes (5): Outstanding balance on the reservation., Outstanding balance on the reservation., Outstanding balance on the reservation., Outstanding balance on the reservation., Outstanding balance on the reservation.

### Community 271 - "Community 271"
Cohesion: 0.33
Nodes (5): Number of nights for the stay., Number of nights for the stay., Number of nights for the stay., Number of nights for the stay., Number of nights for the stay.

### Community 272 - "Community 272"
Cohesion: 0.33
Nodes (5): Check if a state transition is valid., Check if a state transition is valid., Check if a state transition is valid., Check if a state transition is valid., Check if a state transition is valid.
...
- **Thin community `Community 123`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 225`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 248`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 265`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (2 nodes): `chat_completions()`, `_extract_latest_user_message()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (2 nodes): `owner`, `receptionist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `Mailer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 326`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 333`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 335`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 342`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 343`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 344`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 346`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 347`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 348`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 349`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 350`** (1 nodes): `Seed and serve the E2E backend on 127.0.0.1:8040.  This wrapper avoids shell-spe`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 352`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `Bind a SQLAlchemy transaction to the authenticated tenant.  PostgreSQL RLS polic`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 0` to `Community 1`, `Community 215`, `Community 70`, `Community 249`, `Community 9`, `Community 31`, `Community 126`, `Community 64`, `Community 3`, `Community 58`, `Community 194`, `Community 100`, `Community 53`, `Community 2`, `Community 17`, `Community 44`, `Community 15`, `Community 97`, `Community 165`, `Community 39`, `Community 7`, `Community 24`, `Community 104`, `Community 55`, `Community 32`, `Community 127`, `Community 14`, `Community 52`, `Community 36`, `Community 73`, `Community 26`, `Community 4`, `Community 270`, `Community 271`, `Community 272`, `Community 12`, `Community 143`, `Community 6`, `Community 145`, `Community 91`, `Community 86`, `Community 184`, `Community 223`, `Community 224`, `Community 244`, `Community 140`, `Community 103`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 13`, `Community 55`, `Community 9`, `Community 4`, `Community 2`, `Community 11`, `Community 52`, `Community 1`, `Community 44`, `Community 5`, `Community 53`, `Community 194`, `Community 58`, `Community 7`, `Community 39`, `Community 276`, `Community 68`, `Community 89`, `Community 36`, `Community 61`, `Community 32`, `Community 3`, `Community 31`, `Community 75`, `Community 100`, `Community 145`, `Community 91`, `Community 86`, `Community 184`, `Community 26`, `Community 15`, `Community 244`, `Community 140`, `Community 115`, `Community 45`, `Community 17`, `Community 122`, `Community 108`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 7` to `Community 0`, `Community 96`, `Community 52`, `Community 2`, `Community 9`, `Community 124`, `Community 1`, `Community 44`, `Community 270`, `Community 272`, `Community 271`, `Community 64`, `Community 3`, `Community 53`, `Community 194`, `Community 58`, `Community 15`, `Community 235`, `Community 39`, `Community 36`, `Community 61`, `Community 99`, `Community 125`, `Community 120`, `Community 45`, `Community 17`, `Community 122`, `Community 108`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 824 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 824 INFERRED edges - model-reasoned connections that need verification._
- **Are the 818 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 818 INFERRED edges - model-reasoned connections that need verification._
- **Are the 784 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 784 INFERRED edges - model-reasoned connections that need verification._
- **Are the 661 inferred relationships involving `Room` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Room` has 661 INFERRED edges - model-reasoned connections that need verification._