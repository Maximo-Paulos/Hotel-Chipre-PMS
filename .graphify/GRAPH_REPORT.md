...
## Corpus Check
- Large corpus: 1242 files · ~1,816,623 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 13271 nodes · 75607 edges · 476 communities detected
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 25895 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 25895 · ON_BRANCH: 23841 · contains: 7191 · calls: 5243 · MODIFIES: 5071 · rationale_for: 3473 · imports: 1393 · imports_from: 1101 · PARENT_OF: 883 · inherits: 775 · method: 737 · re_exports: 4


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 1242 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 12 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `642c6be`
...
Cohesion: 0.02
Nodes (683): checkin_partial(), CheckInRequest, FastAPI routes for Check-in / Check-out., B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, email_status() (+675 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (478): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses the ca, Calculate pricing for a potential booking without persisting it.     Uses the ca (+470 more)

### Community 2 - "Community 2"
Cohesion: 0.15
Nodes (491): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+483 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (257): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, create_fx_snapshot(), FxRateItem, FxRateUsdOficial, FxSnapshotCreateResponse, get_all_rates(), get_single_rate(), get_usd_oficial_rate() (+249 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (388): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+380 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (195): _archive_historical(), _build_cases(), main(), _write_json(), Shared, secret-safe binding for the Render QA bootstrap configuration., acceptInvitation(), AuthProvidersResponse, AuthResponse (+187 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (245): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), Category (+237 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (267): AuthUser, accept_invitation(), _available_invitation(), get_invitation(), _source_key(), _assert_assignable_role(), _assert_manageable_membership(), invite_user() (+259 more)
...
Cohesion: 0.03
Nodes (213): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+205 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (203): FxSnapshotRead, create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate (+195 more)

### Community 11 - "Community 11"
Cohesion: 0.13
Nodes (233): cancel_reservation(), change_dates(), create_new_reservation(), create_or_update_manual_ota(), create_reservation_charge(), _ensure_action_permission(), _ensure_manual_rate_permission(), extend_stay() (+225 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (129): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _booking_to_read(), cancel_booking(), checkin_booking() (+121 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (167): AnalyticsAIChatPage(), AnalyticsAIChatResponse, AnalyticsAIStatus, AnalyticsCategoryDetailPage(), AnalyticsChannelsPage(), AnalyticsCompanyDetailPage(), AnalyticsEnvelope, analyticsErrorMessage() (+159 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (206): Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, _require_demo_mode(), reset_demo(), seed_demo(), Base, Base class for all ORM models. (+198 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (209): Authenticated field-level collaboration endpoints.  Drafts are ephemeral and saf, Persist an optimistic, field-level merge under the current tenant., Process-local peers plus best-effort Redis pub/sub fan-out., Authenticate with a one-use ticket, then exchange safe draft signals., Keep collaboration permissions aligned with the normal resource API., Tenant-scoped security overview and current-user session revocation., 955325e feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, HotelMembership (+201 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (146): claude/feature/pms-roles-housekeeping-qa, 00bf891 Explain analytics errors and add retry action, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker, 0510fa0 Add guest companion UI journey, 05d296d Fix cash freshness after reservation payments (+138 more)
...
Cohesion: 0.03
Nodes (92): addCashMovement(), approveCashCloseDifference(), CashCloseReport, CashCustodyHandoff, CashDailyCollector, CashDailyEntry, CashDailyPaymentMethod, CashDailySession (+84 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (91): 114b319 Fix invalid verification email requests, 29236bf feat(security): add Google account unlink endpoint with reauthentication, 300d128 feat(security): audit-log MFA, login, and Google account-linking events, 9f4f9ac feat(security): audit-log MFA, login, and Google account-linking events, _auth_headers(), _complete_onboarding(), _configure_resend(), _enroll_and_confirm_mfa() (+83 more)
...
Cohesion: 0.03
Nodes (31): export_cash_ledger_csv(), delete_company_document(), get_company_document(), _get_document_or_404(), getOperationalAudit(), OperationalAuditFilters, OperationalAuditItem, OperationalAuditResponse (+23 more)

### Community 24 - "Community 24"
Cohesion: 0.10
Nodes (77): AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyDaily, FactRoomOccupancyStatusAtNightEnum (+69 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (73): 0d3503a feat(subscription): add idempotent adjustment ledger (TECH-0051), 142d695 feat(subscription): add idempotent adjustment ledger (TECH-0051), 4df2322 fix(migrations): chain subscription adjustment ledger onto guest search index head, 83cc7df fix(migrations): chain subscription adjustment ledger onto staff invitation lifecycle head, 9f8ba34 fix(security): audit and validate comped subscription override, a4d0289 fix(migrations): chain subscription adjustment ledger onto staff invitation lifecycle head, a7d08c3 fix(migrations): chain subscription adjustment ledger onto guest search index head, Lightweight subscription tracking for enforcement and auditing (v2 tables). (+65 more)
...
Cohesion: 0.06
Nodes (68): Base, AllocationAssignment, AllocationAssignmentStatusEnum, AllocationExplanation, AllocationPolicyProfile, AllocationPolicyVersion, AllocationRun, AllocationRunStatusEnum (+60 more)
...
Cohesion: 0.05
Nodes (71): 12f7011 fix(subscription): route all subscription writes through the v2 sync service, Subscription, Ensure a Subscription row exists for the hotel. Returns (subscription, seeded_fl, Return a normalized snapshot for API/middleware:     plan, status, limits, can_w, _collect_plan_entitlements(), delete_entitlement_override(), ensure_entitlements_seeded(), ensure_room_within_limit() (+63 more)
...
Cohesion: 0.07
Nodes (48): AcceptPayload, InviteResponse, PrimaryOwnerTransferPayload, User management per hotel (owners/co-owners)., Transfer billing/property ownership after explicit account reauth., Transfer billing/property ownership after explicit account reauth., Transfer billing/property ownership after explicit account reauth., Transfer billing/property ownership after explicit account reauth. (+40 more)
...
Cohesion: 0.11
Nodes (30): f072302 Sell the product on its own terms, and bake per-route metadata, differentiators, founder, heroBullets, integrationPoints, integrations, marketingRoutes, moduleGroups (+22 more)
...
Cohesion: 0.14
Nodes (25): BrandMarkProps, 6e6d179 Prepare release candidate for landing and onboarding, 87b0eb6 Improve marketing SEO content, linking, and metadata, 9da1f66 Rebuild the public landing page as Hotels-PMS, b48fd42 Add public marketing inquiry flow and SEO, Seo(), SeoProps, StructuredData (+17 more)
...
Cohesion: 0.13
Nodes (21): collaboration_websocket(), CollaborationManager, CollaborationPatchResponse, CollaborationTicket, _consume_ticket(), create_collaboration_ticket(), _live_ticket_is_authorized(), _message_allowed() (+13 more)
...
Cohesion: 0.11
Nodes (19): fetchPublicPricing(), LeadPayload, PublicPricing, PublicPricingPlan, submitLead(), 16473c9 Refresh Graphify graph after the marketing and metadata pass, d7e130f Merge the Hotels-PMS landing page rebuild, hero (+11 more)
...
## Knowledge Gaps
- **1377 isolated node(s):** `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`, `add temporary action grants  Revision ID: 0f85dca5b98b Revises: 20260820_user_se`, `Install the PostgreSQL tenant policy; no-op on other dialects.`, `Remove the PostgreSQL tenant policy before dropping the table.`, `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho` (+1372 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 71`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (1 nodes): `test_database_foundation_complete()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 265`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 339`** (2 nodes): `_context()`, `test_generic_room_status_patch_projects_event_and_reallocates()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 372`** (2 nodes): `HotelConfigUpdate`, `_normalize_currency()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 373`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 380`** (1 nodes): `The marketing site's own origin must not depend on an env var being set.  hotels`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 455`** (1 nodes): `Fix ota_reservation_lifecycle_enum labels to match the ORM's values_callable.  ``
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 456`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 457`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 458`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 459`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 460`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 461`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 462`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 463`** (2 nodes): `main()`, `validate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 464`** (2 nodes): `BridgeActivity`, `MainActivity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 465`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 466`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 467`** (2 nodes): `{ code }`, `source`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 14` to `Community 12`, `Community 3`, `Community 29`, `Community 36`, `Community 27`, `Community 1`, `Community 24`, `Community 66`, `Community 11`, `Community 0`, `Community 23`, `Community 28`, `Community 4`, `Community 54`, `Community 114`, `Community 143`, `Community 35`, `Community 26`, `Community 74`, `Community 15`, `Community 5`, `Community 55`, `Community 39`, `Community 135`, `Community 226`, `Community 88`, `Community 31`, `Community 144`, `Community 32`, `Community 9`, `Community 67`, `Community 87`, `Community 125`, `Community 126`, `Community 369`, `Community 6`, `Community 25`, `Community 30`, `Community 40`, `Community 101`, `Community 68`, `Community 17`, `Community 90`, `Community 99`, `Community 19`, `Community 100`, `Community 410`, `Community 134`, `Community 261`, `Community 415`, `Community 416`, `Community 417`, `Community 150`, `Community 157`, `Community 201`, `Community 18`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 6`, `Community 39`, `Community 11`, `Community 1`, `Community 7`, `Community 9`, `Community 5`, `Community 115`, `Community 12`, `Community 14`, `Community 27`, `Community 24`, `Community 281`, `Community 126`, `Community 10`, `Community 65`, `Community 31`, `Community 91`, `Community 4`, `Community 25`, `Community 30`, `Community 3`, `Community 116`, `Community 66`, `Community 224`, `Community 99`, `Community 19`, `Community 74`, `Community 104`, `Community 100`, `Community 410`, `Community 134`, `Community 52`, `Community 29`, `Community 67`, `Community 15`, `Community 415`, `Community 416`, `Community 417`, `Community 150`, `Community 157`, `Community 59`, `Community 28`, `Community 46`, `Community 475`, `Community 476`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 1`, `Community 9`, `Community 11`, `Community 32`, `Community 12`, `Community 14`, `Community 27`, `Community 24`, `Community 54`, `Community 280`, `Community 35`, `Community 91`, `Community 126`, `Community 4`, `Community 282`, `Community 74`, `Community 104`, `Community 138`, `Community 28`, `Community 46`, `Community 475`, `Community 476`?**
