...
## Corpus Check
- Large corpus: 814 files · ~553,608 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8007 nodes · 29445 edges · 344 communities detected
- Extraction: 57% EXTRACTED · 43% INFERRED · 0% AMBIGUOUS · INFERRED: 12569 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 12569 · contains: 4791 · calls: 3541 · MODIFIES: 2200 · ON_BRANCH: 1753 · rationale_for: 1446 · imports: 831 · imports_from: 646 · method: 594 · inherits: 540 · PARENT_OF: 534


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 814 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 9 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `09d638d`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 790 edges
2. `Reservation` - 789 edges
3. `HotelConfiguration` - 714 edges
4. `Room` - 632 edges
5. `Guest` - 610 edges
...
10. `TransactionTypeEnum` - 327 edges
...
Cohesion: 0.02
Nodes (283): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02c5612 Add tenant realtime sync and warehouse boundary, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 0391f8f Fix flaky detached-node false positive in mobile touch-target check (+275 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (233): PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c (+225 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (221): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, Base, Base class for all ORM models., DeclarativeBase, DocumentTypeEnum (+213 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (214): Application Configuration. Uses pydantic-settings for environment variable manag, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return) (+206 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (175): CheckInRequest, FastAPI routes for Check-in / Check-out., B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, AcceptPayload, Public booking-engine API authenticated only with hotel API keys., Resolve today's effective rate from the single source of truth and attach it, Update room status for housekeeping. When a room is set to cleaning/maintenance/, Manually trigger the allocation engine to optimally redistribute all reservation (+167 more)
...
Cohesion: 0.03
Nodes (135): UpdateRolePayload, BaseModel, 805b47a Unify reservation pricing with signed quote contract, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse (+127 more)
...
Cohesion: 0.02
Nodes (40): dc4b68a ojooooo, e34785c prueba, build_default_ota_orchestrator(), get_default_adapter(), Default OTA adapter registry.  This keeps provider construction in one place so, bubbleStyles, modeLabel, roleLabel (+32 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (95): delete_room(), housekeeping_summary(), FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it, Simple availability helper. Returns a placeholder message if required     parame, Simple availability helper. Returns a placeholder message if required     parame, Generic room update (number, floor, notes, status, etc.)., Generic room update (number, floor, notes, status, etc.). (+87 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (83): _enum_value(), _event_to_read(), _group_to_read(), list_movement_groups(), MovementEventRead, MovementGroupRead, _not_found_or_bad_request(), read_movement_group() (+75 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (38): FastAPI routes for provider connections. Exposes /api/connections/{provider}/con, _require_demo_mode(), reset_demo(), seed_demo(), deactivate_payment_surcharge(), _get_surcharge_or_404(), update_payment_surcharge(), _backfill_not_null_nulls() (+30 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (68): RoomBlockCreate, RoomBlockRead, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., RoomBlockCreate, RoomBlockRead (+60 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (56): _authorize_override(), checkin(), checkin_partial(), createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge (+48 more)
...
Cohesion: 0.05
Nodes (48): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+40 more)
...
Cohesion: 0.05
Nodes (48): SimpleRateLimiter, Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent (+40 more)

### Community 23 - "Community 23"
Cohesion: 0.24
Nodes (59): Company, Operational reservation models for adjustments, room moves and audit history., ReservationStatusHistory, RoomMoveEvent, RoomMoveTypeEnum, ReservationChannelCodeEnum, ReservationNoShowPolicyAppliedEnum, ReservationOutcomeEnum (+51 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (45): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+37 more)
...
Cohesion: 0.06
Nodes (28): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., main(), run() (+20 more)
...
Cohesion: 0.07
Nodes (29): addLaundryItem(), createLaundryBatch(), LaundryBatch, LaundryBatchCreate, LaundryBatchRead, LaundryItem, LaundryItemCreate, LaundryItemRead (+21 more)
...
Cohesion: 0.14
Nodes (31): _apply_corporate_pricing(), _apply_custom_deposit_amount(), _apply_manual_total_override(), _apply_pricing_result_to_reservation(), assert_reservation_version(), calculate_reservation_pricing(), _calendar_pricing_source(), check_room_availability() (+23 more)
...
Cohesion: 0.17
Nodes (29): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by id (v72 §16).      Scoped to the API key (+21 more)
...
Cohesion: 0.10
Nodes (17): listGuests(), Reservation, listRoomCategories(), cancelWaitlistEntry(), createWaitlistEntry(), listWaitlistEntries(), promoteWaitlistEntry(), API routes for reservation waitlist operations. (+9 more)
...
Cohesion: 0.08
Nodes (16): Tests for database models — validates schema creation, constraints, relationship, Tests for Reservation model and state machine., Verify the state machine transition map is correct., Verify can_transition_to method., Verify balance_due computed property., Verify nights calculation., Tests for Transaction model., Create a transaction and verify attributes. (+8 more)
...
Cohesion: 0.15
Nodes (20): approvePaymentProof(), fetchPaymentProofImage(), listPaymentProofs(), PaymentProof, PaymentProofCreatePayload, PaymentProofStatus, rejectPaymentProof(), submitPaymentProof() (+12 more)
...
Cohesion: 0.19
Nodes (13): _configure_resend(), _seed_hotel(), _seed_platform_admin(), _seed_subscription(), test_master_email_status_and_test_mail(), test_master_login_bootstraps_env_account(), test_master_login_cookie_works_on_underscore_alias(), test_master_login_locks_out_after_repeated_failures() (+5 more)
...
Cohesion: 0.11
Nodes (5): 099e4c8 fix(e2e): stop the WebKit business Apple matrix from colliding with itself, f104ab7 docs(qa): record the WebKit business matrix collision findings in the catalog, credentials, credentials, credentials
...
Cohesion: 0.16
Nodes (11): useReservationDrawer(), categoriesKey(), roomsKey(), useRooms(), DashboardPage(), todayIso(), formatMoney(), formatterCache (+3 more)
...
Cohesion: 0.24
Nodes (8): getPaymentSummary(), makePayment(), newPaymentIdempotencyKey(), PaymentRequest, PaymentSummary, TransactionType, d19fd80 fix(frontend): close double-submit race on reservation create/check-in/check-out and stock movements, useGuardedMutation()
...
Cohesion: 1.00
Nodes (2): Guessing the 6-digit verification code must itself be throttled, not     just re, test_verify_email_code_guessing_is_rate_limited()

### Community 363 - "Community 363"
Cohesion: 1.00
Nodes (2): validate-reset (no-op check) and reset-password (consumes the code)     guess th, test_reset_password_code_guessing_is_rate_limited_and_shared_with_validate()

### Community 364 - "Community 364"
Cohesion: 1.00
Nodes (2): Registration had no throttle at all: an attacker could farm unlimited     accoun, test_register_is_rate_limited_by_source()
...
- **Thin community `Community 232`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 275`** (2 nodes): `housekeeping`, `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 277`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (1 nodes): `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `add trial and comped fields to subscriptions  Revision ID: 20260419_subscription`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 326`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 333`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 335`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `SubscriptionEnforcementMiddleware`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 349`** (1 nodes): `_DecimalAwareEncoder`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 350`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 352`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 353`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 355`** (2 nodes): `Derive the BRM §16.2 reportable origin for a reservation.      Precedence:`, `reportable_origin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 361`** (2 nodes): `POST /api/checkin/checkout only enforced authentication (get_auth_context),`, `test_housekeeping_cannot_checkout_reservation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 362`** (2 nodes): `Guessing the 6-digit verification code must itself be throttled, not     just re`, `test_verify_email_code_guessing_is_rate_limited()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 363`** (2 nodes): `validate-reset (no-op check) and reset-password (consumes the code)     guess th`, `test_reset_password_code_guessing_is_rate_limited_and_shared_with_validate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 364`** (2 nodes): `Registration had no throttle at all: an attacker could farm unlimited     accoun`, `test_register_is_rate_limited_by_source()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 365`** (2 nodes): `Preview QA already requires a strong MASTER_ADMIN_PASSWORD/EMAIL, but     produc`, `test_validate_runtime_security_rejects_weak_master_admin_password_in_production()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (2 nodes): `MERCADOPAGO_WEBHOOK_SECRET is required only when MP_ACCESS_TOKEN is set.`, `test_validate_runtime_security_rejects_missing_mp_webhook_when_mp_configured()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 2` to `Community 252`, `Community 12`, `Community 349`, `Community 3`, `Community 233`, `Community 218`, `Community 111`, `Community 254`, `Community 7`, `Community 22`, `Community 118`, `Community 34`, `Community 52`, `Community 18`, `Community 1`, `Community 16`, `Community 23`, `Community 11`, `Community 103`, `Community 8`, `Community 140`, `Community 13`, `Community 4`, `Community 5`, `Community 6`, `Community 78`, `Community 38`, `Community 31`, `Community 119`, `Community 68`, `Community 61`, `Community 32`, `Community 10`, `Community 179`, `Community 355`, `Community 62`, `Community 17`, `Community 63`, `Community 256`, `Community 70`, `Community 226`, `Community 87`, `Community 208`, `Community 209`, `Community 362`, `Community 363`, `Community 364`, `Community 124`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 4` to `Community 5`, `Community 7`, `Community 39`, `Community 6`, `Community 68`, `Community 78`, `Community 3`, `Community 2`, `Community 22`, `Community 13`, `Community 338`, `Community 62`, `Community 18`, `Community 260`, `Community 38`, `Community 89`, `Community 61`, `Community 64`, `Community 31`, `Community 1`, `Community 8`, `Community 23`, `Community 63`, `Community 204`, `Community 93`, `Community 87`, `Community 81`, `Community 185`, `Community 17`, `Community 32`, `Community 11`, `Community 362`, `Community 363`, `Community 364`, `Community 16`, `Community 45`, `Community 10`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 10` to `Community 17`, `Community 13`, `Community 4`, `Community 68`, `Community 1`, `Community 7`, `Community 3`, `Community 2`, `Community 22`, `Community 52`, `Community 34`, `Community 62`, `Community 18`, `Community 11`, `Community 61`, `Community 64`, `Community 23`, `Community 117`, `Community 93`, `Community 81`, `Community 185`, `Community 16`, `Community 45`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Are the 788 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 788 INFERRED edges - model-reasoned connections that need verification._
- **Are the 782 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 782 INFERRED edges - model-reasoned connections that need verification._
- **Are the 707 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 707 INFERRED edges - model-reasoned connections that need verification._
