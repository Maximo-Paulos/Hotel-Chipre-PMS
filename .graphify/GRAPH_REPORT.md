...
## Corpus Check
- Large corpus: 706 files · ~466,434 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6223 nodes · 19526 edges · 281 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 6368 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 6368 · contains: 4088 · calls: 3131 · MODIFIES: 1568 · ON_BRANCH: 1023 · rationale_for: 788 · imports: 697 · imports_from: 555 · method: 554 · inherits: 518 · PARENT_OF: 236


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 706 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 7 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `365b263`
...
Cohesion: 0.01
Nodes (90): _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Database engine and session management. Supports both PostgreSQL (production) an, Fill NULLs in NOT-NULL model columns that carry a default.      A column added i (+82 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (173): FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response., Lightweight availability placeholder. When all parameters are provided,     it r, CheckInRequest, FastAPI routes for Check-in / Check-out., FastAPI routes for Room management + Housekeeping. (+165 more)
...
Cohesion: 0.04
Nodes (94): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login() (+86 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (114): GuestCompanion, HotelConfiguration, Configuration table scoped by hotel (id == hotel_id)., RateLimitEvent, ReservationSourceEnum, RoomCategory, Onboarding service layer.  Tracks completion of required setup steps and produce, Raised when onboarding preconditions are not met. (+106 more)
...
Cohesion: 0.03
Nodes (63): createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge, PaymentSurchargeCreatePayload, PaymentSurchargeType, createRoomBlock() (+55 more)
...
Cohesion: 0.05
Nodes (55): AuthUser, AcceptPayload, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser() (+47 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (28): datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, 3d34a97 Connect system mail through master admin, bad20c6 Gate startup email behind SMTP_STARTUP_NOTIFY and send once, ec54376 Add env example and GHCR build/push workflow, get_mongo_db() (+20 more)
...
Cohesion: 0.11
Nodes (8): ensure_all_ota_webhook_secrets(), Hotel helper utilities (ownership + bootstrap)., Seed default plans if missing., Find a hotel configuration owned by the given email, or create a new one.     Al, Create owner membership and starter subscription if missing., Ensure every hotel has webhook secrets for the OTA providers used by the app., _hotel_default_currency(), OTAIntegrationService

### Community 41 - "Community 41"
Cohesion: 0.19
Nodes (33): build_manifest(), _canonical_hostname(), _connection_fingerprint(), _database_identity(), _database_password(), _deployment_git_identity(), _deployment_hosts(), _dict() (+25 more)
...
Cohesion: 0.06
Nodes (25): MasterAdminProtectedShell(), MasterAdminRoot(), navItems, MasterAdminSessionProvider(), OnboardingWizard(), MasterAdminAuditPage(), MasterAdminDashboardPage(), MasterAdminLoginPage() (+17 more)

### Community 44 - "Community 44"
Cohesion: 0.11
Nodes (28): main(), valid_https(), Shared, secret-safe binding for the Render QA bootstrap configuration., _canonical_host(), _https_preview_url(), main(), _mapping(), _non_empty() (+20 more)
...
Cohesion: 0.08
Nodes (25): bootstrap_configuration_fingerprint(), BootstrapConfigurationError, Hash the exact provider-observed values without exposing them individually., Hash the exact provider-observed values without exposing them individually., _decode_lease_entropy(), JsonGetter, Small GET-only API client with bounded retries and redacted failures., Safe failure whose message never contains provider response bodies. (+17 more)
...
- **Thin community `Community 185`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 187`** (1 nodes): `TestReservationCreation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 190`** (2 nodes): `TestReoptimizationIntegration`, `TestReoptimizationTrigger`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 206`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (2 nodes): `credentials`, `PAGES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 234`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 244`** (1 nodes): `TestAvailability`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 245`** (1 nodes): `TestStateTransitions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 261`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 263`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 8` to `Community 220`, `Community 0`, `Community 23`, `Community 10`, `Community 27`, `Community 30`, `Community 19`, `Community 6`, `Community 3`, `Community 85`, `Community 81`, `Community 131`, `Community 1`, `Community 5`, `Community 156`, `Community 24`, `Community 76`, `Community 16`, `Community 13`, `Community 25`, `Community 104`, `Community 17`, `Community 12`, `Community 47`, `Community 26`, `Community 105`, `Community 33`, `Community 50`, `Community 163`, `Community 14`, `Community 68`, `Community 182`, `Community 183`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 5` to `Community 4`, `Community 13`, `Community 37`, `Community 12`, `Community 154`, `Community 16`, `Community 8`, `Community 23`, `Community 3`, `Community 285`, `Community 19`, `Community 1`, `Community 224`, `Community 40`, `Community 70`, `Community 47`, `Community 25`, `Community 6`, `Community 50`, `Community 163`, `Community 14`, `Community 68`, `Community 165`, `Community 26`, `Community 142`, `Community 75`, `Community 190`, `Community 118`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 156`, `Community 12`, `Community 3`, `Community 37`, `Community 0`, `Community 8`, `Community 23`, `Community 30`, `Community 27`, `Community 19`, `Community 85`, `Community 236`, `Community 47`, `Community 40`, `Community 6`, `Community 33`, `Community 97`, `Community 5`, `Community 103`, `Community 126`, `Community 165`, `Community 142`, `Community 244`, `Community 187`, `Community 245`, `Community 75`, `Community 190`, `Community 118`?**
