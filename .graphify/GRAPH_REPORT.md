...
## Corpus Check
- Large corpus: 767 files · ~511,678 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7173 nodes · 24372 edges · 315 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9286 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9286 · contains: 4450 · calls: 3377 · MODIFIES: 1910 · ON_BRANCH: 1366 · rationale_for: 1162 · imports: 746 · imports_from: 586 · method: 579 · inherits: 534 · PARENT_OF: 376
...
Cohesion: 0.04
Nodes (215): Application Configuration. Uses pydantic-settings for environment variable manag, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main (+207 more)
...
Cohesion: 0.03
Nodes (107): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, requestVerification(), verifyEmail(), apiFetch(), buildAuthHeaders(), buildUrl(), formatErrorDetail(), handleUnauthorized() (+99 more)
...
Cohesion: 0.03
Nodes (98): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), createPaymentLink() (+90 more)
...
Cohesion: 0.11
Nodes (15): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+7 more)
...
Cohesion: 0.14
Nodes (11): 14c3453 Fail closed when managed databases are not migrated, 15f1429 Refresh Graphify and generated system inventories, 34ae6e9 Install dependencies before release evidence checks, 42dd238 Improve vault entrypoint and memory validation, 71cb80e Update Graphify community labels, 85252f7 Refresh Graphify after evidence continuity guard, 9303473 Add scalable data architecture specialist workflow, bf14bf5 Sync QA branch with updated main baseline (+3 more)
...
Cohesion: 0.27
Nodes (8): main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., 0255d4f Normalize Graphify artifact paths, d260449 Harden guest PII exports and audit snapshots, _guest_with_companion(), test_decorator_mongo_projection_excludes_guest_pii(), test_direct_guest_and_companion_audits_exclude_pii()
...
Cohesion: 0.50
Nodes (4): _authenticate_user(), _decode_authorization_header(), get_current_user(), get_current_user_optional()
...
- **Thin community `Community 95`** (2 nodes): `4f50de1 Add successor cash register controls`, `b4c9bd8 Harden cash rotation and payment integrity`
...
- **Thin community `Community 130`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 193`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 218`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 258`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 286`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `add trial and comped fields to subscriptions  Revision ID: 20260419_subscription`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 311`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 314`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `SubscriptionEnforcementMiddleware`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 327`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (2 nodes): `MERCADOPAGO_WEBHOOK_SECRET is required only when MP_ACCESS_TOKEN is set.`, `test_validate_runtime_security_rejects_missing_mp_webhook_when_mp_configured()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 10` to `Community 237`, `Community 200`, `Community 14`, `Community 0`, `Community 22`, `Community 36`, `Community 116`, `Community 38`, `Community 17`, `Community 28`, `Community 66`, `Community 8`, `Community 13`, `Community 15`, `Community 94`, `Community 6`, `Community 140`, `Community 1`, `Community 5`, `Community 9`, `Community 31`, `Community 3`, `Community 29`, `Community 117`, `Community 2`, `Community 32`, `Community 33`, `Community 25`, `Community 75`, `Community 27`, `Community 44`, `Community 62`, `Community 37`, `Community 209`, `Community 85`, `Community 189`, `Community 190`, `Community 125`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 5` to `Community 12`, `Community 22`, `Community 8`, `Community 19`, `Community 34`, `Community 3`, `Community 70`, `Community 0`, `Community 10`, `Community 36`, `Community 1`, `Community 316`, `Community 28`, `Community 27`, `Community 244`, `Community 37`, `Community 87`, `Community 32`, `Community 29`, `Community 2`, `Community 6`, `Community 17`, `Community 62`, `Community 66`, `Community 9`, `Community 13`, `Community 85`, `Community 98`, `Community 169`, `Community 122`, `Community 31`, `Community 33`, `Community 50`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 27`, `Community 31`, `Community 70`, `Community 8`, `Community 0`, `Community 10`, `Community 36`, `Community 17`, `Community 38`, `Community 28`, `Community 5`, `Community 15`, `Community 32`, `Community 37`, `Community 25`, `Community 75`, `Community 2`, `Community 44`, `Community 9`, `Community 13`, `Community 113`, `Community 98`, `Community 169`, `Community 122`, `Community 22`, `Community 50`?**
