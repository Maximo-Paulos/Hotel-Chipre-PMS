...
## Corpus Check
- Large corpus: 729 files · ~479,660 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6566 nodes · 21938 edges · 293 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 7935 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 7935 · contains: 4218 · calls: 3216 · MODIFIES: 1723 · ON_BRANCH: 1256 · rationale_for: 952 · imports: 722 · imports_from: 567 · method: 554 · inherits: 529 · PARENT_OF: 266


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 729 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 8 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `b4c9bd8`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 530 edges
2. `Reservation` - 529 edges
3. `HotelConfiguration` - 476 edges
4. `Room` - 387 edges
5. `Guest` - 383 edges
6. `RoomCategory` - 358 edges
7. `Base` - 336 edges
8. `RoomStatusEnum` - 294 edges
9. `TransactionTypeEnum` - 235 edges
10. `PaymentMethodEnum` - 232 edges
...
Cohesion: 0.04
Nodes (199): FastAPI routes for Check-in / Check-out., FastAPI routes for Guest management., Add new companions to an existing guest., DocumentTypeEnum, Guest, GuestRatingEnum, GuestTag, GuestTagTypeEnum (+191 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (185): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+177 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (127): CheckInRequest, BaseModel, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse, MasterAdminSessionResponse (+119 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (109): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+101 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (115): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+107 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (99): Base, Base class for all ORM models., lifespan(), Initialize database on application startup., Initialize database on application startup., DeclarativeBase, AnalyticsAIUsageMonthly, AnalyticsAlertSetting (+91 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (82): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), _mask_email() (+74 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (87): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re (+79 more)
...
Cohesion: 0.04
Nodes (64): createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge, PaymentSurchargeCreatePayload, PaymentSurchargeType, createRoomBlock() (+56 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (34): datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory() (+26 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (55): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), email_status() (+47 more)
...
Cohesion: 0.05
Nodes (22): _DecimalAwareEncoder, _is_demo_mode_enabled(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., _require_demo_mode(), 1f352e4 feat(reports): SLICE-11 operational reports + alerts, 283135b feat(ops): SLICE-13 laundry + stock foundations (+14 more)
...
Cohesion: 0.07
Nodes (34): 107f875 Support legacy master admin underscore routes, 3d34a97 Connect system mail through master admin, 7e196fa Fix master admin cross-origin session cookies, 885bb1a Prefer completed hotel on login, 89b1823 Align master admin env names and bootstrap login, 92ae064 Reduce noisy master session hydration 401, 96ff88b Migrate system mail to Resend, cfaae45 Fix master billing policy for legacy schema (+26 more)
...
Cohesion: 0.05
Nodes (24): 1a71e7d feat: add ota allocation data foundation, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 7506225 feat(R2b): soft delete for domain records (§26), a61a51c chore: checkpoint de prueba antes de gemma 4, c580b56 ojala si, e1bc3d1 feat(db): v72 gaps phase 3 — room_movement_groups, BillingAdjustment Numeric, Room.description, e202fdd feat(db): v72 gaps phase 1+2 — Numeric precision, new tables, search indexes, OTA dedup (+16 more)
...
Cohesion: 0.07
Nodes (34): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), inviteUser(), list_users(), listUsers() (+26 more)
...
Cohesion: 0.09
Nodes (38): Validate reset code without changing password (paso previo en UI)., Prefer a hotel whose onboarding is already complete.      When a user belongs to, validate_reset(), AcceptPayload, InvitePayload, InviteResponse, User management per hotel (owners/co-owners)., UpdateRolePayload (+30 more)
...
Cohesion: 0.06
Nodes (24): MasterAdminProtectedShell(), MasterAdminRoot(), navItems, MasterAdminSessionProvider(), OnboardingWizard(), SettingsAssistantPage(), SettingsHotelPage(), SettingsSecurityPage() (+16 more)
...
Cohesion: 0.18
Nodes (22): PaymentProof, PaymentProofBlob, PaymentProofStatusEnum, Manual bank-transfer evidence and approval lifecycle., Private image evidence awaiting explicit staff confirmation., Private image evidence awaiting explicit staff confirmation., Private binary payload kept separately from queryable proof metadata., approve_transfer_proof() (+14 more)
...
Cohesion: 0.08
Nodes (11): Tests for Reservation Service — booking creation, availability checks, state tra, Tests for confirmation code generation., Tests for room availability checking., A room with no reservations should be available., Tests for reservation state machine transitions., A room with an overlapping reservation should not be available., Check-out day == next check-in day should be allowed (no overlap)., Find available rooms after booking some. (+3 more)
...
Cohesion: 0.12
Nodes (11): graphify_state(), main(), main(), run(), validate_json(), 1ebf84a Audit and harden agent operations context, bc938cf Add agent ops vault and cloud QA foundation, e2eDbPath (+3 more)
...
Cohesion: 0.14
Nodes (14): buildUrl(), approvePaymentProof(), fetchPaymentProofImage(), listPaymentProofs(), PaymentProof, PaymentProofCreatePayload, PaymentProofStatus, rejectPaymentProof() (+6 more)
...
Cohesion: 0.13
Nodes (8): Tests for reservation creation logic., Create a standard reservation and verify computed fields., Reserve a specific room., Should fail for non-existent guest., Should fail when check-out is before check-in., Should fail when room doesn't match the requested category., Cannot book the same room for overlapping dates., TestReservationCreation
...
Cohesion: 0.20
Nodes (5): 1fd0691 Add display permission fields to hotel config with tests, b33f5a8 Config UI: advanced owner settings and ops fields, e3aa066 feat(R-extra): configurable per-hotel API rate limit §16 + waitlist promotion on OTA release §10.2, HotelConfiguration — per-hotel business rules. No global/singleton: one row per, Pydantic schemas for HotelConfiguration.
...
Cohesion: 0.46
Nodes (7): Exception, _build_message(), ensure_hotel_gmail_ready(), HotelOutboundEmailError, HotelOutboundIdentity, HotelOutboundSendResult, send_hotel_email()
...
Cohesion: 0.40
Nodes (3): Waitlist / overbooking list model — v72 §9.  When the hotel is at capacity for a, Single guest waiting for a room in a given category for a date range.     Priori, WaitlistEntry
...
- **Thin community `Community 122`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 223`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 270`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 271`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 272`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 273`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 274`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 275`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 276`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 277`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 278`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 279`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 280`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 282`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `FakeResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `Schemas for manual OTA reservation entry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 5` to `Community 239`, `Community 205`, `Community 13`, `Community 20`, `Community 249`, `Community 184`, `Community 134`, `Community 26`, `Community 10`, `Community 30`, `Community 8`, `Community 11`, `Community 3`, `Community 96`, `Community 90`, `Community 142`, `Community 0`, `Community 4`, `Community 2`, `Community 85`, `Community 156`, `Community 40`, `Community 25`, `Community 115`, `Community 7`, `Community 52`, `Community 28`, `Community 43`, `Community 68`, `Community 293`, `Community 97`, `Community 135`, `Community 29`, `Community 35`, `Community 55`, `Community 250`, `Community 295`, `Community 216`, `Community 75`, `Community 194`, `Community 195`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 14`, `Community 40`, `Community 47`, `Community 4`, `Community 166`, `Community 156`, `Community 5`, `Community 26`, `Community 294`, `Community 207`, `Community 77`, `Community 11`, `Community 52`, `Community 56`, `Community 25`, `Community 7`, `Community 3`, `Community 8`, `Community 87`, `Community 55`, `Community 190`, `Community 295`, `Community 97`, `Community 75`, `Community 28`, `Community 153`, `Community 43`, `Community 38`, `Community 106`, `Community 83`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 8`, `Community 4`, `Community 7`, `Community 47`, `Community 29`, `Community 5`, `Community 26`, `Community 30`, `Community 96`, `Community 210`, `Community 11`, `Community 52`, `Community 56`, `Community 43`, `Community 68`, `Community 87`, `Community 3`, `Community 35`, `Community 212`, `Community 97`, `Community 128`, `Community 153`, `Community 79`, `Community 121`, `Community 38`, `Community 106`, `Community 83`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Are the 528 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 528 INFERRED edges - model-reasoned connections that need verification._
- **Are the 522 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 522 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 383 inferred relationships involving `Room` (e.g. with `RoomBlockCreate` and `RoomBlockRead`) actually correct?**
  _`Room` has 383 INFERRED edges - model-reasoned connections that need verification._