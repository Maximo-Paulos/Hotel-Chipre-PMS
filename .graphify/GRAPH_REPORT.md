...
## Corpus Check
- Large corpus: 744 files · ~490,767 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6840 nodes · 22898 edges · 296 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 8431 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 8431 · contains: 4350 · calls: 3331 · MODIFIES: 1781 · ON_BRANCH: 1266 · rationale_for: 1052 · imports: 728 · imports_from: 576 · method: 574 · inherits: 533 · PARENT_OF: 276


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 744 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 8 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `307e650`
...
Cohesion: 0.03
Nodes (219): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+211 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (188): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+180 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (83): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, _DecimalAwareEncoder, _is_demo_mode_enabled(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files. (+75 more)
...
Cohesion: 0.07
Nodes (127): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca (+119 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (122): CheckInRequest, UpdateRolePayload, BaseModel, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse (+114 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (107): FastAPI routes for Check-in / Check-out., FastAPI routes for Guest management., Add new companions to an existing guest., Guest, GuestRatingEnum, GuestTag, GuestTagTypeEnum, Guest and GuestCompanion models. Exhaustive fields for check-in panel: identity (+99 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (96): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), approvePaymentProof() (+88 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (81): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+73 more)
...
Cohesion: 0.04
Nodes (79): DocumentTypeEnum, GuestCompanion, Companion/additional occupant traveling with a primary guest.     Hotels often n, Companion/additional occupant traveling with a primary guest.     Hotels often n, RateLimitEvent, ReservationSourceEnum, _enum_value(), get_guest_profile() (+71 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (101): cancel_reservation(), create_new_reservation(), create_or_update_manual_ota(), extend_stay(), mark_no_show(), modify_reservation(), _project_reservation_graph(), FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend (+93 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (87): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), HotelConfiguration (+79 more)
...
Cohesion: 0.03
Nodes (36): _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Database engine and session management. Supports both PostgreSQL (production) an, Fill NULLs in NOT-NULL model columns that carry a default.      A column added i (+28 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (59): Base, Base class for all ORM models., DeclarativeBase, Record an AuditLog row for a successful entity mutation., AuditLog, Tenant-scoped audit log for tracking mutations across core tables. Every write t, Append-only record of every significant mutation within a hotel tenant.     Do N, Check if guest has provided required identity documents for check-in. (+51 more)

### Community 16 - "Community 16"
Cohesion: 0.13
Nodes (63): ReservationAllocationLock, Company, Operational reservation models for adjustments, room moves and audit history., Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, ReservationStatusHistory, RoomMoveEvent, RoomMovementGroup, RoomMoveTypeEnum (+55 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (55): _enum_value(), _event_to_read(), _group_to_read(), list_movement_groups(), MovementEventRead, MovementGroupRead, _not_found_or_bad_request(), read_movement_group() (+47 more)
...
Cohesion: 0.08
Nodes (36): AnalyticsWarehouseUnavailable, build_cash_movement_fact_row(), build_hotel_dimension_row(), build_payment_fact_row(), build_reservation_fact_row(), build_room_category_dimension_row(), build_room_dimension_row(), build_stock_movement_fact_row() (+28 more)
...
Cohesion: 0.08
Nodes (30): AcceptPayload, User management per hotel (owners/co-owners)., AuthContext, get_auth_context(), _parse_header_hotel_id(), _parse_token_hotel_id(), Strict authentication/context helpers.  Every operational request must resolve t, Return an authenticated context scoped to an active hotel membership. (+22 more)
...
Cohesion: 0.13
Nodes (29): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+21 more)
...
Cohesion: 0.09
Nodes (3): 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, credentials
...
Cohesion: 0.17
Nodes (20): AnalyticsExportJob, AnalyticsExportStatusEnum, FactReservationDaily, _date_window(), _decimal_total(), detect_no_shows(), _parse_datetime(), project_all_derived_facts_incremental() (+12 more)
...
Cohesion: 0.16
Nodes (7): 307e650 Add replayable operational warehouse projections, FakeWarehouseClient, _settings(), test_clickhouse_schema_is_derived_and_tenant_partitioned(), test_operational_schema_covers_dimensions_and_non_pii_facts(), test_reconcile_compares_source_and_derived_counts(), test_required_warehouse_configuration_fails_closed()
...
Cohesion: 0.27
Nodes (13): calculate_base_amount_before_surcharge(), calculate_payment_surcharge(), get_hotel_config(), get_reservation_financial_summary(), _payment_method_value(), process_payment(), _recommended_financial_action(), _resolve_payment_currency() (+5 more)
...
Cohesion: 0.24
Nodes (5): _load_composite_fk_migration(), _load_rls_migration(), test_core_composite_fk_migration_covers_the_metadata_contract(), test_rls_migration_covers_every_hotel_scoped_model_table(), test_rls_migration_keeps_api_key_bootstrap_exception_explicit()
...
- **Thin community `Community 295`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 304`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 15` to `Community 233`, `Community 200`, `Community 14`, `Community 2`, `Community 234`, `Community 145`, `Community 265`, `Community 24`, `Community 112`, `Community 29`, `Community 16`, `Community 23`, `Community 81`, `Community 0`, `Community 4`, `Community 17`, `Community 90`, `Community 8`, `Community 134`, `Community 10`, `Community 6`, `Community 5`, `Community 12`, `Community 9`, `Community 55`, `Community 25`, `Community 113`, `Community 59`, `Community 53`, `Community 26`, `Community 61`, `Community 38`, `Community 57`, `Community 236`, `Community 32`, `Community 210`, `Community 80`, `Community 189`, `Community 190`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 12` to `Community 9`, `Community 55`, `Community 11`, `Community 3`, `Community 5`, `Community 59`, `Community 161`, `Community 15`, `Community 24`, `Community 0`, `Community 301`, `Community 23`, `Community 6`, `Community 241`, `Community 83`, `Community 53`, `Community 32`, `Community 25`, `Community 8`, `Community 16`, `Community 57`, `Community 81`, `Community 10`, `Community 4`, `Community 80`, `Community 26`, `Community 149`, `Community 103`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 6`, `Community 59`, `Community 11`, `Community 2`, `Community 15`, `Community 24`, `Community 16`, `Community 29`, `Community 23`, `Community 17`, `Community 10`, `Community 53`, `Community 32`, `Community 4`, `Community 61`, `Community 12`, `Community 38`, `Community 206`, `Community 149`, `Community 103`?**
