...
## Corpus Check
- Large corpus: 723 files · ~474,134 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6380 nodes · 20367 edges · 297 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 6679 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 6679 · contains: 4158 · calls: 3182 · MODIFIES: 1661 · ON_BRANCH: 1251 · rationale_for: 837 · imports: 699 · imports_from: 560 · method: 554 · inherits: 525 · PARENT_OF: 261


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 723 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 7 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `e85df76`
...
Cohesion: 0.05
Nodes (194): v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc, Application decorators., Reservation model with strict state machine. States: pending â†’ deposit_paid â†, Transaction and PaymentMethod models. Supports: Efectivo (Cash), MercadoPago, Pa, mockCategories, mockCalendar, mockDailyRates, 01498d0 Harden password reset flow (verified-only, dev code return) (+186 more)
...
Cohesion: 0.03
Nodes (67): repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi, email_status(), FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., FastAPI routes for Payments., credentials, PAGES, AllocationRunPayload (+59 more)
...
Cohesion: 0.06
Nodes (35): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _assert_assignable_role(), _assert_manageable_membership(), _membership_user_info(), list_users(), invite_user(), revoke_user(), update_role() (+27 more)
...
Cohesion: 0.04
Nodes (84): _generate_code(), _mask_email(), _pick_default_hotel_id(), _build_auth_response(), _issue_email_token(), register(), request_verify(), login() (+76 more)

### Community 33 - "Community 33"
Cohesion: 0.09
Nodes (39): validate_reset(), Prefer a hotel whose onboarding is already complete.      When a user belongs to, Validate reset code without changing password (paso previo en UI)., AcceptPayload, LoginRequest, InvitePayload, InviteResponse, UpdateRolePayload (+31 more)
...
Cohesion: 0.03
Nodes (99): BaseModel, MasterAdminLoginRequest, MasterAdminUserPayload, MasterAdminLoginResponse, MasterAdminSessionResponse, BillingPolicyUpdateRequest, BillingPolicyPayload, EmailTestRequest (+91 more)
...
Cohesion: 0.04
Nodes (71): FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Ensure computed fields land in the response., Lightweight availability placeholder. When all parameters are provided,     it r, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+63 more)
...
Cohesion: 0.04
Nodes (129): DailyRateOut, Config, DailyRateFallbackOut, DailyRateIn, BulkRateIn, BulkFieldRateIn, BulkRateOut, PricePeriodIn (+121 more)
...
Cohesion: 0.10
Nodes (62): PaymentSurchargeRead, PaymentSurchargeCreate, PaymentSurchargeUpdate, _get_surcharge_or_404(), update_payment_surcharge(), deactivate_payment_surcharge(), Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, BillingAdjustmentTypeEnum (+54 more)
...
Cohesion: 0.04
Nodes (211): FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., RoomStatusUpdate, RoomCategoryAssignmentUpdate, Get housekeeping overview: how many rooms in each status., Soft-delete a room when no active reservations are attached. (+203 more)
...
Cohesion: 0.05
Nodes (39): Settings, BaseSettings, get_settings(), _normalized_env_value(), _has_value(), _is_public_https_url(), _mercadopago_is_active(), _paypal_is_active() (+31 more)
...
Cohesion: 0.15
Nodes (30): ReservationAdjustmentKindEnum, ReservationAdjustmentStatusEnum, ReservationAdjustment, Operational reservation models for adjustments, room moves and audit history., ReservationOperationsError, ReservationError, _invalidate_availability_cache(), _hotel_default_currency() (+22 more)
...
Cohesion: 0.11
Nodes (36): PaymentLink, Payment, PaymentWebhookEvent, Payment gateway tracking models: PaymentLink, Payment, PaymentWebhookEvent.  Sou, Guest-facing pre-payment object (checkout URL / QR). May collect partial payment, One gateway payment object (MP preference / PayPal order / Stripe intent)., Raw webhook log per payment — idempotent on (hotel_id, provider, webhook_id)., PaymentLinkError (+28 more)

### Community 215 - "Community 215"
Cohesion: 0.38
Nodes (5): PaymentProofStatusEnum, Manual bank-transfer evidence and approval lifecycle., PaymentProofCreate, PaymentProofReject, PaymentProofRead
...
Cohesion: 0.73
Nodes (5): _image_base64(), _reservation(), test_submit_transfer_proof_validates_image_and_stores_metadata(), test_approval_creates_completed_transfer_transaction_and_updates_balance(), test_rejected_proof_requires_reason_and_cannot_be_approved()
...
- **Thin community `Community 277`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 278`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 279`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 280`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 282`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 296`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `ota hardening: hotel-scoped mappings and webhook credentials  Revision ID: a7f3d`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 302`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (2 nodes): `reportable_origin()`, `Derive the BRM §16.2 reportable origin for a reservation.      Precedence:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 250`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `Schemas for manual OTA reservation entry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 125`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 248`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 3` to `Community 231`, `Community 198`, `Community 10`, `Community 55`, `Community 247`, `Community 174`, `Community 301`, `Community 29`, `Community 7`, `Community 46`, `Community 2`, `Community 17`, `Community 92`, `Community 86`, `Community 136`, `Community 0`, `Community 14`, `Community 25`, `Community 82`, `Community 26`, `Community 33`, `Community 88`, `Community 109`, `Community 12`, `Community 47`, `Community 8`, `Community 27`, `Community 41`, `Community 129`, `Community 215`, `Community 302`, `Community 130`, `Community 1`, `Community 306`, `Community 9`, `Community 35`, `Community 5`, `Community 49`, `Community 233`, `Community 206`, `Community 74`, `Community 185`, `Community 187`, `Community 188`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 6`, `Community 33`, `Community 53`, `Community 9`, `Community 157`, `Community 26`, `Community 3`, `Community 29`, `Community 303`, `Community 14`, `Community 236`, `Community 76`, `Community 8`, `Community 79`, `Community 12`, `Community 47`, `Community 2`, `Community 49`, `Community 20`, `Community 68`, `Community 180`, `Community 17`, `Community 74`, `Community 88`, `Community 185`, `Community 27`, `Community 41`, `Community 42`, `Community 81`, `Community 124`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 9`, `Community 14`, `Community 53`, `Community 2`, `Community 1`, `Community 3`, `Community 29`, `Community 46`, `Community 92`, `Community 251`, `Community 8`, `Community 41`, `Community 129`, `Community 12`, `Community 47`, `Community 35`, `Community 107`, `Community 17`, `Community 42`, `Community 81`, `Community 124`?**
