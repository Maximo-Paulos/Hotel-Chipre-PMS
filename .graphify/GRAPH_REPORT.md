...
## Corpus Check
- Large corpus: 874 files · ~610,885 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 9015 nodes · 38383 edges · 336 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 14773 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 14773 · ON_BRANCH: 6634 · contains: 5312 · calls: 3896 · MODIFIES: 2514 · rationale_for: 1798 · imports: 939 · imports_from: 722 · PARENT_OF: 610 · method: 598 · inherits: 584 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 874 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 11 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `2b75520`
...
Cohesion: 0.02
Nodes (371): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+363 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (307): main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., agent-linensplit, agent-login, agent-mobilenav, agent-otafix (+299 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (326): Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days)., Revenue report for a date range. (+318 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (76): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., 1a71e7d feat: add ota allocation data foundation, 1af6bfc Add demo seed script and README instructions for stage 1, 50ad65d feat: harden gmail onboarding and multi-tenant email flow, 69b2c87 Fix guest quick profile response serialization, a61a51c chore: checkpoint de prueba antes de gemma 4 (+68 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (229): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+221 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (120): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _require_demo_mode(), reset_demo(), seed_demo() (+112 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (223): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser(), list_users() (+215 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (173): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), addGuestCompanions() (+165 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (174): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest. (+166 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (167): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), google_login(), _issue_email_token(), login() (+159 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (156): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+148 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (176): cancel_reservation(), create_new_reservation(), create_or_update_manual_ota(), create_reservation_charge(), _ensure_manual_rate_permission(), extend_stay(), mark_no_show(), modify_reservation() (+168 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (128): StockConsumptionItem, StockConsumptionReportRead, StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead, StockMovementCreate (+120 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (106): _current_user(), Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., recent_security_events(), revoke_current_user_sessions(), _safe_resource_id(), security_overview() (+98 more)
...
Cohesion: 0.03
Nodes (39): _authorize_override(), checkin(), CategoryPayload, DepositPolicyPayload, finishOnboarding(), HotelIdentityPayload, OnboardingProviderSetup, OnboardingStatus (+31 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (65): PermissionGate(), MasterAdminProtectedShell(), MasterAdminRoot(), navItems, MasterAdminSessionProvider(), SettingsAssistantPage(), SettingsHotelPage(), SettingsUsersPage() (+57 more)
...
Cohesion: 0.05
Nodes (49): Base, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterSystemEmailConnection, MasterAdminContext, FxPolicy (+41 more)
...
Cohesion: 0.06
Nodes (38): ad4249c Implement master admin panel, StatCard(), StatCardProps, toneClasses, Email provider abstraction for platform transactional mail., clearMasterAdminCsrfToken(), masterAdminFetch(), MasterAdminLoginResponse (+30 more)
...
Cohesion: 0.12
Nodes (40): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+32 more)

### Community 44 - "Community 44"
Cohesion: 0.10
Nodes (37): RoomBlockCreate, RoomBlockRead, Exception, Date-ranged block on a room. NULL ends_at means indefinite.     resolved_at popu, RoomBlock, RoomBlockReasonEnum, HotelOutboundEmailError, is_review_for_today() (+29 more)
...
Cohesion: 0.21
Nodes (8): getSecurityEvents(), getSecurityOverview(), revokeAllSessions(), RevokeAllSessionsResponse, SecurityEvent, SecurityEventsResponse, SecurityOverview, SettingsSecurityPage()
...
- **Thin community `Community 69`** (2 nodes): `_hotel_default_currency()`, `OTAIntegrationService`
...
- **Thin community `Community 213`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 227`** (1 nodes): `test_failed_audit_log_insert_does_not_roll_back_callers_change()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (2 nodes): `owner`, `receptionist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `Mailer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `TestBookingWebhook`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 339`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 342`** (1 nodes): `add external-effect mode to payment links  Revision ID: 20260812_external_effect`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 343`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 344`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 346`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 347`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 348`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 8` to `Community 5`, `Community 3`, `Community 166`, `Community 67`, `Community 221`, `Community 11`, `Community 49`, `Community 20`, `Community 34`, `Community 60`, `Community 4`, `Community 61`, `Community 90`, `Community 76`, `Community 2`, `Community 17`, `Community 13`, `Community 96`, `Community 147`, `Community 0`, `Community 21`, `Community 57`, `Community 64`, `Community 120`, `Community 15`, `Community 43`, `Community 29`, `Community 51`, `Community 184`, `Community 44`, `Community 72`, `Community 260`, `Community 80`, `Community 1`, `Community 78`, `Community 85`, `Community 209`, `Community 210`, `Community 133`, `Community 99`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 2` to `Community 14`, `Community 57`, `Community 11`, `Community 6`, `Community 65`, `Community 12`, `Community 43`, `Community 62`, `Community 5`, `Community 8`, `Community 20`, `Community 90`, `Community 61`, `Community 0`, `Community 44`, `Community 264`, `Community 24`, `Community 1`, `Community 308`, `Community 310`, `Community 170`, `Community 309`, `Community 286`, `Community 88`, `Community 109`, `Community 69`, `Community 51`, `Community 91`, `Community 4`, `Community 72`, `Community 76`, `Community 78`, `Community 85`, `Community 64`, `Community 245`, `Community 49`, `Community 29`, `Community 316`, `Community 13`, `Community 133`, `Community 93`, `Community 41`, `Community 17`, `Community 110`, `Community 98`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 8`, `Community 43`, `Community 2`, `Community 11`, `Community 5`, `Community 20`, `Community 4`, `Community 60`, `Community 90`, `Community 61`, `Community 13`, `Community 284`, `Community 44`, `Community 109`, `Community 69`, `Community 51`, `Community 119`, `Community 131`, `Community 316`, `Community 41`, `Community 17`, `Community 110`, `Community 98`?**
