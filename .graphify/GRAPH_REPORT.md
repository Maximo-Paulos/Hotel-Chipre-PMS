...
## Corpus Check
- Large corpus: 1250 files · ~1,774,909 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 12024 nodes · 67376 edges · 437 communities detected
- Extraction: 65% EXTRACTED · 35% INFERRED · 0% AMBIGUOUS · INFERRED: 23722 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 23722 · ON_BRANCH: 20578 · contains: 6591 · calls: 4880 · MODIFIES: 4259 · rationale_for: 3101 · imports: 1181 · imports_from: 931 · PARENT_OF: 812 · inherits: 692 · method: 625 · re_exports: 4


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1250 · Candidates: 1384
- Excluded: 9 untracked · 15515 ignored · 12 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `21b67dd`
...
Cohesion: 0.02
Nodes (572): daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c (+564 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (257): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp (+249 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (436): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+428 more)

### Community 3 - "Community 3"
Cohesion: 0.19
Nodes (417): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+409 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (350): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest. (+342 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (153): main(), valid_https(), _archive_historical(), _build_cases(), main(), _write_json(), Shared, secret-safe binding for the Render QA bootstrap configuration., acceptInvitation() (+145 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (220): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), Category (+212 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (216): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), createGuestRestriction() (+208 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (254): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), inviteUser(), list_users(), listUsers(), _membership_user_info() (+246 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (190): AnalyticsAIChatPage(), AnalyticsAIChatResponse, AnalyticsAIStatus, AnalyticsCategoryDetailPage(), AnalyticsChannelsPage(), AnalyticsCompanyDetailPage(), AnalyticsEnvelope, analyticsErrorMessage() (+182 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (205): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses the ca, Calculate pricing for a potential booking without persisting it.     Uses the ca (+197 more)
...
Cohesion: 0.04
Nodes (159): apple_callback(), _apple_full_name(), apple_login(), _apple_login_config(), apple_start(), _attach_user_session_cookies(), _audit_security_event(), _build_auth_response() (+151 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (76): CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload, OnboardingProviderSetup, OnboardingStatus, OTAChannelsPayload (+68 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (38): _authorize_override(), checkin(), create_payment_surcharge(), deactivate_payment_surcharge(), _get_surcharge_or_404(), _has_per_method_nightly_price(), update_payment_surcharge(), 1165233 feat(backups): soft-delete + local restore drill for TECH-0110 (+30 more)
...
Cohesion: 0.08
Nodes (25): ensure_all_ota_webhook_secrets(), Hotel helper utilities (ownership + bootstrap)., Ensure every hotel has webhook secrets for the OTA providers used by the app., Ensure every hotel has webhook secrets for the OTA providers used by the app., Ensure every hotel has webhook secrets for the OTA providers used by the app., _hotel_default_currency(), OTAIntegrationService, Process an incoming reservation from Booking.com through the normalized (+17 more)
...
Cohesion: 0.19
Nodes (41): FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia., Receive reservation notifications from Despegar., OTAConnection, OTAProvider, OTARatePlanMapping, OTARoomMapping (+33 more)
...
Cohesion: 0.13
Nodes (37): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyDaily, FactRoomOccupancyStatusAtNightEnum, HotelAuditEvent, RoomStateEvent, PaymentLinkStatusEnum (+29 more)
...
Cohesion: 0.09
Nodes (37): channel_for_hotel(), discard_queued_domain_changes(), DomainEvent, format_sse(), get_realtime_client(), _get_redis_client(), iter_event_stream(), _model_event_payload() (+29 more)
...
Cohesion: 0.06
Nodes (38): _collect_plan_entitlements(), delete_entitlement_override(), ensure_entitlements_seeded(), ensure_room_within_limit(), ensure_staff_within_limit(), ensure_subscription(), entitlements_payload(), get_effective_room_limit() (+30 more)
...
Cohesion: 0.11
Nodes (18): lifespan(), Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Initialize database on application startup., Initialize database on application startup., Initialize database on application startup., Initialize database on application startup. (+10 more)
...
Cohesion: 0.15
Nodes (13): _infer_type(), Idempotent helper to add/update a plan entitlement row., Idempotent helper to add/update a plan entitlement row., Create/update a hotel-specific entitlement override and return merged payload., Create/update a hotel-specific entitlement override and return merged payload., Create/update a hotel-specific entitlement override and return merged payload., Normalize values into (string, type) for portable storage., Normalize values into (string, type) for portable storage. (+5 more)
...
Cohesion: 0.18
Nodes (11): _is_demo_mode_enabled(), Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed. (+3 more)
...
- **Thin community `Community 145`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 259`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (2 nodes): `_context()`, `test_generic_room_status_patch_projects_event_and_reallocates()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (2 nodes): `credentials`, `receptionistCredentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 368`** (2 nodes): `ownerCredentials`, `receptionistCredentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 375`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 381`** (1 nodes): `TestBookingWebhook`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 390`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 391`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 428`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 430`** (2 nodes): `BridgeActivity`, `MainActivity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 431`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 433`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 438`** (1 nodes): `TestCurrentSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 439`** (1 nodes): `TestExportSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 4` to `Community 1`, `Community 10`, `Community 123`, `Community 40`, `Community 198`, `Community 81`, `Community 43`, `Community 47`, `Community 72`, `Community 2`, `Community 68`, `Community 56`, `Community 83`, `Community 11`, `Community 110`, `Community 23`, `Community 60`, `Community 113`, `Community 108`, `Community 185`, `Community 0`, `Community 369`, `Community 31`, `Community 25`, `Community 13`, `Community 41`, `Community 57`, `Community 36`, `Community 224`, `Community 26`, `Community 137`, `Community 16`, `Community 21`, `Community 124`, `Community 49`, `Community 45`, `Community 5`, `Community 17`, `Community 82`, `Community 119`, `Community 282`, `Community 342`, `Community 76`, `Community 38`, `Community 97`, `Community 32`, `Community 15`, `Community 309`, `Community 85`, `Community 34`, `Community 20`, `Community 96`, `Community 126`, `Community 256`, `Community 382`, `Community 383`, `Community 384`, `Community 143`, `Community 150`, `Community 238`, `Community 70`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 1`, `Community 60`, `Community 4`, `Community 6`, `Community 36`, `Community 11`, `Community 10`, `Community 21`, `Community 25`, `Community 56`, `Community 68`, `Community 268`, `Community 34`, `Community 251`, `Community 12`, `Community 69`, `Community 26`, `Community 89`, `Community 2`, `Community 49`, `Community 35`, `Community 76`, `Community 178`, `Community 62`, `Community 22`, `Community 130`, `Community 83`, `Community 222`, `Community 20`, `Community 104`, `Community 23`, `Community 96`, `Community 41`, `Community 126`, `Community 291`, `Community 43`, `Community 317`, `Community 45`, `Community 381`, `Community 13`, `Community 382`, `Community 383`, `Community 384`, `Community 149`, `Community 15`, `Community 143`, `Community 150`, `Community 66`, `Community 51`, `Community 438`, `Community 439`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 1`, `Community 4`, `Community 60`, `Community 10`, `Community 21`, `Community 11`, `Community 2`, `Community 72`, `Community 56`, `Community 68`, `Community 113`, `Community 31`, `Community 49`, `Community 34`, `Community 109`, `Community 269`, `Community 104`, `Community 23`, `Community 381`, `Community 131`, `Community 51`, `Community 438`, `Community 439`?**
