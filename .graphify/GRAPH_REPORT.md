...
## Corpus Check
- Large corpus: 1162 files · ~1,678,120 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10117 nodes · 48575 edges · 366 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 16168 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16168 · ON_BRANCH: 12872 · contains: 5930 · calls: 4353 · MODIFIES: 3310 · rationale_for: 2081 · imports: 1078 · imports_from: 835 · PARENT_OF: 681 · inherits: 648 · method: 616 · re_exports: 3


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1162 · Candidates: 1295
- Excluded: 1 untracked · 594 ignored · 12 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `9d6c97d`
...
Cohesion: 0.14
Nodes (349): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+341 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (138): _authorize_override(), checkin(), _require_demo_mode(), reset_demo(), seed_demo(), _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck() (+130 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (186): _archive_historical(), _build_cases(), main(), _write_json(), acceptInvitation(), _allow_mfa_attempt(), _attach_user_session_cookies(), _audit_security_event() (+178 more)
...
Cohesion: 0.05
Nodes (226): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser() (+218 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (184): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+176 more)
...
Cohesion: 0.02
Nodes (136): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+128 more)
...
Cohesion: 0.02
Nodes (134): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), apiFetch() (+126 more)
...
Cohesion: 0.07
Nodes (43): google_login(), _pick_default_hotel_id(), Auth endpoints: register, login, email verification and password reset. Verifica, Project a global identity event into every hotel the user actively belongs to., "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, Validate reset code without changing password (paso previo en UI). (+35 more)
...
Cohesion: 0.06
Nodes (44): AcceptPayload, _current_user(), Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., Keep useful internal references while never exposing free-form details., recent_security_events() (+36 more)
...
Cohesion: 0.09
Nodes (40): MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection, MasterAdminContext (+32 more)
...
Cohesion: 0.11
Nodes (31): 955325e feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, Configurable permission matrix models., An employee-specific permission decision within one hotel membership., UserPermissionOverride, _active_membership(), _audit(), audit_permission_denied(), can_role_hold_permission() (+23 more)
...
- **Thin community `Community 267`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (2 nodes): `POST /api/checkin/checkout only enforced authentication (get_auth_context),`, `test_housekeeping_cannot_checkout_reservation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 359`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 361`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 362`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 364`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 365`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 367`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 373`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 374`** (1 nodes): `FakeResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 0` to `Community 2`, `Community 15`, `Community 4`, `Community 151`, `Community 66`, `Community 208`, `Community 8`, `Community 40`, `Community 38`, `Community 34`, `Community 39`, `Community 57`, `Community 96`, `Community 78`, `Community 100`, `Community 11`, `Community 29`, `Community 5`, `Community 103`, `Community 99`, `Community 166`, `Community 318`, `Community 32`, `Community 30`, `Community 37`, `Community 3`, `Community 101`, `Community 53`, `Community 124`, `Community 7`, `Community 13`, `Community 22`, `Community 64`, `Community 77`, `Community 108`, `Community 189`, `Community 80`, `Community 88`, `Community 269`, `Community 83`, `Community 374`, `Community 87`, `Community 217`, `Community 218`, `Community 161`, `Community 50`, `Community 214`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 15`, `Community 29`, `Community 17`, `Community 37`, `Community 8`, `Community 4`, `Community 9`, `Community 12`, `Community 5`, `Community 75`, `Community 96`, `Community 57`, `Community 11`, `Community 274`, `Community 13`, `Community 61`, `Community 53`, `Community 91`, `Community 94`, `Community 7`, `Community 275`, `Community 80`, `Community 78`, `Community 374`, `Community 87`, `Community 20`, `Community 254`, `Community 40`, `Community 161`, `Community 59`, `Community 116`, `Community 214`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 7` to `Community 15`, `Community 29`, `Community 0`, `Community 4`, `Community 5`, `Community 8`, `Community 39`, `Community 34`, `Community 96`, `Community 57`, `Community 103`, `Community 32`, `Community 157`, `Community 11`, `Community 13`, `Community 72`, `Community 135`, `Community 116`?**
