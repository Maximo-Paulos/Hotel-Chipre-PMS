...
## Corpus Check
- Large corpus: 1023 files · ~1,641,243 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 9858 nodes · 44031 edges · 361 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 16130 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16130 · ON_BRANCH: 8852 · contains: 5817 · calls: 4247 · MODIFIES: 3177 · rationale_for: 2000 · imports: 1078 · imports_from: 829 · PARENT_OF: 645 · inherits: 637 · method: 616 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 1023 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 11 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `6cbb087`
...
Cohesion: 0.08
Nodes (338): main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., agent-linensplit, agent-login, agent-mobilenav, agent-otafix (+330 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (328): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp (+320 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (141): Stream tenant-scoped invalidation signals; clients refetch from Postgres-backed, stream_domain_events(), _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, Database engine and session management. Supports both PostgreSQL (production) an (+133 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (296): PaymentSurchargeCreate, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+288 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (258): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+250 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (139): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), loginWithGoogle() (+131 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (225): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser() (+217 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (199): _attach_current_rate(), delete_room(), housekeeping_summary(), FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Materialize the safe projection before FastAPI can inspect the ORM. (+191 more)

### Community 8 - "Community 8"
Cohesion: 0.10
Nodes (204): CheckInRequest, FastAPI routes for Check-in / Check-out., cancel_reservation(), change_dates(), create_reservation_charge(), _ensure_action_permission(), extend_stay(), _is_manager_context() (+196 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (142): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+134 more)
...
Cohesion: 0.02
Nodes (149): StockConsumptionItem, StockConsumptionReportRead, StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead, StockMovementCreate (+141 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (71): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _require_demo_mode(), reset_demo(), seed_demo() (+63 more)
...
Cohesion: 0.03
Nodes (73): validateGuestForCheckin(), add_reservation_guests(), addReservationCharge(), addReservationGuests(), buildQueryString(), cancelReservation(), CheckInPayload, checkInReservation() (+65 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (52): addGuestCompanions(), addGuestTag(), _build_guest_ledger_csv(), buildGuestQueryString(), checkInGuestReservation(), createGuest(), _enum_value(), export_guest_ledger() (+44 more)
...
Cohesion: 0.04
Nodes (48): _authorize_override(), checkin(), email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider. (+40 more)
...
Cohesion: 0.03
Nodes (63): PermissionGate(), SettingsAssistantPage(), SettingsHotelPage(), SettingsUsersPage(), AcceptInvitationPage(), LoginPage(), MarketingHomePage(), PmsHoteleroPage() (+55 more)
...
Cohesion: 0.06
Nodes (44): main(), valid_https(), bootstrap_configuration_fingerprint(), Shared, secret-safe binding for the Render QA bootstrap configuration., Hash the exact provider-observed values without exposing them individually., Hash the exact provider-observed values without exposing them individually., Hash the exact provider-observed values without exposing them individually., Hash the exact provider-observed values without exposing them individually. (+36 more)
...
Cohesion: 0.05
Nodes (39): ReservationStatus, ConfirmDialogProps, GuestRestrictionBadge(), Props, Props, CheckinCaptureForm, emptyCaptureForm, guestFullName() (+31 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (40): 3d34a97 Connect system mail through master admin, ad4249c Implement master admin panel, Email provider abstraction for platform transactional mail., clearMasterAdminCsrfToken(), masterAdminFetch(), MasterAdminLoginResponse, MasterAdminUser, MasterBillingPolicy (+32 more)
...
Cohesion: 0.05
Nodes (42): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), listCategories() (+34 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (42): PendingActionPriorityEnum, PendingActionStatusEnum, PendingActionTypeEnum, PendingOperationalAction, PendingOperationalAction — the "pending_actions" table referenced throughout the, A follow-up item that requires a human decision before the operation can proceed, RefundRequest model — tracks the three-path refund lifecycle per product §8.7., Tracks a refund from request through resolution.     Partial refunds are allowed (+34 more)
...
Cohesion: 0.05
Nodes (20): BridgeActivity, 958fce2 Merge pull request #31 from Maximo-Paulos/feature/mobile-first-operations, dad55df feat(mobile): wrap PWA with Capacitor for App Store/Play Store (Task 11), credentials, createdPromotion, mockCategories, simulateResult, ownerCredentials (+12 more)
...
Cohesion: 0.07
Nodes (41): AcceptPayload, _current_user(), Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., recent_security_events(), revoke_current_user_sessions(), _safe_resource_id() (+33 more)
...
Cohesion: 0.09
Nodes (29): google_login(), _pick_default_hotel_id(), Auth endpoints: register, login, email verification and password reset. Verifica, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, Validate reset code without changing password (paso previo en UI)., Validate reset code without changing password (paso previo en UI)., Validate reset code without changing password (paso previo en UI). (+21 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (35): _canonical_identity(), _enabled(), PostgresTargetSafetyError, Numeric(12,2) columns correctly store and return Decimal values., All PostgreSQL enum types are created by migrations., Critical unique constraints reject duplicates in PostgreSQL., Rebuild the shared test DB into a pristine, fully-migrated schema.      The sess, EXPLAIN ANALYZE for guest search by last_name uses index ix_guest_hotel_last_nam (+27 more)
...
Cohesion: 0.13
Nodes (19): _auth_headers(), _complete_onboarding(), _configure_resend(), _fake_google_claims(), FakeResponse, .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by, _register_owner(), test_auth_flows_fail_without_connected_mail_provider() (+11 more)
...
Cohesion: 0.11
Nodes (19): _load_composite_fk_migration(), _load_extended_composite_fk_migration(), _load_master_admin_bypass_migration(), _load_rls_migration(), _load_user_override_migration(), C2: app/master_admin/router.py queries Subscription directly, and     transitive, Compile the additive RLS helpers through Alembic's PostgreSQL recorder.      Thi, C2: app/master_admin/router.py queries Subscription directly, and     transitive (+11 more)
...
Cohesion: 0.20
Nodes (24): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyStatusAtNightEnum, OTAConnectionStatusEnum, OTASyncJobStatusEnum, PaymentLinkStatusEnum, PaymentProviderEnum (+16 more)
...
Cohesion: 0.17
Nodes (16): calculate_base_amount_before_surcharge(), calculate_payment_surcharge(), get_hotel_config(), _payment_method_value(), process_payment(), Prefer an explicit payment currency, otherwise inherit the reservation currency., Process a payment for a reservation.          This is the core financial engine:, Get or create the per-hotel configuration.     No global/singleton fallback â€” (+8 more)
...
Cohesion: 0.53
Nodes (4): _headers(), test_manager_cannot_read_security_settings(), test_revoke_all_invalidates_the_callers_previous_token(), test_security_overview_and_events_are_redacted_and_tenant_scoped()
...
Cohesion: 0.83
Nodes (3): _active_reservation_conflicts_for_room(), get_group(), revert_group()
...
## Knowledge Gaps
- **785 isolated node(s):** `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`, `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`, `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`, `launch security hardening  Revision ID: 20260408_launch_security_hardening Revis`, `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em` (+780 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 135`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 231`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 242`** (1 nodes): `test_failed_audit_log_insert_does_not_roll_back_callers_change()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 252`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 342`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 344`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 346`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 347`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 348`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 349`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 350`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 352`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 353`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 355`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 356`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 357`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 358`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 359`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 361`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 362`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 363`** (1 nodes): `stock_items.kind (supply vs linen) + soft-delete-aware name uniqueness  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 364`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 365`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 367`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 369`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 1` to `Community 13`, `Community 2`, `Community 161`, `Community 68`, `Community 218`, `Community 8`, `Community 53`, `Community 39`, `Community 40`, `Community 70`, `Community 4`, `Community 58`, `Community 99`, `Community 66`, `Community 3`, `Community 21`, `Community 114`, `Community 111`, `Community 160`, `Community 7`, `Community 329`, `Community 37`, `Community 32`, `Community 43`, `Community 5`, `Community 196`, `Community 54`, `Community 135`, `Community 14`, `Community 9`, `Community 34`, `Community 23`, `Community 221`, `Community 79`, `Community 119`, `Community 276`, `Community 277`, `Community 278`, `Community 197`, `Community 302`, `Community 85`, `Community 279`, `Community 92`, `Community 0`, `Community 73`, `Community 98`, `Community 227`, `Community 168`, `Community 147`, `Community 89`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 1` to `Community 18`, `Community 43`, `Community 8`, `Community 6`, `Community 12`, `Community 9`, `Community 5`, `Community 80`, `Community 13`, `Community 39`, `Community 99`, `Community 58`, `Community 7`, `Community 34`, `Community 283`, `Community 22`, `Community 63`, `Community 54`, `Community 102`, `Community 106`, `Community 3`, `Community 4`, `Community 284`, `Community 85`, `Community 66`, `Community 369`, `Community 73`, `Community 98`, `Community 2`, `Community 261`, `Community 53`, `Community 288`, `Community 168`, `Community 147`, `Community 59`, `Community 48`, `Community 21`, `Community 61`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 7` to `Community 81`, `Community 1`, `Community 9`, `Community 3`, `Community 8`, `Community 13`, `Community 39`, `Community 276`, `Community 278`, `Community 277`, `Community 4`, `Community 70`, `Community 99`, `Community 58`, `Community 114`, `Community 37`, `Community 34`, `Community 118`, `Community 134`, `Community 144`, `Community 48`, `Community 21`, `Community 61`?**
