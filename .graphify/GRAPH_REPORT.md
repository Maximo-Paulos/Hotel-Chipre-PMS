...
## Corpus Check
- Large corpus: 1410 files · ~1,880,233 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10894 nodes · 38354 edges · 584 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: ON_BRANCH: 17000 · contains: 7219 · calls: 5165 · MODIFIES: 3141 · rationale_for: 1423 · imports: 1323 · imports_from: 1102 · inherits: 797 · method: 735 · PARENT_OF: 445 · re_exports: 4
...
- Excluded: 0 untracked · 25710 ignored · 12 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `e45ea5c`
...
Cohesion: 0.19
Nodes (411): audit/tech-0000-baseline, chore/revert-rls-bypass-diagnostic, chore/temp-rls-bypass-diagnostic, codex/debt-audit-log-canonical-contract, codex/debt-jwt-cookie-consolidation, codex/debt-rbac-permission-consolidation, codex/debt-subscription-model-consolidation, codex/google-onboarding-staff-aliases (+403 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (105): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), EmailDeliveryStatus, invite_user(), InvitePayload, InviteResponse, inviteUser() (+97 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (138): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), validateGuestForCheckin() (+130 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (150): ReferenceCountry, PrimaryOwnerTransferPayload, UpdateRolePayload, UpdateStaffAliasPayload, BaseModel, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest (+142 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (118): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), currentUser() (+110 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (99): createLaundryRemito(), createLaundryVendor(), getLaundryVendorBalance(), getLaundryVendorSettlements(), getLaundryVendorSpend(), LaundryRemito, LaundryRemitoCreate, LaundryRemitoCreateResponse (+91 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (95): 5616166 Merge pull request #90 from Maximo-Paulos/feature/realtime-collaboration, 647d22f fix(dev-safety): never redirect to production host from local dev server, 6d665be fix(review): restore preview-host-routing e2e coverage, 9aee997 Implement real-time synchronization and collaboration, createReservation(), localIsoDate(), owner, parseMoney() (+87 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (90): createGuestRestriction(), getGuestProhibitedDetail(), GuestProhibitedErrorBody, GuestRestriction, GuestRestrictionCreatePayload, GuestRestrictionResolvePayload, GuestRestrictionStatus, listGuestRestrictions() (+82 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (101): acknowledgeShiftHandoff(), createOperationalTask(), createShiftHandoff(), listOperationalTaskHistory(), listOperationalTasks(), listShiftHandoffs(), OperationalTask, OperationalTaskCreate (+93 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (62): export_cash_ledger_csv(), Export the existing transaction/cash ledger without creating a second balance., getOperationalAudit(), OperationalAuditFilters, OperationalAuditItem, OperationalAuditResponse, Read-only integral operations audit endpoint., 67e4e68 fix(data-integrity): make audit_logs append-only at the database level (+54 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (62): list_countries(), list_timezones(), Reference data endpoints used by the frontend., Return the cached IANA timezone catalog., Return the curated country -> primary IANA timezone catalog., listCountries(), ReferenceCountry, 7a0f226 Harden realtime sync, fix room-status/data bugs, add settings + i18n (+54 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (91): acceptInvitation(), acceptInvitationWithGoogle(), _allow_mfa_attempt(), apple_callback(), _apple_full_name(), apple_login(), _apple_login_config(), apple_start() (+83 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (92): Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection (+84 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (71): fetchPublicPricing(), LeadPayload, PublicPricing, PublicPricingPlan, submitLead(), 9da1f66 Rebuild the public landing page as Hotels-PMS, a585307 Implement PMS audit remediation workflows, b48fd42 Add public marketing inquiry flow and SEO (+63 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (48): _DecimalAwareEncoder, _frontend_placeholder(), _InvitationAccessLogFilter, _is_demo_mode_enabled(), lifespan(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Initialize database on application startup. (+40 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (66): DailyReportSchedule, DailyReportScheduleUpdate, get_daily_report_schedule(), getDailyReportSchedule(), listNotificationPreferences(), listNotifications(), markAllNotificationsRead(), markNotificationRead() (+58 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (54): Public WhatsApp bot hooks authenticated only by hotel API key., 654d69e Add reservation arrival metadata and internal comments, 8845d08 Fix eight real defects found auditing the whole project, 8c239da Merge pull request #100 from Maximo-Paulos/feature/reservation-arrival-comment, PaymentLinkRead, PublicReservationRead, BookingCreate, BookingRead (+46 more)
...
Cohesion: 0.03
Nodes (35): ca694f7 feat(rbac,config,perf): permission-driven visibility, dedup sweep and infra readiness, cassandra_healthcheck(), _contact_points(), get_cassandra_session(), clientNavigate(), credentials, PAGES, revealCollapsedNavLink() (+27 more)
...
Cohesion: 0.04
Nodes (42): ApiError, 2090dc4 feat(security): make TOTP MFA mandatory for Master Admin (TECH-0023), 2de6004 Add a leads page to the owner console and fix unreadable console styling, { code }, source, clearMasterAdminCsrfToken(), masterAdminFetch(), MasterAdminLoginResponse (+34 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (65): PermissionGate(), FaqPage(), FunctionsPage(), MarketingHomePage(), PmsHoteleroPage(), PricingPage(), PrivacyPage(), SoftwareParaHotelesPage() (+57 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (52): _auth_headers(), _complete_onboarding(), _configure_resend(), _enroll_and_confirm_mfa(), _fake_apple_claims(), _fake_google_claims(), FakeResponse, _next_totp_code() (+44 more)
...
Cohesion: 0.04
Nodes (59): AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, AnalyticsExportJob, AnalyticsExportStatusEnum, FactReservationDaily (+51 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (35): _cors_contains_wildcard(), get_settings(), _gmail_is_active(), _has_value(), is_demo_mode(), is_preview_qa_mode(), is_production_mode(), _is_public_https_url() (+27 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (53): addCashMovement(), approveCashCloseDifference(), CashCloseReport, CashCustodyHandoff, CashDailyCollector, CashDailyEntry, CashDailyPaymentMethod, CashDailySession (+45 more)
...
Cohesion: 0.05
Nodes (49): assignWhatsAppConversation(), completeWhatsAppChannel(), createWhatsAppNote(), channel_status(), complete_channel(), create_note(), inbox(), Authenticated human WhatsApp CRM inbox.  This router never calls Meta directly. (+41 more)
...
Cohesion: 0.05
Nodes (38): 114b319 Fix invalid verification email requests, 29236bf feat(security): add Google account unlink endpoint with reauthentication, 362fdd4 feat(security): add core TOTP/MFA enrollment, verification, and recovery codes, AppleAuthRequest, AppleUnlinkRequest, AppleUserName, AppleUserPayload, _AuthEmailRequest (+30 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (34): Enum, CompanyDocument, CompanyDocumentStatusEnum, CompanyDocumentTypeEnum, CompanyDocument — attachments/vouchers for company reservations (v72 §3.6). Trac, Document/voucher associated with a company reservation (v72 §3.6).     If requir, GuestRestriction, GuestRestrictionStatusEnum (+26 more)
...
Cohesion: 0.09
Nodes (35): refreshAfterMutation(), refreshCashState(), refreshDomains(), refreshGuestState(), refreshPaymentState(), refreshReservationState(), refreshRoomState(), refreshStockState() (+27 more)
...
Cohesion: 0.15
Nodes (35): _actor_payload(), _actor_role(), _actor_user_id(), _apply_plan(), _as_utc(), _assert_same_adjustment(), change_subscription_plan(), clear_room_limit_override() (+27 more)

### Community 59 - "Community 59"
Cohesion: 0.12
Nodes (28): a714b07 fix(security): block replay-reactivation of revoked memberships, d333204 fix(security): require account auth for existing invitation accepts, client_with_db(), _enable_test_google(), get_auth_context_target(), get_db_override_target(), _google_claims(), _invitation_token() (+20 more)
...
Cohesion: 0.17
Nodes (26): _as_aware(), authenticate_master_login(), _authorize_user_for_master_panel(), _bootstrap_master_credentials_match(), create_master_admin_mfa_challenge(), create_master_session(), _hash_value(), _idle_expiry() (+18 more)
...
Cohesion: 0.13
Nodes (10): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, SimpleRateLimiter, requestVerification(), verifyEmail(), BrandMark(), BrandMarkProps, 49fc535 fix(security): harden registration/verification/recovery flows (TECH-0022), clearPendingOwner() (+2 more)
...
Cohesion: 0.15
Nodes (21): _accept_invitation(), accept_invitation_legacy_path(), _accept_invitation_with_google(), accept_invitation_with_google_legacy_path(), AcceptPayload, _activate_invitation_for_user(), _available_invitation(), get_invitation_preview() (+13 more)

### Community 121 - "Community 121"
Cohesion: 0.10
Nodes (17): 3dee498 fix(review): chain permission-metadata migration after latest head, 77fa337 feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, HotelPermissionOverride, Permission, Configurable permission matrix models., RolePermissionDefault, PermissionCatalogItem, PermissionDecision (+9 more)

### Community 122 - "Community 122"
Cohesion: 0.09
Nodes (14): DocumentTypeEnum, Guest, GuestCompanion, GuestRatingEnum, GuestTag, GuestTagTypeEnum, _LenientDateTime, Guest and GuestCompanion models. Exhaustive fields for check-in panel: identity (+6 more)
...
Cohesion: 0.11
Nodes (12): 4d007b9 fix(migrations): chain Apple sign-in migration onto TECH-0110 soft-delete head, 53f480f feat(auth): add Sign in with Apple, symmetric to Google OIDC (TECH-0024), AppleAuthorization, AppleSignInButton(), AppleSignInResult, CLIENT_ID, REDIRECT_URI, Window (+4 more)
...
Cohesion: 0.19
Nodes (15): _attach_actor_names(), audit_timeline(), _build_audit_timeline_csv(), _current_user(), export_audit_timeline(), Tenant-scoped security overview and current-user session revocation., Export the redacted unified timeline, capped at 5,000 rows per request., Invalidate every access token previously issued to the caller. (+7 more)

### Community 172 - "Community 172"
Cohesion: 0.21
Nodes (14): 560076d docs(security): formalize canonical contract for AuditLog/SecurityAuditLog/MasterAdminAuditEvent, _headers(), Security settings API is tenant-scoped, redacted and revokes real JWTs., Audit evidence is readable only; there is no ordinary mutation route., test_audit_surfaces_do_not_expose_mutating_methods(), test_manager_cannot_read_security_settings(), test_revoke_all_invalidates_the_callers_previous_token(), test_security_actor_labels_use_the_current_tenant_alias_in_events_timeline_and_csv() (+6 more)
...
Cohesion: 0.20
Nodes (13): billing_adjustment_totals_by_reservation(), completed_paid_amount(), completed_paid_amounts_by_reservation(), operational_balance_due(), paid_amount_with_legacy_fallback(), Canonical read helpers for reservation financial state.  ``Reservation.amount_pa, Return a completed-ledger transaction with refunds represented as negative., Aggregate confirmed payments once, optionally for a bounded reservation set. (+5 more)
...
Cohesion: 0.36
Nodes (6): GCSObjectStorage, ObjectStorageError, Google Cloud Storage adapter with lazy optional dependency loading., Raised when a storage backend cannot complete an operation., Reject any key that could escape the storage root (no `..`, no leading `/`)., _safe_relative_path()
...
Cohesion: 0.25
Nodes (9): e647cf4 fix(critical): Apple auth f-string syntax breaks production on Python 3.11, AppleTokenError, create_apple_client_secret(), exchange_apple_code(), Apple OIDC verification and authorization-code helpers.  The identity token is a, Raised when an Apple token or provider response is not trustworthy., Verify Apple signature, issuer, audience, expiry and optional nonce., _read_private_key() (+1 more)
...
Cohesion: 0.20
Nodes (4): get_object_storage(), Stub for a real S3-compatible bucket. Not wired to a live bucket --     there ar, Backend picked by `settings.OBJECT_STORAGE_BACKEND` (default: local).      Uses, S3ObjectStorage

### Community 299 - "Community 299"
Cohesion: 0.29
Nodes (3): LocalObjectStorage, ObjectStat, Stores objects as files under a local directory root.      Generalizes the patte
...
Cohesion: 0.22
Nodes (6): Room and RoomCategory models., Room category/type â€” e.g. Standard, Superior, Suite, Penthouse., Physical room in the hotel., Room, RoomCategory, RoomStatusEnum
...
Cohesion: 0.25
Nodes (6): PaymentMethodEnum, Transaction and PaymentMethod models. Supports: Efectivo (Cash), MercadoPago, Pa, Financial transaction linked to a reservation.     Every money movement is recor, Transaction, TransactionStatusEnum, TransactionTypeEnum
...
Cohesion: 0.38
Nodes (5): 239b432 fix(migrations): chain primary owner migration onto temporary action grants head, f3876bb feat(auth): enforce primary owner invariants (TECH-0030), _backfill_primary_owners(), Add an explicit per-hotel Primary Owner membership.  Revision ID: 20260820_prima, upgrade()
...
Cohesion: 0.33
Nodes (6): push_availability_update(), _push_to_booking(), _push_to_expedia(), Send availability update to Booking.com OC API.          In production, this wou, Send availability update to Expedia EQC API.          In production, this would, Push availability updates to all enabled OTAs for a given category and date rang
...
Cohesion: 0.50
Nodes (5): allow_master_admin_mfa_attempt(), authenticate_master_mfa_login(), _master_admin_mfa_attempt_key(), Verify a master-admin MFA challenge before a master session is issued., reset_master_admin_mfa_attempts()

### Community 469 - "Community 469"
Cohesion: 0.40
Nodes (4): NormalizedOTAReservation, OTAAdapterContext, OTAOperationResult, Common contracts for OTA provider adapters.  The goal is to keep Booking, Expedi
...
Cohesion: 1.00
Nodes (2): Recover invalidation domains after a cursor without exposing payloads., recover_domain_events()
...
Cohesion: 1.00
Nodes (2): plan_catalog(), Return the available plan catalog as a list for API responses.

### Community 605 - "Community 605"
Cohesion: 1.00
Nodes (2): plan_has_feature(), Return whether a normalized subscription snapshot grants ``feature``.

### Community 609 - "Community 609"
Cohesion: 1.00
Nodes (2): Full sync: push availability for ALL categories for the next N days.     Typical, sync_all_availability()
...
- **Thin community `Community 119`** (1 nodes): `Fase 12 — cross-hotel ID-collision regression suite (security-auditor).  Reserva`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 186`** (1 nodes): `ExpediaAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 200`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 244`** (1 nodes): `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 266`** (2 nodes): `OTAOrchestratorError`, `OTAOrchestratorService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 349`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 391`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 392`** (2 nodes): `RoomBlockCreate`, `RoomBlockRead`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 409`** (2 nodes): `ObjectStorage`, `Content-addressed-ish blob store: put/get/delete bytes by string key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 496`** (2 nodes): `Connection`, `Connection model for external provider integrations. Stores credentials/settings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 498`** (2 nodes): `Operator-created consumption or extra charge for an active stay.`, `ReservationChargeCreate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 513`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 514`** (1 nodes): `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 515`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 516`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 517`** (1 nodes): `reservation financial lifecycle  Revision ID: 20260410_reservation_financial_lif`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 518`** (1 nodes): `ai assistant sessions  Revision ID: 20260411_ai_assistant_sessions Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 519`** (1 nodes): `ai assistant insights  Revision ID: 20260412_ai_assistant_insights Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 520`** (1 nodes): `extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 521`** (1 nodes): `add trial and comped fields to subscriptions  Revision ID: 20260419_subscription`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 522`** (1 nodes): `master admin panel  Revision ID: 20260421_master_admin_panel Revises: 9c0d2f3e1a`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 523`** (1 nodes): `master admin system owner mail and stripe settings  Revision ID: 20260421_master`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 524`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 525`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 526`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 527`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 528`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 529`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 530`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 531`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 532`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 533`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 534`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 535`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 536`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 537`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 538`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 539`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 540`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 541`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 542`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 543`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 544`** (1 nodes): `repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 545`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 546`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 547`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 548`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 549`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 550`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 551`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 552`** (1 nodes): `Grant receptionist the same-category room move default.  Phase A narrowed reserv`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 553`** (1 nodes): `Fix ota_reservation_lifecycle_enum labels to match the ORM's values_callable.  ``
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 554`** (1 nodes): `add public marketing pricing plans and early-access leads  Revision ID: 20260910`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 555`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 556`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 557`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 558`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 559`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 560`** (1 nodes): `guest legal profile  Revision ID: 9c0d2f3e1a44 Revises: 3eaf48a79290 Create Date`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 561`** (1 nodes): `ota hardening: hotel-scoped mappings and webhook credentials  Revision ID: a7f3d`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 562`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 563`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 564`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 565`** (1 nodes): `Add tenant-scoped object metadata without deleting legacy file references.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 566`** (2 nodes): `graphify_state()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 567`** (2 nodes): `main()`, `validate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 568`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 569`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 571`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 572`** (1 nodes): `Company`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 573`** (2 nodes): `DailyRate`, `Explicit nightly price for a specific category and date.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 574`** (2 nodes): `PricePeriod`, `Named date-range season/period for bulk rate loading.      Higher ``priority`` w`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 575`** (2 nodes): `DomainEventRetentionWatermark`, `Tenant-scoped cursor watermarks used by outbox retention cleanup.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 576`** (1 nodes): `FxRateSnapshot`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 577`** (1 nodes): `PaymentLinkTest`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 578`** (2 nodes): `CategoryPricing`, `Archived legacy pricing shape kept for migration/test compatibility.      Runtim`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 579`** (2 nodes): `RateLimitEvent`, `Persistent rate-limit events for security-sensitive endpoints.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 580`** (2 nodes): `Security / access audit log — free-form operational security events.  Distinct f`, `SecurityAuditLog`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 581`** (2 nodes): `DomainEventRecoveryResponse`, `Safe cursor response used to repair missed realtime invalidations.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 582`** (1 nodes): `One-shot notification cycle: generate due daily reports, then deliver pending ou`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 586`** (1 nodes): `Regression guard for a real bug: `dee1bd0660f6_ota_allocation_foundation` create`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 588`** (1 nodes): `Regression guard for a real bug B3.1 uncovered: on a SQLite database built from`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 591`** (2 nodes): `Recover invalidation domains after a cursor without exposing payloads.`, `recover_domain_events()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 592`** (2 nodes): `Stream tenant-scoped invalidation signals; clients refetch from Postgres-backed`, `stream_domain_events()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 593`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 594`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 595`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 600`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 601`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 602`** (1 nodes): `Foundational OTA adapter interfaces and orchestration services.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 604`** (2 nodes): `plan_catalog()`, `Return the available plan catalog as a list for API responses.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 605`** (2 nodes): `plan_has_feature()`, `Return whether a normalized subscription snapshot grants ``feature``.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 609`** (2 nodes): `Full sync: push availability for ALL categories for the next N days.     Typical`, `sync_all_availability()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 612`** (2 nodes): `Gate assertion: all tables required by the business requirements exist.     This`, `test_database_foundation_complete()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `RealtimeEventsUnavailable` connect `Community 33` to `Community 132`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `VerificationError` connect `Community 64` to `Community 322`, `Community 132`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.014007936507936507 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02036564054308375 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.020048729550991993 - nodes in this community are weakly interconnected._
- **Should `Community 4` be split into smaller, more focused modules?**
  _Cohesion score 0.023784568249617027 - nodes in this community are weakly interconnected._