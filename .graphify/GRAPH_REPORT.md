...
## Corpus Check
- Large corpus: 1025 files · ~1,642,253 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 9923 nodes · 45172 edges · 353 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 16136 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16136 · ON_BRANCH: 9866 · contains: 5837 · calls: 4258 · MODIFIES: 3228 · rationale_for: 2023 · imports: 1078 · imports_from: 829 · PARENT_OF: 661 · inherits: 637 · method: 616 · re_exports: 3
...
Cohesion: 0.02
Nodes (347): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest. (+339 more)

### Community 1 - "Community 1"
Cohesion: 0.10
Nodes (344): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+336 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (156): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _authorize_override(), checkin(), _require_demo_mode(), reset_demo(), seed_demo(), Application Configuration. Uses pydantic-settings for environment variable manag, Database engine and session management. Supports both PostgreSQL (production) an (+148 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (279): create_payment_surcharge(), deactivate_payment_surcharge(), _get_surcharge_or_404(), _has_per_method_nightly_price(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges (+271 more)
...
Cohesion: 0.01
Nodes (149): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), loginWithGoogle() (+141 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (186): AnalyticsAIChatPage(), AnalyticsAIChatResponse, AnalyticsAIStatus, AnalyticsCategoryDetailPage(), AnalyticsChannelsPage(), AnalyticsCompanyDetailPage(), AnalyticsEnvelope, analyticsErrorMessage() (+178 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (218): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser(), list_users() (+210 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (196): User management per hotel (owners/co-owners)., 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum (+188 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (196): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+188 more)
...
Cohesion: 0.02
Nodes (154): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), Category (+146 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (147): Stream tenant-scoped invalidation signals; clients refetch from Postgres-backed, stream_domain_events(), _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), claude/feature/pms-roles-housekeeping-qa, 00bf891 Explain analytics errors and add retry action (+139 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (142): FastAPI routes for Payments., StockConsumptionItem, StockConsumptionReportRead, StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead (+134 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (78): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _booking_to_read(), cancel_booking(), checkin_booking() (+70 more)
...
Cohesion: 0.10
Nodes (48): FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia., Receive reservation notifications from Booking.com., Receive reservation notifications from Despegar., Receive reservation notifications from Expedia., Receive reservation notifications from Despegar., OTAConnection (+40 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (18): DespegarAdapter, ExpediaAdapter, OTASyncEvent, OTASyncJob, NormalizedOTAReservation, OTAAdapterContext, OTAOperationResult, OTAProviderAdapter (+10 more)
...
Cohesion: 0.05
Nodes (49): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), listCategories() (+41 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (41): 469b13e fix(security): reduce rate limiter race window under concurrent requests, 7a7afb0 fix(security): enforce password minimum on invitation accept, dceb376 fix(security): enforce password minimum on invitation accept (#41), df4ee20 feat(security): migrate password hashing to Argon2id with transparent bcrypt upgrade (#40), _About, create_access_token(), create_signed_token(), decode_access_token() (+33 more)
...
Cohesion: 0.06
Nodes (38): PaymentMethod, ReservationStatus, ConfirmDialogProps, GuestRestrictionBadge(), Props, CheckinCaptureForm, emptyCaptureForm, guestFullName() (+30 more)

### Community 35 - "Community 35"
Cohesion: 0.11
Nodes (43): DailyReportSchedule, Notification, NotificationChannelEnum, NotificationOutbox, NotificationOutboxStatusEnum, NotificationPreference, PushSubscription, Notification backend: in-app inbox, Web Push subscriptions, per-user channel pre (+35 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (49): AcceptPayload, _current_user(), Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., recent_security_events(), revoke_current_user_sessions(), _safe_resource_id() (+41 more)
...
Cohesion: 0.10
Nodes (39): MovementEventRead, MovementGroupRead, ReservationAllocationLock, Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, RoomMovementGroup, _adjacency_bonus_for_room(), AllocationError, AllocationResult (+31 more)
...
Cohesion: 0.07
Nodes (29): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+21 more)
...
Cohesion: 0.12
Nodes (38): fail(), load_json_object(), main(), mapping(), nested_value(), positive_integer(), preview_origin(), Return the normalized origin for a credential-free HTTPS preview URL. (+30 more)

### Community 48 - "Community 48"
Cohesion: 0.10
Nodes (40): AuditLog, Append-only record of every significant mutation within a hotel tenant.     Do N, PaymentProof, PaymentProofBlob, PaymentProofStatusEnum, Private image evidence awaiting explicit staff confirmation., Private image evidence awaiting explicit staff confirmation., Private binary payload kept separately from queryable proof metadata. (+32 more)
...
Cohesion: 0.09
Nodes (31): google_login(), _pick_default_hotel_id(), Auth endpoints: register, login, email verification and password reset. Verifica, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, Validate reset code without changing password (paso previo en UI)., Validate reset code without changing password (paso previo en UI). (+23 more)
...
Cohesion: 0.10
Nodes (18): _auth_headers(), _complete_onboarding(), _configure_resend(), _fake_google_claims(), FakeResponse, JWTs are stateless with no server-side blacklist, so a password reset -     the, A guest self-registering must never end up with User.role="platform_admin"     j, _register_owner() (+10 more)
...
Cohesion: 0.11
Nodes (18): ABC, EmailProvider, EmailProviderError, get_email_provider(), _mask_email(), _mask_recipients(), _normalize_display_from(), NullEmailProvider (+10 more)
...
Cohesion: 0.13
Nodes (11): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., main(), run() (+3 more)
...
Cohesion: 0.21
Nodes (13): client_with_db(), get_auth_context_target(), get_db_override_target(), _invitation_token(), owner_ctx(), test_co_owner_cannot_grant_privileged_roles(), test_existing_user_invitation_requires_matching_authenticated_user(), test_existing_user_invitation_with_own_auth_attaches_without_resetting_account() (+5 more)
...
Cohesion: 0.24
Nodes (13): OTACommissionRule, OTACurrencyRate, _apply_tax_policy(), _calculate_rule_amount(), _convert_amount(), _load_json_dict(), quote_rate_plan_stay(), Commercial pricing, tax, commission and FX quoting service.  This layer turns th (+5 more)
...
- **Thin community `Community 143`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 221`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 242`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 263`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 349`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 350`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 352`** (1 nodes): `stock_items.kind (supply vs linen) + soft-delete-aware name uniqueness  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 353`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 355`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 356`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 357`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 358`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 359`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 0` to `Community 14`, `Community 2`, `Community 156`, `Community 66`, `Community 209`, `Community 10`, `Community 53`, `Community 40`, `Community 41`, `Community 68`, `Community 39`, `Community 58`, `Community 96`, `Community 63`, `Community 48`, `Community 8`, `Community 4`, `Community 112`, `Community 109`, `Community 155`, `Community 9`, `Community 316`, `Community 37`, `Community 33`, `Community 36`, `Community 5`, `Community 188`, `Community 35`, `Community 131`, `Community 3`, `Community 144`, `Community 16`, `Community 17`, `Community 22`, `Community 212`, `Community 77`, `Community 118`, `Community 265`, `Community 189`, `Community 289`, `Community 84`, `Community 266`, `Community 89`, `Community 1`, `Community 64`, `Community 95`, `Community 27`, `Community 163`, `Community 142`, `Community 50`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 11`, `Community 36`, `Community 10`, `Community 7`, `Community 8`, `Community 13`, `Community 9`, `Community 5`, `Community 79`, `Community 14`, `Community 40`, `Community 96`, `Community 58`, `Community 3`, `Community 270`, `Community 16`, `Community 21`, `Community 61`, `Community 35`, `Community 99`, `Community 103`, `Community 4`, `Community 271`, `Community 84`, `Community 63`, `Community 360`, `Community 48`, `Community 64`, `Community 95`, `Community 2`, `Community 250`, `Community 53`, `Community 275`, `Community 17`, `Community 163`, `Community 142`, `Community 59`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 9` to `Community 80`, `Community 0`, `Community 3`, `Community 10`, `Community 14`, `Community 40`, `Community 265`, `Community 39`, `Community 68`, `Community 96`, `Community 58`, `Community 112`, `Community 37`, `Community 8`, `Community 16`, `Community 48`, `Community 4`, `Community 116`, `Community 130`?**
