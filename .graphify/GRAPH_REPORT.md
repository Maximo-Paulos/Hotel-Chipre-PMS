...
## Corpus Check
- Large corpus: 1035 files · ~1,649,393 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10139 nodes · 48736 edges · 358 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 16230 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16230 · ON_BRANCH: 12884 · contains: 5948 · calls: 4362 · MODIFIES: 3349 · rationale_for: 2075 · imports: 1091 · imports_from: 840 · PARENT_OF: 690 · inherits: 648 · method: 616 · re_exports: 3
...
Cohesion: 0.01
Nodes (166): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _authorize_override(), checkin(), _require_demo_mode() (+158 more)
...
Cohesion: 0.01
Nodes (131): main(), valid_https(), Shared, secret-safe binding for the Render QA bootstrap configuration., _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), mercadopago_payment_link_webhook() (+123 more)
...
Cohesion: 0.01
Nodes (210): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), createGuestRestriction() (+202 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (236): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser() (+228 more)
...
Cohesion: 0.02
Nodes (181): AnalyticsAIChatPage(), AnalyticsAIChatResponse, AnalyticsAIStatus, AnalyticsCategoryDetailPage(), AnalyticsChannelsPage(), AnalyticsCompanyDetailPage(), AnalyticsEnvelope, analyticsErrorMessage() (+173 more)
...
Cohesion: 0.02
Nodes (155): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), Category (+147 more)
...
Cohesion: 0.02
Nodes (142): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+134 more)
...
Cohesion: 0.03
Nodes (73): acceptInvitation(), _allow_mfa_attempt(), _attach_user_session_cookies(), _audit_security_event(), AuthResponse, _build_auth_response(), complete_mfa_login(), confirm_mfa_enrollment() (+65 more)
...
Cohesion: 0.06
Nodes (38): admin_comped_override(), change_plan(), changeSubscriptionPlan(), getSubscriptionStatus(), listSubscriptionPlans(), _remaining_trial_days(), _serialize_status_payload(), start_subscription_trial() (+30 more)
...
Cohesion: 0.11
Nodes (25): 300d128 feat(security): audit-log MFA, login, and Google account-linking events, 9f4f9ac feat(security): audit-log MFA, login, and Google account-linking events, _auth_headers(), _complete_onboarding(), _configure_resend(), _enroll_and_confirm_mfa(), _fake_google_claims(), _next_totp_code() (+17 more)
...
Cohesion: 0.12
Nodes (29): An employee-specific permission decision within one hotel membership., UserPermissionOverride, _active_membership(), _audit(), audit_permission_denied(), can_role_hold_permission(), canonical_permission_code(), get_effective_permission_details() (+21 more)
...
Cohesion: 0.10
Nodes (19): 839c6a2 feat(security): add Google account unlink endpoint with reauthentication, 88990ce feat(security): add Google account unlink endpoint with reauthentication, AuthResponse, Config, GoogleAuthRequest, LoginRequest, MfaChallengeResponse, MfaCodeRequest (+11 more)
...
Cohesion: 0.22
Nodes (9): 3dee498 fix(review): chain permission-metadata migration after latest head, 77fa337 feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, 955325e feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, Configurable permission matrix models., _auth(), _client(), test_only_owner_can_use_administration_catalog_and_co_owner_is_denied(), test_owner_can_grant_and_revoke_user_override_then_restore_defaults() (+1 more)
...
Cohesion: 0.43
Nodes (5): 0534c64 feat(security): add unified tenant-scoped audit timeline read endpoint, _headers(), test_manager_cannot_read_security_settings(), test_revoke_all_invalidates_the_callers_previous_token(), test_security_overview_and_events_are_redacted_and_tenant_scoped()
...
- **Thin community `Community 131`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 222`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 264`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 331`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 350`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 352`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 353`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 355`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 365`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `FakeResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 0` to `Community 1`, `Community 4`, `Community 152`, `Community 64`, `Community 209`, `Community 9`, `Community 51`, `Community 37`, `Community 33`, `Community 39`, `Community 57`, `Community 94`, `Community 76`, `Community 98`, `Community 11`, `Community 28`, `Community 5`, `Community 102`, `Community 97`, `Community 167`, `Community 313`, `Community 31`, `Community 29`, `Community 38`, `Community 3`, `Community 100`, `Community 53`, `Community 122`, `Community 8`, `Community 15`, `Community 7`, `Community 22`, `Community 137`, `Community 68`, `Community 75`, `Community 106`, `Community 190`, `Community 78`, `Community 86`, `Community 32`, `Community 266`, `Community 81`, `Community 366`, `Community 85`, `Community 218`, `Community 219`, `Community 161`, `Community 49`, `Community 215`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 17`, `Community 38`, `Community 9`, `Community 4`, `Community 7`, `Community 36`, `Community 14`, `Community 5`, `Community 73`, `Community 1`, `Community 28`, `Community 94`, `Community 57`, `Community 11`, `Community 270`, `Community 15`, `Community 61`, `Community 53`, `Community 89`, `Community 92`, `Community 8`, `Community 271`, `Community 78`, `Community 76`, `Community 366`, `Community 85`, `Community 20`, `Community 252`, `Community 51`, `Community 161`, `Community 58`, `Community 113`, `Community 215`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 8` to `Community 4`, `Community 0`, `Community 5`, `Community 9`, `Community 1`, `Community 28`, `Community 39`, `Community 33`, `Community 94`, `Community 57`, `Community 102`, `Community 31`, `Community 157`, `Community 11`, `Community 15`, `Community 70`, `Community 134`, `Community 113`?**
