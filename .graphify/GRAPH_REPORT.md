...
## Corpus Check
- Large corpus: 835 files · ~577,678 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8357 nodes · 30942 edges · 300 communities detected
- Extraction: 59% EXTRACTED · 41% INFERRED · 0% AMBIGUOUS · INFERRED: 12742 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 12742 · contains: 4998 · calls: 3656 · ON_BRANCH: 2386 · MODIFIES: 2346 · rationale_for: 1539 · imports: 877 · imports_from: 673 · method: 595 · PARENT_OF: 567 · inherits: 560 · re_exports: 3
...
Cohesion: 0.02
Nodes (266): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+258 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (83): _require_demo_mode(), reset_demo(), seed_demo(), Database engine and session management. Supports both PostgreSQL (production) an, Reapply RLS tenant context lost when a commit ends the transaction.      ``app.s, _reapply_tenant_context(), _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files. (+75 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (204): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), HotelConfiguration (+196 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (185): add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Base, Base class for all ORM models., DeclarativeBase (+177 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (161): CheckInRequest, FastAPI routes for Check-in / Check-out., B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, Guest, GuestRatingEnum, GuestTag, GuestTagTypeEnum, Guest and GuestCompanion models. Exhaustive fields for check-in panel: identity (+153 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (183): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+175 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (165): worktree-agent-a945788514ece683f, worktree-agent-aa90c760fab5d7651, worktree-agent-accdf065d7f106429, 00af83e chore(graphify): regenerate graph after B4 manual OTA + manual tarifa + B4.2, 0255d4f Normalize Graphify artifact paths, 043b24f Record the Fase 10 WebKit Apple matrix findings in the catalog, 04cd07c feat(reservations): wire global reservation access into header, dashboard and guests, 08af818 qa(catalog): record money-risk-payment-surcharge-daily-rate P1 finding (+157 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (116): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+108 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (145): cancel_reservation(), create_reservation_charge(), extend_stay(), mark_no_show(), modify_reservation(), occupancy_grid(), FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create (+137 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (141): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 0391f8f Fix flaky detached-node false positive in mobile touch-target check, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker (+133 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (59): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 7e2edb6 Merge Analytics R1.0 (+51 more)
...
Cohesion: 0.03
Nodes (92): StockConsumptionItem, StockConsumptionReportRead, StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead, StockMovementCreate (+84 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (64): email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., Lightweight status so the frontend can check the active system email provider., updateHotelConfig() (+56 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (57): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), mercadopago_payment_link_webhook(), _mercadopago_webhook_impl(), get_settings(), _gmail_is_active() (+49 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (72): validateGuestForCheckin(), add_reservation_guests(), addReservationCharge(), addReservationGuests(), buildQueryString(), cancelReservation(), change_dates(), CheckInPayload (+64 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (39): _authorize_override(), checkin(), checkin_partial(), CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload (+31 more)
...
Cohesion: 0.07
Nodes (73): CompanyDocument, CompanyDocumentStatusEnum, CompanyDocumentTypeEnum, CompanyDocument — attachments/vouchers for company reservations (v72 §3.6). Trac, Document/voucher associated with a company reservation (v72 §3.6).     If requir, HotelPermissionOverride, Permission, Configurable permission matrix models. (+65 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (21): a5ee7be fix(migrations): make schema-drift-era tables idempotent against self-healed production, v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin, v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume, v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_, v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event, Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open, laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026, Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay (+13 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (59): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+51 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (65): MasterAdminProtectedShell(), MasterAdminRoot(), navItems, MasterAdminSessionProvider(), OnboardingWizard(), SettingsAssistantPage(), SettingsHotelPage(), SettingsSecurityPage() (+57 more)
...
Cohesion: 0.06
Nodes (55): _load_manifest(), main(), ManifestContinuityError, _provider_subject(), Safe error that never prints provider values., Allow only a newer observation timestamp between provider snapshots., _timestamp(), verify_manifest_continuity() (+47 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (56): addLaundryItem(), createLaundryBatch(), LaundryBatch, LaundryBatchCreate, LaundryBatchRead, LaundryItem, LaundryItemCreate, LaundryItemRead (+48 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (58): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), SessionLike (+50 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (58): Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection (+50 more)
...
Cohesion: 0.04
Nodes (19): 099e4c8 fix(e2e): stop the WebKit business Apple matrix from colliding with itself, 194af4d fix(reservations): search guests by name/DNI instead of raw ID field, credentials, navigateFromShell(), revealCollapsedNavLink(), credentials, credentials, credentials (+11 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (53): AcceptPayload, AuthContext, get_auth_context(), _parse_header_hotel_id(), _parse_token_hotel_id(), Strict authentication/context helpers.  Every operational request must resolve t, Return an authenticated context scoped to an active hotel membership., Return an authenticated context scoped to an active hotel membership. (+45 more)
...
Cohesion: 0.07
Nodes (19): OTACommissionRule, OTACurrencyRate, OTASyncEvent, OTASyncJob, OTA domain models for channel mappings, sync orchestration and external links., NormalizedOTAReservation, OTAAdapterContext, OTAOperationResult (+11 more)

### Community 37 - "Community 37"
Cohesion: 0.10
Nodes (42): APIKeyPurposeEnum, PaymentLinkRead, ReservationRead, HotelAPIKeyIssue, HotelAPIKeyIssued, HotelAPIKeyRead, PublicAvailabilityResponse, PublicCategoryRead (+34 more)
...
Cohesion: 0.08
Nodes (35): RoomBlockCreate, RoomBlockRead, RoomBlockCreate, RoomBlockRead, PendingActionPriorityEnum, PendingActionStatusEnum, PendingActionTypeEnum, PendingOperationalAction (+27 more)
...
Cohesion: 0.06
Nodes (29): 03ec9de Refresh Graphify after Fase 9 role QA fixes, 1cd0fce Merge claude/feature/pms-roles-housekeeping-qa: integrate parallel QA fixes, 2efac9f Record Fase 9 role QA findings in the regression catalog, 32f7bba Require checkin:perform permission for checkout, not just authentication, 9b26f2c Grant receptionist access to POST /api/payments and its summary, 9e4d99e Fix the reservation payment panel to use the operational balance, bf892a8 Grant receptionist access to GET /api/bookings/price-quote, c2f87d1 Grant receptionist read access to room categories (+21 more)
...
Cohesion: 0.14
Nodes (30): 6e6d179 Prepare release candidate for landing and onboarding, 87b0eb6 Improve marketing SEO content, linking, and metadata, Seo(), SeoProps, StructuredData, resolveAppUrl(), benefitPoints, faqItems (+22 more)
...
Cohesion: 0.22
Nodes (36): booking_webhook(), despegar_webhook(), expedia_webhook(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia., Receive reservation notifications from Despegar. (+28 more)
...
Cohesion: 0.12
Nodes (32): ReservationAllocationLock, Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, RoomMovementGroup, _adjacency_bonus_for_room(), AllocationError, AllocationResult, apply_allocation_result(), build_slots_from_db() (+24 more)
...
Cohesion: 0.13
Nodes (36): FactReservationRowKindEnum, FactRoomOccupancyStatusAtNightEnum, OTAConnectionStatusEnum, OTASyncJobStatusEnum, ReservationCancellationReasonCodeEnum, ReservationGuestSegmentSourceEnum, _allocate_monetary_totals(), backfill_channel_code() (+28 more)
...
Cohesion: 0.09
Nodes (26): getPaymentSummary(), makePayment(), newPaymentIdempotencyKey(), PaymentMethod, PaymentRequest, PaymentSummary, FastAPI routes for Payments., TransactionType (+18 more)
...
Cohesion: 0.08
Nodes (14): 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, approve_close_difference(), _confirmed_cash_movements_total(), get_latest_close_report(), get_session_summary(), list_movements(), _money() (+6 more)
...
Cohesion: 0.10
Nodes (25): 15fdb88 Create missing cash custody handoff schema, 9d6d084 Repair legacy payment proof schema, b1e1bd0 Repair legacy cash handoff schema at startup, c32574b Report model schema drift at startup, CashHandoffSchemaRepairError, main(), missing_model_tables(), Repair known legacy PostgreSQL schema drift before starting the API.  The manage (+17 more)
...
Cohesion: 0.14
Nodes (19): FastAPI routes for outsourced laundry vendors, pricing and remitos.  Separate ro, RemitoCreate, RemitoCreateResponse, RemitoLineIn, RemitoLineRead, RemitoRead, VendorBalanceLine, VendorCreate (+11 more)
...
Cohesion: 0.10
Nodes (15): _make_reservation(), Tests for V72 §9 — Waitlist and Overbooking.  Key implementation details discove, Only is_wait_listed=True reservations should appear in the waitlist query., Create one normal and one waitlisted reservation, return (normal, waitlisted)., Service-level tests for the resolve logic (mirrors what the API endpoint does)., Resolving a waitlisted reservation sets room_id and clears is_wait_listed., Resolving with a room of a different category must be blocked., Resolving with an already-occupied room must be blocked. (+7 more)

### Community 84 - "Community 84"
Cohesion: 0.10
Nodes (12): main(), valid_https(), 19b8b7b Harden isolated preview QA and trusted release evidence, issue_provider_evidence_token(), load_provider_evidence_private_key(), main(), Load the producer-only signer from PEM or base64 raw seed bytes., Create a provider-bound capability using the producer-only signer. (+4 more)
...
Cohesion: 0.10
Nodes (13): 07ea889 Record preview functional QA evidence, 3a6ebda Fix legacy analytics freshness metadata, 42a7d23 Record Apple business regression, 8dfaf35 Increase mobile header touch targets, 906d009 Hide room status and block controls from roles that cannot use them, ac2d59b Hide stock adjustment option from manager, bf9b633 Gate the post-close "Aprobar diferencia" button by role too, f72e165 Remove internal IDs from cash movements (+5 more)
...
Cohesion: 0.20
Nodes (16): _enum_value(), _event_to_read(), _group_to_read(), list_movement_groups(), MovementEventRead, MovementGroupRead, _not_found_or_bad_request(), read_movement_group() (+8 more)

### Community 117 - "Community 117"
Cohesion: 0.12
Nodes (5): 0a457cb feat(checkin): B3 partial check-in + mandatory guest profile capture + companions, B3.2: migration adding guests.birth_place/birth_country/marital_status/occupatio, _run(), test_guest_checkin_profile_migration_up_down_up_on_sqlite(), guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho

### Community 118 - "Community 118"
Cohesion: 0.14
Nodes (11): 8e0f9e5 Add PostgreSQL fallback for required locks, ace7f4c Repair missing cash handoff schema, FakeInspector, _load_migration(), test_repair_migration_adds_missing_successor_column_and_constraints(), _add_constraint_if_missing(), _has_fk(), _has_unique() (+3 more)
...
Cohesion: 0.23
Nodes (10): 3c87e58 Add E2E coverage for onboarding resume and real-backend cash/rates setup, ca1e2fc Fix latent unimported Page type in auth-onboarding-journey.spec.ts, emailOutboxPath, readLatestCode(), waitForCode(), cleanupEmailOutbox(), emailOutboxPath, readLatestCode() (+2 more)
...
Cohesion: 0.20
Nodes (9): ActiveRoomBlockItem, AvailableWithReviewItem, CashSessionStatusRead, DailyOperationalReportRead, NightlyOperationalSummaryRead, OperationalAlertRead, OperationalReportDeliveryRead, OperationalReservationGroup (+1 more)
...
Cohesion: 0.25
Nodes (7): 1ac0c3c Add StatCard component and fix reservations dashboard error, 1af6bfc Add demo seed script and README instructions for stage 1, 26970dd Add token store cleanup helper, de996f5 Loosen auth email validation to allow test domains, main(), Seed minimal demo data for local testing.  Usage:     python -m app.scripts.seed, seed()
...
Cohesion: 0.32
Nodes (6): 54eed63 Expose payment method configuration for owners, e85df76 Harden reservation finance loading states, clientNavigate(), credentials, PAGES, revealCollapsedNavLink()
...
Cohesion: 0.68
Nodes (7): _client_with_db(), _override_auth(), _teardown(), test_housekeeping_can_operate_remitos_but_not_manage_vendors(), test_owner_can_manage_vendors_and_receptionist_cannot(), test_remito_rejects_insufficient_house_stock_via_api(), test_vendors_and_balance_are_hotel_scoped_across_the_api()
...
- **Thin community `Community 72`** (2 nodes): `_hotel_default_currency()`, `OTAIntegrationService`
...
- **Thin community `Community 134`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 211`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 247`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 270`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (2 nodes): `owner`, `receptionist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (2 nodes): `RoomMoveEventRead`, `RoomMovementGroupRead`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (1 nodes): `TestCurrentSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (1 nodes): `TestExportSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 3` to `Community 10`, `Community 0`, `Community 1`, `Community 201`, `Community 79`, `Community 232`, `Community 8`, `Community 26`, `Community 125`, `Community 44`, `Community 56`, `Community 27`, `Community 60`, `Community 78`, `Community 22`, `Community 30`, `Community 18`, `Community 102`, `Community 11`, `Community 149`, `Community 4`, `Community 37`, `Community 99`, `Community 2`, `Community 33`, `Community 38`, `Community 126`, `Community 16`, `Community 36`, `Community 54`, `Community 43`, `Community 184`, `Community 250`, `Community 70`, `Community 92`, `Community 209`, `Community 210`, `Community 107`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 2` to `Community 13`, `Community 33`, `Community 8`, `Community 7`, `Community 46`, `Community 12`, `Community 103`, `Community 10`, `Community 3`, `Community 26`, `Community 43`, `Community 301`, `Community 60`, `Community 27`, `Community 4`, `Community 0`, `Community 255`, `Community 74`, `Community 120`, `Community 94`, `Community 54`, `Community 72`, `Community 38`, `Community 11`, `Community 30`, `Community 207`, `Community 97`, `Community 78`, `Community 92`, `Community 36`, `Community 18`, `Community 182`, `Community 22`, `Community 50`, `Community 309`, `Community 310`, `Community 83`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 3`, `Community 103`, `Community 8`, `Community 10`, `Community 26`, `Community 43`, `Community 56`, `Community 44`, `Community 60`, `Community 27`, `Community 4`, `Community 18`, `Community 221`, `Community 54`, `Community 72`, `Community 61`, `Community 2`, `Community 78`, `Community 30`, `Community 116`, `Community 97`, `Community 22`, `Community 50`, `Community 309`, `Community 310`, `Community 83`?**
...
- **Are the 734 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 734 INFERRED edges - model-reasoned connections that need verification._
