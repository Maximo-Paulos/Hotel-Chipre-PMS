...
## Corpus Check
- Large corpus: 1030 files · ~1,644,965 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10002 nodes · 45771 edges · 358 communities detected
- Extraction: 65% EXTRACTED · 35% INFERRED · 0% AMBIGUOUS · INFERRED: 16168 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16168 · ON_BRANCH: 10266 · contains: 5886 · calls: 4318 · MODIFIES: 3252 · rationale_for: 2043 · imports: 1078 · imports_from: 831 · PARENT_OF: 664 · inherits: 646 · method: 616 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 1030 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 12 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `453cc6c`
...
Cohesion: 0.10
Nodes (345): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+337 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (156): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, Stream tenant-scoped invalidation signals; clients refetch from Postgres-backed, stream_domain_events(), _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag (+148 more)
...
Cohesion: 0.01
Nodes (145): requestVerification(), ApiError, ActiveRoomBlockItem, AvailableWithReviewItem, CashSessionStatusRead, DailyOperationalReport, getDailyOperationalReport(), getOccupancyReport() (+137 more)
...
Cohesion: 0.05
Nodes (221): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser(), list_users() (+213 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (220): CheckInRequest, FastAPI routes for Check-in / Check-out., cancel_reservation(), change_dates(), create_reservation_charge(), _ensure_action_permission(), extend_stay(), _is_manager_context() (+212 more)
...
Cohesion: 0.02
Nodes (145): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), Category (+137 more)
...
Cohesion: 0.02
Nodes (148): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., main(), run() (+140 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (148): FastAPI routes for Payments., StockConsumptionItem, StockConsumptionReportRead, StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead (+140 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (73): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _require_demo_mode(), reset_demo(), seed_demo() (+65 more)
...
Cohesion: 0.03
Nodes (47): _authorize_override(), checkin(), CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload, OnboardingProviderSetup (+39 more)
...
Cohesion: 0.04
Nodes (68): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), getGuestProhibitedDetail() (+60 more)
...
Cohesion: 0.06
Nodes (48): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+40 more)
...
Cohesion: 0.04
Nodes (24): create_payment_surcharge(), deactivate_payment_surcharge(), _get_surcharge_or_404(), _has_per_method_nightly_price(), update_payment_surcharge(), BridgeActivity, 958fce2 Merge pull request #31 from Maximo-Paulos/feature/mobile-first-operations, credentials (+16 more)
...
Cohesion: 0.07
Nodes (35): IntegrationCatalog, IntegrationConnection, IntegrationEvent, _account_label_from_payload(), connection_account_label(), decrypt_payload(), derive_expires_at(), encrypt_payload() (+27 more)
...
Cohesion: 0.06
Nodes (38): Base, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterSystemEmailConnection, MasterAdminContext, FxPolicy (+30 more)
...
Cohesion: 0.09
Nodes (37): google_login(), _pick_default_hotel_id(), Auth endpoints: register, login, email verification and password reset. Verifica, Return a session only after the required account MFA factor succeeds., "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, Validate reset code without changing password (paso previo en UI). (+29 more)
...
Cohesion: 0.12
Nodes (24): acceptInvitation(), _allow_mfa_attempt(), AuthResponse, _build_auth_response(), _build_login_response(), complete_mfa_login(), confirm_mfa_enrollment(), disable_mfa() (+16 more)
...
Cohesion: 0.23
Nodes (6): ConfirmDialogProps, Props, Props, RestrictionOverrideModal(), IntegrationHelp, useDialogA11y()
...
- **Thin community `Community 273`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 342`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 343`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 344`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 346`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 347`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 348`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 349`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 350`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 352`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 353`** (1 nodes): `repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 355`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 356`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 357`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 358`** (1 nodes): `stock_items.kind (supply vs linen) + soft-delete-aware name uniqueness  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 359`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 361`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 362`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 363`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 364`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 365`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 367`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 369`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 8` to `Community 14`, `Community 1`, `Community 163`, `Community 68`, `Community 219`, `Community 7`, `Community 55`, `Community 40`, `Community 41`, `Community 70`, `Community 43`, `Community 60`, `Community 108`, `Community 66`, `Community 26`, `Community 113`, `Community 19`, `Community 3`, `Community 115`, `Community 111`, `Community 162`, `Community 9`, `Community 38`, `Community 34`, `Community 45`, `Community 4`, `Community 36`, `Community 198`, `Community 56`, `Community 136`, `Community 16`, `Community 2`, `Community 11`, `Community 24`, `Community 222`, `Community 81`, `Community 120`, `Community 199`, `Community 5`, `Community 297`, `Community 85`, `Community 98`, `Community 275`, `Community 91`, `Community 0`, `Community 32`, `Community 97`, `Community 172`, `Community 53`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 9` to `Community 17`, `Community 45`, `Community 7`, `Community 6`, `Community 13`, `Community 3`, `Community 4`, `Community 82`, `Community 14`, `Community 8`, `Community 40`, `Community 108`, `Community 60`, `Community 279`, `Community 11`, `Community 23`, `Community 63`, `Community 56`, `Community 101`, `Community 5`, `Community 105`, `Community 2`, `Community 280`, `Community 85`, `Community 66`, `Community 367`, `Community 26`, `Community 32`, `Community 106`, `Community 97`, `Community 36`, `Community 260`, `Community 55`, `Community 172`, `Community 1`, `Community 61`, `Community 19`, `Community 47`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 2` to `Community 5`, `Community 8`, `Community 3`, `Community 7`, `Community 14`, `Community 40`, `Community 43`, `Community 70`, `Community 108`, `Community 60`, `Community 9`, `Community 115`, `Community 38`, `Community 26`, `Community 11`, `Community 72`, `Community 118`, `Community 106`, `Community 145`, `Community 19`, `Community 47`?**
