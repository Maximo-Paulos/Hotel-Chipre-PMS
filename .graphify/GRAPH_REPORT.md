...
## Corpus Check
- Large corpus: 1158 files · ~1,675,217 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10018 nodes · 46213 edges · 361 communities detected
- Extraction: 65% EXTRACTED · 35% INFERRED · 0% AMBIGUOUS · INFERRED: 16168 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16168 · ON_BRANCH: 10669 · contains: 5887 · calls: 4323 · MODIFIES: 3271 · rationale_for: 2053 · imports: 1078 · imports_from: 831 · PARENT_OF: 668 · inherits: 646 · method: 616 · re_exports: 3


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1158 · Candidates: 1291
- Excluded: 0 untracked · 1654 ignored · 12 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `300d128`
...
Cohesion: 0.10
Nodes (353): main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., agent-linensplit, agent-login, agent-mobilenav, agent-otafix (+345 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (149): _require_demo_mode(), reset_demo(), seed_demo(), Stream tenant-scoped invalidation signals; clients refetch from Postgres-backed, stream_domain_events(), _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck() (+141 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (299): PaymentSurchargeCreate, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+291 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (257): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+249 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (151): requestVerification(), ApiError, ActiveRoomBlockItem, AvailableWithReviewItem, CashSessionStatusRead, DailyOperationalReport, getDailyOperationalReport(), getOccupancyReport() (+143 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (222): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true). (+214 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (221): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser() (+213 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (224): CheckInRequest, FastAPI routes for Check-in / Check-out., cancel_reservation(), change_dates(), create_reservation_charge(), _ensure_action_permission(), extend_stay(), _is_manager_context() (+216 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (169): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest. (+161 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (173): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, email_status(), Lightweight status so the frontend can check the active system email provider., Lightweight status so the frontend can check the active system email provider. (+165 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (124): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+116 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (152): graphify_state(), main(), main(), run(), validate_json(), claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action (+144 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (141): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), Category (+133 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (147): StockConsumptionItem, StockConsumptionReportRead, StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead, StockMovementCreate (+139 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (76): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _booking_to_read(), cancel_booking(), checkin_booking() (+68 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (105): ad4249c Implement master admin panel, PermissionGate(), Email provider abstraction for platform transactional mail., clearMasterAdminCsrfToken(), masterAdminFetch(), MasterAdminLoginResponse, MasterAdminUser, MasterBillingPolicy (+97 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (52): _authorize_override(), checkin(), CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload, OnboardingProviderSetup (+44 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (62): getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., updateHotelConfig(), createPaymentSurcharge(), deactivatePaymentSurcharge(), listPaymentSurcharges() (+54 more)
...
Cohesion: 0.04
Nodes (57): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), getGuestProhibitedDetail() (+49 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (63): GuestCheckinValidation, validateGuestForCheckin(), add_reservation_guests(), addReservationCharge(), addReservationGuests(), buildQueryString(), cancelReservation(), CheckInPayload (+55 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (49): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+41 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (68): HotelPermissionOverride, Permission, RolePermissionDefault, SecurityAuditLog, _engine_key(), ensure_permission_matrix_seeded(), get_matrix(), _insert_if_missing() (+60 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (49): BulkRateField, BulkRateFieldMode, BulkRateResult, bulkUpdateDailyRateField(), bulkUpsertDailyRates(), DailyRateOut, DailyRatePrices, DailyRateRangeRow (+41 more)
...
Cohesion: 0.06
Nodes (61): AuditLog, Append-only record of every significant mutation within a hotel tenant.     Do N, PaymentProof, PaymentProofBlob, PaymentProofStatusEnum, Manual bank-transfer evidence and approval lifecycle., Private image evidence awaiting explicit staff confirmation., Private image evidence awaiting explicit staff confirmation. (+53 more)
...
Cohesion: 0.05
Nodes (48): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+40 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (45): _auth_headers(), _complete_onboarding(), _configure_resend(), _enroll_and_confirm_mfa(), _fake_google_claims(), FakeResponse, _next_totp_code(), .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by (+37 more)
...
Cohesion: 0.09
Nodes (43): 805b47a Unify reservation pricing with signed quote contract, APIKeyPurposeEnum, PaymentLinkRead, ReservationRead, HotelAPIKeyIssue, HotelAPIKeyIssued, HotelAPIKeyRead, PublicAvailabilityResponse (+35 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (35): addGuestCompanions(), addGuestTag(), _build_guest_ledger_csv(), buildGuestQueryString(), checkInGuestReservation(), createGuest(), _enum_value(), export_guest_ledger() (+27 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (22): BridgeActivity, 958fce2 Merge pull request #31 from Maximo-Paulos/feature/mobile-first-operations, credentials, createdPromotion, mockCategories, simulateResult, ownerCredentials, receptionistCredentials (+14 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (36): acceptInvitation(), _allow_mfa_attempt(), _audit_security_event(), AuthResponse, _build_auth_response(), complete_mfa_login(), confirm_mfa_enrollment(), disable_mfa() (+28 more)
...
Cohesion: 0.10
Nodes (41): create_restriction(), _get_tenant_guest(), list_restrictions(), FastAPI routes for GuestRestriction (formal lodging-prohibition entity)., Tenant-scoped lookup. Cross-hotel access must 404, never 403 --     existence of, resolve_restriction(), GuestRestriction, GuestRestrictionStatusEnum (+33 more)

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (33): IntegrationCatalog, IntegrationConnection, IntegrationEvent, _account_label_from_payload(), connection_account_label(), decrypt_payload(), derive_expires_at(), encrypt_payload() (+25 more)
...
Cohesion: 0.10
Nodes (38): MovementEventRead, MovementGroupRead, ReservationAllocationLock, Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, RoomMovementGroup, _adjacency_bonus_for_room(), AllocationError, AllocationResult (+30 more)
...
Cohesion: 0.07
Nodes (42): AcceptPayload, _current_user(), Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., recent_security_events(), revoke_current_user_sessions(), _safe_resource_id() (+34 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (37): Base, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterSystemEmailConnection, MasterAdminContext, FxPolicy (+29 more)
...
Cohesion: 0.05
Nodes (4): DespegarAdapter, ExpediaAdapter, OTAProviderAdapter, OTAProviderAdapter
...
Cohesion: 0.13
Nodes (29): MasterAdminAuditEvent, MasterStripeWebhookEvent, Subscription, _configure_resend(), FakeResponse, If MASTER_ADMIN_EMAIL happens to collide with a real tenant's login     email (a, If MASTER_ADMIN_EMAIL happens to collide with a real tenant's login     email (a, C2 regression (SQLite, syntactic only -- RLS is a Postgres-only concern,     see (+21 more)
...
Cohesion: 0.11
Nodes (31): _build_login_response(), google_login(), _pick_default_hotel_id(), Auth endpoints: register, login, email verification and password reset. Verifica, Project a global identity event into every hotel the user actively belongs to., Return a session only after the required account MFA factor succeeds., "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front (+23 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (29): EffectivePermissionsResponse, fetchEffectivePermissions(), fetchPermissionMatrix(), PermissionCell, PermissionMatrix, PermissionMatrixResponse, PermissionOverridePayload, PermissionOverrideRequest (+21 more)

### Community 66 - "Community 66"
Cohesion: 0.16
Nodes (30): AnalyticsExportJob, AnalyticsExportStatusEnum, FactReservationDaily, _date_window(), _decimal_total(), detect_no_shows(), _parse_datetime(), project_all_derived_facts_incremental() (+22 more)
...
Cohesion: 0.10
Nodes (24): listCategories(), Guest, GuestPayload, Reservation, emptyQuickGuestForm(), guestFullName(), GuestQuickCreatePanelProps, GuestSummaryCard() (+16 more)
...
Cohesion: 0.20
Nodes (18): changed_blob_paths(), finalize_gate(), full_sha(), GitHubClient, main(), positive_integer(), prepare_gate(), PreparedEvidence (+10 more)
...
Cohesion: 0.14
Nodes (18): evidence_bytes(), FakeGitHub, iso(), prepare(), test_finalize_rejects_artifact_with_different_bytes(), test_github_client_error_never_discloses_token_or_body(), test_prepare_refuses_head_key_substitution_for_base_checkout_key(), test_prepare_rejects_altered_operator_signature() (+10 more)
...
Cohesion: 0.10
Nodes (16): SimpleRateLimiter, Staff management endpoints for hotel public API keys., Authorize a public key for a specific external product surface.      Purpose val, require_public_api_purpose(), _generate_secret(), _hash_secret(), HotelAPIKeyError, issue_key() (+8 more)
...
Cohesion: 0.22
Nodes (17): 6e6d179 Prepare release candidate for landing and onboarding, 87b0eb6 Improve marketing SEO content, linking, and metadata, Seo(), SeoProps, StructuredData, resolveAppUrl(), faqItems, MarketingShell() (+9 more)
...
Cohesion: 0.11
Nodes (20): create_stock_item(), current_stock(), delete_stock_item(), _get_item(), get_location(), get_stock_item(), list_stock_items(), low_stock_items() (+12 more)

### Community 93 - "Community 93"
Cohesion: 0.15
Nodes (20): _canonical_identity(), _enabled(), _identity_contains(), _load_local_evidence(), _load_provider_evidence(), Fail-closed safety guard for PostgreSQL tests that mutate schema or data.  Remot, Return ``dsn`` only when provider evidence proves a disposable QA target.      E, Return ``dsn`` only when provider evidence proves a disposable QA target.      E (+12 more)
...
Cohesion: 0.17
Nodes (22): _active_membership(), _audit(), audit_permission_denied(), can_role_hold_permission(), canonical_permission_code(), get_effective_permission_details(), get_effective_permissions(), get_role_profiles() (+14 more)
...
Cohesion: 0.12
Nodes (15): ReservationGlobalSearch(), useReservationDrawer(), reservationsKey(), useReservations(), categoriesKey(), roomsKey(), useRooms(), DashboardPage() (+7 more)
...
Cohesion: 0.26
Nodes (22): _hotel(), A cash payment on a reservation must land in the open caja as an INCOME     move, MercadoPago and bank-transfer payments settle the reservation balance     but mu, _reservation(), test_cash_movement_requires_open_session(), test_cash_payment_posts_income_movement_to_open_session(), test_cash_payment_with_surcharge_posts_gross_amount_to_caja(), test_cash_payment_without_open_session_is_rejected() (+14 more)
...
Cohesion: 0.23
Nodes (22): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyStatusAtNightEnum, PaymentLinkStatusEnum, PaymentProviderEnum, PaymentStatusEnum, Reference values for payments.provider / payment_links.provider (stored as Strin (+14 more)
...
Cohesion: 0.18
Nodes (15): a714b07 fix(security): block replay-reactivation of revoked memberships, d333204 fix(security): require account auth for existing invitation accepts, client_with_db(), get_auth_context_target(), get_db_override_target(), _invitation_token(), owner_ctx(), test_co_owner_cannot_grant_privileged_roles() (+7 more)
...
Cohesion: 0.24
Nodes (15): fail(), load_json_object(), main(), mapping(), nested_value(), positive_integer(), preview_origin(), Return the normalized origin for a credential-free HTTPS preview URL. (+7 more)
...
Cohesion: 0.26
Nodes (10): benefitPoints, heroBullets, integrationPoints, marketingRoutes, onboardingSteps, pricingCards, problemPoints, screenshotFrames (+2 more)
...
Cohesion: 0.18
Nodes (11): mark_vendor_settlement_paid(), _quarter_bounds(), Total charged by the vendor in a period.      Assumption (see plan D1/D3, flagge, Total charged by the vendor in a period.      Assumption (see plan D1/D3, flagge, Total charged by the vendor in a period.      Assumption (see plan D1/D3, flagge, The 4 calendar quarters of a year for one vendor, cost computed live.      Reuse, The 4 calendar quarters of a year for one vendor, cost computed live.      Reuse, Upsert the paid/not-paid mark for one quarter. Visual alert only -- never blocks (+3 more)
...
Cohesion: 0.38
Nodes (7): _auth_headers(), _ensure_hotel(), test_comped_override_records_audit_event(), test_comped_override_rejects_unknown_hotel_without_subscription_state(), test_manual_transitions_emit_events(), test_role_gating_for_trial_and_comped_override(), test_trial_auto_suspends_after_fourteen_days()
...
Cohesion: 0.22
Nodes (8): Configurable permission matrix models., An employee-specific permission decision within one hotel membership., UserPermissionOverride, publish_permission_invalidation(), Tenant-scoped permission catalog, resolution, mutation, and audit services., Explicit invalidation boundary for callers and future cache adapters.      Effec, Best-effort tenant signal after commit; never roll back the RBAC write., Best-effort tenant signal after commit; never roll back the RBAC write.
...
Cohesion: 0.36
Nodes (6): _active_tag_filter(), add_tag(), _audit(), _now(), _serialize_stay(), set_rating()
...
Cohesion: 0.40
Nodes (5): _default_currency(), Upsert the single current price for a (vendor, item) pair., Upsert the single current price for a (vendor, item) pair., Upsert the single current price for a (vendor, item) pair., set_vendor_price()

### Community 304 - "Community 304"
Cohesion: 0.60
Nodes (4): _active_reservation_conflicts_for_room(), get_group(), list_groups(), revert_group()
...
Cohesion: 0.50
Nodes (4): create_remito(), Record a remito as a pair of StockMovements per line.      outbound: house_locat, Record a remito as a pair of StockMovements per line.      outbound: house_locat, Record a remito as a pair of LinenMovements per line.      outbound: house_locat

### Community 326 - "Community 326"
Cohesion: 0.50
Nodes (4): create_vendor(), Create a vendor and its dedicated StockLocation in one transaction., Create a vendor and its dedicated StockLocation in one transaction., Create a vendor and its dedicated LinenLocation in one transaction.

### Community 327 - "Community 327"
Cohesion: 0.50
Nodes (4): What is physically at the vendor's laundry right now, per item., What is physically at the vendor's laundry right now, per item., What is physically at the vendor's laundry right now, per item., vendor_balance()
...
## Knowledge Gaps
- **823 isolated node(s):** `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`, `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`, `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`, `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`, `launch security hardening  Revision ID: 20260408_launch_security_hardening Revis` (+818 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 136`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 230`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 251`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 274`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 342`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 343`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 344`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 346`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 347`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 348`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 349`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 350`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 352`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 353`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 355`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 356`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 357`** (1 nodes): `repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 358`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 359`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 361`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 362`** (1 nodes): `stock_items.kind (supply vs linen) + soft-delete-aware name uniqueness  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 363`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 364`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 365`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 367`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 369`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 370`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 372`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 8` to `Community 1`, `Community 14`, `Community 164`, `Community 68`, `Community 219`, `Community 7`, `Community 55`, `Community 45`, `Community 41`, `Community 70`, `Community 42`, `Community 60`, `Community 108`, `Community 66`, `Community 26`, `Community 113`, `Community 18`, `Community 3`, `Community 115`, `Community 111`, `Community 163`, `Community 9`, `Community 38`, `Community 33`, `Community 44`, `Community 4`, `Community 39`, `Community 0`, `Community 198`, `Community 56`, `Community 136`, `Community 16`, `Community 2`, `Community 10`, `Community 23`, `Community 222`, `Community 80`, `Community 120`, `Community 199`, `Community 5`, `Community 299`, `Community 84`, `Community 97`, `Community 36`, `Community 277`, `Community 90`, `Community 29`, `Community 96`, `Community 173`, `Community 53`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 9` to `Community 14`, `Community 45`, `Community 17`, `Community 44`, `Community 7`, `Community 6`, `Community 13`, `Community 3`, `Community 4`, `Community 81`, `Community 8`, `Community 108`, `Community 60`, `Community 281`, `Community 10`, `Community 22`, `Community 0`, `Community 325`, `Community 327`, `Community 187`, `Community 326`, `Community 303`, `Community 56`, `Community 100`, `Community 5`, `Community 105`, `Community 2`, `Community 282`, `Community 84`, `Community 66`, `Community 370`, `Community 26`, `Community 29`, `Community 106`, `Community 96`, `Community 39`, `Community 261`, `Community 55`, `Community 173`, `Community 61`, `Community 18`, `Community 47`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 2` to `Community 14`, `Community 8`, `Community 45`, `Community 5`, `Community 3`, `Community 7`, `Community 42`, `Community 70`, `Community 108`, `Community 60`, `Community 9`, `Community 115`, `Community 38`, `Community 26`, `Community 10`, `Community 72`, `Community 118`, `Community 106`, `Community 146`, `Community 18`, `Community 47`?**
