...
## Corpus Check
- Large corpus: 773 files · ~515,892 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7256 nodes · 24733 edges · 295 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9294 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9294 · contains: 4476 · calls: 3396 · MODIFIES: 1941 · ON_BRANCH: 1588 · rationale_for: 1173 · imports: 747 · method: 590 · imports_from: 589 · inherits: 535 · PARENT_OF: 404
...
## Graph Freshness
- Built from Git commit: `2efac9f`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `Reservation` - 605 edges
2. `ReservationStatusEnum` - 604 edges
3. `HotelConfiguration` - 539 edges
4. `Room` - 472 edges
5. `Guest` - 443 edges
6. `RoomCategory` - 425 edges
7. `Base` - 359 edges
...
Cohesion: 0.03
Nodes (205): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+197 more)
...
Cohesion: 0.05
Nodes (156): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), BillingAdjustment (+148 more)
...
Cohesion: 0.04
Nodes (141): FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Guest, Reservation, ReservationSourceEnum, ReservationStatusEnum (+133 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (149): add_reservation_guests(), buildQueryString(), cancel_reservation(), cancelReservation(), change_dates(), checkInReservation(), checkOutReservation(), clearReservationManualReview() (+141 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (168): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+160 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (110): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca (+102 more)
...
Cohesion: 0.04
Nodes (84): Base, Base class for all ORM models., DeclarativeBase, audited_change(), Record an AuditLog row for a successful entity mutation., Record an AuditLog row for a successful entity mutation., AuditLog, Append-only record of every significant mutation within a hotel tenant.     Do N (+76 more)
...
Cohesion: 0.07
Nodes (58): add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., GuestRatingEnum, GuestTag, GuestTagTypeEnum, Guest and GuestCompanion models. Exhaustive fields for check-in panel: identity (+50 more)
...
Cohesion: 0.06
Nodes (58): Payment, PaymentLink, PaymentLinkStatusEnum, PaymentProviderEnum, PaymentStatusEnum, PaymentWebhookEvent, Payment gateway tracking models: PaymentLink, Payment, PaymentWebhookEvent.  Sou, One gateway payment object (MP preference / PayPal order / Stripe intent). (+50 more)
...
Cohesion: 0.04
Nodes (29): 1a71e7d feat: add ota allocation data foundation, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 70b1481 Relax startup validation for optional integrations, c580b56 ojala si, f0ca779 feat(security): prohibido_alojar enforcement, optimistic locking, payment tables, Reservation model with strict state machine. States: pending â†’ deposit_paid â†, Derive the BRM §16.2 reportable origin for a reservation.      Precedence:, reportable_origin() (+21 more)
...
Cohesion: 0.09
Nodes (17): 283135b feat(ops): SLICE-13 laundry + stock foundations, 6f60c12 feat(security): SLICE-01 configurable permission matrix + role boundaries, b4c9bd8 Harden cash rotation and payment integrity, fd617c0 Harden private transfer proof workflow, _seed_hotel(), test_get_matrix_includes_hotel_overrides(), test_housekeeping_cannot_create_reservation_by_default(), test_override_in_hotel_a_does_not_affect_hotel_b() (+9 more)
...
Cohesion: 0.07
Nodes (11): 5de6817 Add field-based bulk rate editing, 6cdbbc5 Polish rate calendar UX and fix Vercel install step, 6e8e1f3 Add hotel_id scope migration and model indexes for rooms/categories/reservations, bed8c5c feat: BR audit — pricing source of truth, caja, checkout, occupancy, surcharges, df770c3 Polish rate calendar and reservation pricing, edf650c WIP: propagate hotel_id scope across services and tests, mockCalendar, mockCategories (+3 more)
...
Cohesion: 0.15
Nodes (14): 9d6d084 Repair legacy payment proof schema, c32574b Report model schema drift at startup, CashHandoffSchemaRepairError, main(), Repair a legacy cash-handoff schema before starting the API.  The managed databa, Apply the additive cash-handoff repair in one PostgreSQL transaction., Raised when the safe repair cannot run against the configured database., Apply the additive cash-handoff repair in one PostgreSQL transaction. (+6 more)
...
Cohesion: 0.15
Nodes (8): 2efac9f Record Fase 9 role QA findings in the regression catalog, ac2d59b Hide stock adjustment option from manager, bf9b633 Gate the post-close "Aprobar diferencia" button by role too, fdce0a4 Hide laundry batch creation from housekeeping, Persona, personas, credentials, receptionistCredentials
...
Cohesion: 0.29
Nodes (5): list_timezones(), Reference data endpoints used by the frontend., Return the cached IANA timezone catalog., 2ba0905 Cache timezone catalog and remove repeated lookups, Pydantic schemas for HotelConfiguration.
...
Cohesion: 0.60
Nodes (3): _override_auth(), test_receptionist_can_check_room_availability(), test_receptionist_can_list_rooms()
...
- **Thin community `Community 221`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 261`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 264`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 277`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 295`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 300`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 10` to `Community 239`, `Community 205`, `Community 12`, `Community 9`, `Community 240`, `Community 151`, `Community 25`, `Community 114`, `Community 34`, `Community 59`, `Community 30`, `Community 69`, `Community 5`, `Community 7`, `Community 47`, `Community 15`, `Community 101`, `Community 8`, `Community 142`, `Community 4`, `Community 17`, `Community 3`, `Community 0`, `Community 33`, `Community 18`, `Community 66`, `Community 115`, `Community 2`, `Community 48`, `Community 31`, `Community 23`, `Community 67`, `Community 300`, `Community 28`, `Community 39`, `Community 64`, `Community 241`, `Community 40`, `Community 85`, `Community 194`, `Community 195`, `Community 121`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 24`, `Community 16`, `Community 5`, `Community 46`, `Community 3`, `Community 111`, `Community 58`, `Community 33`, `Community 10`, `Community 25`, `Community 4`, `Community 95`, `Community 30`, `Community 17`, `Community 7`, `Community 246`, `Community 40`, `Community 247`, `Community 18`, `Community 87`, `Community 48`, `Community 90`, `Community 2`, `Community 8`, `Community 47`, `Community 64`, `Community 69`, `Community 85`, `Community 66`, `Community 31`, `Community 157`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 4` to `Community 0`, `Community 17`, `Community 111`, `Community 5`, `Community 28`, `Community 10`, `Community 25`, `Community 47`, `Community 59`, `Community 34`, `Community 30`, `Community 15`, `Community 7`, `Community 48`, `Community 40`, `Community 23`, `Community 67`, `Community 2`, `Community 39`, `Community 126`, `Community 157`?**
...
- **Are the 532 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 532 INFERRED edges - model-reasoned connections that need verification._
- **Are the 467 inferred relationships involving `Room` (e.g. with `RoomBlockCreate` and `RoomBlockRead`) actually correct?**
  _`Room` has 467 INFERRED edges - model-reasoned connections that need verification._