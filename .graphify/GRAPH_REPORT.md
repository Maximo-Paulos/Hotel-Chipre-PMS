...
## Corpus Check
- Large corpus: 1035 files · ~1,649,079 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10128 nodes · 48674 edges · 366 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 16239 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16239 · ON_BRANCH: 12874 · contains: 5938 · calls: 4356 · MODIFIES: 3321 · rationale_for: 2078 · imports: 1078 · imports_from: 835 · PARENT_OF: 686 · inherits: 650 · method: 616 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 1035 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 12 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `0534c64`
...
Cohesion: 0.01
Nodes (138): _require_demo_mode(), reset_demo(), seed_demo(), _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), cancelPaymentLinkTest() (+130 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (154): requestVerification(), _authorize_override(), checkin(), ApiError, ActiveRoomBlockItem, AvailableWithReviewItem, CashSessionStatusRead, DailyOperationalReport (+146 more)
...
Cohesion: 0.02
Nodes (135): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+127 more)
...
Cohesion: 0.06
Nodes (33): 429e62c fix(review): require the CSRF cookie explicitly, no silent fallback, 9d95564 fix(security): return CSRF token in the response body, b47b916 feat(security): add revocable server-side sessions alongside existing JWT (backend only), Server-side, revocable sessions for the normal user auth plane., An opaque browser session whose raw token is never persisted., UserSession, _as_aware(), create_session() (+25 more)
...
Cohesion: 0.08
Nodes (30): 837ce01 fix(security): redact sensitive metadata in master admin audit events, dashboard_summary(), login(), me(), _serialize_user(), _as_aware(), audit_master_action(), authenticate_master_login() (+22 more)
...
Cohesion: 0.07
Nodes (41): AcceptPayload, Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., Keep useful internal references while never exposing free-form details., recent_security_events(), revoke_current_user_sessions() (+33 more)
...
Cohesion: 0.10
Nodes (33): 3dee498 fix(review): chain permission-metadata migration after latest head, 77fa337 feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, fbd432b fix(data-model): allow HotelAuditEvent to represent system/automated actors (#50), Configurable permission matrix models., An employee-specific permission decision within one hotel membership., UserPermissionOverride, _active_membership(), _audit() (+25 more)
...
Cohesion: 0.12
Nodes (26): acceptInvitation(), _allow_mfa_attempt(), _attach_user_session_cookies(), _audit_security_event(), AuthResponse, _build_auth_response(), complete_mfa_login(), confirm_mfa_enrollment() (+18 more)
...
Cohesion: 0.16
Nodes (18): 0534c64 feat(security): add unified tenant-scoped audit timeline read endpoint, _details_for_row(), list_audit_timeline(), _parse_redacted_json(), Read-only, tenant-scoped projection of the three hotel audit streams., Return a globally ordered, paginated projection of all audit sources.      The t, Remove credential-like values from otherwise useful text fields., _redact_text() (+10 more)

### Community 101 - "Community 101"
Cohesion: 0.10
Nodes (19): 0ff9102 fix(security): return CSRF token in the response body, 839c6a2 feat(security): add Google account unlink endpoint with reauthentication, AuthResponse, Config, GoogleAuthRequest, LoginRequest, MfaChallengeResponse, MfaCodeRequest (+11 more)
...
- **Thin community `Community 225`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 246`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 268`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 0` to `Community 15`, `Community 4`, `Community 2`, `Community 155`, `Community 68`, `Community 211`, `Community 8`, `Community 52`, `Community 38`, `Community 33`, `Community 39`, `Community 61`, `Community 94`, `Community 78`, `Community 102`, `Community 11`, `Community 29`, `Community 5`, `Community 105`, `Community 99`, `Community 169`, `Community 319`, `Community 31`, `Community 30`, `Community 45`, `Community 3`, `Community 103`, `Community 54`, `Community 126`, `Community 7`, `Community 12`, `Community 22`, `Community 60`, `Community 77`, `Community 109`, `Community 192`, `Community 80`, `Community 88`, `Community 32`, `Community 270`, `Community 83`, `Community 374`, `Community 87`, `Community 221`, `Community 222`, `Community 164`, `Community 50`, `Community 218`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 17`, `Community 45`, `Community 8`, `Community 4`, `Community 9`, `Community 37`, `Community 13`, `Community 5`, `Community 75`, `Community 15`, `Community 29`, `Community 94`, `Community 61`, `Community 11`, `Community 274`, `Community 12`, `Community 64`, `Community 54`, `Community 91`, `Community 95`, `Community 7`, `Community 275`, `Community 80`, `Community 78`, `Community 374`, `Community 87`, `Community 20`, `Community 256`, `Community 52`, `Community 164`, `Community 59`, `Community 117`, `Community 218`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 7` to `Community 4`, `Community 0`, `Community 5`, `Community 8`, `Community 15`, `Community 29`, `Community 39`, `Community 33`, `Community 94`, `Community 61`, `Community 105`, `Community 31`, `Community 160`, `Community 11`, `Community 12`, `Community 72`, `Community 139`, `Community 117`?**
