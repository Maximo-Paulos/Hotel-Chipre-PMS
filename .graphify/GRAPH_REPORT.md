...
2. `ReservationStatusEnum` - 655 edges
3. `HotelConfiguration` - 597 edges
4. `Room` - 506 edges
5. `Guest` - 480 edges
6. `RoomCategory` - 465 edges
7. `Base` - 386 edges
8. `RoomStatusEnum` - 317 edges
...
Cohesion: 0.03
Nodes (326): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+318 more)
...
Cohesion: 0.01
Nodes (160): requestVerification(), apiFetch(), buildAuthHeaders(), buildUrl(), formatErrorDetail(), handleUnauthorized(), hasValidSession(), isTokenExpired() (+152 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (192): PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, 62f0868 fix(payments): record WHO triggered a payment state change, not just when, BillingAdjustment, BillingAdjustmentTypeEnum, Payment (+184 more)
...
Cohesion: 0.08
Nodes (121): FastAPI routes for Payments., cancel_reservation(), extend_stay(), mark_no_show(), modify_reservation(), FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create, §5.2 — Run allocation engine in background after reservation changes.     Create (+113 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (109): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca (+101 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (106): UpdateRolePayload, BaseModel, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse, MasterAdminSessionResponse (+98 more)
...
Cohesion: 0.03
Nodes (62): createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge, PaymentSurchargeCreatePayload, PaymentSurchargeType, createRoomBlock() (+54 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (75): RoomBlockCreate, RoomBlockRead, RoomBlockCreate, RoomBlockRead, HotelConfiguration, Serialize policies dict to JSON string., Check if a specific payment method is enabled., Configuration table scoped by hotel (id == hotel_id). (+67 more)
...
Cohesion: 0.14
Nodes (69): ReservationAllocationLock, Company, Operational reservation models for adjustments, room moves and audit history., Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, ReservationAdjustment, ReservationAdjustmentKindEnum, ReservationAdjustmentStatusEnum, ReservationStatusHistory (+61 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (52): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+44 more)
...
Cohesion: 0.08
Nodes (35): SimpleRateLimiter, _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+27 more)
...
Cohesion: 0.14
Nodes (29): PaymentProof, PaymentProofBlob, PaymentProofStatusEnum, Manual bank-transfer evidence and approval lifecycle., Private image evidence awaiting explicit staff confirmation., Private image evidence awaiting explicit staff confirmation., Private binary payload kept separately from queryable proof metadata., Private binary payload kept separately from queryable proof metadata. (+21 more)
...
Cohesion: 0.06
Nodes (14): Tests for database models — validates schema creation, constraints, relationship, Verify auto-generated timestamps., Verify categories are created with correct attributes., Create a transaction and verify attributes., Verify Transaction → Reservation relationship., Verify default configuration values., Verify JSON serialization for extra_policies., Verify category string representation. (+6 more)
...
Cohesion: 0.13
Nodes (15): _frontend_placeholder(), Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin (+7 more)
...
- **Thin community `Community 125`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (2 nodes): `_make_reservation()`, `TestWaitlistResolveLogic`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 194`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 203`** (1 nodes): `Public WhatsApp bot hooks authenticated only by hotel API key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 310`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 5` to `Community 238`, `Community 12`, `Community 2`, `Community 220`, `Community 118`, `Community 260`, `Community 279`, `Community 7`, `Community 28`, `Community 109`, `Community 35`, `Community 16`, `Community 18`, `Community 8`, `Community 15`, `Community 97`, `Community 10`, `Community 133`, `Community 0`, `Community 25`, `Community 14`, `Community 4`, `Community 54`, `Community 31`, `Community 110`, `Community 3`, `Community 39`, `Community 32`, `Community 52`, `Community 327`, `Community 56`, `Community 57`, `Community 241`, `Community 63`, `Community 211`, `Community 79`, `Community 192`, `Community 193`, `Community 116`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 14` to `Community 2`, `Community 54`, `Community 7`, `Community 17`, `Community 30`, `Community 9`, `Community 34`, `Community 4`, `Community 5`, `Community 28`, `Community 0`, `Community 320`, `Community 56`, `Community 18`, `Community 245`, `Community 81`, `Community 39`, `Community 58`, `Community 31`, `Community 3`, `Community 10`, `Community 16`, `Community 57`, `Community 8`, `Community 79`, `Community 59`, `Community 172`, `Community 32`, `Community 144`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 5`, `Community 34`, `Community 7`, `Community 4`, `Community 28`, `Community 16`, `Community 148`, `Community 35`, `Community 56`, `Community 18`, `Community 15`, `Community 264`, `Community 14`, `Community 39`, `Community 58`, `Community 3`, `Community 52`, `Community 206`, `Community 8`, `Community 107`, `Community 59`, `Community 172`, `Community 144`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Are the 649 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 649 INFERRED edges - model-reasoned connections that need verification._
- **Are the 653 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 653 INFERRED edges - model-reasoned connections that need verification._
- **Are the 590 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 590 INFERRED edges - model-reasoned connections that need verification._
- **Are the 501 inferred relationships involving `Room` (e.g. with `RoomBlockCreate` and `RoomBlockRead`) actually correct?**
  _`Room` has 501 INFERRED edges - model-reasoned connections that need verification._