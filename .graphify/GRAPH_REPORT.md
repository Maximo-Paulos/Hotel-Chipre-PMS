...
## Corpus Check
- Large corpus: 704 files · ~464,291 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6171 nodes · 19157 edges · 281 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 6360 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 6360 · contains: 4059 · calls: 3099 · MODIFIES: 1494 · ON_BRANCH: 819 · rationale_for: 776 · imports: 697 · imports_from: 555 · method: 553 · inherits: 516 · PARENT_OF: 229
...
Cohesion: 0.01
Nodes (71): add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c, add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2, add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em, reservation financial lifecycle  Revision ID: 20260410_reservation_financial_lif, ai assistant sessions  Revision ID: 20260411_ai_assistant_sessions Revises: 2026, ai assistant insights  Revision ID: 20260412_ai_assistant_insights Revises: 2026, v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_, ota hardening: hotel-scoped mappings and webhook credentials  Revision ID: a7f3d (+63 more)
...
Cohesion: 0.05
Nodes (29): extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard, add trial and comped fields to subscriptions  Revision ID: 20260419_subscription, _remaining_trial_days(), _serialize_status_payload(), subscription_status(), change_plan(), start_subscription_trial(), admin_comped_override() (+21 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (21): master admin panel  Revision ID: 20260421_master_admin_panel Revises: 9c0d2f3e1a, master admin system owner mail and stripe settings  Revision ID: 20260421_master, sync_model_drift_missing_columns  Revision ID: 3eaf48a79290 Revises: 20260419_on, guest legal profile  Revision ID: 9c0d2f3e1a44 Revises: 3eaf48a79290 Create Date, HotelConfiguration — per-hotel business rules. No global/singleton: one row per, AnalyticsComparisonWindowRead, AnalyticsComparisonStateRead, AnalyticsMetricCardRead (+13 more)
...
Cohesion: 0.03
Nodes (53): repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi, email_status(), FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., _serialize_reallocation_result(), _attach_current_rate(), list_categories(), get_category() (+45 more)
...
Cohesion: 0.04
Nodes (65): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AcceptPayload, LoginRequest, _assert_assignable_role(), _assert_manageable_membership(), _membership_user_info(), list_users(), InvitePayload (+57 more)
...
Cohesion: 0.04
Nodes (87): _generate_code(), _mask_email(), _pick_default_hotel_id(), _build_auth_response(), _issue_email_token(), register(), request_verify(), login() (+79 more)
...
Cohesion: 0.03
Nodes (103): BaseModel, MasterAdminLoginRequest, MasterAdminUserPayload, MasterAdminLoginResponse, MasterAdminSessionResponse, BillingPolicyUpdateRequest, BillingPolicyPayload, EmailTestRequest (+95 more)
...
Cohesion: 0.05
Nodes (172): FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Ensure computed fields land in the response., Lightweight availability placeholder. When all parameters are provided,     it r, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., CheckInRequest, FastAPI routes for Check-in / Check-out., RoomStatusUpdate (+164 more)
...
Cohesion: 0.02
Nodes (86): _require_demo_mode(), seed_demo(), reset_demo(), Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, Base (+78 more)
...
Cohesion: 0.42
Nodes (9): FastAPI routes for Guest management., Add new companions to an existing guest., GuestRatingEnum, GuestTagCreate, GuestTagRead, GuestRatingUpdate, GuestStaySummary, GuestQuickProfileRead (+1 more)
...
Cohesion: 0.03
Nodes (27): get_engine(), _render_server_default(), _column_fill_value(), _backfill_not_null_nulls(), _sync_missing_columns(), init_db(), get_session_factory(), get_db() (+19 more)
...
Cohesion: 0.05
Nodes (120): Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., CashSessionStatusEnum, CashMovementTypeEnum, CashSession (+112 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (74): FastAPI routes for Payments., _is_manager_context(), _trigger_reoptimization_bg(), list_reservations(), get_reservation(), add_reservation_guests(), change_dates(), AllocationRunPayload (+66 more)
...
Cohesion: 0.20
Nodes (36): _to_read(), _project_reservation_graph(), create_new_reservation(), create_or_update_manual_ota(), register_settlement(), cancel_reservation(), release_no_guarantee_reservation(), mark_no_show() (+28 more)
...
Cohesion: 0.12
Nodes (25): Settings, BaseSettings, get_settings(), _normalized_env_value(), _has_value(), _is_public_https_url(), _mercadopago_is_active(), _paypal_is_active() (+17 more)
...
Cohesion: 0.05
Nodes (183): mockCategories, mockCalendar, mockDailyRates, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista, 0a4396e Add multi-hotel isolation tests and bcrypt shim, 0b14a55 Subscription status: seed starter and add safe fallback (+175 more)
...
Cohesion: 0.22
Nodes (8): seed(), main(), Seed minimal demo data for local testing.  Usage:     python -m app.scripts.seed, 1ac0c3c Add StatCard component and fix reservations dashboard error, 1af6bfc Add demo seed script and README instructions for stage 1, 26970dd Add token store cleanup helper, de996f5 Loosen auth email validation to allow test domains, e470215 Frontend: hotel selector and settings per hotel, remove legacy seed dependency
...
Cohesion: 0.09
Nodes (24): AnalyticsAIProviderConfig, AnalyticsAIProviderStatus, AnalyticsAIRequest, AnalyticsAIResult, AnalyticsAIProviderError, DisabledAnalyticsAIProvider, _OpenAICompatibleProvider, GemmaProvider (+16 more)
...
Cohesion: 0.29
Nodes (12): _money(), _require_open_session(), open_session(), add_movement(), get_open_session(), record_cash_payment_movement(), _movement_sign(), _confirmed_cash_movements_total() (+4 more)
...
Cohesion: 0.11
Nodes (13): frontendDir, repoRoot, localPython, e2eDbPath, graphify_state(), main(), run(), validate_json() (+5 more)
...
Cohesion: 0.06
Nodes (26): navItems, MasterAdminRoot(), MasterAdminProtectedShell(), MasterAdminAuditPage(), MasterAdminDashboardPage(), MasterAdminLoginPage(), MasterAdminSessionProvider(), APP_HOST (+18 more)
...
Cohesion: 0.14
Nodes (19): RoomBlockReasonCode, RoomBlock, RoomBlockCreatePayload, listActiveRoomBlocks(), createRoomBlock(), resolveRoomBlock(), roomBlocksKey(), roomBlockReasonLabel (+11 more)
...
Cohesion: 0.42
Nodes (10): ReleaseEvidenceError, git(), resolve_commit(), changed_paths(), is_release_relevant_path(), validate_explicit_summary_path(), select_summary(), main() (+2 more)
...
Cohesion: 0.11
Nodes (39): ProvisionError, _canonical_json(), _decode_token_payload(), _object(), _string(), _canonical_hostname(), _https_origin(), _github_repository() (+31 more)

### Community 83 - "Community 83"
Cohesion: 0.11
Nodes (18): BootstrapConfigurationError, bootstrap_configuration_fingerprint(), Shared, secret-safe binding for the Render QA bootstrap configuration., Hash the exact provider-observed values without exposing them individually., JsonGetter, Safe failure whose message never contains provider response bodies., Require an exclusive provider-observed lease for the shared free QA DB.      Thi, Require a provider-observed, fail-closed QA integration posture.      The dedica (+10 more)
...
Cohesion: 0.16
Nodes (37): VerificationError, VerificationConfig, ProviderClients, _dict(), _list(), _string(), _validate_config(), _decode_lease_entropy() (+29 more)

### Community 155 - "Community 155"
Cohesion: 0.20
Nodes (6): ReadOnlyJsonApi, Small GET-only API client with bounded retries and redacted failures., FakeApi, test_http_failures_do_not_disclose_token_or_response_body(), Small GET-only API client with bounded retries and redacted failures., Small GET-only API client with bounded retries and redacted failures.
...
Cohesion: 0.26
Nodes (8): _register_owner(), _auth_headers(), _complete_onboarding(), _configure_resend(), test_register_verify_and_reset_use_resend_provider(), test_auth_flows_fail_without_connected_mail_provider(), test_unverified_users_cannot_use_operational_endpoints(), test_login_prefers_a_completed_hotel_when_multiple_memberships_exist()
...
Cohesion: 0.15
Nodes (3): TestGuestValidation, TestCheckIn, TestCheckOut
...
Cohesion: 0.14
Nodes (21): wrapper(), env_page(), fixtures(), set_render_preview_env(), configure_dedicated_baseline(), test_happy_path_is_provider_bound_and_never_reads_production_secret_values(), test_preview_rejects_external_effects_enabled(), test_preview_rejects_live_integration_credentials() (+13 more)
...
Cohesion: 0.26
Nodes (16): iso(), write_bundle(), rewrite_summary(), rewrite_manifest(), errors_for(), test_complete_bundle_is_bound_to_manifest_and_provider_identity(), test_short_code_sha_is_rejected(), test_manifest_byte_hash_is_required() (+8 more)
...
Cohesion: 0.20
Nodes (6): test_validate_runtime_security_rejects_missing_mp_webhook_when_mp_configured(), test_validate_runtime_security_ignores_incomplete_optional_integrations(), test_validate_runtime_security_rejects_localhost_redirect_when_service_configured(), MERCADOPAGO_WEBHOOK_SECRET is required only when MP_ACCESS_TOKEN is set., Partial integration env vars should not block production startup., OAuth redirect URIs are only validated when the corresponding service credential
...
- **Thin community `Community 284`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 207`** (2 nodes): `_mercadopago_webhook_impl()`, `mercadopago_payment_link_webhook()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 289`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 236`** (2 nodes): `SubscriptionEnforcementMiddleware`, `Middleware to block mutating requests when subscription enforcement is enabled.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 238`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (2 nodes): `OTAProviderAdapter`, `ExpediaAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 248`** (1 nodes): `TestStateTransitions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 191`** (2 nodes): `TestReoptimizationTrigger`, `TestReoptimizationIntegration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 8` to `Community 222`, `Community 11`, `Community 1`, `Community 22`, `Community 104`, `Community 27`, `Community 31`, `Community 19`, `Community 5`, `Community 3`, `Community 86`, `Community 80`, `Community 132`, `Community 0`, `Community 4`, `Community 156`, `Community 23`, `Community 77`, `Community 14`, `Community 12`, `Community 24`, `Community 105`, `Community 13`, `Community 45`, `Community 26`, `Community 106`, `Community 34`, `Community 6`, `Community 49`, `Community 163`, `Community 70`, `Community 183`, `Community 184`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 4` to `Community 9`, `Community 12`, `Community 39`, `Community 13`, `Community 154`, `Community 14`, `Community 8`, `Community 22`, `Community 3`, `Community 285`, `Community 19`, `Community 0`, `Community 226`, `Community 72`, `Community 45`, `Community 50`, `Community 24`, `Community 5`, `Community 49`, `Community 163`, `Community 70`, `Community 165`, `Community 26`, `Community 143`, `Community 76`, `Community 191`, `Community 118`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `PostgresTargetSafetyError` connect `Community 4` to `Community 0`, `Community 114`?**
