...
## Corpus Check
- Large corpus: 1038 files · ~1,650,514 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10195 nodes · 48970 edges · 368 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 16372 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16372 · ON_BRANCH: 12881 · contains: 5973 · calls: 4402 · MODIFIES: 3356 · rationale_for: 2102 · imports: 1078 · imports_from: 838 · PARENT_OF: 691 · inherits: 658 · method: 616 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 1038 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 12 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `0f570db`
...
Cohesion: 0.01
Nodes (188): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _authorize_override(), checkin(), _require_demo_mode() (+180 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (369): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, email_status(), Lightweight status so the frontend can check the active system email provider., Lightweight status so the frontend can check the active system email provider. (+361 more)

### Community 2 - "Community 2"
Cohesion: 0.15
Nodes (348): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+340 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (150): _archive_historical(), _build_cases(), main(), _write_json(), requestVerification(), ApiError, ActiveRoomBlockItem, AvailableWithReviewItem (+142 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (253): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true). (+245 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (253): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+245 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (200): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+192 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (240): PaymentSurchargeCreate, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+232 more)
...
Cohesion: 0.04
Nodes (231): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser() (+223 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (182): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+174 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (181): RoomBlockCreate, RoomBlockRead, 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement (+173 more)
...
Cohesion: 0.02
Nodes (138): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+130 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (103): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+95 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (100): PermissionGate(), StatCard(), StatCardProps, toneClasses, clearMasterAdminCsrfToken(), masterAdminFetch(), MasterAdminLoginResponse, MasterAdminUser (+92 more)
...
Cohesion: 0.03
Nodes (38): CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload, OnboardingProviderSetup, OnboardingStatus, OTAChannelsPayload (+30 more)

### Community 19 - "Community 19"
Cohesion: 0.10
Nodes (78): HotelPermissionOverride, Permission, An employee-specific permission decision within one hotel membership., RolePermissionDefault, UserPermissionOverride, SecurityAuditLog, ensure_permission_matrix_seeded(), get_matrix() (+70 more)
...
Cohesion: 0.06
Nodes (55): acceptInvitation(), _allow_mfa_attempt(), _attach_user_session_cookies(), _audit_security_event(), AuthResponse, _build_auth_response(), complete_mfa_login(), confirm_mfa_enrollment() (+47 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (65): AcceptPayload, Thin FastAPI transport for the tenant-scoped permission service., Ask for one exceptional permission without changing the requester's role., 0f570db feat(security): add core temporary one-time action authorization (TECH-0041), Strict authentication/context helpers.  Every operational request must resolve t, Dependency factory that enforces a permission via the configurable hotel     per, Dependency factory that enforces a permission via the configurable hotel     per, Dependency factory that enforces a permission via the configurable hotel     per (+57 more)
...
Cohesion: 0.05
Nodes (44): Base, FxPolicy, ProductRoomCompatibility, RatePlan, RatePlanPrice, Commercial domain models for the next reservation/OTA foundation.  These tables, SellableProduct, TaxPolicy (+36 more)
...
Cohesion: 0.08
Nodes (31): 837ce01 fix(security): redact sensitive metadata in master admin audit events, f6f2c8c fix(security): redact sensitive metadata in master admin audit events, dashboard_summary(), login(), me(), _serialize_user(), _as_aware(), audit_master_action() (+23 more)
...
Cohesion: 0.10
Nodes (38): MovementEventRead, MovementGroupRead, Exception, ReservationAllocationLock, Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, RoomMovementGroup, _adjacency_bonus_for_room(), AllocationError (+30 more)
...
Cohesion: 0.10
Nodes (41): _build_login_response(), google_login(), list_sessions(), logout(), _pick_default_hotel_id(), Auth endpoints: register, login, email verification and password reset. Verifica, Project a global identity event into every hotel the user actively belongs to., Set the session cookies and return the raw CSRF token.      The caller must put (+33 more)

### Community 46 - "Community 46"
Cohesion: 0.08
Nodes (36): approve_temporary_action_grant(), consume_temporary_action_grant(), create_temporary_action_grant(), deny_temporary_action_grant(), EffectivePermissionsResponse, fetchEffectivePermissions(), fetchPermissionMatrix(), PermissionCell (+28 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (33): 249a761 fix(security): add missing tenant RLS policy to hotel_api_keys, guest_alerts, reservation_movement_groups, ed0d0eb fix(review): chain RLS migration after audit-log-cascade fix, _load_composite_fk_migration(), _load_extended_composite_fk_migration(), _load_master_admin_bypass_migration(), _load_rls_migration(), _load_user_override_migration(), Return model relationships not covered by the core composite contract. (+25 more)
...
Cohesion: 0.10
Nodes (35): MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection, MasterAdminContext (+27 more)
...
Cohesion: 0.12
Nodes (23): _auth_headers(), _complete_onboarding(), _configure_resend(), _enroll_and_confirm_mfa(), _fake_google_claims(), _next_totp_code(), _register_owner(), test_auth_flows_fail_without_connected_mail_provider() (+15 more)
...
Cohesion: 0.07
Nodes (28): 839c6a2 feat(security): add Google account unlink endpoint with reauthentication, 88990ce feat(security): add Google account unlink endpoint with reauthentication, 9d6c97d fix(security): return CSRF token in the response body (#49), e1b2efe feat(security): add unified tenant-scoped audit timeline read endpoint, fbd432b fix(data-model): allow HotelAuditEvent to represent system/automated actors (#50), AuthResponse, Config, GoogleAuthRequest (+20 more)
...
Cohesion: 0.10
Nodes (17): SimpleRateLimiter, Staff management endpoints for hotel public API keys., Public API-key authentication, separate from staff JWT auth., Authorize a public key for a specific external product surface.      Purpose val, require_public_api_purpose(), _generate_secret(), _hash_secret(), HotelAPIKeyError (+9 more)
...
Cohesion: 0.15
Nodes (22): 3dee498 fix(review): chain permission-metadata migration after latest head, 5871da8 feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog (#51), 77fa337 feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, Configurable permission matrix models., _auth(), _client(), test_only_owner_can_use_administration_catalog_and_co_owner_is_denied(), test_owner_can_grant_and_revoke_user_override_then_restore_defaults() (+14 more)
...
Cohesion: 0.18
Nodes (21): _active_membership(), _audit(), audit_permission_denied(), can_role_hold_permission(), canonical_permission_code(), _engine_key(), get_effective_permission_details(), get_effective_permissions() (+13 more)
...
Cohesion: 0.24
Nodes (10): _current_user(), Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., Keep useful internal references while never exposing free-form details., recent_security_events(), revoke_current_user_sessions() (+2 more)
...
Cohesion: 0.27
Nodes (5): 6d2a815 feat(security): migrate password hashing to Argon2id with transparent bcrypt upgrade, _headers(), test_manager_cannot_read_security_settings(), test_revoke_all_invalidates_the_callers_previous_token(), test_security_overview_and_events_are_redacted_and_tenant_scoped()
...
Cohesion: 0.22
Nodes (9): .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by, .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by, .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by, .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by, JWTs are stateless with no server-side blacklist, so a password reset -     the, JWTs are stateless with no server-side blacklist, so a password reset -     the, JWTs are stateless with no server-side blacklist, so a password reset -     the, test_register_rejects_reserved_test_tld_outside_test_mode() (+1 more)
...
Cohesion: 0.50
Nodes (4): RegisterRequest.email was a plain str with no format validation, so     garbage, RegisterRequest.email was a plain str with no format validation, so     garbage, RegisterRequest.email was a plain str with no format validation, so     garbage, test_register_rejects_malformed_email()

### Community 325 - "Community 325"
Cohesion: 0.50
Nodes (4): The isolated Playwright E2E backend boots with APP_ENV=test and its     specs re, The isolated Playwright E2E backend boots with APP_ENV=test and its     specs re, The isolated Playwright E2E backend boots with APP_ENV=test and its     specs re, test_register_accepts_reserved_test_tld_in_test_mode()

### Community 326 - "Community 326"
Cohesion: 0.50
Nodes (4): A guest self-registering must never end up with User.role="platform_admin"     j, A guest self-registering must never end up with User.role="platform_admin"     j, A guest self-registering must never end up with User.role="platform_admin"     j, test_self_registration_cannot_grant_platform_admin_role()
...
## Knowledge Gaps
- **829 isolated node(s):** `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`, `add temporary action grants  Revision ID: 0f85dca5b98b Revises: 20260820_user_se`, `Install the PostgreSQL tenant policy; no-op on other dialects.`, `Remove the PostgreSQL tenant policy before dropping the table.`, `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho` (+824 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 124`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 223`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 245`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 269`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `Mailer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 362`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 363`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 364`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 365`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 367`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 369`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 370`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 371`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 372`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 373`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 374`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 376`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 377`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 378`** (1 nodes): `FakeResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 380`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 1` to `Community 0`, `Community 4`, `Community 151`, `Community 66`, `Community 211`, `Community 8`, `Community 53`, `Community 38`, `Community 35`, `Community 39`, `Community 59`, `Community 97`, `Community 78`, `Community 101`, `Community 11`, `Community 30`, `Community 5`, `Community 104`, `Community 100`, `Community 166`, `Community 320`, `Community 32`, `Community 31`, `Community 24`, `Community 3`, `Community 102`, `Community 55`, `Community 124`, `Community 18`, `Community 7`, `Community 14`, `Community 19`, `Community 77`, `Community 76`, `Community 108`, `Community 192`, `Community 80`, `Community 88`, `Community 23`, `Community 33`, `Community 271`, `Community 83`, `Community 378`, `Community 87`, `Community 220`, `Community 221`, `Community 47`, `Community 217`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 1` to `Community 16`, `Community 24`, `Community 8`, `Community 4`, `Community 9`, `Community 45`, `Community 13`, `Community 5`, `Community 74`, `Community 0`, `Community 30`, `Community 97`, `Community 59`, `Community 11`, `Community 275`, `Community 14`, `Community 64`, `Community 55`, `Community 91`, `Community 94`, `Community 7`, `Community 276`, `Community 80`, `Community 78`, `Community 378`, `Community 87`, `Community 21`, `Community 257`, `Community 53`, `Community 19`, `Community 61`, `Community 116`, `Community 217`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 7` to `Community 4`, `Community 1`, `Community 5`, `Community 8`, `Community 0`, `Community 30`, `Community 39`, `Community 35`, `Community 97`, `Community 59`, `Community 104`, `Community 32`, `Community 156`, `Community 11`, `Community 14`, `Community 71`, `Community 136`, `Community 116`?**
