...
## Corpus Check
- Large corpus: 1043 files · ~1,655,730 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10374 nodes · 52356 edges · 459 communities detected
- Extraction: 68% EXTRACTED · 32% INFERRED · 0% AMBIGUOUS · INFERRED: 16669 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16669 · ON_BRANCH: 15536 · contains: 6042 · calls: 4472 · MODIFIES: 3533 · rationale_for: 2176 · imports: 1091 · imports_from: 843 · PARENT_OF: 711 · inherits: 663 · method: 617 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 1043 · Candidates: recursive
...
1. `Reservation` - 952 edges
2. `ReservationStatusEnum` - 948 edges
3. `HotelConfiguration` - 924 edges
4. `Room` - 778 edges
5. `Guest` - 734 edges
6. `RoomCategory` - 712 edges
7. `Base` - 545 edges
8. `RoomStatusEnum` - 482 edges
9. `ReservationError` - 438 edges
10. `ReservationSourceEnum` - 376 edges
...
Cohesion: 0.02
Nodes (419): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest. (+411 more)

### Community 1 - "Community 1"
Cohesion: 0.18
Nodes (358): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+350 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (260): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+252 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (251): PaymentSurchargeCreate, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+243 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (212): CheckInRequest, FastAPI routes for Check-in / Check-out., cancel_reservation(), change_dates(), create_reservation_charge(), _ensure_action_permission(), extend_stay(), _is_manager_context() (+204 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (164): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, RoomBlockCreate, RoomBlockRead, Base, Base class for all ORM models. (+156 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (163): 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, AnalyticsExportJob, AnalyticsExportStatusEnum, FactReservationDaily, CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum (+155 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (152): _attach_current_rate(), delete_room(), housekeeping_summary(), FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Materialize the safe projection before FastAPI can inspect the ORM. (+144 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (105): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+97 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (124): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+116 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (108): HotelPermissionOverride, Permission, Configurable permission matrix models., An employee-specific permission decision within one hotel membership., An employee-specific permission decision within one hotel membership., RolePermissionDefault, UserPermissionOverride, SecurityAuditLog (+100 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (79): _allow_mfa_attempt(), _attach_user_session_cookies(), _audit_security_event(), _build_auth_response(), _build_login_response(), complete_mfa_login(), confirm_mfa_enrollment(), disable_mfa() (+71 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (65): createLaundryRemito(), createLaundryVendor(), getLaundryVendorBalance(), getLaundryVendorSettlements(), getLaundryVendorSpend(), LaundryRemito, LaundryRemitoCreate, LaundryRemitoCreateResponse (+57 more)
...
Cohesion: 0.05
Nodes (55): 300d128 feat(security): audit-log MFA, login, and Google account-linking events, 9f4f9ac feat(security): audit-log MFA, login, and Google account-linking events, _auth_headers(), _complete_onboarding(), _configure_resend(), _enroll_and_confirm_mfa(), _fake_google_claims(), FakeResponse (+47 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (61): validateGuestForCheckin(), add_reservation_guests(), addReservationCharge(), addReservationGuests(), buildQueryString(), cancelReservation(), CheckInPayload, checkInReservation() (+53 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (18): 8d88259 Merge pull request #29 from Maximo-Paulos/codex/fix/full-functional-qa, f1644f3 feat(security): fail-closed external effects, RBAC narrowing, QA catalog v2, PermissionGateProps, owner, manager, credentials, owner, receptionist (+10 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (60): PermissionGate(), SettingsAssistantPage(), SettingsUsersPage(), LoginPage(), MarketingHomePage(), PmsHoteleroPage(), PricingPage(), RegisterOwnerPage() (+52 more)

### Community 18 - "Community 18"
Cohesion: 0.08
Nodes (64): AcceptPayload, Thin FastAPI transport for the tenant-scoped permission service., Ask for one exceptional permission without changing the requester's role., Invalidate every access token previously issued to the caller., Invalidate every access token previously issued to the caller., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., Keep useful internal references while never exposing free-form details. (+56 more)
...
Cohesion: 0.05
Nodes (29): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, Database engine and session management. Supports both PostgreSQL (production) an, Reapply RLS tenant context lost when a commit ends the transaction.      ``app.s, _reapply_tenant_context() (+21 more)
...
Cohesion: 0.11
Nodes (56): codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, 116a3bc chore: snapshot analysis artifacts, 127cb22 fix(frontend): make reservation/guest modals scrollable so footer buttons stay reachable, 15fca54 Merge pull request #22 from Maximo-Paulos/chore/claude-code-pro-setup, 1861352 feat(R5b): production payments — MP preference §12.2, link delivery, company deferred §3.5, 1da134a feat(R2a): expand audit coverage to business mutations (§26), 1efb927 Update orchestrator status: multi-agent audit blocked by plan session limits (+48 more)
...
Cohesion: 0.07
Nodes (40): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, 165d047 fix(security): reduce rate limiter race window under concurrent requests, 362fdd4 feat(security): add core TOTP/MFA enrollment, verification, and recovery codes, get_encryption_fernet(), Shared Fernet encryption for secrets stored in the database.  The integration en, Return the repository's existing Fernet instance for stored secrets., _account_label_from_payload(), connection_account_label() (+32 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (42): Base, FxPolicy, ProductRoomCompatibility, RatePlan, RatePlanPrice, Commercial domain models for the next reservation/OTA foundation.  These tables, SellableProduct, TaxPolicy (+34 more)
...
Cohesion: 0.09
Nodes (35): acceptInvitation(), AuthResponse, _burn_auth_timing_work(), _generate_code(), getInvitationInfo(), _issue_email_token(), loginWithGoogle(), _mask_email() (+27 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (34): ad4249c Implement master admin panel, Email provider abstraction for platform transactional mail., clearMasterAdminCsrfToken(), masterAdminFetch(), MasterAdminLoginResponse, MasterAdminUser, MasterBillingPolicy, MasterDashboardSummary (+26 more)
...
Cohesion: 0.08
Nodes (26): main(), valid_https(), Shared, secret-safe binding for the Render QA bootstrap configuration., 19b8b7b Harden isolated preview QA and trusted release evidence, 3635693 Bootstrap trusted isolated cloud QA gate, 365b263 Harden isolated QA bootstrap and provider evidence, b5d6e0f Merge pull request #26 from Maximo-Paulos/codex/feature/trusted-qa-bootstrap, b94ce7b Bind final QA evidence to probed provider state (+18 more)
...
Cohesion: 0.06
Nodes (14): _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., bad20c6 Gate startup email behind SMTP_STARTUP_NOTIFY and send once, e34785c prueba, ec54376 Add env example and GHCR build/push workflow, POST /api/checkin/checkout only enforced authentication (get_auth_context),, test_housekeeping_cannot_checkout_reservation(), _override_auth() (+6 more)
...
Cohesion: 0.07
Nodes (29): setAuthResponseHandler(), setUnauthorizedHandler(), 4048d3b Fix mobile overflow for long hotel names, ReservationGlobalSearch(), isAppHostname(), queryClient, EMPTY_SESSION, initialSession() (+21 more)
...
Cohesion: 0.07
Nodes (29): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), markReservationNoShow() (+21 more)
...
Cohesion: 0.11
Nodes (35): MasterAdminAuditEvent, MasterStripeWebhookEvent, Subscription, _configure_resend(), FakeResponse, If MASTER_ADMIN_EMAIL happens to collide with a real tenant's login     email (a, If MASTER_ADMIN_EMAIL happens to collide with a real tenant's login     email (a, If MASTER_ADMIN_EMAIL happens to collide with a real tenant's login     email (a (+27 more)
...
Cohesion: 0.20
Nodes (26): AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, FactRoomOccupancyDaily, RoomStateEvent, RoomStateEventReasonCodeEnum, RoomStateEventTypeEnum, AnalyticsAIConfigRead (+18 more)
...
Cohesion: 0.06
Nodes (8): dc4b68a ojooooo, Persistent rate-limit events for security-sensitive endpoints., Subscription models: plans and per-hotel subscription status., Lightweight subscription tracking for enforcement and auditing (v2 tables)., InvitationToken, build_gemma_hotel_context(), _enum_value(), baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7
...
Cohesion: 0.07
Nodes (31): bootstrap_configuration_fingerprint(), BootstrapConfigurationError, Hash the exact provider-observed values without exposing them individually., Hash the exact provider-observed values without exposing them individually., Hash the exact provider-observed values without exposing them individually., Hash the exact provider-observed values without exposing them individually., _decode_lease_entropy(), JsonGetter (+23 more)
...
Cohesion: 0.09
Nodes (25): Category, listCategories(), Guest, GuestPayload, Reservation, emptyQuickGuestForm(), guestFullName(), GuestQuickCreatePanelProps (+17 more)
...
Cohesion: 0.12
Nodes (30): chore/weekly-orchestrator-2026-07-03, 1a71e7d feat: add ota allocation data foundation, 1ac0c3c Add StatCard component and fix reservations dashboard error, 1e02ce9 docs(phase1): consolidation baseline green + plan/audit artifacts, 1f19859 test(e2e): GREEN 12/12 authenticated V72 pages with screenshots, 1f352e4 feat(reports): SLICE-11 operational reports + alerts, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 26970dd Add token store cleanup helper (+22 more)

### Community 73 - "Community 73"
Cohesion: 0.13
Nodes (24): 3dee498 fix(review): chain permission-metadata migration after latest head, 77fa337 feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, 955325e feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, _auth(), _client(), test_only_owner_can_use_administration_catalog_and_co_owner_is_denied(), test_owner_can_grant_and_revoke_user_override_then_restore_defaults(), test_user_override_rejects_self_elevation_and_cross_hotel_id_without_disclosure() (+16 more)

### Community 74 - "Community 74"
Cohesion: 0.12
Nodes (26): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, inviteUser(), list_users(), listUsers() (+18 more)

### Community 75 - "Community 75"
Cohesion: 0.12
Nodes (31): claude/feature/pms-roles-housekeeping-qa, 0b2de37 Refresh Graphify for current tenant hardening, 14c3453 Fail closed when managed databases are not migrated, 15f1429 Refresh Graphify and generated system inventories, 2523c66 Refresh QA evidence after cash journey, 2c8cad0 Record audited QA setup commit in vault, 2e45309 Refresh QA evidence after reservation charge journey, 34ae6e9 Install dependencies before release evidence checks (+23 more)

### Community 76 - "Community 76"
Cohesion: 0.13
Nodes (30): codex/feature/trusted-qa-bootstrap, 0c9034f Fix clsx reference in app shell, 107f875 Support legacy master admin underscore routes, 1d1874d Add owner-only visibility panel for hotel config, 1fd0691 Add display permission fields to hotel config with tests, 2ba0905 Cache timezone catalog and remove repeated lookups, 2dc2d84 Trigger Render redeploy for rate-calendar endpoint, 343c4f1 Fix Vercel frontend deploy config for Analytics R1.0 (+22 more)

### Community 77 - "Community 77"
Cohesion: 0.15
Nodes (29): _as_aware(), audit_master_action(), authenticate_master_login(), _authorize_user_for_master_panel(), _bootstrap_master_credentials_match(), create_master_session(), _hash_value(), _idle_expiry() (+21 more)
...
Cohesion: 0.09
Nodes (24): _load_composite_fk_migration(), _load_extended_composite_fk_migration(), _load_master_admin_bypass_migration(), _load_rls_migration(), _load_user_override_migration(), Return model relationships not covered by the core composite contract., C2: app/master_admin/router.py queries Subscription directly, and     transitive, Compile the additive RLS helpers through Alembic's PostgreSQL recorder.      Thi (+16 more)

### Community 81 - "Community 81"
Cohesion: 0.11
Nodes (26): approve_temporary_action_grant(), consume_temporary_action_grant(), create_temporary_action_grant(), deny_temporary_action_grant(), EffectivePermissionsResponse, fetchEffectivePermissions(), PermissionCell, PermissionMatrix (+18 more)
...
Cohesion: 0.16
Nodes (22): _apply_drift(), env_page(), FakeRender, FakeRenderCleanupFailure, FakeRenderPutResponseLost, HealthResponse, manifest(), _mutating_calls() (+14 more)
...
Cohesion: 0.09
Nodes (10): 7e2edb6 Merge Analytics R1.0, df173d1 Implement Analytics R1.0 dashboard, chat IA, and support, HotelConfiguration — per-hotel business rules. No global/singleton: one row per, AnalyticsAIChatRead, AnalyticsInsightRead, AnalyticsInsightStatusRead, master admin panel  Revision ID: 20260421_master_admin_panel Revises: 9c0d2f3e1a, master admin system owner mail and stripe settings  Revision ID: 20260421_master (+2 more)
...
Cohesion: 0.17
Nodes (26): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true). (+18 more)

### Community 90 - "Community 90"
Cohesion: 0.15
Nodes (22): ApiError, apiFetch(), buildAuthHeaders(), buildUrl(), formatErrorDetail(), handleUnauthorized(), hasValidSession(), isPublicAuthPath() (+14 more)
...
Cohesion: 0.11
Nodes (20): ReservationStatus, ConfirmDialogProps, GuestRestrictionBadge(), Props, CheckinCaptureForm, emptyCaptureForm, guestFullName(), paymentMethodOptions (+12 more)

### Community 93 - "Community 93"
Cohesion: 0.14
Nodes (27): codex/fix-render-postgres-enum-values, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista, 0de2c27 Align deploy config and docs for Vercel, Render, and Cloudflare, 1ca1c06 Fix PostgreSQL enum schema drift, 27d2207 Add frontend/vercel.json for Root Directory = frontend deploy, 28e3e55 feat(onboarding): dropdown de categorías y staff opcional con invitación, 2953402 fix(nav): commas and gating for config items, 30df826 Fix Vercel SPA routing for frontend root directory (+19 more)
...
Cohesion: 0.15
Nodes (23): _authorize_oauth_state_actor(), connect_integration(), connectIntegration(), _connection_error_message(), _ensure_enabled(), fetchIntegrations(), finalizeIntegrationOAuth(), _find_integration() (+15 more)

### Community 98 - "Community 98"
Cohesion: 0.14
Nodes (16): cancelPaymentLinkTest(), createMercadoPagoPaymentLinkTest(), listPaymentLinkTests(), PaymentLinkTest, PaymentLinkTestCreatePayload, refreshPaymentLinkTest(), 50ad65d feat: harden gmail onboarding and multi-tenant email flow, 7a43bdd feat: add billing, integrations, and Mercado Pago test flows (+8 more)

### Community 99 - "Community 99"
Cohesion: 0.10
Nodes (16): getSecurityEvents(), getSecurityOverview(), listUserSessions(), revokeAllSessions(), RevokeAllSessionsResponse, revokeUserSession(), SecurityEvent, SecurityEventsResponse (+8 more)

### Community 100 - "Community 100"
Cohesion: 0.14
Nodes (26): main, 01498d0 Harden password reset flow (verified-only, dev code return), 0a4396e Add multi-hotel isolation tests and bcrypt shim, 0f3e9a4 fix(auth): graceful token-expiry handling + 12h TTL, 1eff528 fix(deploy): bump fastapi 0.115.0->0.115.6 to resolve starlette pin conflict, 2882b25 fix(deploy): self-heal column-level schema drift on startup, 47849cf UX: placeholders y labels claras en verificación, 4fdaaf0 Invitation flow and hardened reset codes (+18 more)
...
Cohesion: 0.13
Nodes (20): createRoomBlock(), listActiveRoomBlocks(), resolveRoomBlock(), RoomBlock, RoomBlockCreatePayload, RoomBlockReasonCode, roomBlockReasonLabel, roomBlockReasonOptions (+12 more)

### Community 104 - "Community 104"
Cohesion: 0.12
Nodes (17): checkRoomAvailability(), get_category(), get_room(), _housekeeping_room(), list_categories(), list_rooms(), listRoomCategories(), Room (+9 more)
...
Cohesion: 0.11
Nodes (15): listRooms(), cancelWaitlistEntry(), createWaitlistEntry(), listWaitlistEntries(), promoteWaitlistEntry(), API routes for reservation waitlist operations., WaitlistEntry, WaitlistEntryCreate (+7 more)

### Community 109 - "Community 109"
Cohesion: 0.08
Nodes (7): c580b56 ojala si, OTA (Online Travel Agency) reservation mapping. Tracks the link between external, add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c, reservation financial lifecycle  Revision ID: 20260410_reservation_financial_lif, extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard, add trial and comped fields to subscriptions  Revision ID: 20260419_subscription, ota hardening: hotel-scoped mappings and webhook credentials  Revision ID: a7f3d
...
Cohesion: 0.11
Nodes (15): getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., updateHotelConfig(), createRoom(), createRoomCategory(), updateRoom() (+7 more)
...
Cohesion: 0.09
Nodes (21): 29236bf feat(security): add Google account unlink endpoint with reauthentication, AuthResponse, Config, GoogleAuthRequest, GoogleUnlinkRequest, LoginRequest, MfaChallengeResponse, MfaCodeRequest (+13 more)

### Community 121 - "Community 121"
Cohesion: 0.12
Nodes (15): 6e8e1f3 Add hotel_id scope migration and model indexes for rooms/categories/reservations, 9385c0f Hardening multi-hotel scope and subscription enforcement, af2ce63 perf(backend): fix N+1 queries and missing indexes (TECH-0063), b5bc141 Harden core tenant composite relationships, e202fdd feat(db): v72 gaps phase 1+2 — Numeric precision, new tables, search indexes, OTA dedup, edf650c WIP: propagate hotel_id scope across services and tests, Guest and GuestCompanion models. Exhaustive fields for check-in panel: identity, Hotel API key model — v72 §16.  Each hotel can have multiple named API credentia (+7 more)

### Community 122 - "Community 122"
Cohesion: 0.13
Nodes (12): f11bb67 fix(rooms): close room allocation gap (TECH-0062), _reservation(), test_checkin_allowed_with_prohibited_override(), test_checkin_blocked_by_is_prohibited_stay_flag(), test_checkin_blocked_by_prohibido_alojar(), test_extend_stay_basic(), test_extend_stay_fails_if_new_date_not_later(), test_extend_stay_fails_on_cancelled() (+4 more)

### Community 123 - "Community 123"
Cohesion: 0.22
Nodes (23): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyStatusAtNightEnum, HotelAuditEvent, PaymentLinkStatusEnum, PaymentProviderEnum, PaymentStatusEnum (+15 more)
...
Cohesion: 0.14
Nodes (18): createGuestRestriction(), getGuestProhibitedDetail(), GuestProhibitedErrorBody, GuestRestriction, GuestRestrictionCreatePayload, GuestRestrictionResolvePayload, GuestRestrictionStatus, listGuestRestrictions() (+10 more)

### Community 127 - "Community 127"
Cohesion: 0.13
Nodes (15): Staff management endpoints for hotel public API keys., get_public_api_context(), _public_api_rate_limit_for_hotel(), Public API-key authentication, separate from staff JWT auth., Authorize a public key for a specific external product surface.      Purpose val, require_public_api_purpose(), _generate_secret(), _hash_secret() (+7 more)
...
Cohesion: 0.11
Nodes (6): 3690b59 fix(security): close master admin control plane gaps (TECH-0071), b355c74 fix(security): redact sensitive metadata in master admin audit events, dashboard_summary(), login(), me(), _serialize_user()
...
Cohesion: 0.19
Nodes (20): _available_room_for_conflict(), change_reservation_dates(), _compute_deposit_amount(), extend_reservation_stay(), _extension_amount(), _extension_conflicts(), _has_transactions(), _hotel_default_currency() (+12 more)
...
Cohesion: 0.18
Nodes (15): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), SessionLike (+7 more)
...
Cohesion: 0.17
Nodes (12): 14dfc42 perf(guests): harden tenant-scoped guest search (TECH-0060), Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati, _active_tag_filter(), add_tag(), _audit(), _now(), _serialize_stay(), set_rating() (+4 more)
...
Cohesion: 0.19
Nodes (9): SimpleRateLimiter, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterSystemEmailConnection, MasterAdminContext, Redact the small, known set of sensitive audit metadata fields. (+1 more)

### Community 161 - "Community 161"
Cohesion: 0.18
Nodes (14): APP_URL_HOSTNAME, buildAbsoluteUrl(), ensureLeadingSlash(), normalizeUrl(), PREVIEW_APP_HOST_SUFFIXES, PUBLIC_APP_URL, PUBLIC_SITE_URL, resolveAppLocation() (+6 more)
...
Cohesion: 0.15
Nodes (5): 69b2c87 Fix guest quick profile response serialization, api_client(), _seed_ota_no_guarantee_reservation(), test_release_no_guarantee_endpoint_forbidden_for_unauthorized_role(), test_release_no_guarantee_endpoint_releases_ota_reservation()
...
Cohesion: 0.42
Nodes (14): _client_with_db(), _override_auth(), Backend counterpart of avoiding LaundryPage.tsx's per-item     getCurrentLinenSt, _teardown(), test_housekeeping_can_operate_remitos_but_not_manage_vendors(), test_linen_items_and_locations_are_hotel_scoped(), test_linen_summary_is_hotel_scoped_and_denies_roles_without_laundry_permission(), test_owner_can_manage_linen_items_and_receptionist_cannot() (+6 more)
...
Cohesion: 0.14
Nodes (9): 07ea889 Record preview functional QA evidence, 1588fd0 Record mobile master admin fix, 3a6ebda Fix legacy analytics freshness metadata, 3bf6334 Record full regression after master admin fix, 42a7d23 Record Apple business regression, 49fab24 Record repeated cloud functional P1, f72e165 Remove internal IDs from cash movements, credentials (+1 more)

### Community 183 - "Community 183"
Cohesion: 0.14
Nodes (8): 24135ad Document functional-first cloud QA blocker, 36d5d8f Optimize room availability query shape, 3bf2f7c Add isolated E2E role journeys, 3de633a Document cloud report and analytics blockers, 4236cf3 Harden ledger pricing and payment idempotency, 4992735 Refresh Graphify after guest profile serialization, 5012c54 Refresh Graphify after availability optimization, 804e5ff Refresh Graphify after role E2E coverage

### Community 184 - "Community 184"
Cohesion: 0.21
Nodes (8): useReservationDrawer(), DashboardPage(), todayIso(), formatMoney(), formatterCache, getFormatter(), normalizeCurrencyCode(), resolveSingleCurrencyCode()
...
Cohesion: 0.33
Nodes (13): _client_with_db(), _override_auth(), Owner: "editar el producto por las dudas" -- PATCH already accepted     every fi, Same convention as POST /api/payment-links: a client resending the     same POST, _second_hotel(), _teardown(), test_duplicate_active_name_returns_clean_409_not_a_500(), test_movement_idempotency_key_header_dedupes_a_retried_request() (+5 more)

### Community 191 - "Community 191"
Cohesion: 0.35
Nodes (13): _client_with_db(), _movement(), _override_auth(), _seed_hotels(), _teardown(), test_consumption_report_api_is_hotel_isolated(), test_consumption_report_api_requires_stock_permission(), test_consumption_report_is_hotel_scoped() (+5 more)
...
Cohesion: 0.15
Nodes (11): 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker, 0510fa0 Add guest companion UI journey, 1b3433c Document cloud contract and bundle drift, 6af13d1 Refresh Graphify after availability regression, b5d1a6d Add cash control UI journey, c0c27e4 Refresh QA evidence after guest journey, eba784f Refresh Graphify after analytics coverage (+3 more)

### Community 199 - "Community 199"
Cohesion: 0.18
Nodes (11): 0c6029d Improve responsive dashboard and stock movement UX, 3abbd31 Complete core reservation business journey, 54eed63 Expose payment method configuration for owners, a733848 Refresh Graphify after finance hardening, e85df76 Harden reservation finance loading states, eed124a Harden cash reconciliation and transfer proof approvals, f01c735 Refresh Graphify after tenant isolation hardening, clientNavigate() (+3 more)
...
Cohesion: 0.17
Nodes (12): useConnectIntegration(), useIntegrations(), useRefreshIntegration(), useRevokeIntegration(), connectedSummary, FormState, getErrorMessage(), getProviderErrorMessage() (+4 more)

### Community 203 - "Community 203"
Cohesion: 0.17
Nodes (12): BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse, MasterAdminSessionResponse, MasterAdminUserPayload, MasterEmailConnectRequest (+4 more)
...
Cohesion: 0.26
Nodes (8): client_with_db(), ctx(), get_auth_context_target(), get_db_override_target(), _override_role(), test_manager_cannot_cross_config_manage_security_ceiling(), test_manager_with_config_manage_override_can_access_without_base_role(), test_manager_without_config_manage_permission_is_denied()
...
Cohesion: 0.18
Nodes (7): 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 4378bea chore: preview launch.json + graphify refresh (full-stack verification), 6f4beb1 feat(v72): Wave 3 — public API/keys + allocation V72 rules, 9db1623 feat(frontend): V72 Wave D — room blocks, allocation revert, guest tags/override UI, dd931a0 feat(v72): Wave 4b — OTA manual hardening + WhatsApp bot hooks (backend V72 complete), eedb561 feat(v72): SLICE-06 reservation lifecycle, waitlist, no-show, extensions, eee73bf test(perf+e2e): PG guest-search trgm indexes, benchmark harness, Playwright e2e harness
...
Cohesion: 0.20
Nodes (7): 307e650 Add replayable operational warehouse projections, build_beat_schedule(), Celery application configuration and async tasks for OTA synchronization., Return no scheduled provider/network work for a closed sandbox.      `notificati, _safe_worker_env(), test_celery_process_accepts_explicit_closed_production_profile(), test_celery_process_rejects_missing_production_policy_before_startup()
...
Cohesion: 0.29
Nodes (8): _build_unavailable_message(), _current_status(), _dev_outbox_path(), get_system_email_status(), _normalize_account_email(), _record_dev_email(), send_system_email(), _sender_parts()
...
Cohesion: 0.29
Nodes (9): cancelPaymentLink(), createPaymentLink(), listPaymentLinks(), PaymentLink, PaymentLinkCreatePayload, linksKey(), usePaymentLinkCancel(), usePaymentLinkCreate() (+1 more)
...
Cohesion: 0.25
Nodes (10): 2d62104 feat(rates): apply Codex UX review — editability, keyboard nav, a11y, 554e12d Fix Vercel install command for deploy, 5de6817 Add field-based bulk rate editing, 6cdbbc5 Polish rate calendar UX and fix Vercel install step, d09a8b3 Polish rate calendar UX, df770c3 Polish rate calendar and reservation pricing, f6ad62e feat(rates): homogeneous, windowed rate calendar UX, mockCalendar (+2 more)

### Community 238 - "Community 238"
Cohesion: 0.18
Nodes (9): 7e4a45c feat(phase7a): Redis availability cache + Mongo audit projection (best-effort), 92eca64 feat(phase7b): Cassandra time-series + Neo4j graph projections (best-effort), 9d8f59f fix(phase5): correct MercadoPago webhook signature to manifest HMAC (security), a808f2c feat(phase3): harvest cranky net-new — @audited_change decorator + design docs, dd53b2c fix(phase2): rename surcharge constraint to avoid PG name collision, e7d7971 feat(phase6): NoSQL polyglot foundation — Redis/Mongo/Cassandra/Neo4j clients, f09d3e4 feat(phase4): harvest Redis read-model cache from WIP + wire analytics, Defensive datastore clients for optional infrastructure. (+1 more)
...
Cohesion: 0.33
Nodes (8): 9f8ba34 fix(security): audit and validate comped subscription override, _auth_headers(), _ensure_hotel(), test_comped_override_records_audit_event(), test_comped_override_rejects_unknown_hotel_without_subscription_state(), test_manual_transitions_emit_events(), test_role_gating_for_trial_and_comped_override(), test_trial_auto_suspends_after_fourteen_days()

### Community 241 - "Community 241"
Cohesion: 0.38
Nodes (10): LinenItem, LinenLocation, LinenMovement, Linen (ropa blanca) inventory models -- physically separate tables from app/mode, current_stock(), Hotel-scoped linen (ropa blanca) inventory service.  Mirrors app/services/stock_, Balance of one linen item for a hotel, optionally narrowed to one     location -, Every active linen item's current balance in one query pair, instead     of the (+2 more)
...
Cohesion: 0.36
Nodes (7): 2a14eb9 feat(security): add unified tenant-scoped audit timeline read endpoint, _headers(), test_manager_cannot_read_security_settings(), test_revoke_all_invalidates_the_callers_previous_token(), test_security_overview_and_events_are_redacted_and_tenant_scoped(), test_unified_audit_timeline_combines_sources_orders_redacts_and_isolates_tenant(), test_unified_audit_timeline_supports_inclusive_date_filters_and_role_guard()
...
Cohesion: 0.29
Nodes (7): connectWhatsAppIntegration(), fetchWhatsAppSettings(), issueWhatsAppApiKey(), refreshWhatsAppIntegration(), revokeWhatsAppIntegration(), formatDate(), SettingsWhatsAppPage()
...
Cohesion: 0.25
Nodes (5): bubbleStyles, modeLabel, roleLabel, runtimeLabel, suggestedPrompts
...
Cohesion: 0.29
Nodes (6): AnalyticsComparisonStateRead, AnalyticsComparisonWindowRead, AnalyticsMetricCardRead, AnalyticsResponseEnvelopeRead, AnalyticsStarterSummaryDataRead, AnalyticsStarterSummaryRead
...
Cohesion: 0.40
Nodes (2): _integration_client(), test_gmail_oauth_callback_uses_signed_state()
...
Cohesion: 0.50
Nodes (2): _authorize_override(), checkin()

### Community 390 - "Community 390"
Cohesion: 0.50
Nodes (3): _current_user(), Tenant-scoped security overview and current-user session revocation., security_overview()
...
Cohesion: 0.60
Nodes (3): _ensure_membership_and_subscription(), ensure_plans_seeded(), get_or_create_hotel_for_owner()
...
Cohesion: 0.40
Nodes (2): test_ota_orchestrator_records_failed_verification(), test_ota_orchestrator_verifies_connection_and_persists_event()
...
Cohesion: 0.83
Nodes (3): _require_demo_mode(), reset_demo(), seed_demo()
...
Cohesion: 0.67
Nodes (3): Non-delegable invariant: only this hotel's owner administers RBAC., Non-delegable invariant: only this hotel's owner administers RBAC., require_permission_administrator()
...
Cohesion: 0.67
Nodes (3): Preview QA already requires a strong MASTER_ADMIN_PASSWORD/EMAIL, but     produc, Preview QA already requires a strong MASTER_ADMIN_PASSWORD/EMAIL, but     produc, test_validate_runtime_security_rejects_weak_master_admin_password_in_production()

### Community 485 - "Community 485"
Cohesion: 0.67
Nodes (3): MERCADOPAGO_WEBHOOK_SECRET is required only when MP_ACCESS_TOKEN is set., MERCADOPAGO_WEBHOOK_SECRET is required only when MP_ACCESS_TOKEN is set., test_validate_runtime_security_rejects_missing_mp_webhook_when_mp_configured()
...
## Knowledge Gaps
- **872 isolated node(s):** `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`, `add temporary action grants  Revision ID: 0f85dca5b98b Revises: 20260820_user_se`, `Install the PostgreSQL tenant policy; no-op on other dialects.`, `Remove the PostgreSQL tenant policy before dropping the table.`, `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho` (+867 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 158`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 162`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 171`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 172`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (1 nodes): `Public WhatsApp bot hooks authenticated only by hotel API key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `805b47a Unify reservation pricing with signed quote contract`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 370`** (2 nodes): `_integration_client()`, `test_gmail_oauth_callback_uses_signed_state()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 388`** (2 nodes): `_authorize_override()`, `checkin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 391`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 393`** (2 nodes): `chat_completions()`, `_extract_latest_user_message()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 402`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 405`** (2 nodes): `test_ota_orchestrator_records_failed_verification()`, `test_ota_orchestrator_verifies_connection_and_persists_event()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 420`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 424`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 435`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 436`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 437`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 438`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 439`** (1 nodes): `ai assistant sessions  Revision ID: 20260411_ai_assistant_sessions Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 440`** (1 nodes): `ai assistant insights  Revision ID: 20260412_ai_assistant_insights Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 441`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 442`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 443`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 444`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 445`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 446`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 447`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 448`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 449`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 450`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 451`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 452`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 453`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 454`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 455`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 456`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 457`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 458`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 459`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 460`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 461`** (1 nodes): `repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 462`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 463`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 464`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 465`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 466`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 467`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 468`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 469`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 470`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 471`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 472`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 473`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 474`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 475`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 476`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 477`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 480`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 481`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 486`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 5` to `Community 350`, `Community 20`, `Community 45`, `Community 69`, `Community 4`, `Community 59`, `Community 160`, `Community 39`, `Community 36`, `Community 2`, `Community 62`, `Community 123`, `Community 6`, `Community 133`, `Community 30`, `Community 136`, `Community 130`, `Community 72`, `Community 197`, `Community 0`, `Community 421`, `Community 121`, `Community 31`, `Community 28`, `Community 85`, `Community 18`, `Community 16`, `Community 241`, `Community 53`, `Community 162`, `Community 48`, `Community 3`, `Community 8`, `Community 109`, `Community 10`, `Community 87`, `Community 143`, `Community 64`, `Community 259`, `Community 94`, `Community 111`, `Community 34`, `Community 32`, `Community 11`, `Community 358`, `Community 95`, `Community 14`, `Community 314`, `Community 110`, `Community 292`, `Community 293`, `Community 80`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 117`, `Community 478`, `Community 18`, `Community 4`, `Community 74`, `Community 11`, `Community 2`, `Community 127`, `Community 85`, `Community 5`, `Community 30`, `Community 123`, `Community 62`, `Community 6`, `Community 362`, `Community 8`, `Community 9`, `Community 66`, `Community 53`, `Community 114`, `Community 124`, `Community 3`, `Community 363`, `Community 7`, `Community 94`, `Community 154`, `Community 14`, `Community 110`, `Community 13`, `Community 337`, `Community 59`, `Community 10`, `Community 60`, `Community 150`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 3` to `Community 89`, `Community 0`, `Community 2`, `Community 4`, `Community 7`, `Community 121`, `Community 5`, `Community 30`, `Community 36`, `Community 123`, `Community 62`, `Community 136`, `Community 31`, `Community 6`, `Community 8`, `Community 79`, `Community 153`, `Community 178`, `Community 150`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Are the 945 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 945 INFERRED edges - model-reasoned connections that need verification._
- **Are the 946 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 946 INFERRED edges - model-reasoned connections that need verification._
- **Are the 917 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 917 INFERRED edges - model-reasoned connections that need verification._
- **Are the 773 inferred relationships involving `Room` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Room` has 773 INFERRED edges - model-reasoned connections that need verification._