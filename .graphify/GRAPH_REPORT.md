...
## Corpus Check
- Large corpus: 767 files · ~511,876 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7175 nodes · 24376 edges · 319 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9286 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9286 · contains: 4450 · calls: 3377 · MODIFIES: 1910 · ON_BRANCH: 1368 · rationale_for: 1162 · imports: 746 · imports_from: 586 · method: 579 · inherits: 534 · PARENT_OF: 378


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 767 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 8 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `d1dbe7f`
...
Cohesion: 0.05
Nodes (205): Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return) (+197 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (133): Public booking-engine API authenticated only with hotel API keys., delete_room(), housekeeping_summary(), FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Simple availability helper. Returns a placeholder message if required     parame, Simple availability helper. Returns a placeholder message if required     parame (+125 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (148): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), BillingAdjustment (+140 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (117): requestVerification(), apiFetch(), buildAuthHeaders(), buildUrl(), formatErrorDetail(), handleUnauthorized(), hasValidSession(), isTokenExpired() (+109 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (123): UpdateRolePayload, BaseModel, 805b47a Unify reservation pricing with signed quote contract, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse (+115 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (112): CheckInRequest, FastAPI routes for Check-in / Check-out., Guest, HotelConfiguration, RoomStatusEnum, CheckInError, perform_checkin(), perform_checkout() (+104 more)
...
Cohesion: 0.09
Nodes (113): cancel_reservation(), extend_stay(), mark_no_show(), modify_reservation(), FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create, §5.2 — Run allocation engine in background after reservation changes.     Create, Register the deferred corporate collection (v72 §3.5): settled. (+105 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (103): GuestCompanion, RateLimitEvent, RoomCategory, Hotel-scoped waitlist lifecycle service., Business error for waitlist operations., db(), db_engine(), hotel_config() (+95 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (87): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), createPaymentLink() (+79 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (88): Base, Base class for all ORM models., _DecimalAwareEncoder, _frontend_placeholder(), _is_demo_mode_enabled(), lifespan(), StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on (+80 more)
...
Cohesion: 0.03
Nodes (65): email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., updateHotelConfig(), createPaymentSurcharge() (+57 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (82): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Individual money movement within an open cash session.     Linked optionally to (+74 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (30): Public WhatsApp bot hooks authenticated only by hotel API key., _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Database engine and session management. Supports both PostgreSQL (production) an (+22 more)
...
Cohesion: 0.03
Nodes (34): CategoryPayload, DepositPolicyPayload, finishOnboarding(), HotelIdentityPayload, OnboardingProviderSetup, OnboardingStatus, OTAChannelsPayload, OwnerPayload (+26 more)
...
Cohesion: 0.05
Nodes (51): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+43 more)
...
Cohesion: 0.04
Nodes (49): 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 0449677 Document cloud role and preview blocker, 0510fa0 Add guest companion UI journey, 07ea889 Record preview functional QA evidence, 13f3fec Record WebKit role validation, 1588fd0 Record mobile master admin fix, 1b3433c Document cloud contract and bundle drift (+41 more)
...
Cohesion: 0.05
Nodes (43): AcceptPayload, audited_change(), Record an AuditLog row for a successful entity mutation., Record an AuditLog row for a successful entity mutation., AuthContext, get_auth_context(), _parse_header_hotel_id(), _parse_token_hotel_id() (+35 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (45): approvePaymentProof(), fetchPaymentProofImage(), listPaymentProofs(), PaymentProof, PaymentProofCreatePayload, PaymentProofStatus, rejectPaymentProof(), submitPaymentProof() (+37 more)

### Community 24 - "Community 24"
Cohesion: 0.10
Nodes (42): 6e6d179 Prepare release candidate for landing and onboarding, 87b0eb6 Improve marketing SEO content, linking, and metadata, Seo(), SeoProps, StructuredData, APP_URL_HOSTNAME, buildAbsoluteUrl(), ensureLeadingSlash() (+34 more)

### Community 25 - "Community 25"
Cohesion: 0.07
Nodes (52): Payment, PaymentLink, PaymentWebhookEvent, Payment gateway tracking models: PaymentLink, Payment, PaymentWebhookEvent.  Sou, One gateway payment object (MP preference / PayPal order / Stripe intent)., Raw webhook log per payment — idempotent on (hotel_id, provider, webhook_id)., Raw webhook log per payment — idempotent on (hotel_id, provider, webhook_id)., Guest-facing pre-payment object (checkout URL / QR). May collect partial payment (+44 more)
...
Cohesion: 0.08
Nodes (45): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+37 more)
...
Cohesion: 0.08
Nodes (37): Shared, secret-safe binding for the Render QA bootstrap configuration., 365b263 Harden isolated QA bootstrap and provider evidence, 3f9c8a0 Refresh Graphify after QA hardening, b5d6e0f Merge pull request #26 from Maximo-Paulos/codex/feature/trusted-qa-bootstrap, b94ce7b Bind final QA evidence to probed provider state, dc543a6 Bind final QA evidence to probed provider state, e59f101 Harden isolated QA bootstrap and provider evidence, Fail-closed safeguards for cloud QA external integrations. (+29 more)
...
Cohesion: 0.16
Nodes (36): Exception, OTAConnection, OTAProvider, OTARatePlanMapping, OTAReservationLifecycleEnum, OTAReservationLink, OTARoomMapping, OTAReservationMapping (+28 more)
...
Cohesion: 0.06
Nodes (41): Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection (+33 more)
...
Cohesion: 0.05
Nodes (32): 00bf891 Explain analytics errors and add retry action, 03f4d70 Document cloud date and quote regressions, 275058e Add guarded cash refund flow, 2e14d9a Record owner cloud recheck evidence, 3783d27 Document functional QA findings and refresh graph, 3cb353b Add reservation lifecycle E2E coverage, 5c4faf9 Document cloud reservation quote blocker, 60845ed Extend Apple mobile regression coverage (+24 more)
...
Cohesion: 0.13
Nodes (36): fail(), load_json_object(), main(), mapping(), nested_value(), positive_integer(), preview_origin(), Return the normalized origin for a credential-free HTTPS preview URL. (+28 more)
...
Cohesion: 0.08
Nodes (21): addGuestCompanions(), _build_guest_ledger_csv(), createGuest(), _enum_value(), export_guest_ledger(), getGuest(), Guest, GuestCheckInReservation (+13 more)
...
Cohesion: 0.17
Nodes (23): PaymentProof, PaymentProofBlob, PaymentProofStatusEnum, Manual bank-transfer evidence and approval lifecycle., Private image evidence awaiting explicit staff confirmation., Private image evidence awaiting explicit staff confirmation., Private binary payload kept separately from queryable proof metadata., Private binary payload kept separately from queryable proof metadata. (+15 more)
...
Cohesion: 0.10
Nodes (12): Tests for database models — validates schema creation, constraints, relationship, Tests for Reservation model and state machine., Verify the state machine transition map is correct., Verify can_transition_to method., Verify balance_due computed property., Verify nights calculation., Tests for HotelConfiguration model., Verify default configuration values. (+4 more)
...
Cohesion: 0.13
Nodes (4): main(), valid_https(), 19b8b7b Harden isolated preview QA and trusted release evidence, Seed and serve the E2E backend on 127.0.0.1:8040.  This wrapper avoids shell-spe
...
Cohesion: 0.17
Nodes (12): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), b8b52fa Harden permission seeding and mobile regression coverage, effd195 Harden analytics freshness and distributed concurrency, fd617c0 Harden private transfer proof workflow, FakeRedis (+4 more)
...
Cohesion: 0.16
Nodes (13): getPaymentSummary(), makePayment(), newPaymentIdempotencyKey(), PaymentMethod, PaymentRequest, PaymentSummary, FastAPI routes for Payments., TransactionType (+5 more)
...
Cohesion: 0.17
Nodes (7): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., 1ebf84a Audit and harden agent operations context, bc938cf Add agent ops vault and cloud QA foundation
...
Cohesion: 0.17
Nodes (6): 14c3453 Fail closed when managed databases are not migrated, 4959706 Enforce tenant isolation with PostgreSQL RLS context, c0d33fd Refresh Graphify after schema bootstrap, f01c735 Refresh Graphify after tenant isolation hardening, Middleware to block mutating requests when subscription enforcement is enabled., SubscriptionEnforcementMiddleware
...
Cohesion: 0.33
Nodes (6): 0255d4f Normalize Graphify artifact paths, 4f81793 Refresh Graphify after PII hardening, 7278b2c Reject unconfigured Mercado Pago webhooks, 9caadc9 Record security regression evidence, d1dbe7f Record guest PII security regression, d260449 Harden guest PII exports and audit snapshots
...
- **Thin community `Community 194`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 219`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (1 nodes): `extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `add trial and comped fields to subscriptions  Revision ID: 20260419_subscription`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `ota hardening: hotel-scoped mappings and webhook credentials  Revision ID: a7f3d`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 318`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 333`** (2 nodes): `MERCADOPAGO_WEBHOOK_SECRET is required only when MP_ACCESS_TOKEN is set.`, `test_validate_runtime_security_rejects_missing_mp_webhook_when_mp_configured()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 10` to `Community 238`, `Community 201`, `Community 14`, `Community 0`, `Community 22`, `Community 36`, `Community 117`, `Community 38`, `Community 17`, `Community 28`, `Community 66`, `Community 7`, `Community 13`, `Community 15`, `Community 93`, `Community 6`, `Community 141`, `Community 1`, `Community 5`, `Community 8`, `Community 31`, `Community 4`, `Community 16`, `Community 29`, `Community 118`, `Community 2`, `Community 32`, `Community 33`, `Community 25`, `Community 75`, `Community 27`, `Community 44`, `Community 62`, `Community 37`, `Community 210`, `Community 84`, `Community 190`, `Community 191`, `Community 126`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 5` to `Community 12`, `Community 22`, `Community 7`, `Community 18`, `Community 34`, `Community 4`, `Community 70`, `Community 16`, `Community 10`, `Community 36`, `Community 1`, `Community 320`, `Community 28`, `Community 27`, `Community 246`, `Community 37`, `Community 86`, `Community 32`, `Community 29`, `Community 2`, `Community 6`, `Community 17`, `Community 62`, `Community 66`, `Community 8`, `Community 13`, `Community 84`, `Community 97`, `Community 170`, `Community 123`, `Community 31`, `Community 33`, `Community 50`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 27`, `Community 31`, `Community 70`, `Community 7`, `Community 0`, `Community 10`, `Community 36`, `Community 17`, `Community 38`, `Community 28`, `Community 5`, `Community 15`, `Community 32`, `Community 37`, `Community 25`, `Community 75`, `Community 2`, `Community 44`, `Community 8`, `Community 13`, `Community 113`, `Community 97`, `Community 170`, `Community 123`, `Community 22`, `Community 50`?**
