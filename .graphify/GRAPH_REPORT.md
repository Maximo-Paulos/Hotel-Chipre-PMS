...
## Corpus Check
- Large corpus: 1043 files · ~1,656,246 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10357 nodes · 52182 edges · 357 communities detected
- Extraction: 68% EXTRACTED · 32% INFERRED · 0% AMBIGUOUS · INFERRED: 16491 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16491 · ON_BRANCH: 15540 · contains: 6052 · calls: 4476 · MODIFIES: 3543 · rationale_for: 2147 · imports: 1091 · imports_from: 843 · PARENT_OF: 713 · inherits: 667 · method: 616 · re_exports: 3
...
Cohesion: 0.03
Nodes (348): PaymentSurchargeCreate, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+340 more)

### Community 1 - "Community 1"
Cohesion: 0.19
Nodes (356): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+348 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (152): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _authorize_override(), checkin(), _require_demo_mode(), reset_demo(), seed_demo(), Staff management endpoints for hotel public API keys., Database engine and session management. Supports both PostgreSQL (production) an (+144 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (158): main(), valid_https(), _archive_historical(), _build_cases(), main(), _write_json(), Shared, secret-safe binding for the Render QA bootstrap configuration., _clickhouse_healthcheck() (+150 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (296): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest. (+288 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (260): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys. (+252 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (249): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+241 more)
...
Cohesion: 0.02
Nodes (183): acceptInvitation(), AuthResponse, _burn_auth_timing_work(), _generate_code(), getInvitationInfo(), _issue_email_token(), loginWithGoogle(), _mask_email() (+175 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (235): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, inviteUser(), list_users(), listUsers() (+227 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (207): CheckInRequest, FastAPI routes for Check-in / Check-out., cancel_reservation(), change_dates(), create_reservation_charge(), _ensure_action_permission(), extend_stay(), _is_manager_context() (+199 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (143): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+135 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (180): 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession (+172 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (145): claude/feature/pms-roles-housekeeping-qa, 00bf891 Explain analytics errors and add retry action, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker, 0510fa0 Add guest companion UI journey, 05d296d Fix cash freshness after reservation payments (+137 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (145): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+137 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (106): 3690b59 fix(security): close master admin control plane gaps (TECH-0071), 867e41b fix(security): close master admin control plane gaps (TECH-0071) (#60), ad4249c Implement master admin panel, b355c74 fix(security): redact sensitive metadata in master admin audit events, d7df0ac feat(security): add core temporary one-time action authorization (TECH-0041) (#56), PermissionGate(), isAppHostname(), Email provider abstraction for platform transactional mail. (+98 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (69): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _booking_to_read(), cancel_booking(), checkin_booking() (+61 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (80): email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., Lightweight status so the frontend can check the active system email provider., updateHotelConfig() (+72 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (109): 955325e feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, HotelPermissionOverride, Permission, Configurable permission matrix models., An employee-specific permission decision within one hotel membership., An employee-specific permission decision within one hotel membership., RolePermissionDefault, UserPermissionOverride (+101 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (96): _allow_mfa_attempt(), _attach_user_session_cookies(), _audit_security_event(), _build_auth_response(), _build_login_response(), complete_mfa_login(), confirm_mfa_enrollment(), disable_mfa() (+88 more)
...
Cohesion: 0.10
Nodes (24): ABC, _authorize_oauth_state_actor(), Revalidate the actor embedded in a short-lived OAuth state token.      Provider, EmailProvider, EmailProviderError, get_email_provider(), _mask_email(), _mask_recipients() (+16 more)
...
Cohesion: 0.15
Nodes (29): allow_master_admin_mfa_attempt(), _as_aware(), authenticate_master_login(), authenticate_master_mfa_login(), _authorize_user_for_master_panel(), _bootstrap_master_credentials_match(), create_master_session(), _hash_value() (+21 more)
...
Cohesion: 0.13
Nodes (29): MasterAdminAuditEvent, MasterStripeWebhookEvent, Subscription, SubscriptionEvent, plan_catalog(), Subscription entitlements and enforcement helpers built on v2 tables. Keeps lega, Ensure a Subscription row exists for the hotel. Returns (subscription, seeded_fl, Return a normalized snapshot for API/middleware:     plan, status, limits, can_w (+21 more)
...
Cohesion: 0.13
Nodes (18): SimpleRateLimiter, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterSystemEmailConnection, audit_master_action(), create_master_admin_mfa_challenge() (+10 more)
...
Cohesion: 0.12
Nodes (13): bb8dad5 fix(rooms): close room allocation gap (TECH-0062), f11bb67 fix(rooms): close room allocation gap (TECH-0062), _reservation(), test_checkin_allowed_with_prohibited_override(), test_checkin_blocked_by_is_prohibited_stay_flag(), test_checkin_blocked_by_prohibido_alojar(), test_extend_stay_basic(), test_extend_stay_fails_if_new_date_not_later() (+5 more)
...
Cohesion: 0.18
Nodes (16): 14dfc42 perf(guests): harden tenant-scoped guest search (TECH-0060), Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati, _active_tag_filter(), add_tag(), _audit(), _get_guest(), list_active_tags(), _now() (+8 more)
...
Cohesion: 0.35
Nodes (17): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyDaily, FactRoomOccupancyStatusAtNightEnum, HotelAuditEvent, RoomStateEvent, ReservationGuestSegmentEnum (+9 more)
...
Cohesion: 0.16
Nodes (18): _configure_resend(), C2 regression (SQLite, syntactic only -- RLS is a Postgres-only concern,     see, C2 regression (SQLite, syntactic only -- RLS is a Postgres-only concern,     see, _seed_hotel(), _seed_platform_admin(), _seed_subscription(), test_master_admin_optional_mfa_enroll_confirm_login_and_disable(), test_master_audit_redacts_sensitive_metadata_on_storage_and_read() (+10 more)
...
Cohesion: 0.20
Nodes (8): 3dee498 fix(review): chain permission-metadata migration after latest head, 77fa337 feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, _auth(), _client(), test_only_owner_can_use_administration_catalog_and_co_owner_is_denied(), test_owner_can_grant_and_revoke_user_override_then_restore_defaults(), test_user_override_rejects_self_elevation_and_cross_hotel_id_without_disclosure(), add permission metadata and optimistic override versions  Revision ID: 20260820_
...
Cohesion: 0.31
Nodes (8): 2a14eb9 feat(security): add unified tenant-scoped audit timeline read endpoint, _headers(), Security settings API is tenant-scoped, redacted and revokes real JWTs., test_manager_cannot_read_security_settings(), test_revoke_all_invalidates_the_callers_previous_token(), test_security_overview_and_events_are_redacted_and_tenant_scoped(), test_unified_audit_timeline_combines_sources_orders_redacts_and_isolates_tenant(), test_unified_audit_timeline_supports_inclusive_date_filters_and_role_guard()
...
- **Thin community `Community 137`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 172`** (1 nodes): `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 4` to `Community 16`, `Community 5`, `Community 2`, `Community 59`, `Community 68`, `Community 81`, `Community 129`, `Community 35`, `Community 6`, `Community 63`, `Community 112`, `Community 79`, `Community 10`, `Community 100`, `Community 12`, `Community 11`, `Community 104`, `Community 97`, `Community 9`, `Community 155`, `Community 314`, `Community 32`, `Community 31`, `Community 0`, `Community 23`, `Community 3`, `Community 271`, `Community 101`, `Community 25`, `Community 130`, `Community 83`, `Community 18`, `Community 73`, `Community 113`, `Community 90`, `Community 33`, `Community 19`, `Community 77`, `Community 20`, `Community 89`, `Community 225`, `Community 197`, `Community 66`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 17`, `Community 23`, `Community 10`, `Community 5`, `Community 9`, `Community 19`, `Community 3`, `Community 16`, `Community 4`, `Community 11`, `Community 112`, `Community 63`, `Community 12`, `Community 14`, `Community 55`, `Community 25`, `Community 93`, `Community 83`, `Community 6`, `Community 275`, `Community 68`, `Community 79`, `Community 99`, `Community 20`, `Community 89`, `Community 2`, `Community 24`, `Community 258`, `Community 18`, `Community 366`, `Community 197`, `Community 52`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 5` to `Community 75`, `Community 4`, `Community 0`, `Community 10`, `Community 16`, `Community 11`, `Community 6`, `Community 35`, `Community 112`, `Community 63`, `Community 104`, `Community 32`, `Community 12`, `Community 98`, `Community 235`, `Community 141`, `Community 366`, `Community 19`?**
