...
## Corpus Check
- Large corpus: 825 files · ~564,257 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8175 nodes · 29862 edges · 325 communities detected
- Extraction: 58% EXTRACTED · 42% INFERRED · 0% AMBIGUOUS · INFERRED: 12672 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 12672 · contains: 4905 · calls: 3588 · MODIFIES: 2243 · ON_BRANCH: 1767 · rationale_for: 1478 · imports: 851 · imports_from: 658 · method: 594 · inherits: 558 · PARENT_OF: 548


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 825 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 9 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `c81befd`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 792 edges
2. `Reservation` - 791 edges
3. `HotelConfiguration` - 725 edges
4. `Room` - 632 edges
5. `Guest` - 612 edges
...
Cohesion: 0.01
Nodes (321): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening (+313 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (272): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+264 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (211): Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+203 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (184): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+176 more)
...
Cohesion: 0.03
Nodes (172): add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Base, Base class for all ORM models., DeclarativeBase (+164 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (144): FastAPI routes for Check-in / Check-out., B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, Guest, GuestRatingEnum, GuestTag, GuestTagTypeEnum, Guest and GuestCompanion models. Exhaustive fields for check-in panel: identity, Behavioral / alert tags on a guest (v72 §2.6).     Multiple tags per guest; each (+136 more)
...
Cohesion: 0.03
Nodes (112): CheckInRequest, FastAPI routes for Payments., StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead, StockMovementCreate (+104 more)
...
Cohesion: 0.02
Nodes (35): _authorize_override(), checkin(), checkin_partial(), _require_demo_mode(), reset_demo(), seed_demo(), Database engine and session management. Supports both PostgreSQL (production) an, get_public_api_context() (+27 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (61): EmailSendResponse, EmailVerifyResponse, Legacy public email endpoints.  The system transactional mail now lives exclusiv, _retired(), send_reset(), send_verification(), SmtpStatus, verify_code() (+53 more)
...
Cohesion: 0.03
Nodes (35): 7e2edb6 Merge Analytics R1.0, df173d1 Implement Analytics R1.0 dashboard, chat IA, and support, AnalyticsComparisonStateRead, AnalyticsComparisonWindowRead, AnalyticsMetricCardRead, AnalyticsResponseEnvelopeRead, AnalyticsStarterSummaryDataRead, AnalyticsStarterSummaryRead (+27 more)
...
Cohesion: 0.05
Nodes (63): validateGuestForCheckin(), add_reservation_guests(), addReservationGuests(), buildQueryString(), cancelReservation(), change_dates(), CheckInPayload, checkInReservation() (+55 more)
...
Cohesion: 0.05
Nodes (52): Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection (+44 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (41): addGuestCompanions(), addGuestTag(), _build_guest_ledger_csv(), buildGuestQueryString(), checkInGuestReservation(), createGuest(), _enum_value(), export_guest_ledger() (+33 more)
...
Cohesion: 0.05
Nodes (29): GuestUpdatePayload, PaymentMethod, 0a457cb feat(checkin): B3 partial check-in + mandatory guest profile capture + companions, 369a3cc fix(reservations): allow manual total_amount override without a Company account, CheckinCaptureForm, emptyCaptureForm, guestFullName(), paymentMethodOptions (+21 more)
...
Cohesion: 0.06
Nodes (24): create_movement(), createStockItem(), createStockLocation(), createStockMovement(), CurrentStock, DecimalValue, _ensure_adjustment_permission(), getCurrentStock() (+16 more)
...
Cohesion: 0.07
Nodes (36): listLaundryBatches(), updateLaundryStatus(), createLaundryRemito(), createLaundryVendor(), getLaundryVendorBalance(), LaundryRemito, LaundryRemitoCreate, LaundryRemitoCreateResponse (+28 more)
...
Cohesion: 0.09
Nodes (30): FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, PendingActionPriorityEnum, PendingActionStatusEnum, PendingActionTypeEnum, PendingOperationalAction (+22 more)

### Community 59 - "Community 59"
Cohesion: 0.07
Nodes (24): User, TDD tests for the AuditLog model.  Invariants:   - AuditLog is hotel-scoped (hot, System-triggered events (e.g. OTA sync) have no human actor., When a hotel is deleted all its audit logs cascade., All AuditActionEnum values can be stored., Regression: hotel_id on transactions must have a DB-level FK., test_audit_log_actor_nullable_for_system_actions(), test_audit_log_all_actions_persist() (+16 more)
...
Cohesion: 0.08
Nodes (13): 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, _add_billing_charge(), _create_checked_in_reservation(), opened_cash_register(), test_checkout_blocked_when_reservation_has_operational_balance(), test_checkout_succeeds_when_operational_balance_is_fully_paid(), test_checkout_succeeds_with_force_even_when_balance_remains() (+5 more)
...
Cohesion: 0.10
Nodes (17): 15142fe feat(dashboard): hotel-vocabulary pending action titles + open-drawer button (B6.2), ReservationGlobalSearch(), credentials, useReservationDrawer(), reservationsKey(), useReservations(), categoriesKey(), roomsKey() (+9 more)
...
Cohesion: 0.11
Nodes (11): _make_reservation(), Only is_wait_listed=True reservations should appear in the waitlist query., Create one normal and one waitlisted reservation, return (normal, waitlisted)., Resolving with a room of a different category must be blocked., Resolving with an already-occupied room must be blocked., Trying to resolve with a non-existent room raises ReservationError., Helper — create a reservation through the service layer., After resolve, the DB row reflects the updated state. (+3 more)
...
Cohesion: 0.11
Nodes (10): OccupancyGridBlock, OccupancyGridReservation, OccupancyGridRoom, CategoryGroup, DATE_LABEL, OccupancyGrid(), OccupancyGridProps, usePrefetchOccupancyGrid() (+2 more)
...
Cohesion: 0.11
Nodes (18): _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Fill NULLs in NOT-NULL model columns that carry a default.      A column added i, Additively add model columns that are missing from existing tables.      create_ (+10 more)

### Community 112 - "Community 112"
Cohesion: 0.16
Nodes (13): 8f9e29f feat(reservations): add manual OTA reservation form (B4) + shared guest quick-create, emptyQuickGuestForm(), GuestQuickCreatePanelProps, hasQuickGuestFormData(), QuickGuestFormValues, CHANNEL_OPTIONS, emptyFormState(), FormState (+5 more)
...
Cohesion: 0.17
Nodes (10): current_stock(), delete_stock_item(), _get_item(), get_location(), get_stock_item(), low_stock_items(), Hotel-scoped stock and inventory movement service., Balance of one item for a hotel, optionally narrowed to one location.      Witho (+2 more)
...
Cohesion: 0.67
Nodes (3): A second normalizer run must leave already-portable artifacts unchanged., A second normalizer run must leave already-portable artifacts unchanged., test_is_idempotent_after_generated_paths_are_normalized()

### Community 330 - "Community 330"
Cohesion: 0.67
Nodes (3): A symlinked instruction directory must not allow external files to be rewritten., A symlinked instruction directory must not allow external files to be rewritten., test_does_not_follow_instruction_directory_symlink_outside_generated_directory()
...
- **Thin community `Community 222`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 236`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 240`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (2 nodes): `chat_completions()`, `_extract_latest_user_message()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 280`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 313`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 318`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (2 nodes): `build_gemma_hotel_context()`, `_enum_value()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `_DecimalAwareEncoder`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 333`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 335`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (2 nodes): `Derive the BRM §16.2 reportable origin for a reservation.      Precedence:`, `reportable_origin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 5` to `Community 237`, `Community 1`, `Community 10`, `Community 332`, `Community 2`, `Community 189`, `Community 79`, `Community 223`, `Community 7`, `Community 22`, `Community 121`, `Community 33`, `Community 53`, `Community 18`, `Community 77`, `Community 20`, `Community 24`, `Community 15`, `Community 99`, `Community 9`, `Community 141`, `Community 6`, `Community 27`, `Community 100`, `Community 4`, `Community 3`, `Community 52`, `Community 29`, `Community 122`, `Community 73`, `Community 32`, `Community 58`, `Community 174`, `Community 338`, `Community 65`, `Community 55`, `Community 66`, `Community 59`, `Community 243`, `Community 72`, `Community 114`, `Community 90`, `Community 199`, `Community 200`, `Community 128`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 4` to `Community 3`, `Community 52`, `Community 7`, `Community 36`, `Community 8`, `Community 1`, `Community 10`, `Community 5`, `Community 22`, `Community 324`, `Community 65`, `Community 18`, `Community 6`, `Community 58`, `Community 247`, `Community 35`, `Community 92`, `Community 73`, `Community 67`, `Community 29`, `Community 9`, `Community 24`, `Community 66`, `Community 197`, `Community 59`, `Community 114`, `Community 96`, `Community 77`, `Community 90`, `Community 32`, `Community 15`, `Community 171`, `Community 20`, `Community 44`, `Community 98`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 5`, `Community 58`, `Community 7`, `Community 2`, `Community 22`, `Community 4`, `Community 53`, `Community 33`, `Community 65`, `Community 18`, `Community 6`, `Community 15`, `Community 211`, `Community 73`, `Community 67`, `Community 77`, `Community 24`, `Community 55`, `Community 110`, `Community 120`, `Community 96`, `Community 59`, `Community 20`, `Community 44`, `Community 98`?**
...
- **Are the 718 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 718 INFERRED edges - model-reasoned connections that need verification._
