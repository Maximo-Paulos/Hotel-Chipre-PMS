...
## Corpus Check
- Large corpus: 834 files · ~576,319 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8352 nodes · 30933 edges · 310 communities detected
- Extraction: 59% EXTRACTED · 41% INFERRED · 0% AMBIGUOUS · INFERRED: 12742 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 12742 · contains: 4992 · calls: 3655 · ON_BRANCH: 2386 · MODIFIES: 2348 · rationale_for: 1539 · imports: 873 · imports_from: 671 · method: 595 · PARENT_OF: 569 · inherits: 560 · re_exports: 3
...
Cohesion: 0.02
Nodes (157): requestVerification(), apiFetch(), buildAuthHeaders(), buildUrl(), formatErrorDetail(), handleUnauthorized(), hasValidSession(), isTokenExpired() (+149 more)
...
Cohesion: 0.04
Nodes (208): codex/feature/pms-e2e-scale-hardening, worktree-agent-a945788514ece683f, worktree-agent-aa90c760fab5d7651, worktree-agent-accdf065d7f106429, 00af83e chore(graphify): regenerate graph after B4 manual OTA + manual tarifa + B4.2, 0255d4f Normalize Graphify artifact paths, 0391f8f Fix flaky detached-node false positive in mobile touch-target check, 03ec9de Refresh Graphify after Fase 9 role QA fixes (+200 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (207): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+199 more)
...
Cohesion: 0.02
Nodes (140): graphify_state(), main(), claude/feature/pms-roles-housekeeping-qa, 00bf891 Explain analytics errors and add retry action, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker (+132 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (144): FastAPI routes for outsourced laundry vendors, pricing and remitos.  Separate ro, RemitoCreate, RemitoCreateResponse, RemitoLineIn, RemitoLineRead, RemitoRead, VendorBalanceLine, VendorCreate (+136 more)
...
Cohesion: 0.02
Nodes (28): a5ee7be fix(migrations): make schema-drift-era tables idempotent against self-healed production, guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho, _audit_action_enum(), audit_log table and transaction.hotel_id FK  Adds the tenant-scoped audit_logs t, upgrade(), v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin, v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_, v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus (+20 more)
...
Cohesion: 0.04
Nodes (57): _authorize_override(), checkin(), checkin_partial(), createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge (+49 more)
...
Cohesion: 0.03
Nodes (22): FastAPI routes for provider connections. Exposes /api/connections/{provider}/con, _require_demo_mode(), reset_demo(), seed_demo(), Database engine and session management. Supports both PostgreSQL (production) an, Reapply RLS tenant context lost when a commit ends the transaction.      ``app.s, _reapply_tenant_context(), Tenant-scoped audit log for tracking mutations across core tables. Every write t (+14 more)
...
Cohesion: 0.05
Nodes (61): validateGuestForCheckin(), add_reservation_guests(), addReservationCharge(), addReservationGuests(), buildQueryString(), cancelReservation(), change_dates(), CheckInPayload (+53 more)
...
Cohesion: 0.05
Nodes (49): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+41 more)
...
Cohesion: 0.05
Nodes (39): addGuestCompanions(), addGuestTag(), _build_guest_ledger_csv(), buildGuestQueryString(), checkInGuestReservation(), createGuest(), _enum_value(), export_guest_ledger() (+31 more)
...
Cohesion: 0.05
Nodes (12): 194af4d fix(reservations): search guests by name/DNI instead of raw ID field, 8307525 chore(graphify): refresh code graph after guest search panel changes, credentials, manager, credentials, credentials, receptionist, credentials (+4 more)
...
Cohesion: 0.23
Nodes (35): booking_webhook(), despegar_webhook(), expedia_webhook(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia., Receive reservation notifications from Despegar. (+27 more)
...
Cohesion: 0.07
Nodes (30): Base, FxPolicy, ProductRoomCompatibility, RatePlan, RatePlanPrice, Commercial domain models for the next reservation/OTA foundation.  These tables, SellableProduct, TaxPolicy (+22 more)
...
Cohesion: 0.08
Nodes (27): getPaymentSummary(), makePayment(), newPaymentIdempotencyKey(), PaymentMethod, PaymentRequest, PaymentSummary, FastAPI routes for Payments., TransactionType (+19 more)
...
- **Thin community `Community 289`** (2 nodes): `owner`, `receptionist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 304`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 313`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (1 nodes): `TestCurrentSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `TestExportSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 3` to `Community 250`, `Community 0`, `Community 17`, `Community 1`, `Community 198`, `Community 80`, `Community 233`, `Community 9`, `Community 52`, `Community 125`, `Community 40`, `Community 54`, `Community 23`, `Community 60`, `Community 79`, `Community 19`, `Community 59`, `Community 28`, `Community 14`, `Community 112`, `Community 10`, `Community 145`, `Community 6`, `Community 31`, `Community 104`, `Community 2`, `Community 5`, `Community 33`, `Community 74`, `Community 126`, `Community 36`, `Community 53`, `Community 39`, `Community 181`, `Community 217`, `Community 70`, `Community 89`, `Community 4`, `Community 223`, `Community 95`, `Community 206`, `Community 207`, `Community 110`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 2` to `Community 1`, `Community 311`, `Community 33`, `Community 9`, `Community 22`, `Community 42`, `Community 8`, `Community 107`, `Community 5`, `Community 3`, `Community 59`, `Community 39`, `Community 316`, `Community 60`, `Community 23`, `Community 6`, `Community 0`, `Community 256`, `Community 118`, `Community 97`, `Community 53`, `Community 72`, `Community 101`, `Community 10`, `Community 28`, `Community 70`, `Community 204`, `Community 102`, `Community 79`, `Community 95`, `Community 74`, `Community 52`, `Community 36`, `Community 14`, `Community 179`, `Community 19`, `Community 49`, `Community 319`, `Community 320`, `Community 84`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 3`, `Community 107`, `Community 9`, `Community 5`, `Community 59`, `Community 39`, `Community 54`, `Community 40`, `Community 60`, `Community 23`, `Community 6`, `Community 14`, `Community 218`, `Community 53`, `Community 72`, `Community 62`, `Community 2`, `Community 79`, `Community 28`, `Community 117`, `Community 102`, `Community 19`, `Community 49`, `Community 319`, `Community 320`, `Community 84`?**
