...
## Corpus Check
- Large corpus: 834 files · ~575,951 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8345 nodes · 30508 edges · 330 communities detected
- Extraction: 58% EXTRACTED · 42% INFERRED · 0% AMBIGUOUS · INFERRED: 12742 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 12742 · contains: 4992 · calls: 3655 · MODIFIES: 2331 · ON_BRANCH: 1984 · rationale_for: 1539 · imports: 872 · imports_from: 671 · method: 595 · PARENT_OF: 564 · inherits: 560 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 834 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 9 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `a5ee7be`
...
Cohesion: 0.02
Nodes (337): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, worktree-agent-a945788514ece683f, 00af83e chore(graphify): regenerate graph after B4 manual OTA + manual tarifa + B4.2, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit (+329 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (263): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest. (+255 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (223): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+215 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (96): _authorize_override(), checkin(), checkin_partial(), _require_demo_mode(), reset_demo(), seed_demo(), Database engine and session management. Supports both PostgreSQL (production) an, Reapply RLS tenant context lost when a commit ends the transaction.      ``app.s (+88 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (167): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+159 more)
...
Cohesion: 0.05
Nodes (196): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+188 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (146): CheckInRequest, FastAPI routes for outsourced laundry vendors, pricing and remitos.  Separate ro, RemitoCreate, RemitoCreateResponse, RemitoLineIn, RemitoLineRead, RemitoRead, VendorBalanceLine (+138 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (134): FastAPI routes for Check-in / Check-out., B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, Guest, GuestRatingEnum, GuestTag, GuestTagTypeEnum, Guest and GuestCompanion models. Exhaustive fields for check-in panel: identity, Behavioral / alert tags on a guest (v72 §2.6).     Multiple tags per guest; each (+126 more)
...
Cohesion: 0.03
Nodes (41): 7e2edb6 Merge Analytics R1.0, df173d1 Implement Analytics R1.0 dashboard, chat IA, and support, AnalyticsComparisonStateRead, AnalyticsComparisonWindowRead, AnalyticsMetricCardRead, AnalyticsResponseEnvelopeRead, AnalyticsStarterSummaryDataRead, AnalyticsStarterSummaryRead (+33 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (74): CompanyDocument, CompanyDocumentStatusEnum, CompanyDocumentTypeEnum, CompanyDocument — attachments/vouchers for company reservations (v72 §3.6). Trac, Document/voucher associated with a company reservation (v72 §3.6).     If requir, HotelPermissionOverride, Permission, Configurable permission matrix models. (+66 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (33): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, 02c5612 Add tenant realtime sync and warehouse boundary, 3d34a97 Connect system mail through master admin, 79ee7c9 fix(auth): validate email format on registration (+25 more)
...
Cohesion: 0.04
Nodes (51): createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge, PaymentSurchargeCreatePayload, PaymentSurchargeType, createRoomBlock() (+43 more)
...
Cohesion: 0.03
Nodes (63): OnboardingWizard(), SettingsAssistantPage(), SettingsHotelPage(), SettingsSecurityPage(), SettingsUsersPage(), AcceptInvitationPage(), FunctionsPage(), LoginPage() (+55 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (60): validateGuestForCheckin(), add_reservation_guests(), addReservationCharge(), addReservationGuests(), buildQueryString(), cancelReservation(), change_dates(), CheckInPayload (+52 more)
...
Cohesion: 0.05
Nodes (38): addGuestCompanions(), addGuestTag(), _build_guest_ledger_csv(), buildGuestQueryString(), checkInGuestReservation(), createGuest(), _enum_value(), export_guest_ledger() (+30 more)
...
Cohesion: 0.07
Nodes (38): Base, FxPolicy, ProductRoomCompatibility, RatePlan, RatePlanPrice, Commercial domain models for the next reservation/OTA foundation.  These tables, SellableProduct, TaxPolicy (+30 more)
...
Cohesion: 0.07
Nodes (31): GuestUpdatePayload, PaymentMethod, ReservationStatus, CheckinCaptureForm, emptyCaptureForm, guestFullName(), paymentMethodOptions, Props (+23 more)
...
Cohesion: 0.09
Nodes (23): listRooms(), cancelWaitlistEntry(), createWaitlistEntry(), listWaitlistEntries(), promoteWaitlistEntry(), API routes for reservation waitlist operations., WaitlistEntry, WaitlistEntryCreate (+15 more)
...
Cohesion: 0.10
Nodes (22): Reservation, 8f9e29f feat(reservations): add manual OTA reservation form (B4) + shared guest quick-create, f68087e fix(frontend): stop deriving "today" defaults from UTC, use hotel-local date, emptyQuickGuestForm(), GuestQuickCreatePanelProps, hasQuickGuestFormData(), QuickGuestFormValues, CHANNEL_OPTIONS (+14 more)
...
Cohesion: 0.08
Nodes (15): 0a457cb feat(checkin): B3 partial check-in + mandatory guest profile capture + companions, 369a3cc fix(reservations): allow manual total_amount override without a Company account, compute_missing_guest_fields(), get_profile(), JurisdictionProfile, Jurisdiction profiles for guest/check-in validation.  AR remains the only launch, B3.2: migration adding guests.birth_place/birth_country/marital_status/occupatio, _run() (+7 more)
...
Cohesion: 0.12
Nodes (13): FastAPI routes for provider connections. Exposes /api/connections/{provider}/con, Exception, Connection, Connection model for external provider integrations. Stores credentials/settings, ConnectionError, Connection service to manage external provider credentials/settings. Provides an, Raised for validation problems while creating/updating a connection., Create or update a provider connection while keeping JSON fields intact.     - N (+5 more)
...
Cohesion: 0.15
Nodes (16): MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection, MasterAdminContext (+8 more)
...
Cohesion: 0.18
Nodes (14): _canonical_identity(), _enabled(), _identity_contains(), _load_local_evidence(), _load_provider_evidence(), Fail-closed safety guard for PostgreSQL tests that mutate schema or data.  Remot, Return ``dsn`` only when provider evidence proves a disposable QA target.      E, Return ``dsn`` only when provider evidence proves a disposable QA target.      E (+6 more)
...
Cohesion: 0.20
Nodes (14): _configure_resend(), C2 regression (SQLite, syntactic only -- RLS is a Postgres-only concern,     see, _seed_hotel(), _seed_platform_admin(), _seed_subscription(), test_master_dashboard_summary_counts_subscriptions_across_hotels(), test_master_email_status_and_test_mail(), test_master_login_bootstraps_env_account() (+6 more)
...
Cohesion: 0.26
Nodes (7): getPaymentSummary(), makePayment(), newPaymentIdempotencyKey(), PaymentRequest, PaymentSummary, TransactionType, useGuardedMutation()
...
Cohesion: 0.27
Nodes (9): Lightweight subscription tracking for enforcement and auditing (v2 tables)., Subscription, SubscriptionEvent, plan_catalog(), Subscription entitlements and enforcement helpers built on v2 tables. Keeps lega, Ensure a Subscription row exists for the hotel. Returns (subscription, seeded_fl, Return a normalized snapshot for API/middleware:     plan, status, limits, can_w, Alias to expose the snapshot in a name aligned with the spec wording. (+1 more)
...
Cohesion: 0.22
Nodes (3): a5ee7be fix(migrations): make schema-drift-era tables idempotent against self-healed production, Add transactions.created_by_user_id for payment audit trail.  Transaction had cr, laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre
...
Cohesion: 0.33
Nodes (5): Forward tests for the scalable data-architecture specialist workflow.  These are, A valid entity id from hotel 2 cannot cross hotel 1's API boundary., A tariff revision change invalidates the quote before any write., test_forward_multi_hotel_context_cannot_read_or_attach_foreign_entities(), test_forward_stale_tariff_quote_cannot_persist_reservation()
...
Cohesion: 0.67
Nodes (3): load_provider_evidence_public_key(), Load the sole Ed25519 trust anchor from PEM or base64 raw bytes., Load the sole Ed25519 trust anchor from PEM or base64 raw bytes.
...
- **Thin community `Community 126`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 208`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 246`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 250`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 271`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 273`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (2 nodes): `owner`, `receptionist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (2 nodes): `POST /api/checkin/checkout only enforced authentication (get_auth_context),`, `test_housekeeping_cannot_checkout_reservation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 318`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 326`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (1 nodes): `repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 333`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 1` to `Community 247`, `Community 3`, `Community 197`, `Community 76`, `Community 233`, `Community 9`, `Community 104`, `Community 118`, `Community 37`, `Community 53`, `Community 19`, `Community 57`, `Community 74`, `Community 14`, `Community 42`, `Community 24`, `Community 12`, `Community 94`, `Community 10`, `Community 138`, `Community 2`, `Community 8`, `Community 28`, `Community 95`, `Community 30`, `Community 32`, `Community 119`, `Community 5`, `Community 69`, `Community 36`, `Community 23`, `Community 179`, `Community 162`, `Community 4`, `Community 253`, `Community 84`, `Community 0`, `Community 87`, `Community 125`, `Community 206`, `Community 207`, `Community 101`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 1` to `Community 4`, `Community 335`, `Community 30`, `Community 9`, `Community 40`, `Community 7`, `Community 98`, `Community 3`, `Community 42`, `Community 23`, `Community 339`, `Community 57`, `Community 19`, `Community 8`, `Community 257`, `Community 110`, `Community 89`, `Community 69`, `Community 66`, `Community 32`, `Community 5`, `Community 10`, `Community 2`, `Community 24`, `Community 162`, `Community 204`, `Community 92`, `Community 74`, `Community 87`, `Community 104`, `Community 125`, `Community 116`, `Community 36`, `Community 12`, `Community 174`, `Community 14`, `Community 47`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 2` to `Community 1`, `Community 98`, `Community 23`, `Community 9`, `Community 3`, `Community 42`, `Community 53`, `Community 37`, `Community 57`, `Community 19`, `Community 8`, `Community 12`, `Community 218`, `Community 69`, `Community 66`, `Community 58`, `Community 5`, `Community 74`, `Community 24`, `Community 109`, `Community 92`, `Community 263`, `Community 14`, `Community 47`?**
