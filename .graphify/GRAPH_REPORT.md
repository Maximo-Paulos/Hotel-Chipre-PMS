...
## Corpus Check
- Large corpus: 773 files · ~515,987 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7263 nodes · 24753 edges · 305 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9297 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9297 · contains: 4475 · calls: 3397 · MODIFIES: 1943 · ON_BRANCH: 1598 · rationale_for: 1177 · imports: 746 · method: 590 · imports_from: 587 · inherits: 535 · PARENT_OF: 408
...
Cohesion: 0.03
Nodes (181): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02c5612 Add tenant realtime sync and warehouse boundary, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03ec9de Refresh Graphify after Fase 9 role QA fixes (+173 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (176): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+168 more)
...
Cohesion: 0.03
Nodes (70): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), _mask_email() (+62 more)
...
Cohesion: 0.03
Nodes (32): dc4b68a ojooooo, e34785c prueba, build_default_ota_orchestrator(), get_default_adapter(), Default OTA adapter registry.  This keeps provider construction in one place so, DashboardPage(), todayIso(), bubbleStyles (+24 more)
...
Cohesion: 0.03
Nodes (32): _DecimalAwareEncoder, _frontend_placeholder(), _is_demo_mode_enabled(), lifespan(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on (+24 more)
...
Cohesion: 0.05
Nodes (27): 1f352e4 feat(reports): SLICE-11 operational reports + alerts, 283135b feat(ops): SLICE-13 laundry + stock foundations, 6f4beb1 feat(v72): Wave 3 — public API/keys + allocation V72 rules, 6f60c12 feat(security): SLICE-01 configurable permission matrix + role boundaries, a2c31f7 feat(ops): SLICE-04 room blocks + availability/allocation exclusion, c486aa3 feat(v72): Wave 2 — companies/documents, cash register/arqueo, guest override, get_public_api_context(), _public_api_rate_limit_for_hotel() (+19 more)
...
Cohesion: 0.08
Nodes (16): 70b1481 Relax startup validation for optional integrations, c580b56 ojala si, Transaction and PaymentMethod models. Supports: Efectivo (Cash), MercadoPago, Pa, MERCADOPAGO_WEBHOOK_SECRET is required only when MP_ACCESS_TOKEN is set., Partial integration env vars should not block production startup., Partial integration env vars should not block production startup., OAuth redirect URIs are only validated when the corresponding service credential, OAuth redirect URIs are only validated when the corresponding service credential (+8 more)
...
Cohesion: 0.11
Nodes (18): CashHandoffSchemaRepairError, main(), missing_model_tables(), Apply the additive cash-handoff repair in one PostgreSQL transaction., Apply the additive cash-handoff repair in one PostgreSQL transaction., Return model tables absent from a PostgreSQL database without changing it., Raised when the safe repair cannot run against the configured database., Raised when the safe repair cannot run against the configured database. (+10 more)
...
- **Thin community `Community 283`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 298`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (2 nodes): `Derive the BRM §16.2 reportable origin for a reservation.      Precedence:`, `reportable_origin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `Schemas for manual OTA reservation entry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 6` to `Community 240`, `Community 204`, `Community 21`, `Community 15`, `Community 75`, `Community 22`, `Community 116`, `Community 34`, `Community 57`, `Community 29`, `Community 65`, `Community 7`, `Community 46`, `Community 13`, `Community 103`, `Community 8`, `Community 143`, `Community 5`, `Community 4`, `Community 3`, `Community 33`, `Community 9`, `Community 62`, `Community 117`, `Community 47`, `Community 30`, `Community 24`, `Community 63`, `Community 306`, `Community 2`, `Community 0`, `Community 313`, `Community 39`, `Community 61`, `Community 71`, `Community 241`, `Community 89`, `Community 1`, `Community 40`, `Community 213`, `Community 83`, `Community 193`, `Community 194`, `Community 123`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 3` to `Community 10`, `Community 16`, `Community 31`, `Community 100`, `Community 4`, `Community 113`, `Community 26`, `Community 33`, `Community 6`, `Community 22`, `Community 96`, `Community 29`, `Community 5`, `Community 0`, `Community 246`, `Community 40`, `Community 247`, `Community 9`, `Community 85`, `Community 47`, `Community 91`, `Community 8`, `Community 88`, `Community 46`, `Community 61`, `Community 65`, `Community 75`, `Community 7`, `Community 83`, `Community 62`, `Community 30`, `Community 158`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 5`, `Community 113`, `Community 31`, `Community 2`, `Community 6`, `Community 22`, `Community 3`, `Community 46`, `Community 57`, `Community 34`, `Community 29`, `Community 13`, `Community 47`, `Community 40`, `Community 24`, `Community 63`, `Community 88`, `Community 39`, `Community 7`, `Community 158`?**
