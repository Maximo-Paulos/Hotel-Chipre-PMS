...
## Corpus Check
- Large corpus: 836 files · ~578,627 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8390 nodes · 31483 edges · 297 communities detected
- Extraction: 59% EXTRACTED · 41% INFERRED · 0% AMBIGUOUS · INFERRED: 13006 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 13006 · contains: 5009 · calls: 3682 · ON_BRANCH: 2594 · MODIFIES: 2352 · rationale_for: 1557 · imports: 878 · imports_from: 675 · method: 595 · PARENT_OF: 572 · inherits: 560 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 836 · Candidates: recursive
...
1. `ReservationStatusEnum` - 800 edges
2. `Reservation` - 799 edges
3. `HotelConfiguration` - 751 edges
4. `Room` - 642 edges
5. `Guest` - 628 edges
6. `RoomCategory` - 577 edges
7. `Base` - 453 edges
8. `RoomStatusEnum` - 386 edges
9. `ReservationError` - 360 edges
...
Cohesion: 0.02
Nodes (211): RoomBlockCreate, RoomBlockRead, CheckInRequest, FastAPI routes for Check-in / Check-out., B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp (+203 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (189): add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Base, Base class for all ORM models., DeclarativeBase (+181 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (198): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), HotelConfiguration (+190 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (190): worktree-agent-a945788514ece683f, worktree-agent-aa90c760fab5d7651, worktree-agent-aac480096c25247c2, worktree-agent-accdf065d7f106429, 00af83e chore(graphify): regenerate graph after B4 manual OTA + manual tarifa + B4.2, 0255d4f Normalize Graphify artifact paths, 0391f8f Fix flaky detached-node false positive in mobile touch-target check, 03ec9de Refresh Graphify after Fase 9 role QA fixes (+182 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (186): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+178 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (136): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+128 more)

### Community 7 - "Community 7"
Cohesion: 0.12
Nodes (155): cancel_reservation(), create_new_reservation(), create_or_update_manual_ota(), create_reservation_charge(), _ensure_manual_rate_permission(), extend_stay(), mark_no_show(), modify_reservation() (+147 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (120): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), validateGuestForCheckin() (+112 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (137): graphify_state(), main(), main(), run(), validate_json(), claude/feature/pms-roles-housekeeping-qa, 00bf891 Explain analytics errors and add retry action, 02f4bb4 Record Apple WebKit business matrix (+129 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (59): _require_demo_mode(), reset_demo(), seed_demo(), _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), mercadopago_payment_link_webhook() (+51 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (50): _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., a61a51c chore: checkpoint de prueba antes de gemma 4, dc4b68a ojooooo, e34785c prueba, Common contracts for OTA provider adapters.  The goal is to keep Booking, Expedi, build_default_ota_orchestrator(), get_default_adapter() (+42 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (63): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), 1a71e7d feat: add ota allocation data foundation, 307e650 Add replayable operational warehouse projections, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes (+55 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (113): FastAPI routes for outsourced laundry vendors, pricing and remitos.  Separate ro, RemitoCreate, RemitoCreateResponse, RemitoLineIn, RemitoLineRead, RemitoRead, VendorBalanceLine, VendorCreate (+105 more)
...
Cohesion: 0.04
Nodes (54): addGuestCompanions(), addGuestTag(), _build_guest_ledger_csv(), buildGuestQueryString(), checkInGuestReservation(), createGuest(), _enum_value(), export_guest_ledger() (+46 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (29): 099e4c8 fix(e2e): stop the WebKit business Apple matrix from colliding with itself, 194af4d fix(reservations): search guests by name/DNI instead of raw ID field, 29feed9 chore(graphify): refresh code graph after reservation quote error fix, 45b6181 feat(stock): collapse movement Ubicacion/Reserva behind advanced options, add item delete, 6b53804 Merge price-quote error fix into pms-e2e-scale-hardening, 8307525 chore(graphify): refresh code graph after guest search panel changes, 9f8c4cd fix(reservations): show the real quote error instead of a stuck loading message, b5ae3ca fix(migrations): guard uq_reservation_hotel_id_id against index-only drift (+21 more)
...
Cohesion: 0.05
Nodes (44): cancelPaymentLinkTest(), createMercadoPagoPaymentLinkTest(), listPaymentLinkTests(), PaymentLinkTest, PaymentLinkTestCreatePayload, refreshPaymentLinkTest(), admin_comped_override(), change_plan() (+36 more)
...
Cohesion: 0.05
Nodes (38): getPaymentSummary(), makePayment(), newPaymentIdempotencyKey(), PaymentMethod, PaymentRequest, PaymentSummary, FastAPI routes for Payments., TransactionType (+30 more)
...
Cohesion: 0.06
Nodes (37): Base, FxPolicy, ProductRoomCompatibility, RatePlan, RatePlanPrice, Commercial domain models for the next reservation/OTA foundation.  These tables, SellableProduct, TaxPolicy (+29 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (36): main(), valid_https(), bootstrap_configuration_fingerprint(), Shared, secret-safe binding for the Render QA bootstrap configuration., Hash the exact provider-observed values without exposing them individually., Hash the exact provider-observed values without exposing them individually., Hash the exact provider-observed values without exposing them individually., 3635693 Bootstrap trusted isolated cloud QA gate (+28 more)
...
Cohesion: 0.14
Nodes (29): 6e6d179 Prepare release candidate for landing and onboarding, 87b0eb6 Improve marketing SEO content, linking, and metadata, Seo(), SeoProps, StructuredData, resolveAppUrl(), resolveSalesContactUrl(), benefitPoints (+21 more)
...
Cohesion: 0.10
Nodes (30): MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection, MasterAdminContext (+22 more)
...
Cohesion: 0.06
Nodes (21): 1cd0fce Merge claude/feature/pms-roles-housekeeping-qa: integrate parallel QA fixes, housekeeping, owner, manager, receptionist, Persona, personas, _create_receptionist_user() (+13 more)

### Community 55 - "Community 55"
Cohesion: 0.09
Nodes (34): connect_integration(), connectIntegration(), _connection_error_message(), _ensure_enabled(), fetchIntegrations(), finalizeIntegrationOAuth(), _find_integration(), get_status() (+26 more)
...
Cohesion: 0.09
Nodes (14): _make_reservation(), Tests for V72 §9 — Waitlist and Overbooking.  Key implementation details discove, The Reservation model must have is_wait_listed and wait_list_reason fields., A reservation can be created with is_wait_listed=True and no room., Verify is_wait_listed survives a round-trip through the database., Trying to resolve with a non-existent room raises ReservationError., A waitlisted reservation (room_id=None) must not block room availability., find_available_rooms should still return the room when only waitlisted reservati (+6 more)
...
Cohesion: 0.13
Nodes (15): ActiveRoomBlockItem, AvailableWithReviewItem, CashSessionStatusRead, daily_report(), DailyOperationalReport, getDailyOperationalReport(), getOperationalAlerts(), NightlyOperationalSummary (+7 more)
...
Cohesion: 0.16
Nodes (10): authed_client(), client_with_db(), get_auth_context_target(), get_db_override_target(), Guessing the 6-digit verification code must itself be throttled, not     just re, validate-reset (no-op check) and reset-password (consumes the code)     guess th, Registration had no throttle at all: an attacker could farm unlimited     accoun, test_register_is_rate_limited_by_source() (+2 more)
...
Cohesion: 0.27
Nodes (8): OperationalReservationGroup, OperationalReservationSummary, cashStatusLabel(), money(), reportsErrorMessage(), ReportsPage(), ReservationRow(), today()
...
- **Thin community `Community 70`** (2 nodes): `_hotel_default_currency()`, `OTAIntegrationService`
...
- **Thin community `Community 210`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 248`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 269`** (1 nodes): `TestCheckIn`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 271`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 291`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (1 nodes): `repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 304`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 2` to `Community 12`, `Community 1`, `Community 10`, `Community 11`, `Community 200`, `Community 80`, `Community 232`, `Community 7`, `Community 52`, `Community 126`, `Community 38`, `Community 56`, `Community 25`, `Community 60`, `Community 78`, `Community 19`, `Community 43`, `Community 27`, `Community 17`, `Community 104`, `Community 14`, `Community 146`, `Community 29`, `Community 100`, `Community 3`, `Community 31`, `Community 35`, `Community 127`, `Community 15`, `Community 0`, `Community 34`, `Community 51`, `Community 109`, `Community 185`, `Community 68`, `Community 74`, `Community 92`, `Community 208`, `Community 209`, `Community 141`, `Community 106`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 3` to `Community 6`, `Community 31`, `Community 7`, `Community 41`, `Community 13`, `Community 0`, `Community 10`, `Community 12`, `Community 2`, `Community 43`, `Community 1`, `Community 300`, `Community 60`, `Community 25`, `Community 256`, `Community 118`, `Community 94`, `Community 51`, `Community 70`, `Community 35`, `Community 14`, `Community 27`, `Community 68`, `Community 206`, `Community 109`, `Community 98`, `Community 78`, `Community 92`, `Community 52`, `Community 34`, `Community 17`, `Community 141`, `Community 182`, `Community 19`, `Community 47`, `Community 71`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 2`, `Community 1`, `Community 7`, `Community 12`, `Community 43`, `Community 56`, `Community 38`, `Community 60`, `Community 25`, `Community 17`, `Community 219`, `Community 51`, `Community 70`, `Community 61`, `Community 3`, `Community 78`, `Community 27`, `Community 117`, `Community 109`, `Community 98`, `Community 269`, `Community 19`, `Community 47`, `Community 71`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 798 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 798 INFERRED edges - model-reasoned connections that need verification._
- **Are the 792 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 792 INFERRED edges - model-reasoned connections that need verification._
- **Are the 744 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 744 INFERRED edges - model-reasoned connections that need verification._
- **Are the 637 inferred relationships involving `Room` (e.g. with `RoomBlockCreate` and `RoomBlockRead`) actually correct?**
  _`Room` has 637 INFERRED edges - model-reasoned connections that need verification._