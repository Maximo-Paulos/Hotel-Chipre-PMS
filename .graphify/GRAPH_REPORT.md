...
## Corpus Check
- Large corpus: 772 files · ~515,642 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7250 nodes · 24718 edges · 317 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9297 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9297 · contains: 4473 · calls: 3397 · MODIFIES: 1930 · ON_BRANCH: 1588 · rationale_for: 1177 · imports: 746 · method: 590 · imports_from: 587 · inherits: 535 · PARENT_OF: 398
...
Cohesion: 0.02
Nodes (152): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+144 more)
...
Cohesion: 0.02
Nodes (174): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker (+166 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (160): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+152 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (158): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re (+150 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (125): CheckInRequest, FastAPI routes for Check-in / Check-out., HotelConfiguration, Reservation, CheckInError, Custom exception for check-in validation errors., Custom exception for check-in validation errors., _enum_value() (+117 more)
...
Cohesion: 0.04
Nodes (118): delete_room(), housekeeping_summary(), FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it, Simple availability helper. Returns a placeholder message if required     parame, Simple availability helper. Returns a placeholder message if required     parame, Generic room update (number, floor, notes, status, etc.)., Generic room update (number, floor, notes, status, etc.). (+110 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (110): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), createPaymentLink() (+102 more)
...
Cohesion: 0.03
Nodes (89): Base, Base class for all ORM models., _DecimalAwareEncoder, _frontend_placeholder(), _is_demo_mode_enabled(), lifespan(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on (+81 more)
...
Cohesion: 0.09
Nodes (83): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Individual money movement within an open cash session.     Linked optionally to (+75 more)
...
Cohesion: 0.04
Nodes (33): CategoryPayload, DepositPolicyPayload, finishOnboarding(), HotelIdentityPayload, OnboardingProviderSetup, OnboardingStatus, OTAChannelsPayload, OwnerPayload (+25 more)
...
Cohesion: 0.07
Nodes (51): Payment, PaymentLink, PaymentWebhookEvent, Payment gateway tracking models: PaymentLink, Payment, PaymentWebhookEvent.  Sou, One gateway payment object (MP preference / PayPal order / Stripe intent)., Raw webhook log per payment — idempotent on (hotel_id, provider, webhook_id)., Raw webhook log per payment — idempotent on (hotel_id, provider, webhook_id)., Guest-facing pre-payment object (checkout URL / QR). May collect partial payment (+43 more)
...
Cohesion: 0.19
Nodes (13): CashHandoffSchemaRepairError, main(), missing_model_tables(), Repair a legacy cash-handoff schema before starting the API.  The managed databa, Apply the additive cash-handoff repair in one PostgreSQL transaction., Apply the additive cash-handoff repair in one PostgreSQL transaction., Return model tables absent from a PostgreSQL database without changing it., Raised when the safe repair cannot run against the configured database. (+5 more)
...
Cohesion: 0.40
Nodes (2): Middleware to block mutating requests when subscription enforcement is enabled., SubscriptionEnforcementMiddleware
...
- **Thin community `Community 113`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 189`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 214`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 256`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 257`** (2 nodes): `credentials`, `PAGES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 258`** (2 nodes): `Middleware to block mutating requests when subscription enforcement is enabled.`, `SubscriptionEnforcementMiddleware`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 263`** (1 nodes): `TestCheckIn`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 277`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `add trial and comped fields to subscriptions  Revision ID: 20260419_subscription`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 311`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 319`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 11` to `Community 232`, `Community 196`, `Community 15`, `Community 22`, `Community 42`, `Community 112`, `Community 55`, `Community 18`, `Community 25`, `Community 62`, `Community 10`, `Community 14`, `Community 16`, `Community 92`, `Community 9`, `Community 137`, `Community 3`, `Community 7`, `Community 27`, `Community 6`, `Community 5`, `Community 26`, `Community 113`, `Community 4`, `Community 28`, `Community 29`, `Community 23`, `Community 71`, `Community 37`, `Community 57`, `Community 127`, `Community 32`, `Community 205`, `Community 82`, `Community 185`, `Community 186`, `Community 120`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 5` to `Community 12`, `Community 22`, `Community 10`, `Community 0`, `Community 30`, `Community 6`, `Community 66`, `Community 1`, `Community 11`, `Community 42`, `Community 3`, `Community 318`, `Community 25`, `Community 239`, `Community 32`, `Community 84`, `Community 7`, `Community 28`, `Community 26`, `Community 4`, `Community 9`, `Community 18`, `Community 57`, `Community 62`, `Community 82`, `Community 27`, `Community 29`, `Community 86`, `Community 14`, `Community 43`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 5` to `Community 3`, `Community 27`, `Community 66`, `Community 4`, `Community 10`, `Community 7`, `Community 1`, `Community 11`, `Community 42`, `Community 18`, `Community 55`, `Community 25`, `Community 16`, `Community 28`, `Community 32`, `Community 23`, `Community 71`, `Community 37`, `Community 263`, `Community 86`, `Community 22`, `Community 14`, `Community 43`?**
