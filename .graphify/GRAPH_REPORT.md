...
## Corpus Check
- Large corpus: 1029 files · ~1,644,273 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 9985 nodes · 45519 edges · 360 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 16162 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16162 · ON_BRANCH: 10064 · contains: 5881 · calls: 4313 · MODIFIES: 3228 · rationale_for: 2036 · imports: 1078 · imports_from: 831 · PARENT_OF: 661 · inherits: 646 · method: 616 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 1029 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 12 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `dceb376`
...
Cohesion: 0.10
Nodes (349): main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., agent-linensplit, agent-login, agent-mobilenav, agent-otafix (+341 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (320): PaymentSurchargeCreate, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+312 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (133): Stream tenant-scoped invalidation signals; clients refetch from Postgres-backed, stream_domain_events(), Application Configuration. Uses pydantic-settings for environment variable manag, Database engine and session management. Supports both PostgreSQL (production) an, Reapply RLS tenant context lost when a commit ends the transaction.      ``app.s, _reapply_tenant_context(), _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files. (+125 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (274): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+266 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (263): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true). (+255 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (138): requestVerification(), ApiError, ActiveRoomBlockItem, AvailableWithReviewItem, CashSessionStatusRead, DailyOperationalReport, getDailyOperationalReport(), getOccupancyReport() (+130 more)
...
Cohesion: 0.03
Nodes (183): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp (+175 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (203): email_status(), Lightweight status so the frontend can check the active system email provider., Lightweight status so the frontend can check the active system email provider., AcceptPayload, Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., Subscription status and entitlements endpoints. (+195 more)
...
Cohesion: 0.03
Nodes (150): graphify_state(), main(), main(), run(), validate_json(), claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action (+142 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (140): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), Category (+132 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (101): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+93 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (147): FastAPI routes for Payments., StockConsumptionItem, StockConsumptionReportRead, StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead (+139 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (70): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _require_demo_mode(), reset_demo(), seed_demo() (+62 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (97): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), _allow_mfa_attempt(), AuthResponse, AuthUser, _build_auth_response(), _build_login_response(), complete_mfa_login() (+89 more)
...
Cohesion: 0.03
Nodes (40): _authorize_override(), checkin(), CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload, OnboardingProviderSetup (+32 more)
...
Cohesion: 0.05
Nodes (40): getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., updateHotelConfig(), createPaymentSurcharge(), deactivatePaymentSurcharge(), listPaymentSurcharges() (+32 more)
...
Cohesion: 0.07
Nodes (37): _auth_headers(), _complete_onboarding(), _configure_resend(), _enroll_and_confirm_mfa(), _fake_google_claims(), FakeResponse, _next_totp_code(), RegisterRequest.email was a plain str with no format validation, so     garbage (+29 more)
...
Cohesion: 0.09
Nodes (34): google_login(), _pick_default_hotel_id(), Auth endpoints: register, login, email verification and password reset. Verifica, Return a session only after the required account MFA factor succeeds., "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, Validate reset code without changing password (paso previo en UI). (+26 more)
...
Cohesion: 0.09
Nodes (22): cancelWaitlistEntry(), createWaitlistEntry(), listWaitlistEntries(), promoteWaitlistEntry(), API routes for reservation waitlist operations., WaitlistEntry, WaitlistEntryCreate, WaitlistPromotePayload (+14 more)
...
Cohesion: 0.36
Nodes (6): _authenticate_user(), _decode_authorization_header(), get_current_user(), get_current_user_optional(), Non-delegable invariant: only this hotel's owner administers RBAC., require_permission_administrator()
...
Cohesion: 0.53
Nodes (5): _current_user(), recent_security_events(), revoke_current_user_sessions(), _safe_resource_id(), security_overview()
...
## Knowledge Gaps
- **809 isolated node(s):** `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`, `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`, `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`, `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`, `launch security hardening  Revision ID: 20260408_launch_security_hardening Revis` (+804 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 131`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 145`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 175`** (1 nodes): `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 227`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 233`** (1 nodes): `Public WhatsApp bot hooks authenticated only by hotel API key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 250`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 327`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 365`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 367`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 7` to `Community 14`, `Community 2`, `Community 160`, `Community 69`, `Community 215`, `Community 6`, `Community 45`, `Community 37`, `Community 41`, `Community 71`, `Community 43`, `Community 60`, `Community 108`, `Community 66`, `Community 8`, `Community 18`, `Community 3`, `Community 114`, `Community 111`, `Community 159`, `Community 4`, `Community 39`, `Community 32`, `Community 5`, `Community 36`, `Community 56`, `Community 131`, `Community 17`, `Community 1`, `Community 12`, `Community 23`, `Community 218`, `Community 81`, `Community 119`, `Community 194`, `Community 299`, `Community 85`, `Community 97`, `Community 276`, `Community 90`, `Community 0`, `Community 34`, `Community 96`, `Community 15`, `Community 168`, `Community 54`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 8` to `Community 28`, `Community 6`, `Community 15`, `Community 3`, `Community 5`, `Community 82`, `Community 14`, `Community 7`, `Community 37`, `Community 108`, `Community 60`, `Community 4`, `Community 280`, `Community 22`, `Community 64`, `Community 56`, `Community 100`, `Community 12`, `Community 105`, `Community 1`, `Community 281`, `Community 85`, `Community 66`, `Community 368`, `Community 34`, `Community 106`, `Community 96`, `Community 36`, `Community 259`, `Community 45`, `Community 168`, `Community 61`, `Community 18`, `Community 47`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 4`, `Community 7`, `Community 3`, `Community 6`, `Community 14`, `Community 37`, `Community 43`, `Community 71`, `Community 108`, `Community 60`, `Community 114`, `Community 39`, `Community 8`, `Community 12`, `Community 73`, `Community 117`, `Community 106`, `Community 141`, `Community 18`, `Community 47`?**
