...
## Corpus Check
- Large corpus: 831 files · ~570,258 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8288 nodes · 30147 edges · 320 communities detected
- Extraction: 58% EXTRACTED · 42% INFERRED · 0% AMBIGUOUS · INFERRED: 12717 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 12717 · contains: 4968 · calls: 3636 · MODIFIES: 2278 · ON_BRANCH: 1777 · rationale_for: 1514 · imports: 871 · imports_from: 670 · method: 595 · inherits: 560 · PARENT_OF: 558 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 831 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 9 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `cf391b6`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 792 edges
2. `Reservation` - 791 edges
3. `HotelConfiguration` - 734 edges
4. `Room` - 632 edges
5. `Guest` - 612 edges
...
Cohesion: 0.01
Nodes (318): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening (+310 more)
...
Cohesion: 0.01
Nodes (101): _authorize_override(), checkin(), checkin_partial(), _require_demo_mode(), reset_demo(), seed_demo(), Database engine and session management. Supports both PostgreSQL (production) an, Reapply RLS tenant context lost when a commit ends the transaction.      ``app.s (+93 more)
...
Cohesion: 0.03
Nodes (175): add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Base, Base class for all ORM models., DeclarativeBase (+167 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (198): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+190 more)
...
Cohesion: 0.02
Nodes (128): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+120 more)
...
Cohesion: 0.02
Nodes (114): CheckInRequest, FastAPI routes for Payments., StockConsumptionItem, StockConsumptionReportRead, StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate (+106 more)
...
Cohesion: 0.05
Nodes (41): cancelPaymentLinkTest(), createMercadoPagoPaymentLinkTest(), listPaymentLinkTests(), PaymentLinkTest, PaymentLinkTestCreatePayload, refreshPaymentLinkTest(), admin_comped_override(), change_plan() (+33 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (59): AcceptPayload, AuthContext, get_auth_context(), _parse_header_hotel_id(), _parse_token_hotel_id(), Strict authentication/context helpers.  Every operational request must resolve t, Return an authenticated context scoped to an active hotel membership., Return an authenticated context scoped to an active hotel membership. (+51 more)
...
Cohesion: 0.05
Nodes (27): create_movement(), createStockItem(), createStockLocation(), createStockMovement(), CurrentStock, DecimalValue, deleteStockItem(), _ensure_adjustment_permission() (+19 more)
...
Cohesion: 0.06
Nodes (37): updateLaundryStatus(), createLaundryRemito(), createLaundryVendor(), getLaundryVendorBalance(), getLaundryVendorSpend(), LaundryRemito, LaundryRemitoCreate, LaundryRemitoCreateResponse (+29 more)
...
Cohesion: 0.08
Nodes (26): _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Best concrete default value for a NOT-NULL column, or None if unknown.      Pref, Fill NULLs in NOT-NULL model columns that carry a default.      A column added i (+18 more)
...
Cohesion: 0.13
Nodes (15): getPaymentSummary(), makePayment(), newPaymentIdempotencyKey(), PaymentRequest, PaymentSummary, TransactionType, 7040c65 fix(master-admin): Stripe webhook retry redelivery no longer 500s, bcbaf10 fix(payments): unify dead MP webhook signature validator + guard payment status regressions (+7 more)
...
Cohesion: 0.12
Nodes (10): _make_reservation(), Only is_wait_listed=True reservations should appear in the waitlist query., Create one normal and one waitlisted reservation, return (normal, waitlisted)., Resolving with an already-occupied room must be blocked., Trying to resolve with a non-existent room raises ReservationError., Helper — create a reservation through the service layer., After resolve, the DB row reflects the updated state., A normal reservation blocks the room; a waitlisted one does not. (+2 more)
...
Cohesion: 0.16
Nodes (18): _apply_setting(), Bind a SQLAlchemy transaction to the authenticated tenant.  PostgreSQL RLS polic, Stash the last value applied for ``setting_name`` on this session.      ``sessio, Set or clear the current hotel id for tenant-scoped RLS policies., Set both principals for a request or a single-hotel worker job., Flag the transaction as a verified master-admin session.      RLS policies that, Reapply every ``set_config`` value this session set before a commit.      Called, Set the authenticated user id used by membership RLS policies. (+10 more)
...
Cohesion: 0.15
Nodes (7): 45b6181 feat(stock): collapse movement Ubicacion/Reserva behind advanced options, add item delete, 90e2dd0 feat(stock): D5 -- consumption-by-period card on StockPage, closes Via D, 98907b6 feat(stock): D5 -- consumption report by period, closes Via D, housekeeping, owner, credentials, credentials
...
Cohesion: 0.25
Nodes (3): C1: after_commit listener reapplies transaction-scoped RLS tenant context.  ``se, Most sessions never call set_tenant_*; the listener must not touch them., test_sqlite_commit_with_no_tenant_context_is_a_clean_noop()
...
- **Thin community `Community 228`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 243`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 292`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 320`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 326`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 4` to `Community 244`, `Community 1`, `Community 2`, `Community 197`, `Community 79`, `Community 229`, `Community 8`, `Community 111`, `Community 125`, `Community 35`, `Community 55`, `Community 18`, `Community 78`, `Community 16`, `Community 40`, `Community 25`, `Community 15`, `Community 98`, `Community 10`, `Community 147`, `Community 6`, `Community 28`, `Community 99`, `Community 3`, `Community 5`, `Community 23`, `Community 30`, `Community 126`, `Community 11`, `Community 73`, `Community 34`, `Community 59`, `Community 181`, `Community 65`, `Community 57`, `Community 167`, `Community 7`, `Community 66`, `Community 251`, `Community 72`, `Community 90`, `Community 133`, `Community 205`, `Community 206`, `Community 107`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 3` to `Community 7`, `Community 23`, `Community 8`, `Community 41`, `Community 9`, `Community 1`, `Community 289`, `Community 5`, `Community 4`, `Community 40`, `Community 329`, `Community 65`, `Community 18`, `Community 6`, `Community 59`, `Community 255`, `Community 38`, `Community 92`, `Community 73`, `Community 67`, `Community 30`, `Community 10`, `Community 25`, `Community 167`, `Community 204`, `Community 66`, `Community 96`, `Community 78`, `Community 90`, `Community 111`, `Community 133`, `Community 122`, `Community 34`, `Community 15`, `Community 177`, `Community 16`, `Community 48`, `Community 103`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 4`, `Community 59`, `Community 8`, `Community 2`, `Community 40`, `Community 3`, `Community 55`, `Community 35`, `Community 65`, `Community 18`, `Community 6`, `Community 15`, `Community 216`, `Community 73`, `Community 67`, `Community 78`, `Community 25`, `Community 57`, `Community 117`, `Community 124`, `Community 96`, `Community 66`, `Community 16`, `Community 48`, `Community 103`?**
...
- **Are the 727 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 727 INFERRED edges - model-reasoned connections that need verification._
