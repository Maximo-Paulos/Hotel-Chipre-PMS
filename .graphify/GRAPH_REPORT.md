...
## Corpus Check
- Large corpus: 719 files · ~471,637 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6359 nodes · 20329 edges · 294 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 6679 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 6679 · contains: 4145 · calls: 3177 · MODIFIES: 1651 · ON_BRANCH: 1247 · rationale_for: 836 · imports: 698 · imports_from: 560 · method: 554 · inherits: 525 · PARENT_OF: 257


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 719 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 7 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `eed124a`
...
Cohesion: 0.04
Nodes (211): FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Soft-delete a room when no active reservations are attached., RoomCategoryAssignmentUpdate, RoomStatusUpdate, DocumentTypeEnum (+203 more)
...
Cohesion: 0.04
Nodes (130): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+122 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (95): requestVerification(), apiFetch(), buildAuthHeaders(), buildUrl(), formatErrorDetail(), handleUnauthorized(), hasValidSession(), isTokenExpired() (+87 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (108): Base, Base class for all ORM models., DeclarativeBase, Record an AuditLog row for a successful entity mutation., AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, AnalyticsCurrencyDisplayEnum (+100 more)
...
Cohesion: 0.08
Nodes (53): FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia., Receive reservation notifications from Despegar., OTACommissionRule, OTAConnection, OTACurrencyRate, OTAProvider (+45 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (70): FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response., Lightweight availability placeholder. When all parameters are provided,     it r, Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+62 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (65): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+57 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (35): datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), booking_webhook(), despegar_webhook(), expedia_webhook(), _handle_ota_webhook(), _backfill_not_null_nulls() (+27 more)
...
Cohesion: 0.08
Nodes (57): BillingAdjustment, BillingAdjustmentTypeEnum, Operational reservation models for adjustments, room moves and audit history., ReservationAdjustment, ReservationAdjustmentKindEnum, ReservationAdjustmentStatusEnum, ReservationError, PaymentError (+49 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (57): CheckInRequest, FastAPI routes for Check-in / Check-out., FastAPI routes for Guest management., Add new companions to an existing guest., Exception, GuestRatingEnum, GuestTag, GuestTagTypeEnum (+49 more)
...
Cohesion: 0.04
Nodes (52): createRoomBlock(), listActiveRoomBlocks(), resolveRoomBlock(), RoomBlock, RoomBlockCreatePayload, RoomBlockReasonCode, _attach_current_rate(), checkRoomAvailability() (+44 more)
...
Cohesion: 0.09
Nodes (51): CashCloseReport, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca, Individual money movement within an open cash session.     Linked optionally to, Arqueo de caja: expected vs actual cash at session close.     Differences are fl (+43 more)
...
Cohesion: 0.06
Nodes (43): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+35 more)
...
Cohesion: 0.05
Nodes (20): _DecimalAwareEncoder, _is_demo_mode_enabled(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., _require_demo_mode(), 1f352e4 feat(reports): SLICE-11 operational reports + alerts, 283135b feat(ops): SLICE-13 laundry + stock foundations (+12 more)
...
Cohesion: 0.15
Nodes (33): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), ReservationStatusHistory (+25 more)
...
Cohesion: 0.12
Nodes (37): Payment, PaymentLink, PaymentWebhookEvent, Payment gateway tracking models: PaymentLink, Payment, PaymentWebhookEvent.  Sou, One gateway payment object (MP preference / PayPal order / Stripe intent)., Raw webhook log per payment — idempotent on (hotel_id, provider, webhook_id)., Guest-facing pre-payment object (checkout URL / QR). May collect partial payment, TransactionTypeEnum (+29 more)
...
Cohesion: 0.11
Nodes (34): 7506225 feat(R2b): soft delete for domain records (§26), ae94359 feat(R2c): tenant-isolation query hardening (§1.2), apply_price_period(), get_price_for_date(), get_prices_for_range(), _apply_corporate_pricing(), _apply_custom_deposit_amount(), _apply_pricing_result_to_reservation() (+26 more)
...
Cohesion: 0.46
Nodes (29): FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create, Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled., Cancel a reservation. Post check-in cancellations are not allowed., Cancel a reservation. Post check-in cancellations are not allowed., §10.2 — Internally release a no-guarantee OTA reservation (no provider cancel ca, §10.2 — Internally release a no-guarantee OTA reservation (no provider cancel ca (+21 more)
...
Cohesion: 0.08
Nodes (10): c580b56 ojala si, MERCADOPAGO_WEBHOOK_SECRET is required only when MP_ACCESS_TOKEN is set., Partial integration env vars should not block production startup., OAuth redirect URIs are only validated when the corresponding service credential, test_validate_runtime_security_ignores_incomplete_optional_integrations(), test_validate_runtime_security_rejects_localhost_redirect_when_service_configured(), test_validate_runtime_security_rejects_missing_mp_webhook_when_mp_configured(), add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c (+2 more)
...
Cohesion: 0.15
Nodes (3): eed124a Harden cash reconciliation and transfer proof approvals, Manual bank-transfer evidence and approval lifecycle., Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs
...
Cohesion: 0.28
Nodes (5): 4959706 Enforce tenant isolation with PostgreSQL RLS context, f01c735 Refresh Graphify after tenant isolation hardening, _load_rls_migration(), test_rls_migration_covers_every_hotel_scoped_model_table(), test_rls_migration_keeps_api_key_bootstrap_exception_explicit()
...
- **Thin community `Community 216`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 246`** (2 nodes): `credentials`, `PAGES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 247`** (2 nodes): `Middleware to block mutating requests when subscription enforcement is enabled.`, `SubscriptionEnforcementMiddleware`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 300`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (2 nodes): `Derive the BRM §16.2 reportable origin for a reservation.      Precedence:`, `reportable_origin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (1 nodes): `Schemas for manual OTA reservation entry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 4` to `Community 231`, `Community 201`, `Community 10`, `Community 26`, `Community 245`, `Community 176`, `Community 299`, `Community 29`, `Community 6`, `Community 47`, `Community 2`, `Community 17`, `Community 91`, `Community 85`, `Community 136`, `Community 0`, `Community 13`, `Community 25`, `Community 81`, `Community 138`, `Community 33`, `Community 87`, `Community 109`, `Community 12`, `Community 38`, `Community 7`, `Community 27`, `Community 40`, `Community 110`, `Community 5`, `Community 137`, `Community 130`, `Community 1`, `Community 301`, `Community 8`, `Community 35`, `Community 3`, `Community 49`, `Community 233`, `Community 209`, `Community 73`, `Community 188`, `Community 190`, `Community 191`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 9`, `Community 33`, `Community 53`, `Community 8`, `Community 159`, `Community 138`, `Community 4`, `Community 29`, `Community 1`, `Community 13`, `Community 236`, `Community 75`, `Community 7`, `Community 78`, `Community 12`, `Community 38`, `Community 2`, `Community 49`, `Community 3`, `Community 66`, `Community 183`, `Community 17`, `Community 73`, `Community 87`, `Community 188`, `Community 27`, `Community 40`, `Community 43`, `Community 80`, `Community 125`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 8`, `Community 13`, `Community 53`, `Community 2`, `Community 1`, `Community 4`, `Community 29`, `Community 47`, `Community 91`, `Community 250`, `Community 7`, `Community 40`, `Community 110`, `Community 12`, `Community 38`, `Community 35`, `Community 107`, `Community 17`, `Community 43`, `Community 80`, `Community 125`?**
