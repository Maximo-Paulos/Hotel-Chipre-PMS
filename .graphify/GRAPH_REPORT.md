...
## Corpus Check
- Large corpus: 848 files · ~593,890 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8655 nodes · 36285 edges · 331 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 13865 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 13865 · ON_BRANCH: 6026 · contains: 5127 · calls: 3765 · MODIFIES: 2490 · rationale_for: 1657 · imports: 900 · imports_from: 683 · PARENT_OF: 602 · method: 595 · inherits: 572 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 848 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 11 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `765ff7b`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 834 edges
2. `Reservation` - 833 edges
3. `HotelConfiguration` - 813 edges
4. `Room` - 674 edges
5. `Guest` - 656 edges
6. `RoomCategory` - 611 edges
7. `Base` - 464 edges
8. `RoomStatusEnum` - 406 edges
9. `ReservationError` - 373 edges
...
Cohesion: 0.02
Nodes (311): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest. (+303 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (304): AcceptPayload, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, InvitePayload, InviteResponse (+296 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (131): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _require_demo_mode(), reset_demo(), seed_demo() (+123 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (228): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+220 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (223): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+215 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (199): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista, 0a4396e Add multi-hotel isolation tests and bcrypt shim (+191 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (154): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+146 more)

### Community 7 - "Community 7"
Cohesion: 0.17
Nodes (198): agent-linensplit, agent-mobilenav, agent-otafix, agent-settlement, agent-stocksplit, agent-ux, agent-warehouse, worktree-agent-a256bbe12be1abe44 (+190 more)

### Community 8 - "Community 8"
Cohesion: 0.10
Nodes (181): cancel_reservation(), create_new_reservation(), create_or_update_manual_ota(), create_reservation_charge(), _ensure_manual_rate_permission(), extend_stay(), mark_no_show(), modify_reservation() (+173 more)
...
Cohesion: 0.03
Nodes (120): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), google_login() (+112 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (125): FastAPI routes for Payments., StockConsumptionItem, StockConsumptionReportRead, StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead (+117 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (46): CategoryPayload, DepositPolicyPayload, finishOnboarding(), HotelIdentityPayload, OnboardingProviderSetup, OnboardingStatus, OTAChannelsPayload, OwnerPayload (+38 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (67): _authorize_override(), checkin(), checkin_partial(), email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel). (+59 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (60): worktree-agent-a406cbc9533347deb, worktree-agent-ae2a7c562e14e2abd, 0254334 Merge branch 'agent-ux' into codex/feature/pms-e2e-scale-hardening, 0e11e63 feat(laundry): D3 -- spend-by-period report on LaundryPage, 10e9d42 fix(security): gate manual reservation total_amount behind reservation:manual_rate, 194af4d fix(reservations): search guests by name/DNI instead of raw ID field, 1ae9c1e fix(security): wire room-blocks endpoint to granular create/release permissions, 23f30ca feat(ux): Apple-HIG-style polish pass -- motion, focus rings, tap targets, consistent status colors (+52 more)
...
Cohesion: 0.04
Nodes (63): BulkRateField, BulkRateFieldMode, BulkRateResult, bulkUpdateDailyRateField(), bulkUpsertDailyRates(), DailyRateOut, DailyRatePrices, DailyRateRangeRow (+55 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (72): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), SessionLike (+64 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (75): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+67 more)
...
Cohesion: 0.05
Nodes (57): Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection (+49 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (43): addGuestCompanions(), addGuestTag(), _build_guest_ledger_csv(), buildGuestQueryString(), checkInGuestReservation(), createGuest(), _enum_value(), export_guest_ledger() (+35 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (42): LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead, FastAPI routes for outsourced laundry vendors, pricing, remitos and the linen (r, RemitoCreate (+34 more)
...
Cohesion: 0.05
Nodes (44): createLaundryRemito(), createLaundryVendor(), getLaundryVendorBalance(), getLaundryVendorSettlements(), getLaundryVendorSpend(), LaundryRemito, LaundryRemitoCreate, LaundryRemitoCreateResponse (+36 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (28): create_movement(), createStockItem(), createStockLocation(), createStockMovement(), CurrentStock, deleteStockItem(), _ensure_adjustment_permission(), getCurrentStock() (+20 more)

### Community 32 - "Community 32"
Cohesion: 0.11
Nodes (46): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, AnalyticsExportJob, AnalyticsExportStatusEnum, FactReservationDaily, FactReservationRowKindEnum, FactRoomOccupancyDaily, FactRoomOccupancyStatusAtNightEnum (+38 more)
...
Cohesion: 0.07
Nodes (33): ABC, _pick_default_hotel_id(), Auth endpoints: register, login, email verification and password reset. Verifica, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, Validate reset code without changing password (paso previo en UI)., Validate reset code without changing password (paso previo en UI)., Validate reset code without changing password (paso previo en UI)., Prefer a hotel whose onboarding is already complete.      When a user belongs to (+25 more)
...
Cohesion: 0.07
Nodes (33): ad4249c Implement master admin panel, StatCard(), StatCardProps, toneClasses, Email provider abstraction for platform transactional mail., clearMasterAdminCsrfToken(), masterAdminFetch(), MasterAdminLoginResponse (+25 more)
...
Cohesion: 0.10
Nodes (14): OTASyncEvent, OTASyncJob, NormalizedOTAReservation, OTAAdapterContext, OTAOperationResult, Common contracts for OTA provider adapters.  The goal is to keep Booking, Expedi, Foundational OTA adapter interfaces and orchestration services., OTAOrchestratorError (+6 more)
...
Cohesion: 0.14
Nodes (32): Exception, AllocationAssignment, AllocationAssignmentStatusEnum, AllocationExplanation, AllocationPolicyProfile, AllocationPolicyVersion, AllocationRun, AllocationRunStatusEnum (+24 more)
...
Cohesion: 0.08
Nodes (34): get_settings(), _gmail_is_active(), _has_value(), is_demo_mode(), is_preview_qa_mode(), is_production_mode(), _is_public_https_url(), is_test_mode() (+26 more)

### Community 58 - "Community 58"
Cohesion: 0.29
Nodes (31): OTACommissionRule, OTAConnection, OTACurrencyRate, OTAProvider, OTARatePlanMapping, OTAReservationLifecycleEnum, OTAReservationLink, OTARoomMapping (+23 more)
...
Cohesion: 0.14
Nodes (4): ensure_all_ota_webhook_secrets(), Ensure every hotel has webhook secrets for the OTA providers used by the app., _hotel_default_currency(), OTAIntegrationService
...
Cohesion: 0.14
Nodes (18): _auth_headers(), _complete_onboarding(), _configure_resend(), _fake_google_claims(), FakeResponse, _register_owner(), test_auth_flows_fail_without_connected_mail_provider(), test_google_login_creates_new_user_when_email_unknown() (+10 more)
...
Cohesion: 0.12
Nodes (15): createLinenItem(), createLinenLocation(), createLinenMovement(), CurrentLinenStock, getCurrentLinenStock(), LinenItem, LinenItemCreate, LinenLocation (+7 more)
...
Cohesion: 0.31
Nodes (9): _authenticate_user(), _decode_authorization_header(), get_auth_context(), get_current_user(), get_current_user_optional(), _parse_header_hotel_id(), _parse_token_hotel_id(), require_any_permission() (+1 more)
...
Cohesion: 0.46
Nodes (7): LinenItem, LinenLocation, LinenMovement, Linen (ropa blanca) inventory models -- physically separate tables from app/mode, Hotel-scoped linen (ropa blanca) inventory service.  Mirrors app/services/stock_, Balance of one linen item for a hotel, optionally narrowed to one     location -, Raised when a linen inventory operation is invalid.
...
Cohesion: 0.57
Nodes (7): _client_with_db(), _override_auth(), _teardown(), test_duplicate_active_name_returns_clean_409_not_a_500(), test_owner_can_delete_item_and_recreate_it_with_the_same_name(), test_stock_item_unit_cost_is_exposed_on_create_and_update(), test_stock_items_endpoint_filters_by_kind_for_stock_and_laundry_pages()
...
Cohesion: 0.52
Nodes (6): addDaysIso(), formatLocalIsoDate(), pad(), startOfCurrentMonthIso(), startOfCurrentWeekIso(), todayIso()
...
Cohesion: 0.67
Nodes (3): get_public_api_context(), _public_api_rate_limit_for_hotel(), Public API-key authentication, separate from staff JWT auth.
...
- **Thin community `Community 131`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 164`** (2 nodes): `eed124a Harden cash reconciliation and transfer proof approvals`, `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 215`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 233`** (2 nodes): `TestBookingWebhook`, `TestOTARaceCondition`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 281`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (2 nodes): `chat_completions()`, `_extract_latest_user_message()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (2 nodes): `owner`, `receptionist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 318`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 326`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 333`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 335`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 342`** (1 nodes): `Seed and serve the E2E backend on 127.0.0.1:8040.  This wrapper avoids shell-spe`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 344`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 0` to `Community 2`, `Community 204`, `Community 69`, `Community 241`, `Community 8`, `Community 21`, `Community 39`, `Community 55`, `Community 4`, `Community 62`, `Community 32`, `Community 1`, `Community 20`, `Community 15`, `Community 92`, `Community 156`, `Community 3`, `Community 27`, `Community 97`, `Community 33`, `Community 225`, `Community 115`, `Community 12`, `Community 18`, `Community 58`, `Community 47`, `Community 98`, `Community 181`, `Community 14`, `Community 263`, `Community 75`, `Community 7`, `Community 132`, `Community 68`, `Community 82`, `Community 214`, `Community 129`, `Community 96`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 1` to `Community 13`, `Community 8`, `Community 18`, `Community 305`, `Community 2`, `Community 0`, `Community 21`, `Community 3`, `Community 5`, `Community 32`, `Community 62`, `Community 267`, `Community 60`, `Community 23`, `Community 56`, `Community 85`, `Community 58`, `Community 33`, `Community 4`, `Community 132`, `Community 68`, `Community 98`, `Community 82`, `Community 250`, `Community 271`, `Community 47`, `Community 233`, `Community 15`, `Community 129`, `Community 89`, `Community 46`, `Community 20`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 3` to `Community 0`, `Community 18`, `Community 1`, `Community 8`, `Community 2`, `Community 21`, `Community 55`, `Community 4`, `Community 32`, `Community 62`, `Community 15`, `Community 226`, `Community 147`, `Community 58`, `Community 60`, `Community 93`, `Community 114`, `Community 98`, `Community 233`, `Community 46`, `Community 20`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 832 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 832 INFERRED edges - model-reasoned connections that need verification._
- **Are the 826 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 826 INFERRED edges - model-reasoned connections that need verification._
- **Are the 806 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 806 INFERRED edges - model-reasoned connections that need verification._
- **Are the 669 inferred relationships involving `Room` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Room` has 669 INFERRED edges - model-reasoned connections that need verification._