...
## Corpus Check
- Large corpus: 1266 files · ~1,836,235 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 13694 nodes · 78030 edges · 516 communities detected
- Extraction: 65% EXTRACTED · 35% INFERRED · 0% AMBIGUOUS · INFERRED: 27174 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 27174 · ON_BRANCH: 24247 · contains: 7375 · calls: 5376 · MODIFIES: 5175 · rationale_for: 3698 · imports: 1423 · imports_from: 1125 · PARENT_OF: 889 · inherits: 806 · method: 738 · re_exports: 4


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 1266 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 12 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `788d35b`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `Reservation` - 1433 edges
2. `ReservationStatusEnum` - 1370 edges
3. `HotelConfiguration` - 1363 edges
4. `Room` - 1232 edges
...
Cohesion: 0.01
Nodes (780): checkin_partial(), B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, B3.1: writes PRE_CHECK_IN — the 'huésped ingresó al cuarto, faltan     acompañan, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest. (+772 more)

### Community 1 - "Community 1"
Cohesion: 0.15
Nodes (501): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+493 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (298): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), Demo-only utilities: seed sample data and reset the database. Exposed only when, _clickhouse_healthcheck() (+290 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (389): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses the ca, Calculate pricing for a potential booking without persisting it.     Uses the ca (+381 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (386): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+378 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (194): Shared, secret-safe binding for the Render QA bootstrap configuration., acceptInvitation(), acceptInvitationWithGoogle(), AuthProvidersResponse, AuthResponse, AuthResult, _build_auth_response(), _burn_auth_timing_work() (+186 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (238): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), Category (+230 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (226): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), createGuestRestriction() (+218 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (259): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), EmailDeliveryStatus, invite_user(), InviteResponse, inviteUser(), list_users() (+251 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (259): Base, Base class for all ORM models., Base class for all ORM models., _DecimalAwareEncoder, _frontend_placeholder(), _is_demo_mode_enabled(), lifespan(), Seed the permission matrix once at boot (per worker process).      A1 fix: seed_ (+251 more)
...
Cohesion: 0.03
Nodes (193): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+185 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (214): 955325e feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, HotelRoleVisibilityWindow, Reservation visibility limits configured independently per hotel role.      A mi, HotelPermissionOverride, Permission, Configurable permission matrix models., An employee-specific permission decision within one hotel membership., An employee-specific permission decision within one hotel membership. (+206 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (178): FxSnapshotRead, create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate (+170 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (97): admin_comped_override(), change_plan(), changeSubscriptionPlan(), getSubscriptionStatus(), listSubscriptionPlans(), _remaining_trial_days(), _serialize_status_payload(), start_subscription_trial() (+89 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (144): AnalyticsAIChatPage(), AnalyticsAIChatResponse, AnalyticsAIStatus, AnalyticsCategoryDetailPage(), AnalyticsChannelsPage(), AnalyticsCompanyDetailPage(), AnalyticsEnvelope, analyticsErrorMessage() (+136 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (159): _authorize_oauth_state_actor(), Revalidate the actor embedded in a short-lived OAuth state token.      Provider, Revalidate the actor embedded in a short-lived OAuth state token.      Provider, Revalidate the actor embedded in a short-lived OAuth state token.      Provider, Revalidate the actor embedded in a short-lived OAuth state token.      Provider, _accept_invitation(), accept_invitation_legacy(), accept_invitation_legacy_path() (+151 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (128): claude/feature/pms-roles-housekeeping-qa, 00bf891 Explain analytics errors and add retry action, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker, 0510fa0 Add guest companion UI journey, 05d296d Fix cash freshness after reservation payments (+120 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (147): apple_callback(), _apple_full_name(), apple_login(), _apple_login_config(), apple_start(), _attach_user_session_cookies(), _audit_security_event(), auth_providers() (+139 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (92): _app_secret(), _nested(), Meta Cloud API webhook boundary.  The endpoint verifies Meta's signature before, Walk a chain of dict keys, tolerating non-dict values at any level.      Meta's, receive_webhook(), _verify_token(), verify_webhook(), 7c5f229 Merge WhatsApp CRM W0 and W1 foundation (+84 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (85): addLaundryItem(), createLaundryBatch(), LaundryBatch, LaundryBatchCreate, LaundryBatchRead, LaundryItem, LaundryItemCreate, LaundryItemRead (+77 more)
...
Cohesion: 0.05
Nodes (45): addCashMovement(), approveCashCloseDifference(), CashCloseReport, CashCustodyHandoff, CashDailyCollector, CashDailyEntry, CashDailyPaymentMethod, CashDailySession (+37 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (38): ActiveRoomBlockItem, AvailableWithReviewItem, CashSessionStatusRead, DailyOperationalReport, getDailyOperationalReport(), getOccupancyReport(), getOperationalAlerts(), getRevenueReport() (+30 more)

### Community 33 - "Community 33"
Cohesion: 0.11
Nodes (55): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSessionStatusEnum, Individual money movement within an open cash session.     Linked optionally to, Individual money movement within an open cash session.     Linked optionally to (+47 more)
...
Cohesion: 0.07
Nodes (38): 68f7b1c fix(tests): update _invitation_token call sites to new (db, ctx, email) signature, 8223161 fix(security): close staff invitation lifecycle gaps (TECH-0031), 8f84a98 fix(security): close staff invitation lifecycle gaps (TECH-0031), d3dcbfd fix(migrations): chain staff invitation lifecycle migration onto guest search index head, Persisted staff invitations and their one-time acceptance state., client_with_db(), _enable_test_google(), get_auth_context_target() (+30 more)

### Community 40 - "Community 40"
Cohesion: 0.14
Nodes (48): _assert_manageable_membership(), create_temporary_action_grant(), Thin FastAPI transport for the tenant-scoped permission service., Keep permission exceptions aligned with the staff-management boundary., Keep permission exceptions aligned with the staff-management boundary., Keep permission exceptions aligned with the staff-management boundary., Ask for one exceptional permission without changing the requester's role., Ask for one exceptional permission without changing the requester's role. (+40 more)

### Community 41 - "Community 41"
Cohesion: 0.10
Nodes (45): create_restriction(), _get_tenant_guest(), list_restrictions(), FastAPI routes for GuestRestriction (formal lodging-prohibition entity)., Tenant-scoped lookup. Cross-hotel access must 404, never 403 --     existence of, resolve_restriction(), GuestRestriction, GuestRestrictionStatusEnum (+37 more)
...
Cohesion: 0.11
Nodes (34): 16473c9 Refresh Graphify graph after the marketing and metadata pass, f072302 Sell the product on its own terms, and bake per-route metadata, benefitPoints, differentiators, founder, heroBullets, integrationPoints, integrations (+26 more)
...
Cohesion: 0.14
Nodes (37): Operational task inbox and shift handoff endpoints., OperationalTask, OperationalTaskEvent, OperationalTaskPriorityEnum, OperationalTaskStatusEnum, OperationalTaskTypeEnum, Shared operational tasks and shift handoffs.  Tasks are deliberately separate fr, ShiftHandoff (+29 more)
...
Cohesion: 0.10
Nodes (18): BookingAdapterError, Booking.com Connectivity adapter.  The adapter keeps provider traffic behind a s, Acknowledge processed reservation messages in Booking's queue., A provider operation failed before it could return normalized data., OTASyncEvent, OTASyncJob, NormalizedOTAReservation, OTAAdapterContext (+10 more)

### Community 51 - "Community 51"
Cohesion: 0.11
Nodes (42): AuditLog, Append-only record of every significant mutation within a hotel tenant.     Do N, PaymentProof, PaymentProofBlob, PaymentProofStatusEnum, Private image evidence awaiting explicit staff confirmation., Private image evidence awaiting explicit staff confirmation., Private binary payload kept separately from queryable proof metadata. (+34 more)
...
Cohesion: 0.09
Nodes (41): Subscription, entitlements_for_hotel(), Alias to expose the snapshot in a name aligned with the spec wording., Alias to expose the snapshot in a name aligned with the spec wording., Alias to expose the snapshot in a name aligned with the spec wording., Alias to expose the snapshot in a name aligned with the spec wording., Alias to expose the snapshot in a name aligned with the spec wording., ensure_entitlements_seeded() (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (31): collaboration_websocket(), CollaborationManager, CollaborationPatchResponse, CollaborationResourceType, CollaborationTicket, collaborationWebSocketUrl(), CollaborationWsMessage, _consume_ticket() (+23 more)
...
Cohesion: 0.14
Nodes (23): 2090dc4 feat(security): make TOTP MFA mandatory for Master Admin (TECH-0023), 6e6d179 Prepare release candidate for landing and onboarding, 87b0eb6 Improve marketing SEO content, linking, and metadata, b48fd42 Add public marketing inquiry flow and SEO, d7e130f Merge the Hotels-PMS landing page rebuild, Seo(), SeoProps, StructuredData (+15 more)
...
Cohesion: 0.10
Nodes (32): CashSession, Single cash-register shift. Only one OPEN session per hotel at a time     (enfor, Single cash-register shift. Only one OPEN session per hotel at a time     (enfor, Single cash-register shift. Only one OPEN session per hotel at a time     (enfor, Date-ranged block on a room. NULL ends_at means indefinite.     resolved_at popu, Date-ranged block on a room. NULL ends_at means indefinite.     resolved_at popu, RoomBlock, Close a cash session and create its close report.      The session row is select (+24 more)

### Community 71 - "Community 71"
Cohesion: 0.12
Nodes (35): Immutable ledger entry for a subscription discount or override.      This table, SubscriptionAdjustment, SubscriptionEvent, change_subscription_plan(), clear_room_limit_override(), _compute_can_write(), _default_adjustment_idempotency_key(), ensure_subscription_seed() (+27 more)
...
Cohesion: 0.15
Nodes (28): _configure_resend(), _fake_google_claims(), _register_owner(), test_auth_flows_fail_without_connected_mail_provider(), test_auth_providers_exposes_only_public_google_capabilities(), test_google_account_can_set_password_only_with_linked_google_proof_and_csrf(), test_google_link_rejects_mismatched_email_without_mutation(), test_google_link_requires_password_and_matching_verified_identity() (+20 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (29): .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by, .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by, The isolated Playwright E2E backend boots with APP_ENV=test and its     specs re, The isolated Playwright E2E backend boots with APP_ENV=test and its     specs re, JWTs are stateless with no server-side blacklist, so a password reset -     the, JWTs are stateless with no server-side blacklist, so a password reset -     the, .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by, .test" is an RFC 2606 reserved TLD email-validator blocks as     special-use by (+21 more)
...
Cohesion: 0.17
Nodes (22): _account_label_from_payload(), connection_account_label(), decrypt_payload(), derive_expires_at(), encrypt_payload(), ensure_provider_payload(), get_connection_payload(), get_connection_record() (+14 more)

### Community 91 - "Community 91"
Cohesion: 0.16
Nodes (12): GCSObjectStorage, get_object_storage(), LocalObjectStorage, ObjectStat, ObjectStorageError, Minimal object-storage abstraction: put/get/delete bytes by key.  Why this exist, Google Cloud Storage adapter with lazy optional dependency loading., Backend picked by `settings.OBJECT_STORAGE_BACKEND` (default: local).      Uses (+4 more)
...
Cohesion: 0.10
Nodes (8): 114b319 Fix invalid verification email requests, 29236bf feat(security): add Google account unlink endpoint with reauthentication, 9f4f9ac feat(security): audit-log MFA, login, and Google account-linking events, _fake_apple_claims(), test_apple_login_creates_account_and_persists_first_authorization_name(), test_apple_login_reclaims_matching_local_email_like_google(), test_apple_login_rejects_different_subject_claiming_linked_email(), test_apple_unlink_requires_password_and_revokes_session()
...
Cohesion: 0.18
Nodes (20): RoomBlockCreate, RoomBlockRead, RoomBlockReasonEnum, get_block(), ProtectedReservationConflictError, Base error for room-block business rules., Base error for room-block business rules., Base error for room-block business rules. (+12 more)
...
Cohesion: 0.25
Nodes (20): _actor_payload(), _actor_role(), _actor_user_id(), _apply_plan(), _as_utc(), _assert_same_adjustment(), end_trial(), grant_comped() (+12 more)
...
Cohesion: 0.16
Nodes (17): Public API-key authentication, separate from staff JWT auth., Authorize a public key for a specific external product surface.      Purpose val, require_public_api_purpose(), HotelAPIKey, Per-hotel API credential. `key_hash` stores a hashed version of the secret;, _generate_secret(), _hash_secret(), HotelAPIKeyError (+9 more)
...
Cohesion: 0.13
Nodes (19): consume_invitation(), find_by_token(), hash_invitation_token(), invitation_snapshot(), is_expired(), issue_invitation(), normalize_email(), Domain helpers for secure, auditable staff invitation lifecycle. (+11 more)
...
Cohesion: 0.27
Nodes (15): _available_provider_balance(), balance_due_from_transactions(), create_link(), _find_idempotent_link(), _get_reservation_for_hotel(), _is_safe_provider_url(), _money(), _normalized_idempotency_key() (+7 more)
...
Cohesion: 0.14
Nodes (13): _InvitationAccessLogFilter, Keep invitation capabilities out of Uvicorn's request-target logs., Emit bounded HTTP timing fields and make correlation IDs observable., Emit bounded HTTP timing fields and make correlation IDs observable., Emit bounded HTTP timing fields and make correlation IDs observable., Emit bounded HTTP timing fields and make correlation IDs observable., Emit bounded HTTP timing fields and make correlation IDs observable., Emit bounded HTTP timing fields and make correlation IDs observable. (+5 more)
...
Cohesion: 0.19
Nodes (11): fetchPublicPricing(), LeadPayload, PublicPricing, PublicPricingPlan, 9899fcf Add the master-admin pricing editor, 9eff38b Refresh Graphify graph for the landing page rebuild, notForYou, COLUMN_CLASSES (+3 more)
...
Cohesion: 0.30
Nodes (9): _active_room_blocks(), _alerts(), _available_with_review(), _cash_session(), daily_report(), _group(), _guest_name(), nightly_summary() (+1 more)

### Community 214 - "Community 214"
Cohesion: 0.18
Nodes (12): _collect_plan_entitlements(), delete_entitlement_override(), get_effective_room_limit(), get_entitlements(), _parse_value(), Return merged entitlements (plan + hotel overrides + room override)., Return merged entitlements (plan + hotel overrides + room override)., Return merged entitlements (plan + hotel overrides + room override). (+4 more)
...
Cohesion: 0.20
Nodes (5): ABC, EmailProvider, get_email_provider(), NullEmailProvider, ResendEmailProvider
...
Cohesion: 0.18
Nodes (5): 41ada7f Degrade public pricing instead of failing when the table is unreadable, 628d9a5 Remove screenshot files written to a literal 'undefined' directory, 642c6be Allow our own public hosts through CORS without an env var, The marketing site's own origin must not depend on an env var being set.  hotels, The two endpoints the public website calls, and the ways an anonymous caller cou
...
Cohesion: 0.18
Nodes (11): RegisterRequest.email was a plain str with no format validation, so     garbage, RegisterRequest.email was a plain str with no format validation, so     garbage, RegisterRequest.email was a plain str with no format validation, so     garbage, RegisterRequest.email was a plain str with no format validation, so     garbage, RegisterRequest.email was a plain str with no format validation, so     garbage, RegisterRequest.email was a plain str with no format validation, so     garbage, RegisterRequest.email was a plain str with no format validation, so     garbage, RegisterRequest.email was a plain str with no format validation, so     garbage (+3 more)

### Community 235 - "Community 235"
Cohesion: 0.18
Nodes (11): A guest self-registering must never end up with User.role="platform_admin"     j, A guest self-registering must never end up with User.role="platform_admin"     j, A guest self-registering must never end up with User.role="platform_admin"     j, A guest self-registering must never end up with User.role="platform_admin"     j, A guest self-registering must never end up with User.role="platform_admin"     j, A guest self-registering must never end up with User.role="platform_admin"     j, A guest self-registering must never end up with User.role="platform_admin"     j, A guest self-registering must never end up with User.role="platform_admin"     j (+3 more)
...
Cohesion: 0.22
Nodes (9): _infer_type(), Idempotent helper to add/update a plan entitlement row., Idempotent helper to add/update a plan entitlement row., Normalize values into (string, type) for portable storage., Normalize values into (string, type) for portable storage., Normalize values into (string, type) for portable storage., Idempotent helper to add/update a plan entitlement row., _serialize_value() (+1 more)
...
Cohesion: 0.40
Nodes (5): Spreadsheet-safe serialization helpers for user-controlled CSV cells., Apply formula protection consistently to every text cell in a CSV row., Prefix formula-like text so spreadsheet software treats it as text., spreadsheet_safe_row(), spreadsheet_safe_value()
...
Cohesion: 0.40
Nodes (5): _isolate_object_storage(), A1: permission_service seeds the matrix once per DB engine, not per     request., Route every test's object storage (payment proofs, analytics exports)     to a p, A1: permission_service seeds the matrix once per DB engine, not per     request., _reset_permission_seed_cache()
...
## Knowledge Gaps
- **1428 isolated node(s):** `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`, `add temporary action grants  Revision ID: 0f85dca5b98b Revises: 20260820_user_se`, `Install the PostgreSQL tenant policy; no-op on other dialects.`, `Remove the PostgreSQL tenant policy before dropping the table.`, `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho` (+1423 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 73`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (1 nodes): `test_database_foundation_complete()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 159`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 167`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `TestLeadCapture`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 372`** (2 nodes): `_context()`, `test_generic_room_status_patch_projects_event_and_reallocates()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 379`** (2 nodes): `Tests for reservation state machine transitions.`, `TestStateTransitions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 399`** (1 nodes): `Staff management endpoints for hotel public API keys.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 403`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 407`** (2 nodes): `HotelConfigUpdate`, `_normalize_currency()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 434`** (1 nodes): `authResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 435`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 436`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 437`** (2 nodes): `ownerCredentials`, `receptionistCredentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 441`** (2 nodes): `POST /api/checkin/checkout only enforced authentication (get_auth_context),`, `test_housekeeping_cannot_checkout_reservation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 443`** (1 nodes): `Current hotel membership aliases label historical actor projections.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 445`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 451`** (1 nodes): `Regression: provider-supplied OAuth error text must not break out of the inline`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 465`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 466`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 467`** (1 nodes): `reservation financial lifecycle  Revision ID: 20260410_reservation_financial_lif`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 468`** (1 nodes): `ai assistant sessions  Revision ID: 20260411_ai_assistant_sessions Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 469`** (1 nodes): `ai assistant insights  Revision ID: 20260412_ai_assistant_insights Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 470`** (1 nodes): `extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 471`** (1 nodes): `add trial and comped fields to subscriptions  Revision ID: 20260419_subscription`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 472`** (1 nodes): `master admin panel  Revision ID: 20260421_master_admin_panel Revises: 9c0d2f3e1a`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 473`** (1 nodes): `master admin system owner mail and stripe settings  Revision ID: 20260421_master`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 474`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 475`** (1 nodes): `v72 gaps phase 2: guest search indexes, OTA dedup constraint, updated guest_tag_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 476`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 477`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 478`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 479`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 480`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 481`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 482`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 483`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 484`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 485`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 486`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 487`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 488`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 489`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 490`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 491`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 492`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 493`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 494`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 495`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 496`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 497`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 498`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 499`** (1 nodes): `stock_items.kind (supply vs linen) + soft-delete-aware name uniqueness  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 500`** (1 nodes): `repair: ensure (hotel_id, id) unique constraints exist on rooms/room_categories/`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 501`** (1 nodes): `add idempotency_key to stock_movements  Revision ID: 20260818_stock_movement_ide`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 502`** (1 nodes): `Add soft-delete metadata to guests and payments for TECH-0110.  The columns are`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 503`** (1 nodes): `Grant receptionist the same-category room move default.  Phase A narrowed reserv`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 504`** (1 nodes): `Fix ota_reservation_lifecycle_enum labels to match the ORM's values_callable.  ``
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 505`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 506`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 507`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 508`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 509`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 510`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 511`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 512`** (1 nodes): `Add tenant-scoped object metadata without deleting legacy file references.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 513`** (2 nodes): `main()`, `validate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 514`** (2 nodes): `BridgeActivity`, `MainActivity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 515`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 516`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 520`** (1 nodes): `One-shot notification cycle: generate due daily reports, then deliver pending ou`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 521`** (1 nodes): `FakeResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 526`** (1 nodes): `TestCurrentSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 527`** (1 nodes): `TestExportSession`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 528`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 531`** (1 nodes): `Minimal API for recording room preferences on a guest profile.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 534`** (1 nodes): `Pydantic schemas for the small guest-room preference signal.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 538`** (1 nodes): `Tighten housekeeping's default access to occupancy planning.  Revision ID: 20260`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 539`** (1 nodes): `Set one global default without creating duplicate rows on reruns.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 540`** (1 nodes): `add tenant-scoped guest room preferences  Revision ID: 3c2dea57666d Revises: 202`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 541`** (1 nodes): `Install the PostgreSQL tenant policy; no-op on other dialects.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 542`** (1 nodes): `Remove the PostgreSQL tenant policy before dropping its table.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 9` to `Community 2`, `Community 356`, `Community 25`, `Community 35`, `Community 42`, `Community 3`, `Community 22`, `Community 10`, `Community 51`, `Community 33`, `Community 70`, `Community 4`, `Community 26`, `Community 8`, `Community 127`, `Community 27`, `Community 128`, `Community 0`, `Community 41`, `Community 30`, `Community 120`, `Community 16`, `Community 5`, `Community 12`, `Community 19`, `Community 39`, `Community 140`, `Community 250`, `Community 88`, `Community 23`, `Community 149`, `Community 45`, `Community 11`, `Community 50`, `Community 87`, `Community 129`, `Community 14`, `Community 111`, `Community 404`, `Community 170`, `Community 71`, `Community 57`, `Community 40`, `Community 102`, `Community 34`, `Community 18`, `Community 89`, `Community 169`, `Community 100`, `Community 521`, `Community 234`, `Community 81`, `Community 235`, `Community 101`, `Community 448`, `Community 139`, `Community 455`, `Community 456`, `Community 457`, `Community 157`, `Community 166`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 16`, `Community 10`, `Community 3`, `Community 8`, `Community 120`, `Community 121`, `Community 2`, `Community 9`, `Community 22`, `Community 307`, `Community 26`, `Community 11`, `Community 13`, `Community 72`, `Community 23`, `Community 92`, `Community 70`, `Community 4`, `Community 71`, `Community 57`, `Community 281`, `Community 214`, `Community 117`, `Community 6`, `Community 7`, `Community 100`, `Community 51`, `Community 521`, `Community 234`, `Community 81`, `Community 235`, `Community 106`, `Community 101`, `Community 19`, `Community 448`, `Community 139`, `Community 24`, `Community 59`, `Community 25`, `Community 50`, `Community 12`, `Community 455`, `Community 456`, `Community 457`, `Community 157`, `Community 166`, `Community 65`, `Community 52`, `Community 526`, `Community 527`, `Community 33`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 3`, `Community 10`, `Community 45`, `Community 2`, `Community 9`, `Community 42`, `Community 22`, `Community 26`, `Community 41`, `Community 92`, `Community 70`, `Community 11`, `Community 51`, `Community 4`, `Community 111`, `Community 308`, `Community 106`, `Community 379`, `Community 144`, `Community 52`, `Community 526`, `Community 527`, `Community 33`?**
...
- **Are the 1356 inferred relationships involving `HotelConfiguration` (e.g. with `AcceptPayload` and `GoogleInvitationAcceptPayload`) actually correct?**
  _`HotelConfiguration` has 1356 INFERRED edges - model-reasoned connections that need verification._
