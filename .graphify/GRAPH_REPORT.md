...
## Corpus Check
- Large corpus: 787 files · ~528,602 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7438 nodes · 25400 edges · 313 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9528 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9528 · contains: 4550 · calls: 3443 · MODIFIES: 2044 · ON_BRANCH: 1684 · rationale_for: 1208 · imports: 758 · imports_from: 594 · method: 591 · inherits: 535 · PARENT_OF: 465


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 787 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 8 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `6f39398`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 621 edges
2. `Reservation` - 621 edges
3. `HotelConfiguration` - 555 edges
4. `Room` - 479 edges
5. `Guest` - 452 edges
6. `RoomCategory` - 436 edges
7. `Base` - 373 edges
8. `RoomStatusEnum` - 312 edges
...
Cohesion: 0.02
Nodes (175): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+167 more)
...
Cohesion: 0.04
Nodes (184): Public booking-engine API authenticated only with hotel API keys., Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Simple availability helper. Returns a placeholder message if required     parame, Generic room update (number, floor, notes, status, etc.)., Update room status for housekeeping. When a room is set to cleaning/maintenance/, Update the category of a specific room., Manually trigger the allocation engine to optimally redistribute all reservation (+176 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (190): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+182 more)
...
Cohesion: 0.03
Nodes (127): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, Base, Base class for all ORM models., lifespan(), Initialize database on application startup. (+119 more)
...
Cohesion: 0.02
Nodes (113): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), createPaymentLink() (+105 more)
...
Cohesion: 0.04
Nodes (96): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+88 more)
...
Cohesion: 0.04
Nodes (44): email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., updateHotelConfig(), createPaymentSurcharge() (+36 more)
...
- **Thin community `Community 222`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (2 nodes): `housekeeping`, `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 5` to `Community 241`, `Community 14`, `Community 0`, `Community 242`, `Community 148`, `Community 261`, `Community 6`, `Community 29`, `Community 114`, `Community 36`, `Community 13`, `Community 28`, `Community 61`, `Community 16`, `Community 19`, `Community 101`, `Community 10`, `Community 137`, `Community 2`, `Community 12`, `Community 22`, `Community 4`, `Community 3`, `Community 45`, `Community 30`, `Community 115`, `Community 35`, `Community 33`, `Community 24`, `Community 66`, `Community 329`, `Community 9`, `Community 57`, `Community 244`, `Community 60`, `Community 213`, `Community 82`, `Community 195`, `Community 196`, `Community 121`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 4` to `Community 15`, `Community 45`, `Community 6`, `Community 0`, `Community 32`, `Community 67`, `Community 3`, `Community 5`, `Community 29`, `Community 12`, `Community 97`, `Community 28`, `Community 9`, `Community 2`, `Community 248`, `Community 47`, `Community 84`, `Community 35`, `Community 30`, `Community 10`, `Community 13`, `Community 57`, `Community 77`, `Community 61`, `Community 191`, `Community 89`, `Community 82`, `Community 33`, `Community 16`, `Community 42`, `Community 106`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 2` to `Community 9`, `Community 12`, `Community 67`, `Community 4`, `Community 6`, `Community 65`, `Community 87`, `Community 3`, `Community 5`, `Community 29`, `Community 13`, `Community 150`, `Community 36`, `Community 28`, `Community 19`, `Community 35`, `Community 47`, `Community 24`, `Community 66`, `Community 98`, `Community 89`, `Community 45`, `Community 16`, `Community 42`, `Community 106`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Are the 619 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 619 INFERRED edges - model-reasoned connections that need verification._
- **Are the 614 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 614 INFERRED edges - model-reasoned connections that need verification._
- **Are the 548 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 548 INFERRED edges - model-reasoned connections that need verification._
- **Are the 474 inferred relationships involving `Room` (e.g. with `RoomBlockCreate` and `RoomBlockRead`) actually correct?**
  _`Room` has 474 INFERRED edges - model-reasoned connections that need verification._