...
## Corpus Check
- Large corpus: 838 files · ~582,745 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8453 nodes · 33984 edges · 320 communities detected
- Extraction: 61% EXTRACTED · 39% INFERRED · 0% AMBIGUOUS · INFERRED: 13366 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 13366 · contains: 5018 · ON_BRANCH: 4607 · calls: 3699 · MODIFIES: 2403 · rationale_for: 1591 · imports: 879 · imports_from: 677 · method: 595 · PARENT_OF: 588 · inherits: 558 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 838 · Candidates: recursive
...
3. `HotelConfiguration` - 772 edges
4. `Room` - 656 edges
5. `Guest` - 638 edges
...
Cohesion: 0.02
Nodes (403): FastAPI routes for Guest management., FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, delete_room(), housekeeping_summary(), FastAPI routes for Room management + Housekeeping. (+395 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (265): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), User management per hotel (owners/co-owners). (+257 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (122): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck() (+114 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (187): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+179 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (173): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista, 0a4396e Add multi-hotel isolation tests and bcrypt shim (+165 more)

### Community 5 - "Community 5"
Cohesion: 0.15
Nodes (189): agent-mobilenav, agent-settlement, agent-ux, agent-warehouse, worktree-agent-a256bbe12be1abe44, worktree-agent-a3a198c21200e26be, worktree-agent-a3c8668a591bf7739, worktree-agent-a60ea08d416533eef (+181 more)
...
Cohesion: 0.02
Nodes (132): FastAPI routes for outsourced laundry vendors, pricing and remitos.  Separate ro, RemitoCreate, RemitoCreateResponse, RemitoLineIn, RemitoLineRead, RemitoRead, VendorBalanceLine, VendorCreate (+124 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (140): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 0391f8f Fix flaky detached-node false positive in mobile touch-target check, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker (+132 more)
...
Cohesion: 0.05
Nodes (110): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+102 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (47): cancelPaymentLinkTest(), createMercadoPagoPaymentLinkTest(), listPaymentLinkTests(), PaymentLinkTest, PaymentLinkTestCreatePayload, refreshPaymentLinkTest(), 1af6bfc Add demo seed script and README instructions for stage 1, 26970dd Add token store cleanup helper (+39 more)
...
Cohesion: 0.10
Nodes (42): FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia., Receive reservation notifications from Despegar., OTAConnection, OTAProvider, OTARatePlanMapping, OTAReservationLifecycleEnum (+34 more)
...
Cohesion: 0.04
Nodes (58): addLaundryItem(), createLaundryBatch(), LaundryBatch, LaundryBatchCreate, LaundryBatchRead, LaundryItem, LaundryItemCreate, LaundryItemRead (+50 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (25): 099e4c8 fix(e2e): stop the WebKit business Apple matrix from colliding with itself, 0a457cb feat(checkin): B3 partial check-in + mandatory guest profile capture + companions, 194af4d fix(reservations): search guests by name/DNI instead of raw ID field, 25d09dc fix(mobile): replace two competing mobile nav mechanisms with one menu button, 45b6181 feat(stock): collapse movement Ubicacion/Reserva behind advanced options, add item delete, 531bfbf docs(design): audit action-permission granularity + design step-up token (not wired), b64223d Merge branch 'agent-mobilenav' into codex/feature/pms-e2e-scale-hardening, c93560c Confirm frozen laundry price snapshot and add quarterly settlement paid mark (+17 more)
...
Cohesion: 0.05
Nodes (30): create_movement(), createStockItem(), createStockLocation(), createStockMovement(), CurrentStock, DecimalValue, deleteStockItem(), _ensure_adjustment_permission() (+22 more)
...
Cohesion: 0.13
Nodes (38): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+30 more)
...
Cohesion: 0.10
Nodes (14): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., main(), run() (+6 more)
...
Cohesion: 0.12
Nodes (18): consumption_report(), _consumption_totals_by_item(), create_stock_item(), current_stock(), delete_stock_item(), _get_item(), get_location(), get_stock_item() (+10 more)
...
Cohesion: 0.10
Nodes (18): 0255d4f Normalize Graphify artifact paths, 0ea3e19 Refresh Graphify release evidence, 121ec1a Keep app routes on allowed Vercel previews, 4f81793 Refresh Graphify after PII hardening, d1dbe7f Record guest PII security regression, Regression coverage for portable Graphify artifact normalization., A second normalizer run must leave already-portable artifacts unchanged., A second normalizer run must leave already-portable artifacts unchanged. (+10 more)
...
Cohesion: 0.15
Nodes (6): 0254334 Merge branch 'agent-ux' into codex/feature/pms-e2e-scale-hardening, 1ae9c1e fix(security): wire room-blocks endpoint to granular create/release permissions, 23f30ca feat(ux): Apple-HIG-style polish pass -- motion, focus rings, tap targets, consistent status colors, 75cd40a feat(analytics): incremental write-time fact table refresh (data warehouse pattern), a2019c7 Merge analytics self-heal fix into pms-e2e-scale-hardening, a4ecc40 Merge branch 'agent-warehouse' into codex/feature/pms-e2e-scale-hardening
...
Cohesion: 0.28
Nodes (4): delete_company_document(), get_company_document(), _get_document_or_404(), 7506225 feat(R2b): soft delete for domain records (§26)
...
- **Thin community `Community 131`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 215`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 237`** (1 nodes): `TestStateTransitions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 275`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 277`** (2 nodes): `chat_completions()`, `_extract_latest_user_message()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (2 nodes): `owner`, `receptionist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 319`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `stock_items.kind (supply vs linen) + soft-delete-aware name uniqueness  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 326`** (1 nodes): `Seed and serve the E2E backend on 127.0.0.1:8040.  This wrapper avoids shell-spe`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 10` to `Community 2`, `Community 223`, `Community 55`, `Community 123`, `Community 33`, `Community 3`, `Community 54`, `Community 110`, `Community 102`, `Community 6`, `Community 1`, `Community 22`, `Community 42`, `Community 15`, `Community 93`, `Community 161`, `Community 0`, `Community 12`, `Community 29`, `Community 100`, `Community 35`, `Community 67`, `Community 124`, `Community 14`, `Community 51`, `Community 18`, `Community 17`, `Community 13`, `Community 59`, `Community 49`, `Community 140`, `Community 132`, `Community 141`, `Community 83`, `Community 299`, `Community 213`, `Community 214`, `Community 238`, `Community 136`, `Community 99`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 1` to `Community 16`, `Community 35`, `Community 6`, `Community 11`, `Community 7`, `Community 51`, `Community 4`, `Community 2`, `Community 10`, `Community 42`, `Community 0`, `Community 110`, `Community 54`, `Community 12`, `Community 59`, `Community 18`, `Community 111`, `Community 86`, `Community 88`, `Community 3`, `Community 55`, `Community 102`, `Community 141`, `Community 209`, `Community 83`, `Community 67`, `Community 299`, `Community 213`, `Community 264`, `Community 49`, `Community 17`, `Community 15`, `Community 238`, `Community 136`, `Community 113`, `Community 48`, `Community 22`, `Community 114`, `Community 148`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 12`, `Community 94`, `Community 51`, `Community 6`, `Community 2`, `Community 10`, `Community 42`, `Community 33`, `Community 3`, `Community 110`, `Community 54`, `Community 15`, `Community 278`, `Community 59`, `Community 18`, `Community 1`, `Community 49`, `Community 121`, `Community 119`, `Community 237`, `Community 48`, `Community 22`, `Community 114`, `Community 148`?**
...
- **Are the 765 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 765 INFERRED edges - model-reasoned connections that need verification._
