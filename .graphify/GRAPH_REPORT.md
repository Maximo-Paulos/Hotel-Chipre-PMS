...
## Corpus Check
- Large corpus: 830 files · ~569,694 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8260 nodes · 30105 edges · 330 communities detected
- Extraction: 58% EXTRACTED · 42% INFERRED · 0% AMBIGUOUS · INFERRED: 12717 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 12717 · contains: 4959 · calls: 3631 · MODIFIES: 2272 · ON_BRANCH: 1775 · rationale_for: 1497 · imports: 870 · imports_from: 670 · method: 595 · inherits: 560 · PARENT_OF: 556 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 830 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 9 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `729a33e`
...
Cohesion: 0.01
Nodes (322): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening (+314 more)
...
Cohesion: 0.03
Nodes (48): EmailSendResponse, EmailVerifyResponse, Legacy public email endpoints.  The system transactional mail now lives exclusiv, _retired(), send_reset(), send_verification(), SmtpStatus, verify_code() (+40 more)
...
Cohesion: 0.04
Nodes (61): email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., updateHotelConfig(), createPaymentSurcharge() (+53 more)
...
Cohesion: 0.14
Nodes (8): 45b6181 feat(stock): collapse movement Ubicacion/Reserva behind advanced options, add item delete, 729a33e chore(graphify): regenerate graph after D5 stock consumption report, 90e2dd0 feat(stock): D5 -- consumption-by-period card on StockPage, closes Via D, 98907b6 feat(stock): D5 -- consumption report by period, closes Via D, housekeeping, owner, credentials, credentials
...
Cohesion: 0.25
Nodes (10): Bind a SQLAlchemy transaction to the authenticated tenant.  PostgreSQL RLS polic, Set the authenticated user id used by membership RLS policies., Set or clear the current hotel id for tenant-scoped RLS policies., Set both principals for a request or a single-hotel worker job., Flag the transaction as a verified master-admin session.      RLS policies that, _set_context_value(), set_master_admin_context(), set_tenant_context() (+2 more)
...
- **Thin community `Community 133`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 205`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 226`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 241`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 245`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 267`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 269`** (2 nodes): `chat_completions()`, `_extract_latest_user_message()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 322`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 326`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 330`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (2 nodes): `build_gemma_hotel_context()`, `_enum_value()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `_DecimalAwareEncoder`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 342`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 343`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 344`** (2 nodes): `Derive the BRM §16.2 reportable origin for a reservation.      Precedence:`, `reportable_origin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 5` to `Community 242`, `Community 1`, `Community 10`, `Community 338`, `Community 2`, `Community 194`, `Community 78`, `Community 227`, `Community 7`, `Community 108`, `Community 122`, `Community 34`, `Community 54`, `Community 18`, `Community 77`, `Community 17`, `Community 39`, `Community 24`, `Community 16`, `Community 96`, `Community 9`, `Community 144`, `Community 6`, `Community 27`, `Community 97`, `Community 4`, `Community 3`, `Community 22`, `Community 29`, `Community 123`, `Community 72`, `Community 33`, `Community 58`, `Community 179`, `Community 344`, `Community 64`, `Community 56`, `Community 164`, `Community 65`, `Community 248`, `Community 71`, `Community 88`, `Community 132`, `Community 203`, `Community 204`, `Community 104`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 4` to `Community 13`, `Community 22`, `Community 7`, `Community 3`, `Community 40`, `Community 8`, `Community 1`, `Community 10`, `Community 5`, `Community 39`, `Community 330`, `Community 64`, `Community 18`, `Community 6`, `Community 58`, `Community 252`, `Community 37`, `Community 90`, `Community 72`, `Community 66`, `Community 29`, `Community 9`, `Community 24`, `Community 164`, `Community 201`, `Community 65`, `Community 94`, `Community 77`, `Community 88`, `Community 108`, `Community 132`, `Community 119`, `Community 33`, `Community 16`, `Community 175`, `Community 17`, `Community 47`, `Community 100`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 5`, `Community 58`, `Community 7`, `Community 2`, `Community 39`, `Community 4`, `Community 54`, `Community 34`, `Community 64`, `Community 18`, `Community 6`, `Community 16`, `Community 215`, `Community 72`, `Community 66`, `Community 77`, `Community 24`, `Community 56`, `Community 113`, `Community 121`, `Community 94`, `Community 65`, `Community 17`, `Community 47`, `Community 100`?**
