...
## Corpus Check
- Large corpus: 1038 files · ~1,649,751 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10166 nodes · 49872 edges · 370 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 16324 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16324 · ON_BRANCH: 13894 · contains: 5947 · calls: 4371 · MODIFIES: 3369 · rationale_for: 2093 · imports: 1078 · imports_from: 835 · PARENT_OF: 692 · inherits: 650 · method: 616 · re_exports: 3
...
## Graph Freshness
- Built from Git commit: `666ec24`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `Reservation` - 948 edges
2. `ReservationStatusEnum` - 944 edges
...
Cohesion: 0.02
Nodes (424): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true). (+416 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (158): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _authorize_override(), checkin(), _require_demo_mode(), reset_demo(), seed_demo(), _clickhouse_healthcheck(), datastores_healthcheck() (+150 more)
...
Cohesion: 0.01
Nodes (157): main(), valid_https(), _archive_historical(), _build_cases(), main(), _write_json(), Shared, secret-safe binding for the Render QA bootstrap configuration., requestVerification() (+149 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (250): email_status(), Lightweight status so the frontend can check the active system email provider., Lightweight status so the frontend can check the active system email provider., add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest. (+242 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (254): PaymentSurchargeCreate, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+246 more)
...
Cohesion: 0.05
Nodes (217): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+209 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (237): CheckInRequest, FastAPI routes for Check-in / Check-out., cancel_reservation(), change_dates(), create_new_reservation(), create_or_update_manual_ota(), create_reservation_charge(), _ensure_action_permission() (+229 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (230): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser(), list_users() (+222 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (183): AcceptPayload, RoomBlockCreate, RoomBlockRead, 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, LoginRequest, CashCloseReport, CashCustodyHandoff (+175 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (139): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+131 more)
...
Cohesion: 0.02
Nodes (142): claude/feature/pms-roles-housekeeping-qa, 00bf891 Explain analytics errors and add retry action, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker, 0510fa0 Add guest companion UI journey, 05d296d Fix cash freshness after reservation payments (+134 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (113): ad4249c Implement master admin panel, PermissionGate(), StatCard(), StatCardProps, toneClasses, Email provider abstraction for platform transactional mail., clearMasterAdminCsrfToken(), masterAdminFetch() (+105 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (71): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _booking_to_read(), cancel_booking(), checkin_booking() (+63 more)
...
Cohesion: 0.06
Nodes (44): Thin FastAPI transport for the tenant-scoped permission service., _current_user(), Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., Keep useful internal references while never exposing free-form details., recent_security_events() (+36 more)
...
Cohesion: 0.11
Nodes (37): MovementEventRead, MovementGroupRead, Exception, ReservationAllocationLock, Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, RoomMovementGroup, _adjacency_bonus_for_room(), AllocationError (+29 more)
...
Cohesion: 0.21
Nodes (25): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyDaily, FactRoomOccupancyStatusAtNightEnum, HotelAuditEvent, RoomStateEvent, PaymentLinkStatusEnum (+17 more)
...
Cohesion: 0.18
Nodes (23): MasterAdminAuditEvent, MasterStripeWebhookEvent, Subscription, SubscriptionEvent, plan_catalog(), Subscription entitlements and enforcement helpers built on v2 tables. Keeps lega, Ensure a Subscription row exists for the hotel. Returns (subscription, seeded_fl, Return a normalized snapshot for API/middleware:     plan, status, limits, can_w (+15 more)
...
Cohesion: 0.12
Nodes (5): b355c74 fix(security): redact sensitive metadata in master admin audit events, dashboard_summary(), login(), me(), _serialize_user()
...
Cohesion: 0.22
Nodes (13): _configure_resend(), _seed_hotel(), _seed_platform_admin(), _seed_subscription(), test_master_dashboard_summary_counts_subscriptions_across_hotels(), test_master_email_status_and_test_mail(), test_master_login_bootstraps_env_account(), test_master_login_cookie_works_on_underscore_alias() (+5 more)
...
Cohesion: 0.25
Nodes (3): 666ec24 perf(guests): harden tenant-scoped guest search (TECH-0060), Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati, Add first-name indexes for the tenant-scoped guest search hot path.  Revision ID
...
Cohesion: 0.29
Nodes (6): MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterSystemEmailConnection, MasterAdminContext
...
- **Thin community `Community 70`** (1 nodes): `test_database_foundation_complete()`
...
- **Thin community `Community 129`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 299`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (2 nodes): `POST /api/checkin/checkout only enforced authentication (get_auth_context),`, `test_housekeeping_cannot_checkout_reservation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (1 nodes): `add trial and comped fields to subscriptions  Revision ID: 20260419_subscription`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 373`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 374`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 375`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 376`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 377`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 4` to `Community 16`, `Community 0`, `Community 1`, `Community 160`, `Community 62`, `Community 217`, `Community 8`, `Community 88`, `Community 237`, `Community 128`, `Community 33`, `Community 39`, `Community 64`, `Community 77`, `Community 59`, `Community 100`, `Community 10`, `Community 11`, `Community 7`, `Community 104`, `Community 99`, `Community 173`, `Community 323`, `Community 31`, `Community 30`, `Community 37`, `Community 3`, `Community 274`, `Community 101`, `Community 49`, `Community 129`, `Community 5`, `Community 83`, `Community 18`, `Community 118`, `Community 73`, `Community 112`, `Community 197`, `Community 89`, `Community 32`, `Community 275`, `Community 78`, `Community 22`, `Community 87`, `Community 225`, `Community 65`, `Community 46`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 4` to `Community 17`, `Community 10`, `Community 8`, `Community 9`, `Community 37`, `Community 12`, `Community 11`, `Community 71`, `Community 16`, `Community 77`, `Community 64`, `Community 0`, `Community 279`, `Community 58`, `Community 49`, `Community 92`, `Community 83`, `Community 5`, `Community 7`, `Community 280`, `Community 88`, `Community 59`, `Community 1`, `Community 235`, `Community 22`, `Community 87`, `Community 20`, `Community 259`, `Community 18`, `Community 53`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 4`, `Community 11`, `Community 5`, `Community 8`, `Community 16`, `Community 39`, `Community 33`, `Community 77`, `Community 64`, `Community 104`, `Community 301`, `Community 31`, `Community 10`, `Community 7`, `Community 127`, `Community 142`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Are the 941 inferred relationships involving `Reservation` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`Reservation` has 941 INFERRED edges - model-reasoned connections that need verification._
- **Are the 942 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 942 INFERRED edges - model-reasoned connections that need verification._
