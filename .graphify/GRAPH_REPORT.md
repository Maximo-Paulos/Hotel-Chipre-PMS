...
## Corpus Check
- Large corpus: 773 files · ~516,621 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7273 nodes · 24781 edges · 293 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9298 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9298 · contains: 4481 · calls: 3401 · MODIFIES: 1951 · ON_BRANCH: 1601 · rationale_for: 1178 · imports: 748 · method: 590 · imports_from: 587 · inherits: 535 · PARENT_OF: 411
...
Cohesion: 0.03
Nodes (168): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02c5612 Add tenant realtime sync and warehouse boundary, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions (+160 more)
...
Cohesion: 0.02
Nodes (146): UpdateRolePayload, BaseModel, 805b47a Unify reservation pricing with signed quote contract, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse (+138 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (165): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+157 more)
...
Cohesion: 0.03
Nodes (101): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+93 more)
...
Cohesion: 0.02
Nodes (56): FastAPI routes for provider connections. Exposes /api/connections/{provider}/con, _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Database engine and session management. Supports both PostgreSQL (production) an (+48 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (69): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), _mask_email() (+61 more)
...
Cohesion: 0.04
Nodes (36): 1a71e7d feat: add ota allocation data foundation, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 70b1481 Relax startup validation for optional integrations, c580b56 ojala si, e1bc3d1 feat(db): v72 gaps phase 3 — room_movement_groups, BillingAdjustment Numeric, Room.description, e202fdd feat(db): v72 gaps phase 1+2 — Numeric precision, new tables, search indexes, OTA dedup, f0ca779 feat(security): prohibido_alojar enforcement, optimistic locking, payment tables (+28 more)
...
Cohesion: 0.06
Nodes (31): updateHotelConfig(), list_timezones(), Reference data endpoints used by the frontend., Return the cached IANA timezone catalog., _attach_current_rate(), createRoom(), createRoomCategory(), get_category() (+23 more)
...
Cohesion: 0.06
Nodes (20): 1f352e4 feat(reports): SLICE-11 operational reports + alerts, 283135b feat(ops): SLICE-13 laundry + stock foundations, 32f7bba Require checkin:perform permission for checkout, not just authentication, 6f4beb1 feat(v72): Wave 3 — public API/keys + allocation V72 rules, 6f60c12 feat(security): SLICE-01 configurable permission matrix + role boundaries, a2c31f7 feat(ops): SLICE-04 room blocks + availability/allocation exclusion, c486aa3 feat(v72): Wave 2 — companies/documents, cash register/arqueo, guest override, _active_tag_filter() (+12 more)
...
Cohesion: 0.12
Nodes (21): broadcastDomainChange(), DOMAIN_QUERY_PREFIXES, domainForPath(), getSenderId(), invalidateDomainQueries(), normalizeHotelId(), notifyIfRelevant(), parseMessage() (+13 more)
...
Cohesion: 0.19
Nodes (17): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser(), list_users() (+9 more)
...
Cohesion: 0.21
Nodes (9): _auth_headers(), _complete_onboarding(), _configure_resend(), FakeResponse, _register_owner(), test_auth_flows_fail_without_connected_mail_provider(), test_login_prefers_a_completed_hotel_when_multiple_memberships_exist(), test_register_verify_and_reset_use_resend_provider() (+1 more)
...
Cohesion: 0.14
Nodes (10): 03ec9de Refresh Graphify after Fase 9 role QA fixes, 2efac9f Record Fase 9 role QA findings in the regression catalog, 906d009 Hide room status and block controls from roles that cannot use them, ac2d59b Hide stock adjustment option from manager, bf9b633 Gate the post-close "Aprobar diferencia" button by role too, c2f87d1 Grant receptionist read access to room categories, fdce0a4 Hide laundry batch creation from housekeeping, Persona (+2 more)
...
Cohesion: 0.40
Nodes (5): 1af6bfc Add demo seed script and README instructions for stage 1, 26970dd Add token store cleanup helper, main(), Seed minimal demo data for local testing.  Usage:     python -m app.scripts.seed, seed()
...
- **Thin community `Community 99`** (2 nodes): `4f50de1 Add successor cash register controls`, `b4c9bd8 Harden cash rotation and payment integrity`
...
- **Thin community `Community 197`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 205`** (1 nodes): `Public WhatsApp bot hooks authenticated only by hotel API key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 265`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 276`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 282`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 6` to `Community 241`, `Community 204`, `Community 10`, `Community 153`, `Community 76`, `Community 27`, `Community 118`, `Community 36`, `Community 17`, `Community 28`, `Community 65`, `Community 8`, `Community 13`, `Community 105`, `Community 9`, `Community 142`, `Community 3`, `Community 4`, `Community 2`, `Community 33`, `Community 11`, `Community 61`, `Community 119`, `Community 31`, `Community 29`, `Community 23`, `Community 62`, `Community 296`, `Community 16`, `Community 0`, `Community 42`, `Community 60`, `Community 244`, `Community 72`, `Community 34`, `Community 115`, `Community 85`, `Community 192`, `Community 193`, `Community 125`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 2` to `Community 7`, `Community 15`, `Community 30`, `Community 103`, `Community 4`, `Community 70`, `Community 33`, `Community 6`, `Community 27`, `Community 98`, `Community 28`, `Community 3`, `Community 0`, `Community 249`, `Community 34`, `Community 11`, `Community 87`, `Community 31`, `Community 92`, `Community 9`, `Community 90`, `Community 17`, `Community 60`, `Community 65`, `Community 76`, `Community 115`, `Community 8`, `Community 85`, `Community 61`, `Community 29`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 3`, `Community 70`, `Community 30`, `Community 16`, `Community 6`, `Community 27`, `Community 2`, `Community 17`, `Community 36`, `Community 28`, `Community 13`, `Community 31`, `Community 34`, `Community 23`, `Community 62`, `Community 90`, `Community 42`, `Community 8`?**
