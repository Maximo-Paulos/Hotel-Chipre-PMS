...
## Corpus Check
- Large corpus: 773 files · ~517,376 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7284 nodes · 24814 edges · 293 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 9298 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9298 · contains: 4481 · calls: 3401 · MODIFIES: 1962 · ON_BRANCH: 1612 · rationale_for: 1178 · imports: 748 · method: 590 · imports_from: 587 · inherits: 535 · PARENT_OF: 422


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 773 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 8 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `c5a9d6c`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `Reservation` - 605 edges
2. `ReservationStatusEnum` - 604 edges
3. `HotelConfiguration` - 538 edges
4. `Room` - 471 edges
5. `Guest` - 443 edges
6. `RoomCategory` - 424 edges
7. `Base` - 365 edges
...
- `Return ``dsn`` only when provider evidence proves a disposable QA target.      E` --uses--> `QABootstrapError`  [INFERRED]
  tests/postgres_test_safety.py → scripts/bootstrap_cloud_qa.py
- `Regression tests for final provider-evidence continuity.` --uses--> `ManifestContinuityError`  [INFERRED]
  tests/test_compare_preview_manifests.py → scripts/agent_ops/compare_preview_manifests.py

## Communities

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (252): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+244 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (174): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02c5612 Add tenant realtime sync and warehouse boundary, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions (+166 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (152): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), HotelConfiguration (+144 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (148): UpdateRolePayload, BaseModel, 805b47a Unify reservation pricing with signed quote contract, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse (+140 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (133): CheckInRequest, FastAPI routes for Check-in / Check-out., add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., Guest, GuestRatingEnum (+125 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (170): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+162 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (111): Base, Base class for all ORM models., DeclarativeBase, DocumentTypeEnum, GuestCompanion, Check if guest has provided required identity documents for check-in., Check if guest has provided required identity documents for check-in., Companion/additional occupant traveling with a primary guest.     Hotels often n (+103 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (103): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca (+95 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (85): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+77 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (43): _DecimalAwareEncoder, _is_demo_mode_enabled(), lifespan(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Initialize database on application startup. (+35 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (70): acceptInvitation(), getInvitationInfo(), requestVerification(), verifyEmail(), 6e6d179 Prepare release candidate for landing and onboarding, 87b0eb6 Improve marketing SEO content, linking, and metadata, f7f7d60 Add auth endpoints, JWT security and login rate limiter, Seo() (+62 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (33): FastAPI routes for provider connections. Exposes /api/connections/{provider}/con, _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Database engine and session management. Supports both PostgreSQL (production) an (+25 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (64): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+56 more)
...
Cohesion: 0.13
Nodes (66): ReservationAllocationLock, Company, Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, RoomMoveEvent, RoomMovementGroup, RoomMoveTypeEnum, ReservationNoShowPolicyAppliedEnum, ReservationOutcomeEnum (+58 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (39): AcceptPayload, cancelPaymentLinkTest(), createMercadoPagoPaymentLinkTest(), listPaymentLinkTests(), PaymentLinkTest, PaymentLinkTestCreatePayload, refreshPaymentLinkTest(), 50ad65d feat: harden gmail onboarding and multi-tenant email flow (+31 more)
...
Cohesion: 0.06
Nodes (55): Public WhatsApp bot hooks authenticated only by hotel API key., Payment, PaymentLink, PaymentLinkStatusEnum, PaymentProviderEnum, PaymentStatusEnum, Payment gateway tracking models: PaymentLink, Payment, PaymentWebhookEvent.  Sou, One gateway payment object (MP preference / PayPal order / Stripe intent). (+47 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (46): ApiError, apiFetch(), buildUrl(), formatErrorDetail(), handleUnauthorized(), isTokenExpired(), jwtExpMs(), RequestOptions (+38 more)
...
Cohesion: 0.04
Nodes (36): 3f48c33 chore: snapshot current implementation state for analysis, 620a33e Add hotel memberships, subscription plans, room cap enforcement, 8765a87 Enforce role guard, room cap checks, auth schema hotel_ids, 9385c0f Hardening multi-hotel scope and subscription enforcement, a02082a Fix users API import and utf-8 subscription service, b63ab83 Bind users to own hotel and return hotel_id in auth, AuthContext, _authenticate_user() (+28 more)
...
Cohesion: 0.04
Nodes (32): 1a71e7d feat: add ota allocation data foundation, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 70b1481 Relax startup validation for optional integrations, c580b56 ojala si, f0ca779 feat(security): prohibido_alojar enforcement, optimistic locking, payment tables, Reservation model with strict state machine. States: pending â†’ deposit_paid â†, Derive the BRM §16.2 reportable origin for a reservation.      Precedence: (+24 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (48): email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., updateHotelConfig(), 1ac0c3c Add StatCard component and fix reservations dashboard error (+40 more)
...
Cohesion: 0.06
Nodes (44): Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection (+36 more)

### Community 30 - "Community 30"
Cohesion: 0.13
Nodes (43): AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyDaily, FactRoomOccupancyStatusAtNightEnum (+35 more)
...
Cohesion: 0.34
Nodes (47): FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create, §5.2 — Run allocation engine in background after reservation changes.     Create, Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled., Cancel a reservation. Post check-in cancellations are not allowed. (+39 more)

### Community 33 - "Community 33"
Cohesion: 0.16
Nodes (35): OTAConnection, OTAProvider, OTARatePlanMapping, OTAReservationLifecycleEnum, OTAReservationLink, OTARoomMapping, OTAReservationMapping, OTASyncStatusEnum (+27 more)
...
Cohesion: 0.05
Nodes (11): 307e650 Add replayable operational warehouse projections, 7e2edb6 Merge Analytics R1.0, b5bc141 Harden core tenant composite relationships, df173d1 Implement Analytics R1.0 dashboard, chat IA, and support, HotelConfiguration — per-hotel business rules. No global/singleton: one row per, Room and RoomCategory models., Celery application configuration and async tasks for OTA synchronization., master admin panel  Revision ID: 20260421_master_admin_panel Revises: 9c0d2f3e1a (+3 more)

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (22): _ensure_membership_and_subscription(), ensure_plans_seeded(), get_or_create_hotel_for_owner(), Hotel helper utilities (ownership + bootstrap)., Seed default plans if missing., Find a hotel configuration owned by the given email, or create a new one.     Al, Create owner membership and starter subscription if missing., _hotel_default_currency() (+14 more)
...
Cohesion: 0.07
Nodes (30): ABC, Validate reset code without changing password (paso previo en UI)., validate_reset(), EmailProvider, EmailProviderError, get_email_provider(), _mask_email(), _mask_recipients() (+22 more)
...
Cohesion: 0.09
Nodes (31): create_room_block(), _exclusive_end(), _existing_user_id(), _inclusive_end(), list_room_blocks(), _read_block(), release_room_block(), RoomBlockCreate (+23 more)
...
Cohesion: 0.07
Nodes (34): Stream tenant-scoped invalidation signals; clients refetch from Postgres-backed, stream_domain_events(), get_settings(), _gmail_is_active(), _has_value(), is_demo_mode(), is_preview_qa_mode(), is_production_mode() (+26 more)
...
Cohesion: 0.09
Nodes (31): AuthResponse, AuthUser, _build_auth_response(), _generate_code(), _issue_email_token(), login(), _mask_email(), _pick_default_hotel_id() (+23 more)
...
Cohesion: 0.09
Nodes (22): main(), valid_https(), Shared, secret-safe binding for the Render QA bootstrap configuration., 19b8b7b Harden isolated preview QA and trusted release evidence, 3635693 Bootstrap trusted isolated cloud QA gate, 365b263 Harden isolated QA bootstrap and provider evidence, b5d6e0f Merge pull request #26 from Maximo-Paulos/codex/feature/trusted-qa-bootstrap, b94ce7b Bind final QA evidence to probed provider state (+14 more)

### Community 57 - "Community 57"
Cohesion: 0.09
Nodes (23): listGuests(), cancelWaitlistEntry(), createWaitlistEntry(), listWaitlistEntries(), promoteWaitlistEntry(), API routes for reservation waitlist operations., WaitlistEntry, WaitlistEntryCreate (+15 more)
...
Cohesion: 0.09
Nodes (23): 4529a78 Fix hotel payment method settings save, 9d6d084 Repair legacy payment proof schema, c32574b Report model schema drift at startup, credentials, CashHandoffSchemaRepairError, main(), missing_model_tables(), Repair a legacy cash-handoff schema before starting the API.  The managed databa (+15 more)
...
Cohesion: 0.07
Nodes (18): 03ec9de Refresh Graphify after Fase 9 role QA fixes, 181a413 Record Fase5 reception journey findings in the regression catalog, 2efac9f Record Fase 9 role QA findings in the regression catalog, 32f7bba Require checkin:perform permission for checkout, not just authentication, 411ce75 Add a full laundry cycle regression test for the housekeeping role, 54c5e97 Record housekeeping laundry cycle regression in the catalog, 906d009 Hide room status and block controls from roles that cannot use them, 9b26f2c Grant receptionist access to POST /api/payments and its summary (+10 more)

### Community 64 - "Community 64"
Cohesion: 0.10
Nodes (15): 1f352e4 feat(reports): SLICE-11 operational reports + alerts, 6f4beb1 feat(v72): Wave 3 — public API/keys + allocation V72 rules, a2c31f7 feat(ops): SLICE-04 room blocks + availability/allocation exclusion, c486aa3 feat(v72): Wave 2 — companies/documents, cash register/arqueo, guest override, _active_tag_filter(), add_tag(), _audit(), _get_guest() (+7 more)
...
Cohesion: 0.17
Nodes (25): AnalyticsExportJob, AnalyticsExportStatusEnum, FactReservationDaily, _date_window(), _decimal_total(), detect_no_shows(), _parse_datetime(), project_all_derived_facts_incremental() (+17 more)
...
Cohesion: 0.10
Nodes (13): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., main(), run(), validate_json() (+5 more)

### Community 79 - "Community 79"
Cohesion: 0.12
Nodes (17): audited_change(), Record an AuditLog row for a successful entity mutation., Record an AuditLog row for a successful entity mutation., AuditActionEnum, AuditLog, Tenant-scoped audit log for tracking mutations across core tables. Every write t, Append-only record of every significant mutation within a hotel tenant.     Do N, Allow-list guest audit context before persistence or external projection. (+9 more)
...
Cohesion: 0.11
Nodes (12): 283135b feat(ops): SLICE-13 laundry + stock foundations, 6f60c12 feat(security): SLICE-01 configurable permission matrix + role boundaries, b4c9bd8 Harden cash rotation and payment integrity, fd617c0 Harden private transfer proof workflow, laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026, permission matrix, role boundaries, and security audit log  Revision ID: 2026061, Store private transfer-proof bytes separately from searchable metadata., downgrade() (+4 more)

### Community 92 - "Community 92"
Cohesion: 0.19
Nodes (22): ReservationError, add_reservation_charge(), _available_room_for_conflict(), change_reservation_dates(), _compute_deposit_amount(), extend_reservation_stay(), _extension_amount(), _extension_conflicts() (+14 more)
...
Cohesion: 0.10
Nodes (7): 5de6817 Add field-based bulk rate editing, bed8c5c feat: BR audit — pricing source of truth, caja, checkout, occupancy, surcharges, df770c3 Polish rate calendar and reservation pricing, mockCalendar, mockCategories, mockDailyRates, repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi

### Community 100 - "Community 100"
Cohesion: 0.10
Nodes (16): createStockItem(), createStockLocation(), createStockMovement(), getCurrentStock(), listLowStockItems(), listStockItems(), listStockLocations(), listStockMovements() (+8 more)

### Community 101 - "Community 101"
Cohesion: 0.10
Nodes (10): 54eed63 Expose payment method configuration for owners, 731394e perf(measured): guest-search hot path EXPLAIN ANALYZE on real PG — trgm indexes used, <6ms p, meets SLO, a146746 test(e2e): seed completed onboarding (valid provider JSON) + robust login selector, e85df76 Harden reservation finance loading states, eee73bf test(perf+e2e): PG guest-search trgm indexes, benchmark harness, Playwright e2e harness, credentials, PAGES, Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati (+2 more)
...
Cohesion: 0.14
Nodes (11): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, 15fca54 Merge pull request #22 from Maximo-Paulos/chore/claude-code-pro-setup, 1ca1c06 Fix PostgreSQL enum schema drift, 30424d0 Add project skills and document professional Claude Code setup, 3d7e0fc Fix Windows-era paths and outdated checkout test after macOS migration, 50abb05 Merge pull request #23 from Maximo-Paulos/security/ota-webhook-constant-time, 5c302fd feat(reservations): cancel active seña payment links when a reservation is cancelled (BR §M), 603ec14 fix(ci): lowercase GHCR image names so Build and Push workflow succeeds (+3 more)
...
Cohesion: 0.17
Nodes (12): FastAPI routes for stock and inventory operations., StockItemCreate, StockItemRead, StockItemUpdate, StockLocationCreate, StockLocationRead, StockMovementCreate, StockMovementRead (+4 more)

### Community 152 - "Community 152"
Cohesion: 0.17
Nodes (12): _frontend_placeholder(), Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Fallback page shown when the Vite build is missing., Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, Serve the SPA shell. We no longer block by onboarding here to avoid     returnin, SPA fallback for React Router.     Skips API/asset paths to avoid shadowing. (+4 more)
...
Cohesion: 0.56
Nodes (8): _client_with_db(), _override_auth(), test_override_in_hotel_a_does_not_affect_hotel_b(), test_permission_denied_is_audited(), test_permission_override_allows_receptionist_guest_edit(), test_permissions_matrix_available_to_authenticated_hotel_member(), test_stock_history_api_is_hotel_scoped_and_limited(), test_stock_operator_cannot_adjust_without_explicit_adjust_permission()
...
Cohesion: 0.43
Nodes (6): create_audit_log(), model_snapshot(), payload_json(), queue_audit_log(), safe_create_audit_log(), sanitize_audit_payload()
...
Cohesion: 0.29
Nodes (6): Schemas for operational reservation actions., ReservationAdjustmentSummaryRead, ReservationFinancialSummaryRead, ReservationOTALinkSummaryRead, ReservationRoomMoveSummaryRead, ReservationTransactionSummaryRead
...
Cohesion: 0.52
Nodes (6): _seed_hotels(), test_low_stock_items_are_hotel_scoped(), test_stock_item_and_movement_are_hotel_scoped(), test_stock_movement_history_is_hotel_scoped_newest_first_and_limited(), test_stock_movement_requires_positive_quantity(), test_stock_outbound_cannot_make_quantity_negative()
...
Cohesion: 0.33
Nodes (5): StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, SafeStaticFiles, StaticFiles
...
Cohesion: 0.60
Nodes (5): completed_paid_amount(), completed_paid_amounts_by_reservation(), operational_balance_due(), paid_amount_with_legacy_fallback(), signed_transaction_amount()
...
Cohesion: 0.50
Nodes (3): AnalyticsAIChatRead, AnalyticsInsightRead, AnalyticsInsightStatusRead
...
- **Thin community `Community 196`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 220`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 259`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 275`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 282`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (1 nodes): `Schemas for manual OTA reservation entry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 6` to `Community 239`, `Community 203`, `Community 11`, `Community 9`, `Community 240`, `Community 152`, `Community 79`, `Community 29`, `Community 117`, `Community 37`, `Community 15`, `Community 30`, `Community 69`, `Community 7`, `Community 14`, `Community 106`, `Community 8`, `Community 141`, `Community 4`, `Community 3`, `Community 2`, `Community 35`, `Community 22`, `Community 65`, `Community 118`, `Community 33`, `Community 31`, `Community 19`, `Community 66`, `Community 297`, `Community 24`, `Community 0`, `Community 42`, `Community 62`, `Community 241`, `Community 61`, `Community 36`, `Community 87`, `Community 191`, `Community 192`, `Community 124`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 2` to `Community 25`, `Community 16`, `Community 32`, `Community 48`, `Community 3`, `Community 74`, `Community 35`, `Community 6`, `Community 29`, `Community 101`, `Community 30`, `Community 4`, `Community 0`, `Community 246`, `Community 36`, `Community 22`, `Community 89`, `Community 33`, `Community 94`, `Community 8`, `Community 92`, `Community 15`, `Community 62`, `Community 69`, `Community 79`, `Community 7`, `Community 87`, `Community 65`, `Community 31`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 4`, `Community 74`, `Community 32`, `Community 24`, `Community 6`, `Community 29`, `Community 2`, `Community 15`, `Community 37`, `Community 30`, `Community 14`, `Community 33`, `Community 36`, `Community 19`, `Community 66`, `Community 92`, `Community 42`, `Community 7`?**
...
- **Are the 602 inferred relationships involving `ReservationStatusEnum` (e.g. with `FastAPI routes for Booking management (thin layer over Reservation). Provides ba` and `Calculate pricing for a potential booking without persisting it.     Uses Catego`) actually correct?**
  _`ReservationStatusEnum` has 602 INFERRED edges - model-reasoned connections that need verification._
- **Are the 531 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 531 INFERRED edges - model-reasoned connections that need verification._
- **Are the 466 inferred relationships involving `Room` (e.g. with `RoomBlockCreate` and `RoomBlockRead`) actually correct?**
  _`Room` has 466 INFERRED edges - model-reasoned connections that need verification._