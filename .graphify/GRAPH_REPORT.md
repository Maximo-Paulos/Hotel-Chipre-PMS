...
## Summary
- 8523 nodes · 34931 edges · 326 communities detected
- Extraction: 61% EXTRACTED · 39% INFERRED · 0% AMBIGUOUS · INFERRED: 13565 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 13565 · ON_BRANCH: 5216 · contains: 5050 · calls: 3726 · MODIFIES: 2442 · rationale_for: 1618 · imports: 883 · imports_from: 677 · method: 595 · PARENT_OF: 595 · inherits: 561 · re_exports: 3
...
Cohesion: 0.02
Nodes (329): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest. (+321 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (268): Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, User management per hotel (owners/co-owners)., AuditLog, Append-only record of every significant mutation within a hotel tenant.     Do N (+260 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (237): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+229 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (51): _DecimalAwareEncoder, Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files., a61a51c chore: checkpoint de prueba antes de gemma 4, dc4b68a ojooooo, e34785c prueba, HotelMembership model: many-to-many between users and hotels with roles. Roles:, Persistent rate-limit events for security-sensitive endpoints., User accounts for authentication. Stores hashed passwords and basic profile flag (+43 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (175): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+167 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (193): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista, 0a4396e Add multi-hotel isolation tests and bcrypt shim (+185 more)

### Community 6 - "Community 6"
Cohesion: 0.16
Nodes (200): agent-mobilenav, agent-settlement, agent-stocksplit, agent-ux, agent-warehouse, worktree-agent-a256bbe12be1abe44, worktree-agent-a3a198c21200e26be, worktree-agent-a3c8668a591bf7739 (+192 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (95): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _require_demo_mode(), reset_demo(), seed_demo() (+87 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (159): cancel_reservation(), create_reservation_charge(), extend_stay(), mark_no_show(), modify_reservation(), occupancy_grid(), FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create (+151 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (114): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+106 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (127): FastAPI routes for outsourced laundry vendors, pricing and remitos.  Separate ro, RemitoCreate, RemitoCreateResponse, RemitoLineIn, RemitoLineRead, RemitoRead, SettlementMarkPaid, SettlementQuarterRead (+119 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (128): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 0391f8f Fix flaky detached-node false positive in mobile touch-target check, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker (+120 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (76): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), mercadopago_payment_link_webhook(), _mercadopago_webhook_impl(), get_settings(), _gmail_is_active() (+68 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (43): _authorize_override(), checkin(), checkin_partial(), CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload (+35 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (69): email_status(), getHotelConfig(), HotelConfig, HotelConfigUpdate, FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., Lightweight status so the frontend can check the active system email provider., updateHotelConfig() (+61 more)
...
Cohesion: 0.05
Nodes (80): MovementEventRead, MovementGroupRead, _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail). (+72 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (74): ApiKeyPurpose, HotelApiKey, HotelApiKeyIssued, issueApiKey(), IssueHotelApiKeyPayload, listApiKeys(), revokeApiKey(), SessionLike (+66 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (38): 099e4c8 fix(e2e): stop the WebKit business Apple matrix from colliding with itself, 0a457cb feat(checkin): B3 partial check-in + mandatory guest profile capture + companions, 194af4d fix(reservations): search guests by name/DNI instead of raw ID field, 1cd0fce Merge claude/feature/pms-roles-housekeeping-qa: integrate parallel QA fixes, 25d09dc fix(mobile): replace two competing mobile nav mechanisms with one menu button, 531bfbf docs(design): audit action-permission granularity + design step-up token (not wired), 906d009 Hide room status and block controls from roles that cannot use them, 98dce04 feat(nav): collapse 29-item menu to 5 daily links + collapsible groups (B6.1) (+30 more)
...
Cohesion: 0.05
Nodes (33): 2eb0e87 chore(migrations): merge stock_kind_fix and laundry_vendor_settlements alembic heads, 45b6181 feat(stock): collapse movement Ubicacion/Reserva behind advanced options, add item delete, 5779868 fix(reservations): explicit total_amount must skip rate-plan quoting entirely, 8850d76 Merge branch 'agent-stocksplit' into codex/feature/pms-e2e-scale-hardening, bfb74db fix(tests): target explicit revision instead of ambiguous downgrade -1, f2dd2fe fix(stock): allow reusing a deleted item's name; separate stock/lavanderia catalogs, ConfirmDialogProps, housekeeping (+25 more)
...
Cohesion: 0.39
Nodes (26): OTAConnection, OTAProvider, OTARatePlanMapping, OTAReservationLifecycleEnum, OTAReservationLink, OTARoomMapping, OTASyncStatusEnum, OTAWebhookCredential (+18 more)
...
Cohesion: 0.12
Nodes (21): Guest, GuestPayload, emptyQuickGuestForm(), guestFullName(), GuestQuickCreatePanelProps, GuestSummaryCard(), hasQuickGuestFormData(), QuickGuestFormValues (+13 more)
...
Cohesion: 0.10
Nodes (16): Reservation, listRooms(), cancelWaitlistEntry(), createWaitlistEntry(), listWaitlistEntries(), promoteWaitlistEntry(), API routes for reservation waitlist operations., WaitlistEntry (+8 more)
...
Cohesion: 0.15
Nodes (22): _load_manifest(), main(), ManifestContinuityError, _provider_subject(), Safe error that never prints provider values., Allow only a newer observation timestamp between provider snapshots., _timestamp(), verify_manifest_continuity() (+14 more)
...
Cohesion: 0.27
Nodes (21): AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, FactReservationRowKindEnum, FactRoomOccupancyDaily, FactRoomOccupancyStatusAtNightEnum, HotelAuditEvent, RoomStateEvent, OTAConnectionStatusEnum (+13 more)
...
Cohesion: 0.10
Nodes (6): a5ee7be fix(migrations): make schema-drift-era tables idempotent against self-healed production, v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event, Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re, Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for, Add transactions.created_by_user_id for payment audit trail.  Transaction had cr, laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre

### Community 99 - "Community 99"
Cohesion: 0.25
Nodes (19): Exception, AllocationAssignment, AllocationAssignmentStatusEnum, AllocationExplanation, AllocationRun, AllocationRunStatusEnum, Allocation, solver and LLM policy models.  The deterministic solver remains the, SolverMetric (+11 more)
...
Cohesion: 0.35
Nodes (11): _active_tag_filter(), add_tag(), _audit(), _get_guest(), GuestServiceError, list_active_tags(), _now(), quick_profile() (+3 more)
...
Cohesion: 0.18
Nodes (4): 5f2f6a7 feat(reservations): dual ARS/USD quoted amounts for manual OTA loads, credentials, Schemas for manual OTA reservation entry., Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing
...
Cohesion: 0.44
Nodes (7): _adjacency_bonus_for_room(), _check_overlap(), _lowest_available_compatible_floor(), _lowest_compatible_floor(), _one_night_gap_penalty_for_room(), run_allocation(), _run_allocation_greedy()
...
Cohesion: 0.25
Nodes (2): TestBookingWebhook, TestOTARaceCondition
...
Cohesion: 0.62
Nodes (6): _client_with_db(), _override_auth(), _teardown(), test_duplicate_active_name_returns_clean_409_not_a_500(), test_owner_can_delete_item_and_recreate_it_with_the_same_name(), test_stock_items_endpoint_filters_by_kind_for_stock_and_laundry_pages()
...
Cohesion: 0.67
Nodes (3): 15fdb88 Create missing cash custody handoff schema, b1e1bd0 Repair legacy cash handoff schema at startup, Repair known legacy PostgreSQL schema drift before starting the API.  The manage
...
- **Thin community `Community 62`** (2 nodes): `_hotel_default_currency()`, `OTAIntegrationService`
...
- **Thin community `Community 134`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 218`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 226`** (1 nodes): `Public WhatsApp bot hooks authenticated only by hotel API key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 235`** (2 nodes): `TestBookingWebhook`, `TestOTARaceCondition`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 257`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 278`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (2 nodes): `owner`, `receptionist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 312`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 318`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 326`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `Seed and serve the E2E backend on 127.0.0.1:8040.  This wrapper avoids shell-spe`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `Bind a SQLAlchemy transaction to the authenticated tenant.  PostgreSQL RLS polic`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 0` to `Community 7`, `Community 3`, `Community 207`, `Community 70`, `Community 241`, `Community 8`, `Community 35`, `Community 124`, `Community 99`, `Community 139`, `Community 16`, `Community 59`, `Community 89`, `Community 105`, `Community 1`, `Community 20`, `Community 48`, `Community 2`, `Community 15`, `Community 95`, `Community 161`, `Community 4`, `Community 26`, `Community 104`, `Community 57`, `Community 36`, `Community 125`, `Community 13`, `Community 67`, `Community 30`, `Community 106`, `Community 186`, `Community 33`, `Community 9`, `Community 261`, `Community 78`, `Community 298`, `Community 140`, `Community 90`, `Community 84`, `Community 216`, `Community 217`, `Community 137`, `Community 103`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 1` to `Community 14`, `Community 57`, `Community 8`, `Community 9`, `Community 10`, `Community 16`, `Community 12`, `Community 7`, `Community 0`, `Community 48`, `Community 4`, `Community 5`, `Community 89`, `Community 59`, `Community 265`, `Community 68`, `Community 87`, `Community 67`, `Community 62`, `Community 36`, `Community 2`, `Community 35`, `Community 105`, `Community 140`, `Community 90`, `Community 106`, `Community 84`, `Community 30`, `Community 235`, `Community 15`, `Community 137`, `Community 116`, `Community 49`, `Community 20`, `Community 102`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 16` to `Community 4`, `Community 0`, `Community 1`, `Community 8`, `Community 7`, `Community 48`, `Community 99`, `Community 89`, `Community 59`, `Community 15`, `Community 280`, `Community 153`, `Community 2`, `Community 67`, `Community 62`, `Community 97`, `Community 229`, `Community 106`, `Community 235`, `Community 49`, `Community 20`, `Community 102`?**
