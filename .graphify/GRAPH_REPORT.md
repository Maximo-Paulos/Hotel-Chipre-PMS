...
## Corpus Check
- Large corpus: 729 files · ~480,088 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6579 nodes · 22004 edges · 294 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 7975 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 7975 · contains: 4220 · calls: 3217 · MODIFIES: 1734 · ON_BRANCH: 1257 · rationale_for: 962 · imports: 722 · imports_from: 567 · method: 554 · inherits: 529 · PARENT_OF: 267
...
Cohesion: 0.04
Nodes (204): FastAPI routes for Check-in / Check-out., FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, DocumentTypeEnum, Guest, GuestTag (+196 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (142): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+134 more)
...
Cohesion: 0.03
Nodes (105): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login() (+97 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (131): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+123 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (104): RoomBlockCreate, RoomBlockRead, FastAPI routes for Guest management., Add new companions to an existing guest., RoomBlockCreate, RoomBlockRead, Base, Base class for all ORM models. (+96 more)
...
Cohesion: 0.03
Nodes (81): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+73 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (85): deactivate_payment_surcharge(), _get_surcharge_or_404(), PaymentSurchargeCreate, PaymentSurchargeRead, PaymentSurchargeUpdate, Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, update_payment_surcharge(), BillingAdjustment (+77 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (28): dc4b68a ojooooo, e34785c prueba, build_default_ota_orchestrator(), get_default_adapter(), Default OTA adapter registry.  This keeps provider construction in one place so, DashboardPage(), todayIso(), bubbleStyles (+20 more)
...
Cohesion: 0.02
Nodes (31): datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory() (+23 more)
...
Cohesion: 0.06
Nodes (55): GuestCompanion, Companion/additional occupant traveling with a primary guest.     Hotels often n, RateLimitEvent, Room category/type â€” e.g. Standard, Superior, Suite, Penthouse., RoomCategory, _enum_value(), get_guest_profile(), GuestProfile (+47 more)
...
Cohesion: 0.15
Nodes (43): AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, AnalyticsExportJob, AnalyticsExportStatusEnum, FactReservationDaily (+35 more)
...
Cohesion: 0.05
Nodes (24): 1a71e7d feat: add ota allocation data foundation, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 6e8e1f3 Add hotel_id scope migration and model indexes for rooms/categories/reservations, c580b56 ojala si, e1bc3d1 feat(db): v72 gaps phase 3 — room_movement_groups, BillingAdjustment Numeric, Room.description, e202fdd feat(db): v72 gaps phase 1+2 — Numeric precision, new tables, search indexes, OTA dedup, f0ca779 feat(security): prohibido_alojar enforcement, optimistic locking, payment tables (+16 more)
...
Cohesion: 0.43
Nodes (36): FastAPI routes for Reservations. Complete CRUD + cancel, modify, no-show, extend, §5.2 — Run allocation engine in background after reservation changes.     Create, Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled., Register the deferred corporate collection (v72 §3.5): settled., Cancel a reservation. Post check-in cancellations are not allowed., Cancel a reservation. Post check-in cancellations are not allowed., Cancel a reservation. Post check-in cancellations are not allowed. (+28 more)
...
- **Thin community `Community 110`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 191`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 199`** (1 nodes): `Public WhatsApp bot hooks authenticated only by hotel API key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 286`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (1 nodes): `FakeResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 298`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 300`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 5` to `Community 231`, `Community 198`, `Community 12`, `Community 40`, `Community 244`, `Community 178`, `Community 291`, `Community 128`, `Community 27`, `Community 11`, `Community 30`, `Community 1`, `Community 24`, `Community 4`, `Community 13`, `Community 29`, `Community 88`, `Community 2`, `Community 135`, `Community 0`, `Community 15`, `Community 3`, `Community 20`, `Community 32`, `Community 38`, `Community 25`, `Community 110`, `Community 8`, `Community 52`, `Community 28`, `Community 43`, `Community 59`, `Community 292`, `Community 26`, `Community 55`, `Community 245`, `Community 294`, `Community 208`, `Community 76`, `Community 187`, `Community 188`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 7`, `Community 38`, `Community 45`, `Community 4`, `Community 159`, `Community 32`, `Community 5`, `Community 27`, `Community 293`, `Community 24`, `Community 235`, `Community 78`, `Community 52`, `Community 56`, `Community 25`, `Community 8`, `Community 1`, `Community 85`, `Community 55`, `Community 15`, `Community 294`, `Community 76`, `Community 28`, `Community 146`, `Community 43`, `Community 13`, `Community 36`, `Community 100`, `Community 83`, `Community 93`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 4` to `Community 5`, `Community 0`, `Community 45`, `Community 26`, `Community 27`, `Community 1`, `Community 30`, `Community 24`, `Community 29`, `Community 15`, `Community 52`, `Community 56`, `Community 43`, `Community 59`, `Community 8`, `Community 85`, `Community 204`, `Community 122`, `Community 146`, `Community 13`, `Community 36`, `Community 100`, `Community 83`, `Community 93`?**
