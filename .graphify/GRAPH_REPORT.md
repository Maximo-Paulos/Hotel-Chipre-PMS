...
## Summary
- 6251 nodes · 19636 edges · 275 communities detected
- Extraction: 68% EXTRACTED · 32% INFERRED · 0% AMBIGUOUS · INFERRED: 6369 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 6369 · contains: 4100 · calls: 3142 · MODIFIES: 1622 · ON_BRANCH: 1038 · rationale_for: 792 · imports: 697 · imports_from: 555 · method: 554 · inherits: 519 · PARENT_OF: 248
...
Cohesion: 0.01
Nodes (97): _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Database engine and session management. Supports both PostgreSQL (production) an, Fill NULLs in NOT-NULL model columns that carry a default.      A column added i (+89 more)
...
Cohesion: 0.06
Nodes (175): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+167 more)
...
Cohesion: 0.04
Nodes (86): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), _mask_email() (+78 more)
...
Cohesion: 0.06
Nodes (54): _load_manifest(), main(), ManifestContinuityError, _provider_subject(), Safe error that never prints provider values., Allow only a newer observation timestamp between provider snapshots., _timestamp(), verify_manifest_continuity() (+46 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (30): datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, 373fd62 feat(auth): pilot-ready email-optional verification + CORS safety net, 39d221d Add request-verify route observability, 3d34a97 Connect system mail through master admin, 4cd2294 Fix SMTP verification confirmation (+22 more)
...
Cohesion: 0.06
Nodes (35): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+27 more)
...
Cohesion: 0.11
Nodes (13): 19b8b7b Harden isolated preview QA and trusted release evidence, 2c8cad0 Record audited QA setup commit in vault, 406e97e Document verified cloud deployment state, 767226c Record Vercel preview integration drift, b3bdae1 Refresh Graphify at audited QA commit, issue_provider_evidence_token(), load_provider_evidence_private_key(), main() (+5 more)
...
- **Thin community `Community 104`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 123`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 180`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 182`** (1 nodes): `TestReservationCreation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 185`** (2 nodes): `TestReoptimizationIntegration`, `TestReoptimizationTrigger`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 202`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 228`** (2 nodes): `credentials`, `PAGES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 230`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 239`** (1 nodes): `TestAvailability`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 240`** (1 nodes): `TestStateTransitions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 256`** (1 nodes): `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 257`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 258`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 276`** (1 nodes): `add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 277`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 278`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 280`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 9` to `Community 215`, `Community 0`, `Community 22`, `Community 10`, `Community 28`, `Community 32`, `Community 19`, `Community 5`, `Community 3`, `Community 88`, `Community 84`, `Community 131`, `Community 1`, `Community 4`, `Community 156`, `Community 23`, `Community 79`, `Community 27`, `Community 13`, `Community 24`, `Community 104`, `Community 17`, `Community 12`, `Community 46`, `Community 25`, `Community 105`, `Community 36`, `Community 49`, `Community 162`, `Community 70`, `Community 177`, `Community 178`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 4` to `Community 6`, `Community 13`, `Community 34`, `Community 12`, `Community 154`, `Community 27`, `Community 9`, `Community 22`, `Community 3`, `Community 278`, `Community 19`, `Community 1`, `Community 220`, `Community 72`, `Community 46`, `Community 50`, `Community 24`, `Community 5`, `Community 49`, `Community 162`, `Community 70`, `Community 25`, `Community 143`, `Community 78`, `Community 185`, `Community 118`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 156`, `Community 12`, `Community 3`, `Community 34`, `Community 0`, `Community 9`, `Community 22`, `Community 32`, `Community 28`, `Community 19`, `Community 88`, `Community 231`, `Community 4`, `Community 46`, `Community 50`, `Community 5`, `Community 36`, `Community 98`, `Community 103`, `Community 117`, `Community 143`, `Community 239`, `Community 182`, `Community 240`, `Community 78`, `Community 185`, `Community 118`?**
