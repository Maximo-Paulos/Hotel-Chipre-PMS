...
## Corpus Check
- Large corpus: 1165 files · ~1,679,965 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10177 nodes · 49801 edges · 365 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 16234 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16234 · ON_BRANCH: 13893 · contains: 5948 · calls: 4378 · MODIFIES: 3368 · rationale_for: 2105 · imports: 1078 · imports_from: 835 · PARENT_OF: 692 · inherits: 651 · method: 616 · re_exports: 3


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1165 · Candidates: 1298
- Excluded: 1 untracked · 15628 ignored · 12 sensitive · 0 missing committed
...
Cohesion: 0.02
Nodes (606): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true). (+598 more)

### Community 1 - "Community 1"
Cohesion: 0.16
Nodes (351): agent-linensplit, agent-login, agent-mobilenav, agent-otafix, agent-settlement, agent-stockedit, agent-stocksplit, agent-ux (+343 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (157): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _authorize_override(), checkin(), _require_demo_mode(), reset_demo(), seed_demo(), _clickhouse_healthcheck(), datastores_healthcheck() (+149 more)
...
Cohesion: 0.04
Nodes (259): PaymentSurchargeCreate, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+251 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (141): main(), valid_https(), _archive_historical(), _build_cases(), main(), _write_json(), Shared, secret-safe binding for the Render QA bootstrap configuration., requestVerification() (+133 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (202): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+194 more)
...
Cohesion: 0.05
Nodes (230): AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, inviteUser(), list_users(), listUsers() (+222 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (147): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+139 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (172): RoomBlockCreate, RoomBlockRead, 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement (+164 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (156): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+148 more)
...
Cohesion: 0.02
Nodes (120): ad4249c Implement master admin panel, PermissionGate(), StatCard(), StatCardProps, toneClasses, Email provider abstraction for platform transactional mail., clearMasterAdminCsrfToken(), masterAdminFetch() (+112 more)
...
Cohesion: 0.02
Nodes (57): CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload, OnboardingProviderSetup, OnboardingStatus, OTAChannelsPayload (+49 more)
...
Cohesion: 0.06
Nodes (66): AcceptPayload, _current_user(), Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., Keep useful internal references while never exposing free-form details., recent_security_events() (+58 more)
...
Cohesion: 0.08
Nodes (39): acceptInvitation(), _allow_mfa_attempt(), _attach_user_session_cookies(), _audit_security_event(), AuthResponse, _build_auth_response(), _build_login_response(), _burn_auth_timing_work() (+31 more)
...
Cohesion: 0.14
Nodes (30): _active_membership(), _audit(), audit_permission_denied(), can_role_hold_permission(), canonical_permission_code(), _engine_key(), ensure_permission_matrix_seeded(), get_effective_permission_details() (+22 more)
...
Cohesion: 0.13
Nodes (13): 3dee498 fix(review): chain permission-metadata migration after latest head, 77fa337 feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, 955325e feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, Configurable permission matrix models., An employee-specific permission decision within one hotel membership., An employee-specific permission decision within one hotel membership., UserPermissionOverride, _auth() (+5 more)
...
Cohesion: 0.40
Nodes (4): Check if guest has provided required identity documents for check-in., Check if guest has provided required identity documents for check-in., Check if guest has provided required identity documents for check-in., Check if guest has provided required identity documents for check-in.
...
- **Thin community `Community 319`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 335`** (1 nodes): `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `v72 gaps phase 3: room_movement_groups table, BillingAdjustment/ReservationAdjus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 357`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 358`** (1 nodes): `Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 359`** (1 nodes): `Add (hotel_id, room_id, check_in_date, check_out_date) index on reservations for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (1 nodes): `Add transactions.created_by_user_id for payment audit trail.  Transaction had cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 363`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 364`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 365`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `laundry vendors and remitos  Revision ID: 795e124adaad Revises: 62fddec52b79 Cre`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 367`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (1 nodes): `baseline  Revision ID: cb9001557529 Revises:  Create Date: 2026-03-31 19:04:53.7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 369`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 370`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 372`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 373`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 375`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 0` to `Community 2`, `Community 15`, `Community 156`, `Community 61`, `Community 210`, `Community 7`, `Community 83`, `Community 229`, `Community 124`, `Community 34`, `Community 3`, `Community 16`, `Community 96`, `Community 10`, `Community 9`, `Community 100`, `Community 94`, `Community 169`, `Community 320`, `Community 296`, `Community 31`, `Community 30`, `Community 22`, `Community 5`, `Community 269`, `Community 97`, `Community 49`, `Community 125`, `Community 17`, `Community 4`, `Community 79`, `Community 20`, `Community 95`, `Community 70`, `Community 108`, `Community 270`, `Community 271`, `Community 272`, `Community 84`, `Community 32`, `Community 74`, `Community 21`, `Community 82`, `Community 218`, `Community 63`, `Community 46`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 15`, `Community 9`, `Community 18`, `Community 371`, `Community 22`, `Community 7`, `Community 8`, `Community 3`, `Community 78`, `Community 16`, `Community 10`, `Community 276`, `Community 11`, `Community 57`, `Community 49`, `Community 87`, `Community 79`, `Community 4`, `Community 277`, `Community 83`, `Community 2`, `Community 6`, `Community 21`, `Community 82`, `Community 254`, `Community 20`, `Community 53`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 15`, `Community 9`, `Community 270`, `Community 272`, `Community 271`, `Community 3`, `Community 4`, `Community 7`, `Community 34`, `Community 16`, `Community 100`, `Community 31`, `Community 161`, `Community 10`, `Community 123`, `Community 119`?**
