...
## Corpus Check
- Large corpus: 742 files · ~486,621 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6758 nodes · 22496 edges · 313 communities detected
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 8153 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 8153 · contains: 4317 · calls: 3301 · MODIFIES: 1774 · ON_BRANCH: 1261 · rationale_for: 1011 · imports: 728 · imports_from: 576 · method: 571 · inherits: 533 · PARENT_OF: 271


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 742 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 8 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `b933ce7`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `ReservationStatusEnum` - 538 edges
2. `Reservation` - 537 edges
3. `HotelConfiguration` - 477 edges
4. `Room` - 395 edges
5. `Guest` - 383 edges
...
Cohesion: 0.04
Nodes (244): FastAPI routes for Check-in / Check-out., DocumentTypeEnum, Guest, GuestCompanion, Companion/additional occupant traveling with a primary guest.     Hotels often n, HotelConfiguration, RateLimitEvent, Reservation (+236 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (181): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/pms-e2e-scale-hardening, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+173 more)
...
Cohesion: 0.02
Nodes (74): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), Application Configuration. Uses pydantic-settings for environment variable manag, _DecimalAwareEncoder, _is_demo_mode_enabled(), Hotel PMS — FastAPI Main Application. Serves the API + bundled frontend files. (+66 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (102): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), _mask_email() (+94 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (113): RoomBlockCreate, RoomBlockRead, FastAPI routes for Guest management., Add new companions to an existing guest., RoomBlockCreate, RoomBlockRead, Base, Base class for all ORM models. (+105 more)
...
Cohesion: 0.03
Nodes (27): dc4b68a ojooooo, e34785c prueba, build_default_ota_orchestrator(), get_default_adapter(), Default OTA adapter registry.  This keeps provider construction in one place so, DashboardPage(), todayIso(), bubbleStyles (+19 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (81): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+73 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (65): createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge, PaymentSurchargeCreatePayload, PaymentSurchargeType, createRoomBlock() (+57 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (83): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca (+75 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (28): _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Database engine and session management. Supports both PostgreSQL (production) an, Fill NULLs in NOT-NULL model columns that carry a default.      A column added i (+20 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (50): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), approvePaymentProof() (+42 more)
...
Cohesion: 0.04
Nodes (21): 7e2edb6 Merge Analytics R1.0, df173d1 Implement Analytics R1.0 dashboard, chat IA, and support, AnalyticsComparisonStateRead, AnalyticsComparisonWindowRead, AnalyticsMetricCardRead, AnalyticsResponseEnvelopeRead, AnalyticsStarterSummaryDataRead, AnalyticsStarterSummaryRead (+13 more)
...
Cohesion: 0.15
Nodes (44): AnalyticsAIUsageMonthly, AnalyticsAlertSetting, AnalyticsAlertSnooze, AnalyticsCurrencyDisplayEnum, AnalyticsExportFormatEnum, AnalyticsExportJob, AnalyticsExportStatusEnum, FactReservationDaily (+36 more)
...
Cohesion: 0.10
Nodes (40): CompanyDocument, CompanyDocumentStatusEnum, CompanyDocumentTypeEnum, CompanyDocument — attachments/vouchers for company reservations (v72 §3.6). Trac, Document/voucher associated with a company reservation (v72 §3.6).     If requir, HotelPermissionOverride, Permission, Configurable permission matrix models. (+32 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (37): AnalyticsAIChatPage(), AnalyticsAIChatResponse, AnalyticsAIStatus, AnalyticsCategoryDetailPage(), AnalyticsChannelsPage(), AnalyticsCompanyDetailPage(), AnalyticsEnvelope, AnalyticsFilterState (+29 more)
...
Cohesion: 0.07
Nodes (33): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, AuthUser, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), inviteUser(), list_users(), listUsers() (+25 more)
...
Cohesion: 0.08
Nodes (40): delete_room(), housekeeping_summary(), FastAPI routes for Room management + Housekeeping., Resolve today's effective rate from the single source of truth and attach it, Resolve today's effective rate from the single source of truth and attach it, Simple availability helper. Returns a placeholder message if required     parame, Simple availability helper. Returns a placeholder message if required     parame, Generic room update (number, floor, notes, status, etc.). (+32 more)
...
Cohesion: 0.07
Nodes (28): 14c3453 Fail closed when managed databases are not migrated, 15f1429 Refresh Graphify and generated system inventories, 2c8cad0 Record audited QA setup commit in vault, 34ae6e9 Install dependencies before release evidence checks, 365b263 Harden isolated QA bootstrap and provider evidence, 3f9c8a0 Refresh Graphify after QA hardening, 42dd238 Improve vault entrypoint and memory validation, 71cb80e Update Graphify community labels (+20 more)
...
Cohesion: 0.13
Nodes (20): RuntimeError, AnalyticsWarehouseUnavailable, build_reservation_fact_row(), ClickHouseHTTPClient, ensure_schema(), get_clickhouse_client(), project_reservation_fact_rows(), ClickHouse derived analytics warehouse boundary.  PostgreSQL facts remain author (+12 more)
...
Cohesion: 0.29
Nodes (12): _credentials(), E2ESafetyError, main(), normalize_sqlite_url(), prepare_e2e_environment(), Prepare the fixed local SQLite database used by Playwright E2E tests.  The safet, Raised before any database-capable dependency is imported., Validate and normalize the only database target allowed for local E2E.      Both (+4 more)
...
Cohesion: 0.29
Nodes (5): FakeWarehouseClient, _settings(), test_clickhouse_schema_is_derived_and_tenant_partitioned(), test_reconcile_compares_source_and_derived_counts(), test_required_warehouse_configuration_fails_closed()
...
Cohesion: 0.40
Nodes (5): 1ac0c3c Add StatCard component and fix reservations dashboard error, 1af6bfc Add demo seed script and README instructions for stage 1, 26970dd Add token store cleanup helper, de996f5 Loosen auth email validation to allow test domains, e470215 Frontend: hotel selector and settings per hotel, remove legacy seed dependency
...
- **Thin community `Community 112`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (2 nodes): `ExpediaAdapter`, `OTAProviderAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 199`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 207`** (1 nodes): `Public WhatsApp bot hooks authenticated only by hotel API key.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 309`** (1 nodes): `add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 310`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 313`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `FakeResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 319`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `Email provider abstraction for platform transactional mail.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `Master admin panel backend package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `Schemas for manual OTA reservation entry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 5` to `Community 243`, `Community 206`, `Community 12`, `Community 3`, `Community 244`, `Community 148`, `Community 129`, `Community 25`, `Community 111`, `Community 29`, `Community 2`, `Community 23`, `Community 35`, `Community 11`, `Community 27`, `Community 90`, `Community 1`, `Community 136`, `Community 0`, `Community 19`, `Community 10`, `Community 39`, `Community 24`, `Community 112`, `Community 7`, `Community 9`, `Community 54`, `Community 26`, `Community 42`, `Community 61`, `Community 312`, `Community 57`, `Community 260`, `Community 314`, `Community 219`, `Community 78`, `Community 195`, `Community 196`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 0` to `Community 4`, `Community 39`, `Community 48`, `Community 9`, `Community 164`, `Community 10`, `Community 5`, `Community 25`, `Community 313`, `Community 23`, `Community 209`, `Community 80`, `Community 11`, `Community 54`, `Community 58`, `Community 24`, `Community 7`, `Community 2`, `Community 87`, `Community 57`, `Community 190`, `Community 35`, `Community 314`, `Community 78`, `Community 26`, `Community 151`, `Community 42`, `Community 37`, `Community 102`, `Community 85`, `Community 95`, `Community 84`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 9`, `Community 5`, `Community 7`, `Community 48`, `Community 35`, `Community 3`, `Community 25`, `Community 2`, `Community 29`, `Community 23`, `Community 27`, `Community 212`, `Community 11`, `Community 54`, `Community 58`, `Community 42`, `Community 61`, `Community 87`, `Community 215`, `Community 123`, `Community 151`, `Community 37`, `Community 102`, `Community 85`, `Community 95`, `Community 84`?**
...
- **Are the 470 inferred relationships involving `HotelConfiguration` (e.g. with `FastAPI routes for Hotel Configuration (Admin Panel).` and `Lightweight status so the frontend can check the active system email provider.`) actually correct?**
  _`HotelConfiguration` has 470 INFERRED edges - model-reasoned connections that need verification._
