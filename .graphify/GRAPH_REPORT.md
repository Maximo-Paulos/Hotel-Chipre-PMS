...
## Corpus Check
- Large corpus: 773 files · ~515,740 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7259 nodes · 24742 edges · 298 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9297 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9297 · contains: 4475 · calls: 3397 · MODIFIES: 1940 · ON_BRANCH: 1594 · rationale_for: 1177 · imports: 746 · method: 590 · imports_from: 587 · inherits: 535 · PARENT_OF: 404
...
Cohesion: 0.03
Nodes (167): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02c5612 Add tenant realtime sync and warehouse boundary, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions (+159 more)
...
Cohesion: 0.07
Nodes (169): chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp, 093f7d3 ui(manager): ocultar config y redirigir al dashboard al cambiar vista (+161 more)
...
Cohesion: 0.02
Nodes (30): FastAPI routes for provider connections. Exposes /api/connections/{provider}/con, Public WhatsApp bot hooks authenticated only by hotel API key., _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db() (+22 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (40): 1a71e7d feat: add ota allocation data foundation, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 70b1481 Relax startup validation for optional integrations, b4c9bd8 Harden cash rotation and payment integrity, c580b56 ojala si, f0ca779 feat(security): prohibido_alojar enforcement, optimistic locking, payment tables, fd617c0 Harden private transfer proof workflow (+32 more)
...
Cohesion: 0.05
Nodes (45): SimpleRateLimiter, Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent (+37 more)
...
Cohesion: 0.07
Nodes (54): Payment, PaymentLink, PaymentLinkStatusEnum, PaymentProviderEnum, PaymentStatusEnum, Payment gateway tracking models: PaymentLink, Payment, PaymentWebhookEvent.  Sou, One gateway payment object (MP preference / PayPal order / Stripe intent)., Reference values for payments.provider / payment_links.provider (stored as Strin (+46 more)
...
Cohesion: 0.06
Nodes (17): 1f352e4 feat(reports): SLICE-11 operational reports + alerts, 283135b feat(ops): SLICE-13 laundry + stock foundations, 6f4beb1 feat(v72): Wave 3 — public API/keys + allocation V72 rules, 6f60c12 feat(security): SLICE-01 configurable permission matrix + role boundaries, a2c31f7 feat(ops): SLICE-04 room blocks + availability/allocation exclusion, c486aa3 feat(v72): Wave 2 — companies/documents, cash register/arqueo, guest override, get_public_api_context(), _public_api_rate_limit_for_hotel() (+9 more)
...
Cohesion: 0.28
Nodes (38): Company, RoomMoveEvent, RoomMoveTypeEnum, ReservationNoShowPolicyAppliedEnum, ReservationOutcomeEnum, AllocationError, apply_allocation_result(), Custom exception for allocation engine errors. (+30 more)
...
Cohesion: 0.14
Nodes (28): ReservationAllocationLock, Groups multiple RoomMoveEvents triggered by the same cause (v72 §5.4).     Suppo, RoomMovementGroup, _adjacency_bonus_for_room(), AllocationResult, build_slots_from_db(), _check_overlap(), _is_protected_reservation() (+20 more)
...
Cohesion: 0.11
Nodes (21): 9d6d084 Repair legacy payment proof schema, c32574b Report model schema drift at startup, CashHandoffSchemaRepairError, main(), missing_model_tables(), Repair a legacy cash-handoff schema before starting the API.  The managed databa, Apply the additive cash-handoff repair in one PostgreSQL transaction., Apply the additive cash-handoff repair in one PostgreSQL transaction. (+13 more)
...
Cohesion: 0.11
Nodes (7): create_movement(), CurrentStock, DecimalValue, _ensure_adjustment_permission(), StockItem, StockLocation, StockMovement
...
Cohesion: 0.11
Nodes (15): createStockItem(), createStockLocation(), createStockMovement(), getCurrentStock(), listLowStockItems(), listStockItems(), listStockLocations(), StockMovementCreate (+7 more)
...
Cohesion: 0.18
Nodes (11): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by id (v72 §16).      Scoped to the API key (+3 more)
...
Cohesion: 0.16
Nodes (8): 2efac9f Record Fase 9 role QA findings in the regression catalog, 906d009 Hide room status and block controls from roles that cannot use them, ac2d59b Hide stock adjustment option from manager, bf9b633 Gate the post-close "Aprobar diferencia" button by role too, fdce0a4 Hide laundry batch creation from housekeeping, Persona, personas, credentials
...
- **Thin community `Community 126`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 198`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 222`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 263`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 265`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 279`** (1 nodes): `FakeRedis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 288`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 296`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 299`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 301`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 302`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (1 nodes): `Schemas for manual OTA reservation entry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 6` to `Community 240`, `Community 205`, `Community 11`, `Community 9`, `Community 241`, `Community 151`, `Community 77`, `Community 24`, `Community 114`, `Community 34`, `Community 59`, `Community 29`, `Community 67`, `Community 7`, `Community 48`, `Community 15`, `Community 102`, `Community 8`, `Community 141`, `Community 4`, `Community 3`, `Community 2`, `Community 33`, `Community 17`, `Community 64`, `Community 115`, `Community 49`, `Community 30`, `Community 26`, `Community 65`, `Community 302`, `Community 12`, `Community 0`, `Community 40`, `Community 63`, `Community 242`, `Community 73`, `Community 41`, `Community 85`, `Community 194`, `Community 195`, `Community 121`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 2` to `Community 23`, `Community 16`, `Community 31`, `Community 47`, `Community 3`, `Community 111`, `Community 38`, `Community 33`, `Community 6`, `Community 24`, `Community 96`, `Community 29`, `Community 4`, `Community 0`, `Community 247`, `Community 41`, `Community 248`, `Community 17`, `Community 87`, `Community 49`, `Community 91`, `Community 8`, `Community 89`, `Community 48`, `Community 63`, `Community 67`, `Community 77`, `Community 7`, `Community 85`, `Community 64`, `Community 30`, `Community 159`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 4`, `Community 111`, `Community 31`, `Community 12`, `Community 6`, `Community 24`, `Community 2`, `Community 48`, `Community 59`, `Community 34`, `Community 29`, `Community 15`, `Community 49`, `Community 41`, `Community 26`, `Community 65`, `Community 89`, `Community 40`, `Community 7`, `Community 159`?**
