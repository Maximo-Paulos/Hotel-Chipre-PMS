...
## Corpus Check
- Large corpus: 845 files · ~591,534 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 8586 nodes · 35111 edges · 336 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 13442 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 13442 · ON_BRANCH: 5418 · contains: 5103 · calls: 3743 · MODIFIES: 2442 · rationale_for: 1620 · imports: 895 · imports_from: 682 · PARENT_OF: 597 · method: 595 · inherits: 571 · re_exports: 3


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 845 · Candidates: recursive
...
Cohesion: 0.02
Nodes (255): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest. (+247 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (124): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _require_demo_mode(), reset_demo(), seed_demo() (+116 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (258): Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range., Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, AuditLog, Append-only record of every significant mutation within a hotel tenant.     Do N, HotelConfiguration (+250 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (224): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true)., Ensure computed fields land in the response. (+216 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (214): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+206 more)

### Community 5 - "Community 5"
Cohesion: 0.16
Nodes (202): agent-mobilenav, agent-otafix, agent-settlement, agent-stocksplit, agent-ux, agent-warehouse, worktree-agent-a256bbe12be1abe44, worktree-agent-a3a198c21200e26be (+194 more)
...
Cohesion: 0.02
Nodes (127): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, acceptInvitation(), AuthResponse, AuthUser, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token() (+119 more)
...
Cohesion: 0.03
Nodes (144): claude/feature/pms-roles-housekeeping-qa, codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 0391f8f Fix flaky detached-node false positive in mobile touch-target check, 03f4d70 Document cloud date and quote regressions (+136 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (122): LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead, FastAPI routes for outsourced laundry vendors, pricing, remitos and the linen (r, RemitoCreate (+114 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (130): _derive_payment_status(), public_reservation_status(), public_reservation_status_by_code(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by confirmation code (v72 §16).      Scoped (+122 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (46): _authorize_override(), checkin(), checkin_partial(), CategoryPayload, DepositPolicyPayload, finishOnboarding(), getOnboardingStatus(), HotelIdentityPayload (+38 more)
...
Cohesion: 0.04
Nodes (52): createPaymentSurcharge(), deactivatePaymentSurcharge(), grossWithSurcharge(), listPaymentSurcharges(), PaymentSurcharge, PaymentSurchargeCreatePayload, PaymentSurchargeType, list_timezones() (+44 more)
...
Cohesion: 0.05
Nodes (59): Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection (+51 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (42): create_movement(), createStockItem(), createStockLocation(), createStockMovement(), CurrentStock, deleteStockItem(), _ensure_adjustment_permission(), getCurrentStock() (+34 more)
...
Cohesion: 0.04
Nodes (20): 099e4c8 fix(e2e): stop the WebKit business Apple matrix from colliding with itself, 0a457cb feat(checkin): B3 partial check-in + mandatory guest profile capture + companions, 194af4d fix(reservations): search guests by name/DNI instead of raw ID field, 25d09dc fix(mobile): replace two competing mobile nav mechanisms with one menu button, b64223d Merge branch 'agent-mobilenav' into codex/feature/pms-e2e-scale-hardening, credentials, navigateFromShell(), revealCollapsedNavLink() (+12 more)
...
Cohesion: 0.06
Nodes (20): OTACommissionRule, OTACurrencyRate, OTASyncEvent, OTASyncJob, OTA domain models for channel mappings, sync orchestration and external links., NormalizedOTAReservation, OTAAdapterContext, OTAOperationResult (+12 more)
...
Cohesion: 0.06
Nodes (24): 45b6181 feat(stock): collapse movement Ubicacion/Reserva behind advanced options, add item delete, 8850d76 Merge branch 'agent-stocksplit' into codex/feature/pms-e2e-scale-hardening, f2dd2fe fix(stock): allow reusing a deleted item's name; separate stock/lavanderia catalogs, ConfirmDialogProps, housekeeping, owner, credentials, credentials (+16 more)
...
Cohesion: 0.08
Nodes (34): PendingActionPriorityEnum, PendingActionStatusEnum, PendingActionTypeEnum, PendingOperationalAction, PendingOperationalAction — the "pending_actions" table referenced throughout the, A follow-up item that requires a human decision before the operation can proceed, RefundPathEnum, RefundStatusEnum (+26 more)
...
Cohesion: 0.15
Nodes (31): Exception, AllocationAssignment, AllocationAssignmentStatusEnum, AllocationExplanation, AllocationPolicyProfile, AllocationPolicyVersion, AllocationRun, AllocationRunStatusEnum (+23 more)
...
Cohesion: 0.08
Nodes (19): 15fdb88 Create missing cash custody handoff schema, 1cd0fce Merge claude/feature/pms-roles-housekeeping-qa: integrate parallel QA fixes, 8b6cb4d Enlarge cash approval touch target, 906d009 Hide room status and block controls from roles that cannot use them, ac2d59b Hide stock adjustment option from manager, bf9b633 Gate the post-close "Aprobar diferencia" button by role too, c98bfa9 Grant receptionist read access to room list and availability, e18d711 Document cloud cash handoff recovery (+11 more)
...
Cohesion: 0.24
Nodes (18): 8765a87 Enforce role guard, room cap checks, auth schema hotel_ids, a02082a Fix users API import and utf-8 subscription service, _collect_plan_entitlements(), delete_entitlement_override(), ensure_entitlements_seeded(), ensure_room_within_limit(), ensure_subscription(), entitlements_payload() (+10 more)
...
Cohesion: 0.18
Nodes (14): LinenItem, LinenLocation, LinenMovement, Linen (ropa blanca) inventory models -- physically separate tables from app/mode, create_linen_item(), create_location(), current_stock(), delete_linen_item() (+6 more)
...
Cohesion: 0.62
Nodes (6): _client_with_db(), _override_auth(), _teardown(), test_duplicate_active_name_returns_clean_409_not_a_500(), test_owner_can_delete_item_and_recreate_it_with_the_same_name(), test_stock_item_unit_cost_is_exposed_on_create_and_update()
...
- **Thin community `Community 137`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (1 nodes): `FastAPI routes for the commercial configuration domain.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 222`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 238`** (2 nodes): `TestBookingWebhook`, `TestOTARaceCondition`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 244`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `SimpleRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (2 nodes): `chat_completions()`, `_extract_latest_user_message()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (2 nodes): `owner`, `receptionist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 318`** (1 nodes): `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 322`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `Add one-open-cash-session partial unique index.  Revision ID: 20260613_cash_open`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (1 nodes): `laundry and stock foundations  Revision ID: 20260613_laundry_stock Revises: 2026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (1 nodes): `Add transaction idempotency key for gateway payments.  Revision ID: 20260613_pay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 326`** (1 nodes): `permission matrix, role boundaries, and security audit log  Revision ID: 2026061`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (1 nodes): `Add PostgreSQL trigram indexes for guest search hot path.  Revision ID: 20260614`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (1 nodes): `Add daily rates and price periods.  Revision ID: 20260624_daily_rates Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 333`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 334`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 335`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 339`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 341`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 342`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 344`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 346`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 347`** (1 nodes): `Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 348`** (1 nodes): `Seed and serve the E2E backend on 127.0.0.1:8040.  This wrapper avoids shell-spe`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 350`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 0` to `Community 1`, `Community 212`, `Community 71`, `Community 245`, `Community 8`, `Community 20`, `Community 39`, `Community 56`, `Community 4`, `Community 61`, `Community 93`, `Community 107`, `Community 2`, `Community 18`, `Community 13`, `Community 98`, `Community 164`, `Community 3`, `Community 28`, `Community 106`, `Community 58`, `Community 33`, `Community 117`, `Community 126`, `Community 12`, `Community 11`, `Community 29`, `Community 69`, `Community 347`, `Community 48`, `Community 190`, `Community 41`, `Community 267`, `Community 79`, `Community 66`, `Community 94`, `Community 88`, `Community 220`, `Community 221`, `Community 139`, `Community 105`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 2` to `Community 7`, `Community 58`, `Community 8`, `Community 38`, `Community 10`, `Community 11`, `Community 1`, `Community 0`, `Community 20`, `Community 6`, `Community 93`, `Community 61`, `Community 3`, `Community 48`, `Community 271`, `Community 55`, `Community 91`, `Community 69`, `Community 64`, `Community 33`, `Community 4`, `Community 107`, `Community 94`, `Community 88`, `Community 21`, `Community 253`, `Community 274`, `Community 29`, `Community 238`, `Community 13`, `Community 139`, `Community 119`, `Community 47`, `Community 18`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 11` to `Community 3`, `Community 0`, `Community 2`, `Community 8`, `Community 1`, `Community 20`, `Community 56`, `Community 4`, `Community 93`, `Community 61`, `Community 13`, `Community 157`, `Community 48`, `Community 69`, `Community 64`, `Community 100`, `Community 125`, `Community 238`, `Community 47`, `Community 18`?**
