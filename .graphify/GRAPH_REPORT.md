...
## Corpus Check
- Large corpus: 1035 files · ~1,648,544 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 10119 nodes · 47889 edges · 352 communities detected
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 16273 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 16273 · ON_BRANCH: 12074 · contains: 5931 · calls: 4355 · MODIFIES: 3308 · rationale_for: 2087 · imports: 1078 · imports_from: 835 · PARENT_OF: 680 · inherits: 649 · method: 616 · re_exports: 3
...
Cohesion: 0.01
Nodes (185): _ensure_wide_version_table(), get_url(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, run_migrations_offline(), run_migrations_online(), _authorize_override(), checkin(), _require_demo_mode() (+177 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (386): email_status(), Lightweight status so the frontend can check the active system email provider., Lightweight status so the frontend can check the active system email provider., Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, Subscription status and entitlements endpoints. (+378 more)

### Community 2 - "Community 2"
Cohesion: 0.12
Nodes (357): main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., Replace this repository's absolute root in generated instructions only., agent-linensplit, agent-login, agent-mobilenav, agent-otafix (+349 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (292): PaymentSurchargeCreate, daily_report(), occupancy_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Occupancy report for a date range (default: last 30 days). (+284 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (151): Shared, secret-safe binding for the Render QA bootstrap configuration., requestVerification(), ApiError, ActiveRoomBlockItem, AvailableWithReviewItem, CashSessionStatusRead, DailyOperationalReport, getDailyOperationalReport() (+143 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (245): apply_period_to_daily_rates(), ApplyPeriodOut, _bulk_field_value(), bulk_update_daily_rate_field(), bulk_upsert_daily_rates(), BulkFieldRateIn, BulkRateIn, BulkRateOut (+237 more)
...
Cohesion: 0.07
Nodes (240): CheckInRequest, FastAPI routes for Check-in / Check-out., cancel_reservation(), change_dates(), create_new_reservation(), create_or_update_manual_ota(), create_reservation_charge(), _ensure_action_permission() (+232 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (184): RoomBlockCreate, RoomBlockRead, 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity, CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement (+176 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (128): booking_webhook(), despegar_webhook(), expedia_webhook(), _guarded_json_payload(), _handle_ota_webhook(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+120 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (161): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+153 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (152): create_laundry_remito(), _housekeeping_remito(), LinenItemCreate, LinenItemRead, LinenLocationCreate, LinenLocationRead, LinenMovementCreate, LinenMovementRead (+144 more)
...
Cohesion: 0.03
Nodes (144): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., Quickly seed demo bookings (requires DEMO_MODE=true). (+136 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (108): ad4249c Implement master admin panel, PermissionGate(), StatCard(), StatCardProps, toneClasses, Email provider abstraction for platform transactional mail., clearMasterAdminCsrfToken(), masterAdminFetch() (+100 more)
...
Cohesion: 0.05
Nodes (86): MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection, _as_aware() (+78 more)
...
Cohesion: 0.11
Nodes (72): HotelPermissionOverride, Permission, RolePermissionDefault, SecurityAuditLog, _insert_if_missing(), Tenant-scoped permission catalog, resolution, mutation, and audit services., Create or repair the built-in role permission matrix., Return a complete deny-by-default role row for every known permission. (+64 more)
...
Cohesion: 0.08
Nodes (65): add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., Add new companions to an existing guest., GuestRatingEnum, GuestTag (+57 more)
...
Cohesion: 0.06
Nodes (35): 0ff9102 fix(security): return CSRF token in the response body, 429e62c fix(review): require the CSRF cookie explicitly, no silent fallback, 70c936b revert: remove temporary RLS bypass diagnostic (#48), 9d95564 fix(security): return CSRF token in the response body, b47b916 feat(security): add revocable server-side sessions alongside existing JWT (backend only), Server-side, revocable sessions for the normal user auth plane., An opaque browser session whose raw token is never persisted., UserSession (+27 more)
...
Cohesion: 0.07
Nodes (38): 362fdd4 feat(security): add core TOTP/MFA enrollment, verification, and recovery codes, fbb6c00 fix(security): bind Google logins to a stable subject id to close an email-squatting account-takeover vector, IntegrationCatalog, IntegrationConnection, User accounts for authentication. Stores hashed passwords and basic profile flag, get_encryption_fernet(), Shared Fernet encryption for secrets stored in the database.  The integration en, Return the repository's existing Fernet instance for stored secrets. (+30 more)
...
Cohesion: 0.06
Nodes (44): AcceptPayload, Thin FastAPI transport for the tenant-scoped permission service., _current_user(), Tenant-scoped security overview and current-user session revocation., Invalidate every access token previously issued to the caller., Invalidate every access token previously issued to the caller., Keep useful internal references while never exposing free-form details., Keep useful internal references while never exposing free-form details. (+36 more)
...
Cohesion: 0.09
Nodes (40): _build_login_response(), google_login(), list_sessions(), logout(), _pick_default_hotel_id(), Auth endpoints: register, login, email verification and password reset. Verifica, Project a global identity event into every hotel the user actively belongs to., Project a global identity event into every hotel the user actively belongs to. (+32 more)
...
Cohesion: 0.09
Nodes (28): EffectivePermissionsResponse, fetchEffectivePermissions(), fetchPermissionMatrix(), PermissionCell, PermissionMatrix, PermissionMatrixResponse, PermissionOverridePayload, PermissionOverrideRequest (+20 more)
...
Cohesion: 0.11
Nodes (20): 6d2a815 feat(security): migrate password hashing to Argon2id with transparent bcrypt upgrade, _register_owner(), test_initial_state_is_empty(), test_multihotel_isolation_owner_state(), test_onboarding_flow_complete(), test_permissions_headers_applied_to_config(), _complete_onboarding_setup(), API coverage for the expanded onboarding wizard. (+12 more)
...
Cohesion: 0.19
Nodes (23): PaymentLinkTest, _apply_terminal_dates(), cancel_mercadopago_payment_link_test(), create_mercadopago_payment_link_test(), _ensure_utc(), _friendly_mercadopago_error(), _is_public_webhook_base(), list_payment_link_tests() (+15 more)
...
Cohesion: 0.13
Nodes (16): lifespan(), _log_rls_bypass_diagnostic_once(), Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Initialize database on application startup., Initialize database on application startup., Initialize database on application startup., TEMPORARY: log whether the app's own DB role bypasses RLS.      Read-only, logs, Initialize database on application startup. (+8 more)

### Community 122 - "Community 122"
Cohesion: 0.13
Nodes (12): ff29e0d feat(security): add critical/step-up/delegable metadata and optimistic versioning to permission catalog, Configurable permission matrix models., An employee-specific permission decision within one hotel membership., An employee-specific permission decision within one hotel membership., UserPermissionOverride, publish_permission_invalidation(), Raised when a permission override was changed after it was read., Explicit invalidation boundary for callers and future cache adapters.      Effec (+4 more)
...
Cohesion: 0.43
Nodes (5): _headers(), Security settings API is tenant-scoped, redacted and revokes real JWTs., test_manager_cannot_read_security_settings(), test_revoke_all_invalidates_the_callers_previous_token(), test_security_overview_and_events_are_redacted_and_tenant_scoped()
...
- **Thin community `Community 134`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 220`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 302`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (2 nodes): `_override_auth()`, `test_receptionist_can_get_price_quote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `add user TOTP MFA and recovery codes  Revision ID: 0c66ee6f32fa Revises: 2026082`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 342`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 343`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 344`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 345`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 346`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 347`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 348`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 349`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 350`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 351`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 352`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 353`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 354`** (1 nodes): `bind users to Google subject  Revision ID: 5e86f1b9ccbb Revises: 0c66ee6f32fa Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 355`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 356`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 357`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 358`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 359`** (1 nodes): `owner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Base` connect `Community 1` to `Community 0`, `Community 121`, `Community 56`, `Community 208`, `Community 8`, `Community 18`, `Community 123`, `Community 35`, `Community 39`, `Community 65`, `Community 72`, `Community 77`, `Community 99`, `Community 9`, `Community 10`, `Community 5`, `Community 101`, `Community 98`, `Community 164`, `Community 24`, `Community 318`, `Community 33`, `Community 32`, `Community 38`, `Community 4`, `Community 34`, `Community 268`, `Community 173`, `Community 52`, `Community 124`, `Community 19`, `Community 3`, `Community 83`, `Community 7`, `Community 22`, `Community 122`, `Community 76`, `Community 106`, `Community 14`, `Community 187`, `Community 89`, `Community 31`, `Community 269`, `Community 84`, `Community 25`, `Community 88`, `Community 216`, `Community 69`, `Community 258`, `Community 50`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 1` to `Community 16`, `Community 38`, `Community 8`, `Community 7`, `Community 41`, `Community 12`, `Community 5`, `Community 74`, `Community 0`, `Community 10`, `Community 72`, `Community 65`, `Community 3`, `Community 24`, `Community 9`, `Community 273`, `Community 60`, `Community 52`, `Community 92`, `Community 83`, `Community 274`, `Community 14`, `Community 18`, `Community 77`, `Community 25`, `Community 88`, `Community 34`, `Community 21`, `Community 252`, `Community 22`, `Community 258`, `Community 57`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 14` to `Community 24`, `Community 5`, `Community 3`, `Community 8`, `Community 0`, `Community 1`, `Community 10`, `Community 39`, `Community 35`, `Community 72`, `Community 65`, `Community 101`, `Community 33`, `Community 9`, `Community 68`?**
