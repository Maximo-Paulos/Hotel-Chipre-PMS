...
## Corpus Check
- Large corpus: 1003 files · ~642,369 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 9071 nodes · 39609 edges · 325 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 14773 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 14773 · ON_BRANCH: 7436 · contains: 5340 · calls: 3937 · MODIFIES: 2842 · rationale_for: 1818 · imports: 939 · imports_from: 722 · PARENT_OF: 616 · method: 598 · inherits: 585 · re_exports: 3


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1003 · Candidates: 1105
- Excluded: 4 untracked · 14507 ignored · 11 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `46a90d5`
...
Cohesion: 0.02
Nodes (86): get_url(), run_migrations_offline(), _ensure_wide_version_table(), run_migrations_online(), Alembic creates alembic_version with version_num VARCHAR(32) by default.     Som, master admin panel  Revision ID: 20260421_master_admin_panel Revises: 9c0d2f3e1a, master admin system owner mail and stripe settings  Revision ID: 20260421_master, _analytics_enum() (+78 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (310): guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho, v72 gaps phase 6: payment tables (payments, payment_links, payment_webhook_event, _policy_name(), _quoted_table(), upgrade(), downgrade(), Enable PostgreSQL row-level tenant isolation.  Revision ID: 20260724_tenant_rls_, Add (hotel_id, created_at) index on reservations for A2 recent-order paging.  Re (+302 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (126): add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c, add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em, reservation financial lifecycle  Revision ID: 20260410_reservation_financial_lif, ai assistant sessions  Revision ID: 20260411_ai_assistant_sessions Revises: 2026, ai assistant insights  Revision ID: 20260412_ai_assistant_insights Revises: 2026, ota hardening: hotel-scoped mappings and webhook credentials  Revision ID: a7f3d, _require_demo_mode(), seed_demo() (+118 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (138): add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2, add integration catalog  Revision ID: 9b0becb6c658 Revises: 20260407_subscriptio, add payment link tests  Revision ID: b7c1f0a8f9d2 Revises: 9b0becb6c658 Create D, _ensure_enabled(), _connection_error_message(), _origin_for_popup(), _oauth_state_token(), _oauth_callback_page() (+130 more)
...
Cohesion: 0.03
Nodes (40): extend onboarding state for wizard flow  Revision ID: 20260419_onboarding_wizard, add trial and comped fields to subscriptions  Revision ID: 20260419_subscription, FastAPI routes for the onboarding flow used by smoke tests., Onboarding state scoped by hotel. Tracks completion of setup steps and stores dr, OnboardingProviderSetup, OnboardingStatus, OwnerPayload, HotelIdentityPayload (+32 more)
...
Cohesion: 0.03
Nodes (308): v72 section 12.3 - payment_surcharges table.  Revision ID: 20260624_payment_surc, Application decorators., Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg, Security / access audit log — free-form operational security events.  Distinct f, Pydantic schemas for HotelConfiguration., mockCategories, mockCalendar, mockDailyRates (+300 more)
...
Cohesion: 0.05
Nodes (46): repair: ensure uq_reservation_hotel_id_id exists before payment_links FK  Revisi, _authorize_override(), checkin(), email_status(), FastAPI routes for Hotel Configuration (Admin Panel)., Lightweight status so the frontend can check the active system email provider., _attach_current_rate(), _housekeeping_room() (+38 more)
...
Cohesion: 0.09
Nodes (7): _add_successor_reference(), _drop_successor_reference(), upgrade(), downgrade(), Add zero-balance cash rotation and custody handoffs., 4f50de1 Add successor cash register controls, b4c9bd8 Harden cash rotation and payment integrity
...
Cohesion: 0.02
Nodes (113): add external-effect mode to payment links  Revision ID: 20260812_external_effect, get_public_api_context(), _public_api_rate_limit_for_hotel(), Public API-key authentication, separate from staff JWT auth., HotelMembership model: many-to-many between users and hotels with roles. Roles:, Payment gateway tracking models: PaymentLink, Payment, PaymentWebhookEvent.  Sou, validatedSha(), resolveCodeSha() (+105 more)
...
Cohesion: 0.04
Nodes (69): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, _generate_code(), _mask_email(), _build_auth_response(), _issue_email_token(), register(), request_verify(), login() (+61 more)

### Community 72 - "Community 72"
Cohesion: 0.10
Nodes (16): SimpleRateLimiter, Staff management endpoints for hotel public API keys., require_public_api_purpose(), Authorize a public key for a specific external product surface.      Purpose val, HotelAPIKeyError, _hash_secret(), _generate_secret(), issue_key() (+8 more)
...
Cohesion: 0.13
Nodes (22): _pick_default_hotel_id(), validate_reset(), Prefer a hotel whose onboarding is already complete.      When a user belongs to, Validate reset code without changing password (paso previo en UI)., User management per hotel (owners/co-owners)., MasterEmailConnectionError, _dev_outbox_path(), _record_dev_email() (+14 more)

### Community 125 - "Community 125"
Cohesion: 0.17
Nodes (14): google_login(), Auth endpoints: register, login, email verification and password reset. Verifica, "Sign in with Google" via Google Identity Services' ID-token flow: the     front, GoogleLoginDisabled, external_effects_enabled(), inbound_provider_events_enabled(), google_login_enabled(), require_external_effects() (+6 more)
...
Cohesion: 0.02
Nodes (372): availability(), price_quote(), FastAPI routes for Booking management (thin layer over Reservation). Provides ba, Ensure computed fields land in the response., Lightweight availability placeholder. When all parameters are provided,     it r, Calculate pricing for a potential booking without persisting it.     Uses Catego, Quickly seed demo bookings (requires DEMO_MODE=true)., CheckInRequest (+364 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (128): BaseModel, StockItemCreate, StockItemUpdate, StockItemRead, StockLocationCreate, StockLocationRead, StockMovementCreate, StockMovementRead (+120 more)
...
Cohesion: 0.04
Nodes (229): DailyRateOut, Config, DailyRateFallbackOut, DailyRateIn, BulkRateIn, BulkFieldRateIn, BulkRateOut, PricePeriodIn (+221 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (167): Demo-only utilities: seed sample data and reset the database. Exposed only when, Guard endpoints so they only run in explicit demo mode or tests., Populate the database with minimal demo data.     Idempotent: running twice simp, Drop and recreate all tables.     Keeps the app in a known-good empty state for, add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Base (+159 more)
...
Cohesion: 0.04
Nodes (52): _enum_value(), _build_guest_ledger_csv(), export_guest_ledger(), Guest, GuestTagType, GuestTag, GuestTagPayload, GuestStaySummary (+44 more)
...
Cohesion: 0.08
Nodes (35): AcceptPayload, LoginRequest, AuthContext, _parse_header_hotel_id(), _parse_token_hotel_id(), _resolve_membership(), get_auth_context(), require_permission() (+27 more)
...
Cohesion: 0.19
Nodes (17): _handle_ota_webhook(), booking_webhook(), expedia_webhook(), despegar_webhook(), _guarded_json_payload(), FastAPI Webhook endpoints for OTA integrations., Receive reservation notifications from Booking.com., Receive reservation notifications from Expedia. (+9 more)
...
Cohesion: 0.10
Nodes (22): PaymentSurchargeRead, PaymentSurchargeCreate, PaymentSurchargeUpdate, _get_surcharge_or_404(), update_payment_surcharge(), deactivate_payment_surcharge(), get_hotel_config(), validate_payment_method_enabled() (+14 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (322): Payment surcharges API - v72 section 12.3.  GET    /api/payment-surcharges, daily_report(), occupancy_report(), revenue_report(), FastAPI routes for Reports & Night Audit. Daily summaries, occupancy reports, re, Night Audit / Daily Report.     Shows arrivals, departures, occupancy, revenue c, Occupancy report for a date range (default: last 30 days)., Revenue report for a date range. (+314 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (40): FastAPI routes for Payments., PaymentMethod, TransactionType, PaymentRequest, PaymentSummary, getPaymentSummary(), newPaymentIdempotencyKey(), makePayment() (+32 more)
...
Cohesion: 0.10
Nodes (9): get_group(), list_groups(), create_grouped_room_move(), revert_group(), _active_reservation_conflicts_for_room(), 299301c feat(R-extra): motor residuals — solver capacity §5.1, safe revert §5.4, manual move audit §5.5, 6f4beb1 feat(v72): Wave 3 — public API/keys + allocation V72 rules, db51e3e feat(R3c): extension conflict resolution flow (§8.6) (+1 more)

### Community 42 - "Community 42"
Cohesion: 0.12
Nodes (40): _derive_payment_status(), _serialize_reservation_status(), public_reservation_status_by_code(), public_reservation_status(), Public booking-engine API authenticated only with hotel API keys., Coarse payment status derived from amounts (no sensitive detail)., Read-only reservation/payment status by confirmation code (v72 §16).      Scoped, Read-only reservation/payment status by id (v72 §16).      Scoped to the API key (+32 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (62): RateCalendarChannelPrice, RateCalendarChannelRestrictions, RateCalendarChannelDay, RateCalendarDay, RateCalendarMeta, RateCalendarResponse, GetRateCalendarDailyParams, getRateCalendarDaily() (+54 more)
...
Cohesion: 0.03
Nodes (71): _is_manager_context(), _ensure_manual_rate_permission(), _project_reservation_graph(), create_new_reservation(), create_or_update_manual_ota(), list_reservations(), get_reservation(), add_reservation_guests() (+63 more)

### Community 8 - "Community 8"
Cohesion: 0.10
Nodes (192): _to_read(), _trigger_reoptimization_bg(), occupancy_grid(), register_settlement(), cancel_reservation(), create_reservation_charge(), release_no_guarantee_reservation(), mark_no_show() (+184 more)

### Community 43 - "Community 43"
Cohesion: 0.10
Nodes (37): RoomBlockCreate, RoomBlockRead, RoomBlockReasonEnum, RoomBlock, Date-ranged block on a room. NULL ends_at means indefinite.     resolved_at popu, Exception, HotelOutboundEmailError, is_review_for_today() (+29 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (110): _current_user(), _safe_resource_id(), security_overview(), recent_security_events(), revoke_current_user_sessions(), Tenant-scoped security overview and current-user session revocation., Keep useful internal references while never exposing free-form details., Invalidate every access token previously issued to the caller. (+102 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (28): _ensure_adjustment_permission(), create_movement(), FastAPI routes for stock and inventory operations., StockItem, StockLocation, StockMovement, CurrentStock, StockConsumptionGroupBy (+20 more)

### Community 70 - "Community 70"
Cohesion: 0.10
Nodes (20): _remaining_trial_days(), _serialize_status_payload(), subscription_status(), change_plan(), start_subscription_trial(), admin_comped_override(), Subscription status and entitlements endpoints., SubscriptionPlan (+12 more)
...
Cohesion: 0.08
Nodes (35): Settings, BaseSettings, get_settings(), _normalized_env_value(), _has_value(), _is_public_https_url(), _mercadopago_is_active(), _paypal_is_active() (+27 more)
...
Cohesion: 0.25
Nodes (8): _is_demo_mode_enabled(), _require_demo_mode(), Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed., Check whether demo-only utilities should be exposed.

### Community 173 - "Community 173"
Cohesion: 0.18
Nodes (11): _seed_permission_matrix_once(), lifespan(), Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Initialize database on application startup., Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Initialize database on application startup., Seed the permission matrix once at boot (per worker process).      A1 fix: seed_, Initialize database on application startup. (+3 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (28): SafeStaticFiles, StaticFiles, _frontend_placeholder(), serve_frontend(), serve_spa(), StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, Fallback page shown when the Vite build is missing., Serve the SPA shell. We no longer block by onboarding here to avoid     returnin (+20 more)
...
Cohesion: 0.17
Nodes (14): RuntimeError, SystemEmailStatus, _mask_email(), _mask_recipients(), _normalize_display_from(), EmailProviderError, EmailProvider, ABC (+6 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (50): MasterAdminSession, Base, MasterAdminAuthLockout, MasterBillingPolicy, MasterSystemEmailConnection, MasterStripeSettings, MasterAdminContext, SellableProduct (+42 more)

### Community 47 - "Community 47"
Cohesion: 0.13
Nodes (29): MasterAdminAuditEvent, MasterStripeWebhookEvent, Subscription, FakeResponse, _seed_platform_admin(), _seed_hotel(), _seed_subscription(), _configure_resend() (+21 more)
...
Cohesion: 0.18
Nodes (27): str, AnalyticsExportFormatEnum, AnalyticsCurrencyDisplayEnum, HotelAuditEvent, RoomStateEvent, FactReservationRowKindEnum, FactRoomOccupancyStatusAtNightEnum, FactRoomOccupancyDaily (+19 more)
...
Cohesion: 0.11
Nodes (59): CashSessionStatusEnum, CashMovementTypeEnum, CashCustodyStatusEnum, CashSession, CashMovement, CashCloseReport, CashCustodyHandoff, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca (+51 more)
...
Cohesion: 0.09
Nodes (44): APIKeyPurposeEnum, HotelAPIKeyIssue, HotelAPIKeyRead, HotelAPIKeyIssued, PublicAvailabilityResponse, PublicCategoryRead, PublicRateQuote, PublicReservationCreate (+36 more)
...
Cohesion: 0.27
Nodes (32): OTASyncStatusEnum, OTAWebhookCredential, OTA (Online Travel Agency) reservation mapping. Tracks the link between external, Per-hotel OTA webhook credential. The secret is stored as a hash so the     raw, OTAReservationLifecycleEnum, OTAProvider, OTAConnection, OTARoomMapping (+24 more)

### Community 128 - "Community 128"
Cohesion: 0.21
Nodes (14): OTACurrencyRate, OTACommissionRule, OTA domain models for channel mappings, sync orchestration and external links., quote_rate_plan_stay(), _select_rate_plan_price(), _select_tax_policy(), _apply_tax_policy(), _calculate_rule_amount() (+6 more)
...
Cohesion: 0.15
Nodes (14): CashHandoffSchemaRepairError, repair_cash_handoff_schema(), missing_model_tables(), main(), Raised when the safe repair cannot run against the configured database., Apply the additive cash-handoff repair in one PostgreSQL transaction., Return model tables absent from a PostgreSQL database without changing it., Apply the additive cash-handoff repair in one PostgreSQL transaction. (+6 more)
...
Cohesion: 0.29
Nodes (15): CashRegisterError, _money(), _require_open_session(), open_session(), get_latest_close_report(), add_movement(), get_open_session(), record_cash_payment_movement() (+7 more)
...
Cohesion: 0.11
Nodes (36): RealtimeEventsUnavailable, DomainEvent, _settings(), channel_for_hotel(), revision_key_for_hotel(), validate_event_input(), _validate_hotel_id(), _get_redis_client() (+28 more)
...
Cohesion: 0.05
Nodes (50): AllocationRunPayload, AllocationRunResponse, RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), listRoomMovementGroups(), revertRoomMovementGroup(), listCategories() (+42 more)
...
Cohesion: 0.04
Nodes (59): RemitoDirection, LaundryVendor, LaundryVendorCreate, LaundryVendorUpdate, LaundryVendorPrice, LaundryVendorPriceUpsert, LaundryRemitoLine, LaundryRemito (+51 more)
...
Cohesion: 0.14
Nodes (29): StructuredData, SeoProps, Seo(), navItems, MarketingShellProps, MarketingShell(), PublicButtonLinkProps, isExternal() (+21 more)
...
Cohesion: 0.07
Nodes (26): inline_list(), graphify_command_error(), main(), Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., command(), heading(), fenced() (+18 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (40): bootstrap_configuration_fingerprint(), Shared, secret-safe binding for the Render QA bootstrap configuration., Hash the exact provider-observed values without exposing them individually., _required(), load_provider_evidence_private_key(), issue_provider_evidence_token(), _safe_output_path(), write_private_token() (+32 more)

### Community 124 - "Community 124"
Cohesion: 0.24
Nodes (15): fail(), mapping(), positive_integer(), utc_timestamp(), preview_origin(), nested_value(), load_json_object(), validate_evidence_bundle() (+7 more)
...
Cohesion: 0.09
Nodes (54): BootstrapConfigurationError, VerificationError, JsonGetter, ReadOnlyJsonApi, VerificationConfig, ProviderClients, _dict(), _list() (+46 more)
...
Cohesion: 0.07
Nodes (58): QABootstrapError, Persona, QABootstrapConfig, QABootstrapResult, ProviderEvidence, _required(), _flag(), _required_port() (+50 more)
...
Cohesion: 0.13
Nodes (19): FakeResponse, _register_owner(), _auth_headers(), _complete_onboarding(), _configure_resend(), test_register_verify_and_reset_use_resend_provider(), test_auth_flows_fail_without_connected_mail_provider(), test_unverified_users_cannot_use_operational_endpoints() (+11 more)
...
Cohesion: 0.24
Nodes (8): ExplodingDB, ExplodingRequest, test_credential_access_and_email_stop_before_db_or_network(), test_connections_flag_alone_closes_credential_lane(), test_payment_link_test_stops_before_db_or_provider(), test_google_login_stops_before_transport_or_db(), test_provider_callbacks_stop_before_body_parse(), test_ota_callback_stops_before_json_parse()
...
Cohesion: 0.50
Nodes (12): _override_auth(), _client_with_db(), _teardown(), test_owner_can_manage_vendors_and_receptionist_cannot(), test_owner_can_manage_linen_items_and_receptionist_cannot(), test_owner_can_register_a_linen_movement_and_load_an_opening_balance(), test_housekeeping_can_operate_remitos_but_not_manage_vendors(), test_remito_rejects_insufficient_house_stock_via_api() (+4 more)
...
Cohesion: 0.13
Nodes (20): _target_safety_error(), _reset_pg_to_clean_head(), test_alembic_upgrade_on_empty_database(), test_alembic_downgrade_and_reupgrade(), Safety contract for destructive PostgreSQL validation tests.  These tests never, PostgresTargetSafetyError, _enabled(), _canonical_identity() (+12 more)
...
Cohesion: 0.22
Nodes (7): get_db_override_target(), get_auth_context_target(), client_with_db(), authed_client(), test_verify_email_code_guessing_is_rate_limited(), test_reset_password_code_guessing_is_rate_limited_and_shared_with_validate(), test_register_is_rate_limited_by_source()
...
Cohesion: 0.27
Nodes (6): FakeConnection, FakeEngine, test_repair_adds_missing_cash_handoff_schema_objects(), test_repair_refuses_non_postgres_targets(), test_schema_report_lists_only_missing_model_tables(), test_repair_adds_only_missing_cash_handoff_schema_objects()
...
Cohesion: 0.53
Nodes (8): _override_auth(), _client_with_db(), _teardown(), test_owner_can_delete_item_and_recreate_it_with_the_same_name(), test_duplicate_active_name_returns_clean_409_not_a_500(), test_stock_item_unit_cost_is_exposed_on_create_and_update(), test_stock_item_full_edit_updates_name_sku_unit_and_min_quantity(), test_stock_items_endpoint_filters_by_kind_for_stock_and_laundry_pages()
...
Cohesion: 0.13
Nodes (22): _seed_hotels(), test_stock_item_and_movement_are_hotel_scoped(), test_stock_movement_requires_positive_quantity(), test_stock_outbound_cannot_make_quantity_negative(), test_stock_movement_history_is_hotel_scoped_newest_first_and_limited(), test_stock_adjustment_can_correct_quantity_downward(), test_stock_adjustment_downward_cannot_make_quantity_negative(), test_current_stock_location_filter_is_additive_and_hotel_wide_total_unchanged() (+14 more)
...
## Knowledge Gaps
- **699 isolated node(s):** `guest checkin profile fields  Revision ID: 17f1689785f3 Revises: 20260725_res_ho`, `add hotel scope to core tables  Revision ID: 20260404_add_hotel_scope Revises: c`, `add subscription v2 tables  Revision ID: 20260407_subscription_tables Revises: 2`, `launch security hardening  Revision ID: 20260408_launch_security_hardening Revis`, `add sender metadata to payment link tests  Revision ID: 20260408_payment_link_em` (+694 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 303`** (1 nodes): `v72 gaps phase 1: Numeric precision, room score/accessibility, guest dedup+ratin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (1 nodes): `v72 gaps phase 4: PRE_CHECK_IN state, RoomMoveEvent audit fields, company_docume`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `v72 gaps phase 5: optimistic locking on reservations  Revision ID: 20260612_v72_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 312`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 314`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 315`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 316`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 317`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 318`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 319`** (1 nodes): `Store private transfer-proof bytes separately from searchable metadata.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 320`** (1 nodes): `Add private bank-transfer proof workflow.  Revision ID: 20260724_payment_proofs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `repair: create hotel_memberships table (was never migrated)  Revision ID: 202607`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 322`** (1 nodes): `Add quoted_amount_ars/quoted_amount_usd to reservations (dual manual OTA pricing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (1 nodes): `merge stock kind fix and laundry vendor settlements  Revision ID: 513720cf2551 R`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 324`** (1 nodes): `merge linen split and reservation quoted dual amounts  Revision ID: 6feb3dd16d0f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 325`** (1 nodes): `repair: ensure uq_stock_items_hotel_id_id / uq_stock_locations_hotel_id_id exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 326`** (1 nodes): `laundry vendor settlements (quarterly paid/not-paid mark)  Revision ID: e2c4a9f7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (1 nodes): `repair audit_logs stray legacy columns  Revision ID: ebd2db08c7d0 Revises: 6feb3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (2 nodes): `_mercadopago_webhook_impl()`, `mercadopago_payment_link_webhook()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 333`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 271`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `Mailer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (1 nodes): `BookingAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (2 nodes): `OTAProviderAdapter`, `ExpediaAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (1 nodes): `DespegarAdapter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (2 nodes): `_hotel_default_currency()`, `OTAIntegrationService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 329`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 269`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (2 nodes): `graphify_state()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `Fast server-side EXPLAIN ANALYZE probe for hot queries on real PostgreSQL.  Rati`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 225`** (1 nodes): `test_failed_audit_log_insert_does_not_roll_back_callers_change()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 279`** (1 nodes): `Response`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 212`** (2 nodes): `FakeRedis`, `test_availability_key_shape_and_serialization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 7` to `Community 4`, `Community 10`, `Community 173`, `Community 67`, `Community 220`, `Community 8`, `Community 47`, `Community 27`, `Community 36`, `Community 61`, `Community 5`, `Community 62`, `Community 68`, `Community 80`, `Community 2`, `Community 21`, `Community 106`, `Community 102`, `Community 154`, `Community 0`, `Community 28`, `Community 55`, `Community 6`, `Community 127`, `Community 13`, `Community 42`, `Community 128`, `Community 48`, `Community 34`, `Community 3`, `Community 12`, `Community 189`, `Community 43`, `Community 1`, `Community 74`, `Community 250`, `Community 143`, `Community 64`, `Community 90`, `Community 210`, `Community 140`, `Community 105`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 2` to `Community 10`, `Community 27`, `Community 7`, `Community 20`, `Community 55`, `Community 8`, `Community 14`, `Community 77`, `Community 11`, `Community 42`, `Community 6`, `Community 72`, `Community 330`, `Community 68`, `Community 62`, `Community 0`, `Community 43`, `Community 254`, `Community 22`, `Community 57`, `Community 93`, `Community 99`, `Community 71`, `Community 48`, `Community 95`, `Community 5`, `Community 74`, `Community 80`, `Community 64`, `Community 90`, `Community 4`, `Community 239`, `Community 47`, `Community 257`, `Community 34`, `Community 12`, `Community 140`, `Community 97`, `Community 41`, `Community 21`, `Community 115`, `Community 104`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 0` to `Community 10`, `Community 7`, `Community 27`, `Community 42`, `Community 2`, `Community 8`, `Community 5`, `Community 61`, `Community 68`, `Community 62`, `Community 106`, `Community 272`, `Community 43`, `Community 99`, `Community 71`, `Community 48`, `Community 126`, `Community 138`, `Community 41`, `Community 21`, `Community 115`, `Community 104`?**
