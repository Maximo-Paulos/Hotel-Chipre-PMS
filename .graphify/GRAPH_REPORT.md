...
## Corpus Check
- Large corpus: 768 files · ~512,837 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7186 nodes · 24400 edges · 278 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 9286 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: uses: 9286 · contains: 4451 · calls: 3377 · MODIFIES: 1915 · ON_BRANCH: 1377 · rationale_for: 1162 · imports: 746 · imports_from: 586 · method: 579 · inherits: 534 · PARENT_OF: 387
...
Cohesion: 0.06
Nodes (174): Rate limiter with DB-backed persistence for security-sensitive endpoints.  When, chore/weekly-orchestrator-2026-07-03, codex/feature/agent-ops-knowledge, codex/feature/trusted-qa-bootstrap, codex/fix-render-postgres-enum-values, main, 01498d0 Harden password reset flow (verified-only, dev code return), 0737a5a feat(frontend): V72 Wave A/B/C — companies, cash, reports, waitlist, laundry, stock, api-keys, permissions, whatsapp (+166 more)
...
Cohesion: 0.02
Nodes (148): BaseModel, 805b47a Unify reservation pricing with signed quote contract, BillingPolicyPayload, BillingPolicyUpdateRequest, EmailTestRequest, MasterAdminLoginRequest, MasterAdminLoginResponse, MasterAdminSessionResponse (+140 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (147): codex/feature/pms-e2e-scale-hardening, 00bf891 Explain analytics errors and add retry action, 0255d4f Normalize Graphify artifact paths, 02f4bb4 Record Apple WebKit business matrix, 03832c5 Run onboarding journey on WebKit, 03f4d70 Document cloud date and quote regressions, 0449677 Document cloud role and preview blocker, 0510fa0 Add guest companion UI journey (+139 more)
...
Cohesion: 0.05
Nodes (148): add_reservation_guests(), buildQueryString(), cancel_reservation(), cancelReservation(), change_dates(), checkInReservation(), checkOutReservation(), clearReservationManualReview() (+140 more)
...
Cohesion: 0.03
Nodes (95): Base, Base class for all ORM models., _frontend_placeholder(), _is_demo_mode_enabled(), lifespan(), StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on, StaticFiles that returns 404 on invalid filenames (e.g., containing wildcards on (+87 more)
...
Cohesion: 0.03
Nodes (85): AllocationRunPayload, AllocationRunResponse, listRoomMovementGroups(), revertRoomMovementGroup(), RoomMoveEvent, RoomMovementGroup, triggerAllocationRecalculation(), Category (+77 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (47): _backfill_not_null_nulls(), _column_fill_value(), get_db(), get_engine(), get_session_factory(), init_db(), Database engine and session management. Supports both PostgreSQL (production) an, Fill NULLs in NOT-NULL model columns that carry a default.      A column added i (+39 more)
...
Cohesion: 0.09
Nodes (79): CashCloseReport, CashCustodyHandoff, CashCustodyStatusEnum, CashMovement, CashMovementTypeEnum, CashSession, CashSessionStatusEnum, Cash register (caja) models — Sprint 1 requirement per v72 §13.  Lifecycle:   Ca (+71 more)
...
Cohesion: 0.05
Nodes (55): acceptInvitation(), AuthResponse, _build_auth_response(), _generate_code(), getInvitationInfo(), _issue_email_token(), login(), _mask_email() (+47 more)
...
Cohesion: 0.04
Nodes (34): 1a71e7d feat: add ota allocation data foundation, 24d09f0 feat(db): v72 complete audit — phase 4, multi-tenancy tests, architecture docs, 52604e5 feat(db): PostgreSQL real validation green 8/8 — payment models, migration fixes, 941aa14 feat(payments): SLICE-07 production payment links + webhooks + idempotency, a61a51c chore: checkpoint de prueba antes de gemma 4, c580b56 ojala si, e1bc3d1 feat(db): v72 gaps phase 3 — room_movement_groups, BillingAdjustment Numeric, Room.description, e202fdd feat(db): v72 gaps phase 1+2 — Numeric precision, new tables, search indexes, OTA dedup (+26 more)
...
Cohesion: 0.08
Nodes (41): _load_manifest(), main(), ManifestContinuityError, _provider_subject(), Safe error that never prints provider values., Allow only a newer observation timestamp between provider snapshots., _timestamp(), verify_manifest_continuity() (+33 more)
...
Cohesion: 0.05
Nodes (19): 283135b feat(ops): SLICE-13 laundry + stock foundations, 32c7435 feat(phase2): port daily rates (§13) from fervent, 6f60c12 feat(security): SLICE-01 configurable permission matrix + role boundaries, 83674a3 feat(phase2): port payment surcharges (§12.3) from fervent, eed124a Harden cash reconciliation and transfer proof approvals, f01c735 Refresh Graphify after tenant isolation hardening, fd617c0 Harden private transfer proof workflow, Payment surcharge model - v72 section 12.3.  Defines per-payment-method surcharg (+11 more)
...
Cohesion: 0.11
Nodes (39): add_companions(), FastAPI routes for Guest management., Add new companions to an existing guest., Add new companions to an existing guest., GuestRatingEnum, GuestTag, GuestTagTypeEnum, Guest and GuestCompanion models. Exhaustive fields for check-in panel: identity (+31 more)
...
Cohesion: 0.06
Nodes (30): graphify_state(), main(), main(), normalize_instruction_paths(), Replace this repository's absolute root in generated instructions only., main(), run(), validate_json() (+22 more)
...
Cohesion: 0.05
Nodes (11): 3f48c33 chore: snapshot current implementation state for analysis, 5de6817 Add field-based bulk rate editing, bed8c5c feat: BR audit — pricing source of truth, caja, checkout, occupancy, surcharges, df770c3 Polish rate calendar and reservation pricing, mockCalendar, mockCategories, mockDailyRates, _resolve_jurisdiction_code() (+3 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (34): Base, MasterAdminAuditEvent, MasterAdminAuthLockout, MasterAdminSession, MasterBillingPolicy, MasterStripeSettings, MasterStripeWebhookEvent, MasterSystemEmailConnection (+26 more)
...
Cohesion: 0.08
Nodes (33): AuthUser, AcceptPayload, _assert_assignable_role(), _assert_manageable_membership(), invite_user(), InvitePayload, InviteResponse, inviteUser() (+25 more)
...
Cohesion: 0.11
Nodes (21): graphify_command_error(), inline_list(), main(), Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Parse the simple unquoted frontmatter lists used by context packs., Reject context commands that the installed Graphify CLI cannot route., Reject context commands that the installed Graphify CLI cannot route. (+13 more)

### Community 78 - "Community 78"
Cohesion: 0.09
Nodes (10): _clickhouse_healthcheck(), datastores_healthcheck(), _postgres_healthcheck(), _redis_healthcheck(), effd195 Harden analytics freshness and distributed concurrency, annotate_analytics_payload(), _as_utc_datetime(), Freshness metadata for analytics responses and derived read models. (+2 more)
...
Cohesion: 0.12
Nodes (21): 02c5612 Add tenant realtime sync and warehouse boundary, broadcastDomainChange(), DOMAIN_QUERY_PREFIXES, domainForPath(), getSenderId(), invalidateDomainQueries(), normalizeHotelId(), notifyIfRelevant() (+13 more)
...
Cohesion: 0.29
Nodes (9): 4959706 Enforce tenant isolation with PostgreSQL RLS context, Bind a SQLAlchemy transaction to the authenticated tenant.  PostgreSQL RLS polic, Set the authenticated user id used by membership RLS policies., Set or clear the current hotel id for tenant-scoped RLS policies., Set both principals for a request or a single-hotel worker job., _set_context_value(), set_tenant_context(), set_tenant_hotel_context() (+1 more)
...
- **Thin community `Community 120`** (1 nodes): `OnboardingState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 220`** (2 nodes): `mercadopago_payment_link_webhook()`, `_mercadopago_webhook_impl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 254`** (1 nodes): `credentials`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 255`** (2 nodes): `Persona`, `personas`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 257`** (1 nodes): `HotelIdentityPayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 272`** (1 nodes): `v72 fx rate snapshots table.  Revision ID: 20260624_fx_rate_snapshots Revises: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 273`** (1 nodes): `drop orphan payment_surcharge_configs table (R5b).  main carries TWO surcharge i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 274`** (1 nodes): `Add configurable public API rate limit per hotel.  Revision ID: 20260625_public_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 275`** (1 nodes): `v72 §16.2: add 'company' value to reservation_channel_code_enum.  Adds the corpo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 276`** (1 nodes): `add reservations.settlement_due_date for corporate deferred billing (R5b §3.5).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 277`** (1 nodes): `reservation waitlist flags (BRM v72 §9).  Add denormalized waitlist flags to res`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 278`** (1 nodes): `soft delete audited domain records.  Revision ID: 20260625_soft_delete Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 279`** (2 nodes): `get_mongo_db()`, `mongo_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 280`** (2 nodes): `get_neo4j_driver()`, `neo4j_healthcheck()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 281`** (1 nodes): `Build the canonical quote shared by reservation-facing surfaces.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `Defensive datastore clients for optional infrastructure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `Application decorators.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `Dependency injection helpers (auth, etc.).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Base` connect `Community 8` to `Community 236`, `Community 204`, `Community 11`, `Community 89`, `Community 50`, `Community 119`, `Community 62`, `Community 18`, `Community 31`, `Community 69`, `Community 5`, `Community 13`, `Community 15`, `Community 100`, `Community 7`, `Community 145`, `Community 1`, `Community 6`, `Community 9`, `Community 40`, `Community 2`, `Community 36`, `Community 52`, `Community 66`, `Community 120`, `Community 4`, `Community 32`, `Community 33`, `Community 26`, `Community 79`, `Community 35`, `Community 19`, `Community 30`, `Community 45`, `Community 64`, `Community 37`, `Community 90`, `Community 193`, `Community 194`, `Community 128`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `HotelConfiguration` connect `Community 6` to `Community 10`, `Community 52`, `Community 5`, `Community 73`, `Community 36`, `Community 8`, `Community 50`, `Community 1`, `Community 101`, `Community 31`, `Community 30`, `Community 241`, `Community 37`, `Community 92`, `Community 32`, `Community 95`, `Community 4`, `Community 7`, `Community 18`, `Community 64`, `Community 69`, `Community 9`, `Community 89`, `Community 13`, `Community 90`, `Community 66`, `Community 105`, `Community 173`, `Community 125`, `Community 40`, `Community 33`, `Community 51`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Reservation` connect `Community 1` to `Community 30`, `Community 40`, `Community 73`, `Community 5`, `Community 19`, `Community 8`, `Community 50`, `Community 18`, `Community 62`, `Community 31`, `Community 6`, `Community 15`, `Community 32`, `Community 37`, `Community 26`, `Community 79`, `Community 4`, `Community 45`, `Community 9`, `Community 13`, `Community 117`, `Community 105`, `Community 173`, `Community 125`, `Community 51`?**
