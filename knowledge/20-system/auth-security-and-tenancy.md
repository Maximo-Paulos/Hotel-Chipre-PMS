...
Se exige autorización explícita y alcance de hotel en toda operación sensible. Nunca se loguean secretos, tokens, datos de tarjeta o PII innecesaria. CORS debe contener exactamente los hosts de preview/producción necesarios, sin usar base compartida.
